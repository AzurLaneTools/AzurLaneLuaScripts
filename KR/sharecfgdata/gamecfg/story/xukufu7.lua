return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "맞다! 지휘관, 일이 끝나면 됭케르크한테 가서 과자 먹기로 한 약속, 잊지 않았지?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
