return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 102240,
			nameColor = "#a9f548",
			say = "좋아. 실은 우리 모항에서 \"해상 콘서트\"를 준비하고 있어. 그래서 이 해역에 공연할 무대를 건설한 거야.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "전혀 상관 없는 곳에서 이세계의 손님과 관련된 현상이 나타났다는 건…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
