return {
	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				{
					"<size=51>「낡은 것을 답습하거나, 줏대 없이 휩쓸리거나.」</size>",
					1
				},
				{
					"<size=51>「이 두 가지는 복잡하게 얽혀있지만 절대로 교차하지 않는 나선과 같다.」</size>",
					3
				},
				{
					"<size=51>「설령 그렇다 해도,」</size> ",
					5
				},
				{
					"<size=51>「거울을 깨고 궤적을 뒤튼다면 어떤 결과가 나올까?」</size>",
					7
				},
				{
					"<size=51>「현행 시스템으로 할 수 없는 일을 아예 바꾸면 어떨까?」</size>",
					9
				},
				{
					"<size=51>「게임의 규칙을, 바꿔야 할 때야.」</size>",
					12
				}
			}
		},
