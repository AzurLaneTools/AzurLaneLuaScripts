return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "셰필드… 로열 메이드단의 명예를 실추시키지는 않을 것 같군요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "좋네~ 나도 저렇게 땡땡이, 아니 로열 메이드단의 명예를 빛내고 싶은데!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "오…? 꽤 하잖아? 스테이지 위에서 보여 줄 모습, 기대하겠다고 언.니~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "스테이지는 또 다른 전장입니다. 언니, 언니의 전투는 이 두 눈으로 똑똑히 보겠습니다…!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "우후후… 지휘관님 한 사람만을 위한 라이브의 연습이라고 해둘까요~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
