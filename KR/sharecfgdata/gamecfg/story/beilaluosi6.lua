return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "기회가 되면 이걸 지휘관 동지에게 알리고 과학 기술부와 상의해봐야 겠어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "아니면 아침 식사 준비할까? 이 시간이면 기숙사 살롱에서 혼자 조용히 식사할 수 있어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "결국 우리 둘 다 같이 술에 취해버렸고...... 이 계획은 합격인 거겠지?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "걱정 마. 내가 도와줄 거니까. 이런 상태로 만든 사람도 나잖아.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "15분 후에 밖으로 연막탄을 하나 던질게. 연막에 가려진 채로 노스 유니온 기숙사를 벗어나면 돼.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
