...
_G.pg.base.gametip.doa_collection = {
	tip = {
		{
			info = "이벤트 기간: <color=#92fc63>5.4-5.18 업데이트</color>\n1. 이벤트 기간에, 이벤트에 참여하여 「캐릭터 취향」을 수집하세요. <color=#92fc63>18</color>개 수집 후 한정 가구 <color=#92fc63>「비너스 휴가 기념장」, 「장비스킨 상자(비너스 휴가)*3」</color>를 획득할 수 있습니다.\n※「비너스 휴가 기념장」은 중복 획득이 불가합니다."
		},
		{
			info = [[
2. 「캐릭터 취향」 수집 방법:
...
⑤펑펑둥 챌린지 완료]]
		...
		{
			info = "3. 수령 마감 시간은 5월 24일 23시 59분입니다."
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1.<color=#92fc63>5월 10일</color>까지 매일 0시마다 <color=#92fc63>1</color>경기씩 총 <color=#92fc63>7</color>경기가 개방되며,
누적 가능합니다. 전부 완료 후 한정 장비 <color=#92fc63>「각성 구슬」</color>및 캐
	...
	tip = {
		{
			info = [[
이벤트 규칙
<color=#92fc63>5.4-5.18 업데이트</color> 기간 동안 한정 이벤트 「휴일 항로」가 오픈됩니다.
1. 특별 작전을 통해 「비너스Pt」를 획득하여 「누적 보상」과 「보급 상점」에서 다양한 보상과 교환할 수 있습니다.
2. 「펑펑둥 챌린지」를 통해 루나 특수 장비 <color=#92fc63>「군고구마」</color>, 타마키 특수 장비<color=#92fc63>「마카롱」</color> 등 보상을 획득할 수 있습니다.
3. 「배구 연습 경기」 미니 게임 7장 완료 시 한정 장비 <color=#92fc63>「각성 구슬」</color>을 획득할 수 있습니다.
주의: 매일 1장씩 총 7장까지 개방됩니다.
4. 이벤트에서 「캐릭터 취향」 아이템 18개 수집 후, 「기념장」에서 <color=#92fc63>「비너스 휴가 기념장」</color> 등 보상을 획득할 수 있습니다. 상세한 획득 조건은 「기념장」 화면 내 설명을 참고해 주세요.
5. 「한정 건조」를 터치하여 건조 화면으로 이동할 수 있습니다.
6. 「교환 상점」을 터치하여 스킨 교환 상점 화면으로 이동할 수 있습니다.
7. <color=#92fc63>5.4-5.17</color>까지 매일 이벤트 특별 의뢰가 갱신되며, 해당 의뢰는 파견 가능한 함대의 상한이 없습니다. 의뢰 완료 시 이벤트 보상을 획득하며 진행하지 않은 의뢰는 다음날 소멸됩니다. 진행 중인 의뢰는 다음날 보상을 수령할 수 있으며, 보상 수령 후 새로운 이벤트 특별 의뢰가 갱신됩니다.]]
		}
	}
}
