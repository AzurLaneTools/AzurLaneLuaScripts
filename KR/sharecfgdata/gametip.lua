...
_G.pg.base.gametip.exercise_rule_tip = {
	tip = [[
1. <color=#92fc63>14</color>일마다 한 시즌입니다. 시즌 중 지정 계급에 도달 시 해당 보상을 획득할 수 있습니다.
2. 전투 승리 시 계급 등급에 따라 공훈을 획득합니다. 패배하더라도 <color=#92fc63>절반</color>의 공훈을 획득할 수 있습니다.
3. 전투 승리 시, 포인트를 획득합니다. 패배 시 <color=#92fc63>포인트는 차감되지 않습니다</color>.
4. 도전을 받아 패배할 시 포인트가 차감되지 않습니다.
5. 포인트가 일정 수치에 달하면 계급이 상승하며, <color=#92fc63>준장 이상</color> 계급은 일정 순위에 도달해야 합니다.
6. 계급은 1회만 도달해도 계급 보상을 즉시 획득할 수 있습니다.
7. 획득한 공훈은 공훈 상점에서 과학기술 상자, 캐릭터 등 보상과 교환할 수 있습니다.
8. 연습전 상대는 무료로 수동 변경이 가능하며, 하루에 최대 <color=#92fc63>5</color>회만 가능합니다.
9. 도전 후, 승패에 상관없이 상대 목록이 자동 변경됩니다.
10. 연습전 횟수는 매일 00:00, 12:00, 18:00마다 갱신되며 갱신 시 횟수는 <color=#92fc63>5</color>회 증가됩니다. 연습전 횟수는 최대 <color=#92fc63>10</color>회까지 누적됩니다.
	...
	tip = {
		{
			info = [[
※ 플레이 방법 ※
・「그림일기」에서는 색칠 영역으로 지정된 번호에 해당하는 물감을 선택하여 탭하면, 해당 영역에 색을 입힐 수 있습니다.
・색칠 영역은 손가락 줌 조작으로 확대하거나 축소할 수 있습니다.
・색칠은 같은 색상의 영역이 완전히 채색되거나, 물감이 모두 소진될 때까지 자동적으로 실시됩니다.
・색칠은 「물감」을 소모합니다. 물감의 잔량이 0이 되면 해당 색상의 영역을 색칠할 수 없습니다.
...
_G.pg.base.gametip.world_boss_help_meta = {
	tip = {
		{
			info = [[
<color=#92fc63>2026.9.17 ~ 2026.12.24</color>
비콘·META 새러토가·META가 진행 중입니다. 비콘·META에서는 동기화 수치를 모아 META 함선을 획득할 수 있습니다. 
...
_G.pg.base.gametip.help_shipinfo_attr = {
	tip = {
		...
		{
			info = "  <color=#92fc63FF>장비</color>: 장착 중인 장비의 능력치 강화 표시"
		},
		{
		...
		{
			info = "    장갑 타입: 중장갑, 중형장갑, 경장갑의 세 종류가 있으며, 장갑 타입에 따라 각 무기 타입과의 데미지 효율이 다르므로, 함선이나 무기 조합을 어떻게 하느냐에 따라 공략 효율이 상승함",
			icon = {
				posX = 0,
				atlas = "attricon",
				posY = -6,
		...
		{
			info = "    장전: 일부 장비의 장전 및 준비 시간을 단축시킴",
			icon = {
				posX = 0,
				atlas = "attricon",
				posY = -6,
		...
		{
			info = "    항속: 전투 중 함대 이동 속도에 영향을 줌\n       일부 스테이지에서 아군 턴의 최대 이동 거리에 영향을 줌\n ",
			icon = {
				posX = 0,
				atlas = "attricon",
				posY = 0,
		...
		{
			info = "    대잠: 대잠 장비로 주는 피해량 증가, 대잠 탐지 범위에 영향을 줌 ",
			icon = {
				posX = 0,
				atlas = "attricon",
				posY = -6,
		...
		{
			info = "    탄약량: 전투 중 잠수함 지원 및 해역 지도 상의 적 함대 점감 시 탄약 소모",
			icon = {
				posX = 0,
				atlas = "attricon",
				posY = -6,
...
_G.pg.base.gametip.ship_remould_warning_201524 = {
	tip = "개조 실시 시 <color=#92fc63>[주포 포좌 +1]</color>\n개조를 실시하시겠습니까?"
}
...
_G.pg.base.gametip.ship_remould_warning_506114 = {
	tip = "이번 개조 작업으로 <color=#92fc63>[제1무기 슬롯 전투기 장착 가능] [제1 무기 슬롯 함재기 수+2]</color>, <color=#92fc63>[제2 무기 슬롯에 모든 유형의 함재기 장착 가능] [제2 무기 슬롯 함재기 및 받침대 수+1]</color>로 업그레이드됩니다.\n계속 진행하시겠습니까?"
}


_G.pg.base.gametip.ship_remould_warning_506124 = {
	tip = "개조(근대화 개수)를 실시하면 <color=#92fc63>[첫 번째 장비 슬롯에 전투기 장착 가능]</color>, <color=#92fc63>[두 번째 장비 슬롯에 함재기 장착 가능]</color>해 집니다.\n개조하시겠습니까?"
}


_G.pg.base.gametip.ship_remould_warning_520024 = {
	tip = [[
개조(근대화 개수)를 실시하면 함종이
미사일 구축함(선봉 배치 모드)으로 변경됩니다.
또한 일부 능력치가 변화합니다.
개조하시겠습니까?]]
}
...
· 숙련도:
한계돌파 MAX를 달성한 100레벨 캐릭터는 출격 시 획득 경험치에 따라 일정 비율의 숙련도를 획득합니다. 매주 일요일에 출격 시 숙련도 비율 2배로 획득합니다.

· 대강당 레벨:
대강당 레벨업 시, <color=#92fc63>함선 연습 데이터 베이스 상한, 숙련도 상한, 숙련도 획득 비율</color> 등 관련 수치가 상승합니다.

대강당에서 시간에 따라 함선 출격 시 획득한 숙련도를 소모하여 자동으로 함선 연습 데이터를 생성합니다. 숙련도가 부족한 함선의 연습 데이터 생성 과정은 잠시 중지됩니다.

함선 연습 데이터:
숙련도 3000을 소모할 때마다 「함선 연습 데이터」 T1을 생성합니다.
 [함선 연습 데이터]는 기타 함선에게 빠르게 경험치를 획득하게 해주는 아이템입니다.

· 대강당 수업:
시간표에 따라 매일 각각의 수업이 진행됩니다.

· 시간표:
월요일: 《구축함 뇌장 수업—어뢰 발사 기술 분석》
화요일: 《순양함 포격 수업—올바른 탄약 선택 방법》
수요일: 《전함 이론 수업—대포 거함의 우세 분석》
목요일: 《항공모함 이론 수업—해공 종합 작전의 중요성》
금요일: 《구축함 실전 수업—실용 진형 기술 분석》
토요일: 《순양함 실전 수업—화력 최대화 방법 분석》
일요일: 자율 학습]]
		}
	}
}
...
·연구 경향을 선택하지 않았을 경우, 갱신 범위가 모든 스페셜 프로젝트 함선으로 확대됩니다.
		...
		},
		{
			info = [[
※새로운 기능: 연구 지향 변경
·경향 연구 선택 후, 연구 항목이 갱신될 때마다, 3가지 항목이 고정적으로 해당하는 경향 연구 항목으로 갱신됩니다.


※새로운 기능: 연구 대열
 ·연구를 시작한 항목은 [연구 완료 조건]을 달성하면 [연구 대열]에 추가할 수 있습니다.
추가된 연구 항목은 순서대로 연구가 진행되며, 취소할 수 없습니다.
연구 항목이 연구 대열에 추가된 후, 연구 항목이 새로 갱신되며 선택할 수 있습니다.
연구 대열은 최대 5개 연구 항목을 추가할 수 있으며, 한 번에 한 항목씩 연구가 진행됩니다.
...
개발 시작
1. 「특별계획함」의 개발 개방 조건을 달성하면 함선을 개발할 수 있게 됩니다. 
2. 「특별계획함」의 개발 개방 조건은 화면 중앙에 표시됩니다. 
3. 개발도크에서 대상 함선을 선택하고 「개발 시작」을 탭하면 개발을 시작할 수 있습니다. 
4. 동시에 여러 개발을 진행할 수는 없습니다. 

개발 임무
1. 대상 함선의 개발 임무가 모두 완료되면 대상 함선을 획득할 수 있습니다. 
2. 개발 중 24시간마다 새로운 개발 임무가 오픈됩니다. 또한 임무를 완료하면 개발이 진행됩니다. 
3. 첫 개발 임무는 개발을 시작하면 오픈됩니다. 
4. 일부 개발 임무는 다른 임무를 완료해야 진행할 수 있습니다. 

개발 대상 변경
1. 개발 중에 개발 대상을 다른 함선으로 변경할 수 있습니다. 
2. 개발 대상을 변경하더라도 개발 전체 진척도 및 진행 중 임무의 진척 상황은 보존됩니다. 
3. 개발 시작 및 재개 후부터 24시간 동안은 개발 대상을 변경할 수 없습니다. 

개발 완료
1. 대상 함선의 개발 임무를 모두 완료하면 개발 함선을 획득할 수 있으며, 강화 기능이 오픈됩니다. 
2. 개발 완료 후 새로운 개발 대상은 수동으로 지정해야 합니다. 

「특별계획함」 강화
1. 「특별계획함」 획득 후에는 함선 강화 기능이 오픈됩니다. 
2. 강화하려면 함선의 「강화 유닛」이 필요합니다. 
3. 「강화 유닛」은 군부연구실에서 연구하면 획득할 수 있습니다. 
4. 강화하면 「특별계획함」의 성능을 향상시킬 수 있습니다. 또한 일정 강화 레벨에 달하면 추가 강화 효과를 획득할 수 있습니다. (new!)5. 일부 특별계획함은 「강화 유닛」이 없더라도 그 대신 물자를 사용하여 강화 및 용골편찬을 실시할 수 있습니다. 
※ 주의
물자로 특별계획함을 강화·용골편찬할 경우, 매일 DR과 PR 각각 최초 15개분까지는 소모 물자량이 할인됩니다. 
...
8개째 ~ 10개째: 소모 물자 40%
11개째 ~ 15개째: 소모 물자 70%
16개째 이후: 소모 물자 100% = 1개당 1,500 소모
DR 특별계획함
0개째 ~ 2개째: 무료
3개째 ~ 6개째: 소모 물자 10%
7개째 ~ 10개째: 소모 물자 20%
11개째 ~ 15개째: 소모 물자 50%
16개째 이후: 소모 물자 100% = 1개당 6,000 소모
물자 소모량은 강화 시 강화 유닛 사용 수 선택 화면에서 자동으로 계산됩니다. 
강화 할인 횟수는 매일 4:00에 초기화됩니다. 

「특별계획함」의 최대 레벨
 「특별계획함」은 한계 돌파를 하지 않아도 레벨을 100까지 올릴 수 있지만, 최대 레벨을 올리기 위해서는 물자와 성정 유닛을 사용해 「인식 각성」을 해야 합니다. 

 「용골편찬」이란 
 ・「용골편찬」은 특별계획함의 함력이라 할 수 있는 용골을 보강하여 전력을 더욱 강화하는 시스템입니다. 
 ・특별계획함의 강화 레벨이 Lv.30에 도달하면 해당 함선의 「용골편찬」이 오픈됩니다. 
 ・함선에 대응하는 강화 유닛을 사용하여 진척도를 100%까지 채우면 해당 레벨의 용골편찬이 완료됩니다. 
 ・「용골편찬」은 최대 레벨 5까지 강화할 수 있으며, 레벨 1 ~ 4에서는 함선의 「행운」 능력치가 강화되고, 레벨 5에서는 일부 스킬이 강화됩니다. 
(new!)・일부 특별계획함은 「강화 유닛」이 없어도 그 대신 물자를 소모하여 용골편찬을 진행할 수 있습니다. 

탄막 확인 기능이란
 ・특별 계획함 Ⅱ기·Ⅲ기·Ⅳ기·Ⅴ기·Ⅵ기·Ⅶ기의 「탄막 사양」을 확인할 수 있는 기능입니다. 
...
1. 특별 스테이지의 「이지」, 「노멀」, 「하드」는 각각 날마다 출격 <color=#92fc63>15회</color>까지가 「보너스 출격」으로 간주되며, 얻을 수 있는 보상이 일반 출격 시보다 푸짐합니다. 
...
2.「EX」에서 전투하실 때에는 <color=#92fc63>매뉴얼(수동)</color> 조작으로 도전하는 것을 추천드립니다. 
...
2. 「연속 도전」 기능은 난이도 「이지」, 「노멀」, 「하드」의 특별 스테이지를 1회 클리어하면, 해당 스테이지 출격 시의 편성 화면 우측 하단에 열리는 「자동 도전」 버튼으로 이용할 수 있습니다. 
...
_G.pg.base.gametip.blueprint_simulation_confirm_29905 = {
	tip = [[
<size=28>
전술 모의전을 시작하시겠습니까?(모의전에서 아군 함선은 특수 버프의 영향을 받으며,
<color=#ff5c5c>실제 성능은 획득 함선을 기준으로 합니다.</color>)
사용 장비:<color=#92fc63>
시제형 4연장 152mm 주포
4연장 533mm 어뢰 Mark IX
2연장 20mm 엘리콘 기관포
</color></size>]]
}
...
<color=#ff5c5c>실제 성능은 획득 함선을 기준으로 합니다.</color>)
사용 장비:<color=#92fc63>
시제형 2연장 406mm SKC 주포
2연장 TbtsKC/36식 150mm 주포
시제형 4연장 30mm 기관포
</color></size>]]
}
...
<color=#ff5c5c>실제 성능은 획득 함선을 기준으로 합니다.</color>)
사용 장비:<color=#92fc63>
시제형 4연장 330mm 주포 Mle1931(대형순양함용)
138.6mm 단장포 Mle1929
2연장 40mm 보포스 대공포
</color></size>]]
}
...
<color=#92fc63>우편함에 대해</color>
 ...
 3. 일반 우편에 [중요]를 설정하면, [중요] 우편으로 분류할 수 있습니다. [중요]로 설정한 우편은 일괄 삭제로 삭제되지 않습니다.
 4. [물자], [연료], [공훈 Pt], [큐브] 이외의 우편은 [특수]로 분류됩니다.

  <color=#92fc63>저장실</color>
 1. 우편에서 수령한 첨부 아이템 중 [물자]와 [연료]는 저장실에 보관됩니다.
 2. 원하면 언제든 저장실에서 자원을 반출할 수 있습니다.
...
자신의 UID(이벤트 배너에 표시된 숫자)를 친구 쪽 이벤트 배너에 입력시키면, 친구가 사령부 동원지령에 참가할 수 있게 됩니다. 
사령부 동원지령에 참가한 친구의 ID는 초청자의 배너 우측 하단에 표시됩니다. 
...
<color=#FF5C5C>대형함 건조</color> <color=#ff5e39>UR</color>: 1.2% <color=#ffde38>SSR</color>: 7%  <color=#d797ff>SR</color>: 12%  <color=#3dc6ff>R</color>: 51%  N: 28.8% 
<color=#FF5C5C>특형함 건조</color>  <color=#ff5e39>UR</color>: 1.2% <color=#ffde38>SSR</color>: 7%  <color=#d797ff>SR</color>: 12%  <color=#3dc6ff>R</color>: 51%  N: 28.8%]]
		},
		{
...
_G.pg.base.gametip.challenge_help = {
	tip = {
		...
		{
			info = "한계 챌린지란 숙련된 지휘관(Lv80 이상)만 참가할 수 있는 콘텐츠입니다.\n전용 편성으로 다양한 스테이지를 클리어하면 난이도에 따라 한정 채팅 아이콘 및 채팅 프레임을 획득할 수 있습니다.\n"
		},
		{
			info = "[플레이 방법]"
		},
		{
			info = "1. 한계 챌린지 모드에는 세 가지 난이도의 스테이지가 등장합니다. 스테이지를 클리어하면 최단 클리어 시간이 기록되며, 클리어한 스테이지에 따라 한정 보상(채팅 아이콘, 채팅 프레임)을 1회 획득할 수 있습니다. 이미 획득한 아이템을 중복으로 획득한 경우, 물자로 자동 변환됩니다."
		},
		{
			info = "2. 한계 챌린지 모드 화면에서는 '편성'으로 챌린지 전용 편성을 설정할 수 있으며, '전투 시작'으로 스테이지에 도전할 수 있습니다. 또한, 한계 챌린지 모드에서는 지휘냥 및 잠수함을 편성할 수 있으며, 전투 한 번당 잠수 지원을 1회 실시할 수 있습니다."
		},
		{
			info = "3. 한계 챌린지 모드의 전투는 연료를 소비하지 않으며, 전함의 호감도 및 승패 수, 함선/지휘관/지휘냥 경험치에도 영향을 주지 않습니다. 또한, 오픈 기간 중에는 여러 번 도전할 수 있습니다."
		},
		{
			info = "4. 전투 중에는 언제든 전투를 중단할 수 있습니다. 전투를 중단할 경우, 클리어 시간이 기록되지 않습니다.\n"
		},
		{
			info = "[스테이지 리셋에 대해]"
		},
		{
			info = "1. 한계 챌린지의 스테이지는 매월 첫 날 0시에 새로운 스테이지로 바뀌며, 공략 상황 및 클리어 시간 기록, 보상, 출몰 보스 또한 새롭게 바뀝니다."
		},
		{
			info = "2. 매월 첫 날 0시 시점에 한계 챌린지 스테이지를 진행하던 중이었다면, 해당 전투를 클리어해도 새로운 스테이지를 클리어한 것으로는 간주되지 않으니, 이 점 주의하시기 바랍니다."
		}
	}
}
...
_G.pg.base.gametip.doa_collection = {
	tip = {
		...
		{
			info = [[
「캐릭터 선호 정보」에서는 콜라보 이벤트에 참여하여
다양한 조건을 달성함으로써 「캐릭터 선호 정보」를
오픈할 수 있습니다. 
「캐릭터 선호 정보」 18개를 모두 오픈하면, 한정 가구
「비너스 기념상」(총 1개만 소지 가능), 「장비 스킨 상자(비너스 바캉스)*3」를 획득할 수 있습니다. ]]
		},
		{
			info = "■캐릭터 선호 정보 오픈 방법"
		},
		{
			info = [[
캐릭터 선호 정보는 다음 각 방법을 통해 오픈
됩니다. 
・이벤트 해역(스테이지) 클리어
・이벤트 임무 클리어
・비너스 Pt 「획득 합계 보상」
・「미니 게임 2(엉덩이 씨름 게임)」, 「미니 게임 1(비너스 연습 경기)」에 참여

캐릭터 선호 정보의 오픈 보상은 5월 21일(목) 23:59까지
기간 한정으로 수령할 수 있습니다. ]]
		}
	}
}
	...
	tip = {
		{
			info = [[
■ 만쥬 레스토랑에 대해
・「만쥬 레스토랑」에서는 미니 게임으로 획득한 「세뱃돈」을 개봉하여 보상을 얻을 수 있습니다. 
・「세뱃돈」은 「푸슌의 대모험」, 「그림일기」, 「푸보의 완전 작전」, 「춘절 폭죽」을 플레이하면 획득할 수 있습니다. 
・획득한 「세뱃돈」은 15개째까지는 「세뱃돈(대)」가 됩니다. 
・획득한 「세뱃돈」을 개봉할 때는「세뱃돈(대)」부터 우선적으로 개봉됩니다. 
개봉하면, 다이아 등의 보상을 무작위로 획득할 수 있습니다. 
또한 「세뱃돈」을 총 15개 개봉하면, <color=#92fc63>「푸슌」의 스킨(복각)</color>을 획득할 수 있습니다. 「세뱃돈」을 총 25개 개봉하면, <color=#92fc63>「와카츠키」의 스킨(복각)</color>을 획득할 수 있습니다.]]
		}
	}
}
...
1. 매일 1회의 답변 기회가 해제됩니다(최대 14회). 정답을 <color=#92fc63>7</color>회 맞히면 보상을 획득합니다. 오답 선택 시 일정 시간 대기 후 다시 답을 선택해야 합니다. 
...
정답 5회: 범용 부속 T3*3, 300 물자 
정답 6회: 공격 교본T3*2, 100 연료 
정답 7회: <color=#92fc63>고급 지향형 강화 유닛 – 제5기*2</color>，300 물자]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 소개:
 1. 이벤트 기간 동안, 7일 이벤트 임무를 완성하면 정보PT를 획득할 수 있습니다. 최대 60PT 획득 가능 
 2. 정보 페이지의 각 칸을 터치하여 해독할 때마다 정보PT를 1 소모합니다.
 3. 일정 횟수의 정보 해독을 완료 시 보상을 획득할 수 있습니다.
 10회 완료: 물자*1000
 20회 완료: 범용 부속 T3*5
 30회 완료: 물자*1000
 40회 완료: 공격 교본 T3*2
 50회 완료: 랜덤 개조 도면 T3*2
 60회 완료: 지원 교본 T3*2 
 4. 정보 페이지 3장을 모두 해독 완료 후 암호 페이지 버튼이 나타나며 버튼을 누르면 기밀 해제 모드로 진입합니다. 기밀 해제 모드에서 다시 정보 페이지를 터치하여 비교 대조할 수 있습니다. 대조 후 각 정보 페이지마다 암호를 3개 획득하여 칸에 입력할 수 있습니다. <color=#92fc63>9자리 암호를 모두 정확하게 입력하면 최종 보상을 획득할 수 있습니다</color>.
5. 9자리 암호는 3개씩 한 조를 이루며, 각 조마다의 암호는 한 정보 페이지에서 얻을 수 있습니다.
6. 잘못된 암호 입력 시, 좌측의 적색등이 켜지고, 정확한 암호 입력 시, 우측의 녹색등이 켜지며 암호가 저장됩니다.]]
		}
	}
}
...
_G.pg.base.gametip.retire_setting_help = {
	tip = {
		{
			info = [[
 ・「퇴역 실수 방지 확인」을 ON으로 설정하면, 퇴역 대상 함선이 도크 내에다른 동명함이 없는 <color=#92fc63>유일한 함선</color>인 경우, 퇴역 확인 화면이 표시됩니다.
 ・일괄 퇴역:
  1. 레어도가 SR, R, N
  2. 잠금(보호) 상태가 아님
  3. 레벨 1
  4. 부린 이외
  5. 출격 중이거나 편성 중, 비서함으로 설정 중이거나 의뢰 중 등 특수 상태가 아님
  ・「일괄 설정」은 상기 1~5의 조건을 모두 충족하는 함선만 대상으로 합니다.
  ・기본적인 우선 순위는 N, R, SR(자동 선택의 우선 순위는 설정 화면에서 설정 가능)]]
		}
	}
}
...
_G.pg.base.gametip.help_monopoly_car_2 = {
	tip = {
		...
		{
			info = "출발점을 통과할 때마다 물자*200를 획득합니다."
		},
		{
			info = "    ：일정량의 물자 획득",
			icon = {
...
_G.pg.base.gametip.guild_member_tip = {
	tip = {
		...
		{
			info = "2. 함대 사령관 및 부사령관은 <color=#92fc63>자신보다 직위가 낮은 멤버</color>의 역할을 자유롭게 변경할 수 있습니다. 함대 사령관은 <color=#92fc63>부사령관</color> 중에 한하여 새로운 함대 사령관을 임명할 수 있습니다. 대함대를 위임할 수 있는 부사령관 수는 최대 <color=#92fc63>4</color>명입니다."
		},
		{
...
_G.pg.base.gametip.ur_exchange_help_tip = {
	tip = {
		...
		{
			info = "부린 모으기는 \"\"특장형 부린 MKⅢ\"\"로 교환 가능한 \"\"특장 원형\"\"을 획득할 수 있는 상설 이벤트입니다. 이벤트 진행 기간 중에는 다음 방법으로 \"\"특장 원형\"\"을 획득할 수 있으며, 매월마다 획득 가능한 개수에 제한이 있습니다. 획득 가능한 개수 제한은 매월 1일 0:00에 초기화됩니다."
		},
		{
			info = "■ \"\"특장 원형\"\" 획득 방법"
		},
		{
			info = [[
① 주간 임무 ""일간 임무 20/50개 완료""를 완수하면, ""특장 원형""을 대량으로 획득할 수 있습니다. 
② 메인 해역(보통·어려움), 이벤트 해역, 작전 문서의 상설 이벤트 해역에 출격하여 보스 함대를 격퇴하면 ""특장 원형""을 소량 획득할 수 있습니다. 
③ 군부연구실에서 연구를 실시하면 ""특장 원형""을 소량 획득할 수 있습니다. 
④ 건조로 획득한 UR 함선을 퇴역시키면 ""특장 원형""을 획득할 수 있습니다.]]
		}
	}
}
...
2. 추가 탐지 범위기본 탐지 범위를 제외하고, 기타 방식을 통해 추가 탐지 범위를 늘릴 수 있다.
기본 범위와 추가 범위를 더한 후, 실제 대잠 소나 탐지 범위가형성된다.
 ·후열에 편성된 모든 캐릭터들의 대잠 수치 합계 후, 공식에 따라 추가 범위를계산한다.
...
_G.pg.base.gametip.venusvolleyball_help = {
	tip = {
		...
		{
			info = [[
「비너스 연습 경기」는 비치발리볼 미니 게임을 플레이하여 보상을 획득하는
미니 이벤트입니다. 
캐릭터를 선택하여 처음부터 오픈된 7개의 스테이지를 모두
클리어하면, 콜라보 장비 「비너스 각성 젬」을
획득할 수 있습니다. ]]
		},
		{
			info = "■ 플레이 방법"
		...
		{
			info = [[
본 경기, 그리고 본 경기 클리어 후에 오픈되는 자유롭게 플레이
가능한 연습 경기, 이렇게 총 두 가지가 있습니다. 
・경기에 참가하려면 「시작」을 탭하고,
팀 캐릭터를 선택해야 합니다. 
・경기에서는 멤버가 자동으로 필드를 이동하며,
화면을 적절한 타이밍에 탭하면 서브나 어택이
성공 판정이 됩니다. 
・본 경기는 팀 멤버를 변경할 수 없습니다. 
・본 경기는 매일 횟수 제한 없이 재도전할 수
있습니다. 
・자유 경기는 매번 팀 멤버를 다시 선택할 수
있습니다. ]]
		}
	}
}
...
_G.pg.base.gametip.doa_main = {
	tip = {
		...
		{
			info = "휴일 백사장은 이벤트 「휴일 항로」의\n메인 페이지로, 이벤트 내 각종 화면으로 이동할 수\n있습니다. "
		},
		{
			info = "■ 각 콘텐츠 설명"
		},
		{
			info = [[
이벤트 해역：
이벤트 기간 동안 오픈되는 한정 해역입니다. 이벤트 해역을
클리어하면 아이템 「비너스 Pt」를 수집할 수
있습니다. ]]
		},
		{
			info = "상점:\n「비너스 Pt」를 다양한 보상으로 교환할 수 있습니다. "
		},
		{
			info = "합계 보상:\n획득한 「비너스 Pt」의 누적 수량에 따라, 함선 「뇨텐구」 등\n다양한 보상을 획득할 수 있습니다. "
		},
		{
			info = "한정 건조:\n건조의 「기간 한정 건조」 페이지로 이동합니다. "
		},
		{
			info = "스킨:\n상점의 「스킨」 페이지로 이동합니다. "
		},
		{
			info = [[
컬렉션:
다양한 조건을 달성하여 「캐릭터 선호 정보」를
오픈할 수 있습니다. 「캐릭터 선호 정보」를 모두 오픈하면
한정 가구 「비너스 기념상」을 획득할 수 있습니다. ]]
		},
		{
			info = [[
미니 게임 2(엉덩이 씨름 게임):
미니게임을 플레이할 수 있습니다. 첫날 오픈된 모든 스테이지를 클리어하면
「루나」의 특수 장비 「군고구마」, 「타마키」의 특수 장비 「마카롱」 등을 획득할 수
있습니다. ]]
		},
		{
			info = [[
미니 게임 1(비너스 연습 경기):
미니게임을 플레이할 수 있습니다. 첫날 오픈된 모든 스테이지를 클리어하면
특수 장비 「비너스 각성 젬」을 획득할 수
있습니다. ]]
		},
		{
			info = [[
또한, 콜라보 이벤트 기간 동안 매일 「특별 의뢰」가
등장합니다. 의뢰를 수행하면 보상을 획득할 수 있습니다.
 특별 의뢰는 기존의 의뢰 출격 슬롯 및 의뢰 등장 슬롯과는
별도로 취급되며, 의뢰 보상은 5월 15일(금) 23:59까지
기간 한정으로 수령할 수 있습니다. ]]
		}
	}
}
	...
	tip = {
		{
			info = [[
■ META 연구실이란
META 연구실이란, 「META」 함선을 획득 및 강화할 수 있는 전용 시스템입니다. 
META 연구실에서는 다음 조작을 실시할 수 있습니다. 
·「META」 함선별 획득 정보 확인 및 함선 획득
·「META」 함선별 동기화 수치 획득
·「META」 함선의 의장 강화, 스킬 습득, 한계돌파
·「META」 함선은 한 종류에 한 척만 소유할 수 있으며, 「META」 함선은 퇴역 및 강화 재료로 사용할 수 없습니다. 
...
※<color=#92fc63>2026.9.18-2026.12.24</color>새러토가·META의 비콘·META 오픈 기간 동안에는 「새러토가·META」의 동기화 수치를 획득할 수 있습니다. 
 동기화 수치 및 동기화 수치 총 획득 수 보상은 진행 기간 종료 후에 초기화됩니다. 

■ 「META」 함선의 의장 강화
·획득한 「META」 함선 화면의 「의장 강화」를 탭하면 의장 강화 화면을 확인할 수 있습니다. 
·강화 실시 시에는 포격·뇌격·항공·장전 중 임의 항목을 선택해서 강화할 수 있습니다. 
·강화를 실시하면 그에 상응하는 능력치가 상승합니다. 또한 강화를 일정 단계 진행하면, 능력치에 추가 보너스를 얻을 수 있습니다. 
·「META」 함선의 「의장 강화」는 특정 재료를 소모합니다. 

■ 「META」 함선의 한계돌파
·획득한 「META」 함선 화면의 「한계돌파」를 탭하면, 한계돌파 화면을 확인할 수 있습니다. 
·한계돌파를 실시하려면 「부린」이 아닌 해당 함선의 「결정」이 필요합니다. 
·「결정」은 META 연구실의 동기화 수치로 획득할 수 있습니다. 
■ 「META」 함선의 스킬 습득
·「META」 함선의 스킬 습득과 강화는 「META 연구실」에서만
실시할 수 있습니다. 
·획득한 「META」 함선 화면의 「한계돌파」를 탭하면, 스킬 습득 화면을 확인할 수 있습니다. 
·「META」 함선의 스킬 습득에는 재료가 필요하며, 강화는 전용 임무를 처리해 습득 경험치를 쌓음으로써 실시할 수 있습니다.
 (습득 경험치는 하루에 획득할 수 있는 한도가 있습니다.)
·「META」 함선은 각각 한 종류의 스킬만 동시에 강화할 수 있습니다. 
]]
		}
	}
}
...
_G.pg.base.gametip.activity_event_building = {
	tip = {
		{
			info = [[
이벤트 기간: 2021.9.24-10.22
이벤트 규칙: 
1. <color=#92fc63>9월 30일</color>까지 매일 0시마다 임무가 1개씩 해제되며, 이벤트 임무 완성 시 「파크 건설 재료」 및 보상을 획득할 수 있습니다. 이벤트 임무는 누적 가능합니다.
2. 「파크 건설 재료」를 소모하여 쥬쥬 워터파크에서 건물을 업그레이드할 수 있으며, 각 건물은 여러 버프를 제공해 줍니다.
3. 건물마다 3가지 등급이 있으며, 등급 상승에 따라 제공하는 버프도 증가합니다.
4. 업그레이드 가능한 4가지 건물:
쥬쥬 서핑
쥬쥬 다이빙
슬라이드 월드
쥬쥬 폭포
5. 이벤트 기간 동안 매일 사용 가능 횟수를 1회 획득하며, 최대 7회 누적됩니다.
6. 사용 가능 횟수를 보유 중인 경우, 쥬쥬 인양단에 참여할 시 출석 횟수를 획득하며, 출석 횟수 7회 도달 시 <color=#92fc63>「축제 초대장」</color>을 획득할 수 있습니다.
7. 사용 가능 횟수는 쥬쥬 워터파크 화면 우측에서 확인할 수 있으며, 출석 진도는 쥬쥬 워터파크 화면 「초대장」 버튼을 눌러 확인할 수 있습니다.
8. 사용 가능 횟수가 없을 경우, 쥬쥬 인양단 진행 시 출석 횟수를 획득하지 못합니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
■ 플레이 방법
「만쥬 샐비지」는 화면을 탭해서 후크를 떨어뜨려, 다양한 아이템을 끌어올림으로써 점수를 획득하는 미니 게임입니다. 

■ 규칙
・게임이 시작되면 화면 내에 다양한 샐비지 대상이 등장합니다. 아이템이나 캐릭터를 탭하여 끌어올리면, 점수가 증가하거나 감소합니다.
・샐비지 대상 목록
　회중시계: 남은 시간 +15초
　보물상자: 600점
　진주: 500점
...
　이168: -50점
　어뢰: -50점
・남은 시간이 0이 되거나 [돌아가기] 버튼을 탭하면 게임이 종료됩니다.]]
		}
	}
}
...
이벤트 기간: 2021.9.24-10.22
이벤트 규칙: 
1. <color=#92fc63>9월 30일</color>까지 매일 0시마다 임무가 1개씩 해제되며, 이벤트 임무 완성 시 「추첨권」을 2장 획득합니다. 이벤트 임무는 누적 가능합니다.
2. 추첨권으로 한 번 회전시킬 수 있으며, 모든 이벤트 임무 완성 시 구슬 기계의 구슬 수량과 같은 「추첨권」을 획득할 수 있습니다.
3. 구슬 기계에는 금색 구슬 1개, 보라색 구슬 2개, 파란색 구슬 3개, 녹색 및 흰색 구슬이 4개씩 들어있습니다. 각 색깔의 구슬 별로 각기 다른 보상을 획득합니다:
금색 구슬: 고급 지향형 강화 유닛・제4기*2
보라색 구슬: 고효율 작전 명령서*5
파란색 구슬: SSR 냥박스*1
초록색 구슬: T3 랜덤 교본*2
흰색 구슬: 자오중공 장비상자 T4*2]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1. <color=#92fc63>9월 4일</color>까지 카우보이 경기가 매일 0시마다 <color=#92fc63>1</color>회씩 총 <color=#92fc63>7</color>경기가 개방되며, 누적 가능합니다. 경기를 완료할 시 풍부한 보상을 획득할 수 있습니다.
게임 규칙:
	...
	tip = {
		{
			info = [[
이벤트 규칙:
이벤트 기간 동안 매일 사용 가능 횟수 <color=#92fc63>1</color>회를 획득하며, 최대 <color=#92fc63>7</color>회까지 누적할 수 있습니다.
1. 사용 가능 횟수를 보유 중인 경우, 쥬쥬 인양단에 참여할 시 출석 횟수를 획득하며, 출석 횟수 <color=#92fc63>7</color>회 도달 시 <color=#92fc63>「축제 초대장」</color>을 획득할 수 있습니다.
2. 사용 가능 횟수는 쥬쥬 워터파크 화면 우측에서 확인할 수 있으며, 출석 진도는 쥬쥬 워터파크 화면 <color=#92fc63>「초대장」</color> 버튼을 눌러 확인할 수 있습니다.
3. 사용 가능 횟수가 없을 경우, 쥬쥬 인양단 진행 시 출석 횟수를 획득하지 못합니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1. <color=#92fc63>9월 28일</color>까지 매일 0시마다 <color=#92fc63>1</color>장의 게임이 오픈됩니다. 총 <color=#92fc63>7</color>장이며 누적 가능합니다. 게임을 완료하여 고기를 누적 획득하면 유다치 한정 개조 아이템—고기 냄새 향수를 획득할 수 있습니다.
이미 고기 냄새 향수 소지 혹은 도크에 개조 완료한 유다치 보유 중일 시 이번에 획득할 고기 냄새 향수는 기념품 대식가의 증표로 대체됩니다.
게임 규칙:
1. 화면에 스크롤 바가 나타납니다. 닭다리가 이동할 때 화면을 터치하여 닭다리를 정지시킬 수 있으며, 유다치가 닭다리를 더 빨리 먹을 수 있도록 녹색 구역에 닭다리를 정지시켜야 합니다. 녹색 구역에 누적 15회 정지시키면 대식가 대회에서 승리합니다.
2. 다른 색깔 구역에 닭다리를 정지시킬 시 획득 포인트가 다릅니다: 녹색 구역에 정지시킬 때 중심부에 가까울수록 높은 점수를 얻습니다. 황색 구역은 점수가 없으며, 홍색 구역은 감점입니다.
3. 게임 시간이 0이 되거나 게임 내 퇴장 버튼 터치 시 게임을 완성한 것으로 간주됩니다. 기타 원인으로 인해 중도 퇴장 시 미완성한 것으로 간주됩니다.]]
		}
	}
}
...
(1)기본 투어 보상: <color=#ff5c5c>「후소·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제4기</color> 등
    지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>요크타운 스킨 「성자의 날개」</color>, <color=#ff5c5c>다이아</color> 등
...
（2）「특허 투어 패스」는 <color=#ff5c5c>이벤트 종료 1시간 전</color> 판매가 중지됩니다(11.30 22:59:59). 구매 시간에 주의해 주세요.
	...
	tip = {
		{
			info = [[
이벤트 규칙：
8.03-8.17점검 전 까지 기간 한정 이벤트 「호광은 교차하는 세계에서」 오픈
1.특별 작전을 통해 「호광 결정」을 획득하여 「괴수 양성」과
「보급 상점」에서 풍부한 보상과 교환
2.「격전! 그리드맨 쥬 vs 괴수 쥬!」 제7회를 완료하여 한정 가구 그림 「도시 격전!」 획득주의: 매일 1회씩 총 7회까지 개방됩니다.
3.「유메의 여행」에 참여하여 한정 가구, 「호광 결정」이 포함된 풍부한 보상 획득자세한 보상 및 획득 조건은 「유메의 여행」 화면에서 확인해 주세요.
4. 이벤트 임무를 완성하여 「세이렌 정보」 12개 수집 후, 「피규어 선반」에서 「SSSS 기념장」 획득 가능자세한 획득 조건은 「피규어 선반」 화면에서 확인해 주세요.
	...
	tip = {
		{
			info = [[
이벤트 규칙:
미니 게임 ""격전! 그리드맨 쥬 VS 괴수쥬!""에서는 제한 시간 내에 화면 하단의 블록을 탭으로 지우며, 같은 색깔의 블록을 모아 점수를 획득하는 미니 게임입니다. 

미니 게임은 8/9(수)까지 매일 새로운 게임이 오픈되며, 클리어하면 장비 스킨 상자 및 호광 결정, 한정 가구를 획득할 수 있습니다. 
(오픈된 스테이지 하나당 한번만 획득 가능)

■ 플레이 방법
・화면 하단의 블록을 탭하면, 탭한 블록과 해당 블록 근처에 있는 같은 색깔 블록을 지울 수 있습니다. 또한, 블록을 지워서 같은 색깔 블록을 3개 이상 붙이면, 같은 색깔 블록이 모두 사라집니다. 
・블록이 두 개 이상 사라질 때마다 SD 캐릭터가 공격을 실시하고, 점수를 획득함과 동시에 해당 색깔에 대응되는 화면 상단의 필살기 게이지, 화면 하단의 변신 게이지가 쌓입니다. 
・필살기 게이지가 MAX가 되면, SD 캐릭터가 필살기를 사용하며, 점수를 획득할 수 있습니다.
・변신 게이지가 MAX가 되면, SD 캐릭터가 파워업합니다. 또한, 필살기의 연출 및 획득 점수가 변합니다. 
・파워업 상태에서는 블록을 지우더라도 변신 게이지가 상승하지 않습니다. 또한, 파워업 상태에서는 변신 게이지가 계속 감소하며, 0에 도달하면 원래 상태로 돌아갑니다. 
・제한 시간이 0이 되면, 게임 클리어로 처리됩니다. 
・게임은 여러 번 도전할 수 있습니다. 
]]
		}
	}
...
_G.pg.base.gametip.ssss_medal_tip = {
	tip = {
		{
			info = "이벤트 기간: <color=#92fc63>8.03-8.17 점검 전</color>\n1.이벤트 기간 동안 이벤트에 참여하여 「세이렌 정보」<color=#92fc63>12</color>개 모두 수집 시, <color=#92fc63>「SSSS 기념장」</color> 및 랜덤 3개의 <color=#92fc63>「SSSS」시리즈 장비 스킨</color> 을 획득 가능"
		},
		{
			info = "2.세이렌 정보의 획득 조건은 아카네의 피규어 선반 화면에서 확인해 주세요."
		},
		{
			info = "3.수령 기간은 8월 23일 23시 59분까지입니다."
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1.<color=#92fc63>1월 8일</color>까지 매일 0시마다 신규 게임<color=#92fc63>1</color>장 오픈, 총<color=#92fc63>7</color>장, 누적 가능. 7장의 게임을 완성하면 한정 가구를 포함한 보상을 획득 가능.
게임 규칙:
1. 게임은 한 장 당 세 판으로 구성되어 있으며, 세 판의 점수의 총합이 최종 득점입니다.
2. 좌측 근육 지휘냥을 눌러 차징할 수 있으며, 위아래로 이동하여 스톤 발사 방향을 조절할 수 있습니다. 손을 떼면 스톤이 발사됩니다. 스톤이 장애물에 부딪히면 각도에 따라 튕기며 이때 추가 점수를 획득합니다.
3. 스톤을 발사해 동그란 원 안에 도달하면 득점합니다. 파란색 구역 1000점, 노란색 구역 2000점, 빨간색 구역 3000점. 원 밖으로 나갈 시 점수를 획득하지 못합니다.
4. 게임을 완료하거나 퇴장 버튼을 눌러 퇴장할 경우 게임을 완료한 것으로 간주됩니다. 기타 원인으로 인해 중도 퇴장할 경우 미완료로 간주됩니다.]]
		}
	}
}
...
_G.pg.base.gametip.maid_task_tips1 = {
	tip = {
		{
			info = [[
이벤트 기간 동안 매일 2개씩 임무를 해제할 수 있으며, 1월 4일 모든 임무를 해제할 수 있습니다.
1. 「탄산과 홍차」 이벤트의 모든 임무 완료 시 한정 가구 「로열 네이비 찻집」&「메탈 블러드 카페」를 획득할 수 있습니다.
2. <color=#ff5c5c></color>1~6일차 이벤트 임무 완료 시 건물 업그레이드 아이템을 획득할 수 있습니다<color=#ff5c5c></color>. 건물 업그레이드 아이템을 사용하여 신년 축복 페이지에서 로열 네이비 찻집과 메탈 블러드 카페 건물을 업그레이드할 수 있으며, 건물 업그레이드 시 버프 효과가 상승합니다.
...
_G.pg.base.gametip.pray_cant_tips = {
	tip = "카드를 선물하면 소원 빌기 가능 횟수를 얻을 수 있습니다."
}
...
_G.pg.base.gametip.help_xinnian2022_feast = {
	tip = {
		{
			info = [[
이벤트 기간: <color=#92fc63>2021.12.29-2021.1.13</color>
이벤트 소개:
「쥬쥬 컬링」: 미니 게임에 참여하여 사우스햄튼 한정 스킨 「오후의 여유로운 선율」 획득
「폭죽 공방」: 미니 게임에 참여하여 한정 캐릭터 「Z28」 획득
「에마 기원」: 에마 기원에 참여하여 보상 「연하장」 획득
「스킨상점」: 신년 한정 스킨 구매
「한정 건조」: 한정 캐릭터 건조
「로열 네이비 찻집」&「메탈 블러드 카페」: 탄산과 홍차 임무에 참여하여 업그레이드 허가증을 획득하고 건물 업그레이드. 건물등급 차이가 1을 넘지 않아야 계속 업그레이드 가능]]
		}
	}
}
	...
	tip = {
		{
			info = [[
■ 개요
겨울 축하 카드와 소원은 「소원 빌기」로 함대에 일정 기간 동안 강화 효과를 부여하는 이벤트입니다. 

「카드」를 선물하면 「겨울의 소원」을 1개 획득할 수 있습니다. 「겨울의 소원」을 7개 모으면 이벤트 페이지에서 함선으로 교환할 수 있는 「소원 카드(2026)」를 획득할 수 있습니다. 

「소원 빌기」를 실시하면 함선 강화 효과를 일정 시간 동안 얻습니다. 

■ 「카드」에 대해
・이벤트 기간 중에는 매일 「잔여 카드」 횟수가 1회 증가합니다(최대 7회). 
・「잔여 카드」를 가지고 있는 상태에서는 함선에게 카드를 선물할 수 있습니다. 
・카드를 선물하면 다음 효과가 발동됩니다.
　① 「겨울의 소원」 1개 획득
　② 소원 빌기 가능 횟수 2회 증가
　③ 카드를 받은 함선에 의한 함대 강화 효과 1개 획득
　※ ③의 함대 강화 효과는 함선마다 다릅니다.
　※ ③에 의한 함대 강화 효과는 동시에 1종류만 적용되며, 새로 함선에게 카드를 선물할 경우 이전 효과는 덮어쓰기됩니다. 
・「겨울의 소원」을 7개 모으면 이벤트 배너에서 「소원 카드(2026)」를 획득할 수 있습니다.
・「소원 카드(2026)」를 창고에서 사용하면 SSR 함선 1척과 기념 아이템을 획득할 수 있습니다.

■ 「소원 빌기」에 대해
・카드를 선물하면 소원 빌기 가능 횟수가 2회 증가합니다.
・소원 빌기 가능 횟수를 보유한 상태에서 화면 우측의 소원 빌기 버튼을 탭하면 「소원 빌기」를 실시할 수 있습니다.
・「소원 빌기」를 실시하면, 3종류의 강화 효과 중 1개를 선택하여 일정 시간 동안 함대에 부여할 수 있습니다.
　※ 「소원 빌기」에 의한 함대 강화 효과는 동시에 1종류만 적용되며, 새로 「소원 빌기」를 실시할 경우 이전 효과는 덮어쓰기됩니다. ]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1. <color=#92fc63>1월 4일</color>까지 0시마다 게임 횟수를 <color=#92fc63>1</color>회씩 총 <color=#92fc63>7</color>회 획득합니다. 누적 가능.
2. 「신년 폭죽 공방」에 참여하여 <color=#92fc63>게임 결산</color> 진행 시 게임 횟수를 소모하며 보상과 불꽃놀이 티켓을 획득합니다. 티켓 7장을 수집하면 한정 캐릭터 <color=#92fc63>「Z28」</color>을 획득할 수 있습니다.
3. 게임 횟수가 없는 상황에서 「신년 폭죽 공방」에 참여할 시 보상과 불꽃놀이 티켓을 얻지 못합니다.
4. 게임을 완료하거나 퇴장 버튼을 눌러 퇴장할 경우 게임을 완료한 것으로 간주됩니다.
기타 원인으로 인해 중도 퇴장할 경우 미완료로 간주됩니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
<size=31><color=#92fc63>TIPS:
게임 횟수가 없어도 폭죽 공방에 참여할 수 있지만 불꽃놀이 티켓과 보상은 획득하지 못합니다.</color></size>
폭죽 제작 과정:
1. 세팅 시작을 터치하여 폭죽 제작을 시작합니다.
2. 폭죽은 안쪽, 중간, 바깥 3개의 층으로 나뉩니다. 색공을 터치하여 폭죽에 넣을 수 있으며, 공의 색은 폭죽의 색에 영향을 미칩니다.
이미 넣은 공을 다시 터치하면 공을 뺄 수 있으며, 공백을 터치하면 선택한 구역을 전환할 수 있습니다.
3. 3개의 층을 모두 채운 뒤, 장입 시작을 터치하여 폭죽을 장입하며, 게임 횟수를 보유한 상황에서 장입 시 게임 횟수를 소모하고 불꽃놀이 티켓과 장입 총 가치에 따른 각각의 보상을 획득합니다.
4. 장입 3회 후 폭죽 제작이 완료됩니다. 제작한 폭죽은 신년 축복 이벤트 화면의 불꽃놀이 버튼을 통해 사용할 수 있습니다. 가장 최근에 제작한 폭죽부터 사용됩니다.
5. 폭죽은 기타 화면으로 이동하거나 신년 축복 이벤트에서 퇴장할 때까지 발사됩니다. 신년 축복 이벤트 화면에 재진입 시 다시 버튼을 눌러 폭죽을 발사할 수 있습니다. 이튿날에는 폭죽을 다시 세팅하여야 합니다.
...
_G.pg.base.gametip.springfes_tips1 = {
	tip = {
		{
			info = [[
이벤트 기간: <color=#92fc63>2022.1.27-2021.2.10</color>
소개: 
<color=#92fc63>「푸슌의 대모험III」</color>: 미니게임 참여하고 한정 캐릭터 <color=#92fc63>「푸슌」</color> 획득
<color=#92fc63>「하이티엔과 하이치의 그림 세계」</color>：이벤트 참여하고 한정 캐릭터 <color=#92fc63>「하이티엔」</color>과 <color=#92fc63>「하이치」</color> 획득
<color=#92fc63>「그림 일기」</color>：이벤트 참여하고 한정 캐릭터 <color=#92fc63>「안샨」</color> 획득
<color=#92fc63>「용등호약」</color>：이벤트 참여하고 안샨, 창춘 <color=#92fc63>전용 개조 아이템</color> 획득
<color=#92fc63>「쥬쥬 레스토랑」</color>：이벤트 참여하고 세뱃돈을 오픈하여 풍부한 보상 획득
<color=#92fc63>「스킨 상점」</color>：설날 한정 스킨 구매
<color=#92fc63>「한정 건조」</color>：한정 캐릭터 건조]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1. <color=#92fc63>2월 29일</color>까지 매일 0시에 <color=#92fc63>1</color>라운드의 새로운 게임이 오픈되며, 총 <color=#92fc63>7</color>라운드로 누적 가능합니다. 7라운드를 클리어할 경우 푸슌을 포함하여 풍부한 보상을 획득할 수 있습니다.
게임 규칙:
1. 라운드마다 제한 시간은 없으며, 4포인트의 HP를 잃거나 지붕에 떨어지면 게임이 종료됩니다.
2. 왼쪽 점프 버튼을 누르면 푸슌이 점프하고, 오른쪽 공격 버튼을 누르면 푸슌이 공격합니다.
3. 아이템에 따라 다른 효과가 발동됩니다.
코인: 50포인트 획득
옥패: 300포인트 획득
런닝화: 점프력&이동속도 증가, 점프 후 밟기로 쥬쥬를 제거할 수 있습니다.
미사일 폭탄: 장거리 미사일 공격으로 바뀝니다.
자석: 아이템을 자동으로 끌어당깁니다.
방패: 1회 피해 데미지를 상쇄할 수 있으며, 최대 3개까지 보유할 수 있습니다.
쥬쥬를 제거하면 500포인트 획득
4. 게임을 클리어하거나 게임 내 종료 버튼을 클릭하면 게임이 종료되는 것으로 간주됩니다. 기타 사유로 게임 도중 종료될 경우 클리어로 간주되지 않습니다.]]
		}
	}
}
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「준요·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제4기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>컬럼비아 스킨 「종횡무진 초원 여행」</color>, <color=#ff5c5c>다이아</color> 등
 「특허 투어 패스」 구매 및 지정 투어 진도 도달 시, 특허 투어 보상을 수령할 수 있습니다.
 주의: 「특허 투어 패스」 구매 후, 기본 투어 보상 수령에 영향을 끼치지 않습니다.

·<color=#92fc63>「특허 투어 패스」설명</color>
(1)「특허 투어 패스」는 「상점」-「특혜 패키지」에서 구매할 수 있으며, 구매 즉시 <color=#ff5c5c>1500</color> 「투어 PT」를 획득하며 특허 투어 보상이 해제됩니다.
（2）「특허 투어 패스」는 <color=#ff5c5c>이벤트 종료 1시간 전</color> 판매가 중지됩니다(4.7 22:59:59). 구매 시간에 주의해 주세요.
...
_G.pg.base.gametip.battlepass_main_help_2204 = {
	tip = {
		{
			info = [[
월드 투어(2022.4.8-2022.6.7)

·<color=#92fc63>개방 기간</color>
 2022.4.8 0시 ~ 2022.6.7 23:59:59
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「야마시로·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제4기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>엔터프라이즈 스킨 「여행의 출발」</color>, <color=#ff5c5c>다이아</color> 등
 「특허 투어 패스」 구매 및 지정 투어 진도 도달 시, 특허 투어 보상을 수령할 수 있습니다.
 주의: 「특허 투어 패스」 구매 후, 기본 투어 보상 수령에 영향을 끼치지 않습니다.
...
_G.pg.base.gametip.battlepass_main_help_2206 = {
	tip = {
		{
			info = [[
월드 투어(2022.6.8-2022.8.7)

·<color=#92fc63>개방 기간</color>
 2022.6.8 0시 ~ 2022.8.7 23:59:59
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「멤피스·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제4기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>아카츠키 스킨 「닌자 곡예 대승부!」</color>, <color=#ff5c5c>다이아</color> 등
 「특허 투어 패스」 구매 및 지정 투어 진도 도달 시, 특허 투어 보상을 수령할 수 있습니다.
 주의: 「특허 투어 패스」 구매 후, 기본 투어 보상 수령에 영향을 끼치지 않습니다.

·<color=#92fc63>「특허 투어 패스」설명</color>
(1)「특허 투어 패스」는 「상점」-「특혜 패키지」에서 구매할 수 있으며, 구매 즉시 <color=#ff5c5c>1500</color> 「투어 PT」를 획득하며 특허 투어 보상이 해제됩니다.
（2）「특허 투어 패스」는 <color=#ff5c5c>이벤트 종료 1시간 전</color> 판매가 중지됩니다(8.7 22:59:59). 구매 시간에 주의해 주세요.
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「트렌토·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제5기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>키타카제 스킨 「비둘기와 요술의 밤」</color>, <color=#ff5c5c>다이아</color> 등
 「특허 투어 패스」 구매 및 지정 투어 진도 도달 시, 특허 투어 보상을 수령할 수 있습니다.
 주의: 「특허 투어 패스」 구매 후, 기본 투어 보상 수령에 영향을 끼치지 않습니다.
...
_G.pg.base.gametip.battlepass_main_help_2302 = {
	tip = {
		{
			info = [[
월드 투어(2023.2.8-2023.4.7)

·<color=#92fc63>개방 기간</color>
 2023.2.8 0시 ~ 2023.4.7 23:59:59
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「셰필드·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제5기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>유구레 「해변의 유희」</color>, <color=#ff5c5c>다이아</color> 등
 「특허 투어 패스」 구매 및 지정 투어 진도 도달 시, 특허 투어 보상을 수령할 수 있습니다.
 주의: 「특허 투어 패스」 구매 후, 기본 투어 보상 수령에 영향을 끼치지 않습니다.
...
_G.pg.base.gametip.battlepass_main_help_2304 = {
	tip = {
		{
			info = [[
월드 투어(2023.4.8-2023.6.7)

·<color=#92fc63>개방 기간</color>
 2023.4.8 0시 ~ 2023.6.7 23:59:59
...
·<color=#92fc63>「특허 투어 패스」설명</color>
(1)「특허 투어 패스」는 「상점」-「특혜 패키지」에서 구매할 수 있으며, 구매 즉시 <color=#ff5c5c>1500</color> 「투어 PT」를 획득하며 특허 투어 보상이 해제됩니다.
（2）「특허 투어 패스」는 <color=#ff5c5c>이벤트 종료 1시간 전</color> 판매가 중지됩니다(6.7 22:59:59). 구매 시간에 주의해 주세요.
...
_G.pg.base.gametip.battlepass_main_help_2306 = {
	tip = {
		{
			info = [[
월드 투어(2023.6.8-2023.8.7)

·<color=#92fc63>개방 기간</color>
 2023.6.8 0시 ~ 2023.8.7 23:59:59
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「베스탈·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제5기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>카가 「하얀 비단의 여우의 춤」</color>, <color=#ff5c5c>다이아</color> 등
 「특허 투어 패스」 구매 및 지정 투어 진도 도달 시, 특허 투어 보상을 수령할 수 있습니다.
 주의: 「특허 투어 패스」 구매 후, 기본 투어 보상 수령에 영향을 끼치지 않습니다.
...
_G.pg.base.gametip.battlepass_main_help_2308 = {
	tip = {
		{
			info = [[
월드 투어(2023.8.8-2023.10.7)

·<color=#92fc63>개방 기간</color>
 2023.8.8 0시 ~ 2023.10.7 23:59:59
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「하타카제·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제4기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
...
_G.pg.base.gametip.battlepass_main_tip_2312 = {
	tip = {
		{
			info = [[
월드 투어(2023.12.8-2024.2.7)

·<color=#92fc63>개방 기간</color>
 2023.12.8 0시 ~ 2024.2.7 23:59:59
...
·<color=#92fc63>「특허 투어 패스」설명</color>
(1)「특허 투어 패스」는 「상점」-「특혜 패키지」에서 구매할 수 있으며, 구매 즉시 <color=#ff5c5c>1500</color> 「투어 PT」를 획득하며 특허 투어 보상이 해제됩니다.
（2）「특허 투어 패스」는 <color=#ff5c5c>이벤트 종료 1시간 전</color> 판매가 중지됩니다(12.8 22:59:59). 구매 시간에 주의해 주세요.
...
_G.pg.base.gametip.battlepass_main_help_2402 = {
	tip = {
		{
			info = [[
월드 투어(2024.2.8-2024.4.7)

·<color=#92fc63>개방 기간</color>
 2024.2.8 0시 ~ 2024.4.7 23:59:59
...
·<color=#92fc63>보상 규칙</color>
투어 진도 보상은 2가지로 나뉘어집니다:
(1)기본 투어 보상: <color=#ff5c5c>「킴벌리·META」</color>, <color=#ff5c5c>성정 큐브</color>, <color=#ff5c5c>고급 지향형 강화 유닛·제4기</color> 등
 지정 투어 진도 도달 시, 기본 투어 보상을 즉시 수령할 수 있습니다.
(2)특허 투어 보상: <color=#ff5c5c>포슈 스킨 「푸른 하늘과 크레이프」</color>, <color=#ff5c5c>다이아</color> 등
 「특허 투어 패스」 구매 및 지정 투어 진도 도달 시, 특허 투어 보상을 수령할 수 있습니다.
 주의: 「특허 투어 패스」 구매 후, 기본 투어 보상 수령에 영향을 끼치지 않습니다.
	...
	tip = {
		{
			info = [[
■ 이벤트 진행 기간
 2024.4.8(월) 0:00 ~ 2024.6.7(금) 23:59
...
기본 투어 보상으로는 함선 "뱀파이어·META", 특허 투어 보상으로는 구축함 "이나즈마"의 한정 스킨인 "바이올렛 장미의 향기"를 획득할 수 있습니다. 
...
_G.pg.base.gametip.battlepass_main_tip_2408 = {
	tip = "<size=23>2024.8.8 ~ 2024.10.7 이벤트 기간 중에 월드 투어 보상으로 <color=#854747>\"카스미·META\"</color> 등 획득 가능! </size>"
}
	...
	tip = {
		{
			info = [[
■ 이벤트 진행 기간
 2024.8.8 0:00 ~ 2024.10.7 23:59

■ 개요
"월드 투어"란, 이벤트 진행 중에 임무를 클리어하고 "투어 PT"를 모아, 획득한 투어 PT 합계에 따라 보상을 얻을 수 있는 이벤트입니다. 
또한, 기본 투어 보상에는 추가적으로 "특허 투어 보상"이 존재하며, 상점 아이템 "특허 투어 패스"를 구매하면 특허 투어 보상을 획득할 수 있습니다. 
기본 투어 보상으로는 함선 "카스미·META", 특허 투어 보상으로는 "아틸리오 레골로"의 한정 스킨인 "구름 위에 내린 천사"를 획득할 수 있습니다. 
...
_G.pg.base.gametip.battlepass_main_tip_2504 = {
	tip = "2025/4/8 ~ 2025/6/7 이벤트 기간 중에 월드 투어 <icon name=pt w=0.5 h=0.5/>획득 합계 보상으로 <color=#854747>「네바다·META」</color> 등 획득 가능"
}
...
「월드 투어」란, 이벤트 진행 중에 임무를 클리어하고 「투어 PT」를 모아, 획득한 투어 PT 합계에 따라 보상을 얻을 수 있는 이벤트입니다. 
또한, 기본 투어 보상에는 추가적으로 「특허 투어 보상」이 존재하며, 상점 아이템 「특허 투어 패스」를 구매하면 특허 투어 보상을 획득할 수 있습니다. 
기본 투어 보상으로는 함선 「네바다·META」, 특허 투어 보상으로는 구축함 「스트례미텔니」의 한정 스킨인 「야간 간호 당직 중」을 획득할 수 있습니다. 
...
_G.pg.base.gametip.battlepass_main_tip_2506 = {
	tip = "2025/6/8 ~ 2025/8/7 이벤트 기간 중에 월드 투어 <icon name=pt w=0.5 h=0.5/>획득 합계 보상으로 <color=#854747>「네바다·META」</color> 등 획득 가능"
}
	...
	tip = {
		{
			info = [[
■ 이벤트 진행 기간
 2025.6.8 0:00 ~ 2025.8.7 23:59

■ 개요
「월드 투어」란, 이벤트 진행 중에 임무를 클리어하고 「투어 PT」를 모아, 획득한 투어 PT 합계에 따라 보상을 얻을 수 있는 이벤트입니다. 
또한, 기본 투어 보상에는 추가적으로 「특허 투어 보상」이 존재하며, 상점 아이템 「특허 투어 패스」를 구매하면 특허 투어 보상을 획득할 수 있습니다. 
기본 투어 보상으로는 함선 「그렌빌·META」, 특허 투어 보상으로는 구축함 「하츠즈키」의 한정 스킨인 「명절의 사치 타임♪」를 획득할 수 있습니다. 
...
_G.pg.base.gametip.battlepass_main_tip_2510 = {
	tip = "2025/10/8 ~ 2025/12/7 이벤트 기간 중에 월드 투어 <icon name=pt w=0.5 h=0.5/>획득 보상으로 <color=#854747>「듀이·META」</color> 등 획득 가능"
}
	...
	tip = {
		{
			info = [[
■ 이벤트 진행 기간
 2025.10.8 0:00 ~ 2025.12.7 23:59

■ 개요
「월드 투어」란, 이벤트 진행 중에 임무를 클리어하고 「투어 PT」를 모아, 획득한 투어 PT 합계에 따라 보상을 얻을 수 있는 이벤트입니다. 
또한, 기본 투어 보상에는 추가적으로 「특허 투어 보상」이 존재하며, 상점 아이템 「특허 투어 패스」를 구매하면 특허 투어 보상을 획득할 수 있습니다. 
기본 투어 보상으로는 함선 「듀이·META」, 특허 투어 보상으로는 구축함 「카와카제」의 한정 스킨인 「충직한 수호령 여우」를 획득할 수 있습니다. 
...
1. 「비콘 파일」 화면에서 파일 META를 분석 및 도전하여 동기화 수치를 누적해<color=#92fc63>META 캐릭터</color>와 기타 풍부한 보상을 획득할 수 있습니다. 이전의 기존 이벤트에서 획득한 동기화 수치는 비콘 파일에 계승됩니다.

2.「파일 비콘 데이터」 획득 및 분석
·대형 작전을 통해 「파일 비콘 데이터」를 획득할 수 있으며, 지정 데이터량 도달 후, 분석 및 비콘을 발견할 수 있습니다.
·매일 최대 <color=#92fc63>200</color>까지 획득할 수 있으며, 0시마다 획득 가능량이 초기화됩니다. 사용하지 않은 「파일 비콘 데이터」는 보류됩니다.
·매번 분석 시 <color=#92fc63>100</color> 「파일 비콘 데이터」가 필요합니다.

3. 파일 분석 개방 및 파일 분석 전환
·「비콘 파일」 화면에서 분석할 META 캐릭터를 개방할 수 있습니다. 개방 후 「파일 비콘」 화면에서 분석 및 도전할 수 있습니다.
·분석 개방 후 임의로 전환할 수 있으며, 제한은 없습니다.

4. 자신이 분석한 비콘 도전
·자신이 분석한 비콘에 처음으로 도전 시 연료를 소모하지 않으며, 두번째 도전부터 도전 횟수가 증가함에 따라 소모하는 연료는 <color=#92fc63>40</color>에서부터 <color=#92fc63>0</color>까지 점차 감소합니다.(도전 횟수는 소모하지 않습니다.)
·비콘의 HP가 0이 되면 전투에서 승리하며, 대량의 캐릭터 동기화 수치 보상을 획득합니다.
·분석한 비콘은 <color=#92fc63>24시간</color> 동안 유지되며, 이후 사라집니다.
·파일 비콘의 초기 난이도는 15단계입니다.

5. 기타 비콘 도전
·파일 목록 화면의 「친구」, 「대함대」 칸에서 다른 지휘관이 도움을 요청한 비콘에 도전할 수 있습니다.
·<color=#92fc63>파일 비콘 지원은 횟수 제한이 없고, 연료를 소모하지 않으며, 보상을 획득하지 못합니다.</color>
·동일한 비콘에 최대 누적 30명의 지휘관이 도전할 수 있습니다.

6. 전투 설명
·파일 비콘 도전은 지휘냥과 잠수함은 사용할 수 없습니다.
...
②파일 비콘 작전 지원 시 보상은 없으며, 횟수 제한도 없습니다.
 <color=#92fc63>작전 참여 시 네트워크 환경을 원활히 유지해 주세요.</color>

7. 자율 작전 기능 설명
·자신이 분석한 파일 비콘에 수동으로 1회 도전 후 자율 작전 기능이 해제됩니다.
·자율 작전은 현재 파일 META에게 입힌 최고 대미지에 따라 자동으로 전투를 진행하며, 최고 대미지에 따라 필요한 작전 횟수를 계산하여 그에 따른 연료를 소모합니다. 소모되는 연료는 수동 도전과 동일합니다.
·자율 작전은 고정 15분이 소요되며, 도전 화면을 이탈하거나 게임 종료할 경우 자율 작전에 영향을 주지 않습니다.
·또한, 수동으로 자율 작전을 취소할 수 있지만, 이미 소모된 연료는 반환되지 않으며, 입힌 대미지는 합산되지 않습니다.]]
		}
	}
}
...
_G.pg.base.gametip.littleChaijun_npc = {
	tip = {
		...
		{
			info = "1. 이벤트 기간 동안, 임시 NPC 캐릭터 「꼬마 체셔」를 획득할 수 있습니다. 임시 캐릭터는 서약, 퇴역 및 강화, 돌파 재료로 사용이 불가능합니다."
		},
		{
			info = "2. 이벤트 기간 동안, 이벤트 임무 완료 시 「크림 쿠키」 보상을 획득하며, 「꼬마 체셔」에게 주면 호감도를 누적할 수 있습니다."
		},
		{
			info = "3. 5월 1일까지, 매일 달성 가능한 호감도 단계가 하나씩 해제됩니다."
		},
		{
			info = "4. 이벤트 종료 전 호감도를 10000까지 누적하면 임시 캐릭터 보상을 획득하며 「꼬마 체셔」가 영구  캐릭터로 전환됩니다."
		},
		{
			info = "5.이벤트 종료 후, 전환되지 않은 임시 캐릭터 「꼬마 체셔」는 모항을 떠나며, 소모한 강화, 돌파 재료 등 성장 재료는 반환되지 않습니다."
		},
		{
			info = "6. NPC 캐릭터는 대형 작전에 참여할 수 없습니다."
		},
	...
	tip = {
		{
			info = [[
이벤트 규칙:
이벤트 기간 동안 매일 사용 가능 횟수 <color=#92fc63>1</color>회씩 최대 <color=#92fc63>7</color>회까지 획득할 수 있습니다.
1. 사용 가능 횟수가 있을 경우, 디저트 대작전 참여 시 사용 가능 횟수가 소모되며 출석 횟수를 얻습니다. 출석 <color=#92fc63>7</color>회 시 <color=#92fc63>「축제 초대장」</color>을 획득합니다.
2. 사용 가능 횟수는 축제 광장 화면 우측에서 확인할 수 있으며, 출석 진도는 축제 광장 화면에서 <color=#92fc63>「초대장」</color> 버튼을 터치하여 확인할 수 있습니다.
3. 사용 가능 횟수가 없는 경우, 디저트 대작전 진행 시 출석 횟수를 얻지 못합니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1. <color=#92fc63>6월 8일</color>까지 매일 0시마다 <color=#92fc63>1</color>장씩 총 <color=#92fc63>7</color>장까지 게임이 오픈되며, 누적 가능합니다. 7장까지 게임을 완료하면 한정 가구가 포함된 풍부한 보상을 획득할 수 있습니다.
게임 규칙:
1. 매 게임은 60초간 지속되며, 타임 오버 시 게임이 종료됩니다.
2. 게임 진행 시 각 가구들에서 캐릭터가 나타나며 <color=#92fc63>캐릭터를 터치하여 잡으면 점수를 획득합니다</color>.
3. 숨은 캐릭터를 잡으면 100점, 2초 내로 숨은 캐릭터를 잡는데 성공하면 50점을 추가 획득하며, 최고 300점까지 누적됩니다. 도망가는 캐릭터를 잡으면 400점을 획득합니다.
4. 게임을 완료하거나 게임 내 퇴장 버튼을 눌러 퇴장 시 게임이 완료된 것으로 간주됩니다. 기타 원인으로 인해 중도 퇴장 시 게임은 미완료된 것으로 간주됩니다.]]
		}
	}
}
...
2. 이벤트 기간 동안 및 완료한 군사의뢰에서만 「군사의뢰 증빙」 보상을 획득할 수 있습니다.
...
_G.pg.base.gametip.backhill_campusfestival_tip = {
	tip = {
		{
			info = [[
이벤트 기간: 2022.9.22-10.20
이벤트 규칙:
1. <color=#92fc63>9월 28일</color>까지 매일 0시마다 임무가 1개씩 해제되며, 이벤트 임무 완성 시 「장식용품」 및 보상을 획득할 수 있습니다. 임무는 누적 가능합니다.
2. 「장식용품」을 소모하여 쥬쥬 학원 축제 건물을 업그레이드할 수 있으며, 각 건물들은 각기 다른 BUFF를 제공합니다.
3. 건물은 3가지 등급이 있습니다. 등급이 높을수록 제공하는 BUFF도 증가합니다.
4. 업그레이드 가능한 건물:
메인 빌딩
축제 상가
공연 무대
점술집
5. 이벤트 기간 동안 매일 사용 가능 횟수를 1회 획득하며, 최대 7회까지 누적할 수 있습니다.
6. 사용 가능 횟수를 보유한 상황에서 디저트 대작전에 참여할 경우, 사용 가능 횟수를 소모하며 출석 횟수를 획득합니다. 출석 7회 시 <color=#92fc63>「축제 초대장」</color>을 획득합니다.
7. 사용 가능 횟수는 쥬쥬 학원 축제 화면 우측에서 확인할 수 있으며, 출석 진도는 쥬쥬 학원 축제 화면에서 「초대장」 버튼을 터치하여 확인할 수 있습니다.
8. 사용 가능 횟수가 없는 경우, 디저트 대작전 진행 시 출석 횟수를 얻지 못합니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
플레이 방법:
""디저트 대작전""는 만쥬가 주문한 디저트를 화면 좌측으로 전달함으로써 점수를 획득하여 고득점을 노리는 게임입니다. 
	...
	tip = {
		{
			info = [[
이벤트 규칙：
1.<color=#92fc63>2024.1.24</color>까지 매일 0시마다<color=#92fc63>1</color>장의 신규 게임 오픈, 총<color=#92fc63>7</color>장, 누적 가능. 게임을 완성하면 버밍햄 한정 스킨 「도착지는 바람 따라」 획득 가능.

게임 규칙：
1.지휘관은 사이렌의 공격을 막기 위해 공격 또는 방어 유형의 캐릭터를 배치해야 하며, 캐릭터를 배치하려면 일정량의 「불꽃」이 소모해야 합니다!
2.생산쥬는 「불꽃」을 생산할 수 있습니다. 지휘관은 더 많은 생산 쥬를 배치하여 「불꽃」의 공급을 보장하십시오!
3.캐릭터는 기본 캐릭터와 한정 캐릭터로 나뉘며, 한정 캐릭터 필드에는 하나만 배치할 수 있습니다!
기본 캐릭터：전투쥬、방어쥬、생산쥬
한정 캐릭터：노시로、체셔、카시노、리토리오、버밍햄
4.지휘관은 「게임 수첩」에서 캐릭터, 적의 자세한 설명을 볼 수 있습니다.
5.지휘관은 이미 배치된 캐릭터를 소환할 수 있으며, 캐릭터 소환은 소모된 「불꽃」을 반환하지 않습니다.
6.게임 내 탈퇴 버튼을 클릭해도 게임이 완료된 것으로 간주됩니다. 기타 사유로 인한 게임 중도 탈퇴는 미완료로 간주됩니다.
7.제7장·무진: 적은 끊임없이 경신하고 점점 더 어려워집니다. 지휘관은 더 높은 점수를 얻기 위해 도전할 수 있습니다!]]
		}
	}
}
...
_G.pg.base.gametip.sevenday_nianye = {
	tip = {
		{
			info = "보상 내용:\n7일 동안 일일 성정 큐브의 수량은 랜덤이지만, 7일차에 마지막 로그인 보상 획득 후, 이벤트 기간 동안 각 지휘관이 획득한 성정 큐브의 총 수량은 동일합니다."
		}
	}
}
...
2. 춘련 해제 후, 뒤 구절을 드래그하여 순서를 조정할 수 있습니다. 매칭 성공 후 세뱃돈 보상을 획득하며, 모든 춘련 완성 시 얏센 전용 장비 <color=#92fc63>「매화 이야기」</color>를 획득할 수 있습니다.
]]
		}
	}
}
	...
	tip = {
		{
			info = [[
개요:
「푸슌의 대모험Ⅳ」는 SD 캐릭터를 조작하여 괴수 만쥬를 피하면서 화면 상단에 있는 요리를 비롯한 아이템을 모아 점수를 얻는 미니 게임입니다. 
<color=#92fc63>1.29(수)</color>까지 매일 하나씩 스테이지가 오픈됩니다. 일곱 스테이지를 모두 클리어하면, 구축함 「푸슌」과 「푸슌」의 개조 아이템인 「주작의 인」을 획득할 수 있습니다. 

플레이 방법:
1. 화면 좌측 하단에 있는 버튼을 조작하면, 푸슌을 움직일 수 있습니다. 또한 화면 우측 하단의 버튼으로는 오픈된 아이템 및 스킬을 사용할 수 있습니다. 

2. 화면 상단에 표시된 아이템 아이콘과 똑같은 아이템을 획득하면 점수를 획득할 수 있습니다. 제한 시간이 0이 되거나, 게임을 중지하면 게임이 종료됩니다. 

3. 게임 내 「각종 설정」에서는 획득한 점수를 사용하여 아이템 및 스킬을 오픈하고 장착할 수 있습니다. 

4. 스테이지 시작 화면에는 해당 스테이지에 출현하는 괴수의 능력이 표시됩니다. 괴수의 능력을 무효화하면, 스테이지에서 획득할 수 있는 점수 배율도 저하합니다. 

5. 각 스테이지마다 괴수의 능력, 스테이지에서 획득할 수 있는 점수 배율이 다릅니다. 
...
_G.pg.base.gametip.series_enemy_help = {
	tip = [[
연전 이벤트 「극지 폭풍」
진행 기간: <color=#92fc63>2025.4.29 ~ 2025.5.8 점검까지</color>

개요: 
이벤트 「극지 폭풍」이란 함대를 편성하고 특별 스테이지에 출격하여 이벤트 Pt를 얻고, 이벤트 보상을 획득하는 이벤트입니다. 
이벤트 Pt를 모으면 총 획득 수 보상을 얻을 수 있습니다. 
이벤트 배너의 「출격」을 탭하면, 이벤트 스테이지 선택 화면으로 이동합니다. 

플레이 방법
1. 이벤트 스테이지 선택 화면에서는 좌측 하단의 버튼으로 「전투 준비」와 「스토리 열람」을 서로 전환할 수 있습니다. 
2. 「전투 준비」에서는 전함을 편성하여 특별 스테이지에 도전할 수 있습니다. 특별 스테이지를 낮은 난이도로 클리어하면, 더 높은 난이도의 스테이지가 오픈됩니다. 
3. EASY 난이도 이외의 특별 스테이지는 한 출격에 여러 전투가 펼쳐집니다. 
4. 출격 시에 전투 횟수만큼 함대를 편성해 출격시킬 수 있습니다. 출격 함대 수는 출격 준비 화면에서 「단독 출격」, 「협동 출격」을 전환할 수 있습니다.  
　단독 출격 시에는 1개 함대로 모든 스테이지의 전투를 실시합니다.
　 협동 출격은 스테이지의 전투에 따라 각각 함대를 편성하여 출격시켜, 전투를 각 함대가 실시하게 하는 형식입니다. 
5. 특별 스테이지에 출격하여 모든 전투에서 승리하면, 스테이지 승리로 처리되며 이벤트 Pt를 획득할 수 있습니다. 여러 함대로 출격(협동 출격)한 경우에는 추가 보상을 획득할 수 있습니다. 
6. EASY, NORMAL, HARD 난이도 스테이지는 연료를 소모하여 얼마든지 도전할 수 있습니다. SP 스테이지는 하루에 한 번만 클리어할 수 있으며, EX 스테이지에는 얼마든지 출격할 수 있지만 이벤트 Pt는 획득할 수 없습니다. 일부 스테이지는 「연료 소비량 제한」 및 「연속 자동 출격」을 적용할 수 있습니다. 
7. 이벤트 Pt를 모으면 총 획득 수 보상을 얻을 수 있는 것 외에도 「스토리」 모드에서 새로운 스토리를 오픈할 수 있습니다. 
8. 「스토리」 모드에서 모든 스토리를 오픈하면 한정 장비를 얻을 수 있습니다. 
]]
}
	...
	tip = {
		{
			info = [[
이벤트 설명:
1. 이벤트 기간 동안, 특정 화면 또는 스테이지에서 신기의 단서를 수집할 수 있습니다.
2. 단서 수집이 어려울 경우, 단서 슬롯을 터치하여 힌트를 해제할 수 있습니다.
주의: 20분 내에 1가지 힌트만 해제할 수 있습니다.
3. 단서 수집 완료 시 특별 스테이지가 오픈되며, 도전하여 승리 시
특수 보상을 획득할 수 있습니다.]]
		}
	}
}
...
_G.pg.base.gametip.gametip_xiaoqiye = {
	tip = {
		{
			info = "「분투하자, 꼬마 엔터프라이즈!」 설명:"
		},
		{
			info = "1. 이벤트 기간 동안, 임시 NPC 캐릭터 꼬마 엔터프라이즈를 획득할 수 있습니다. 임시 캐릭터는 서약, 퇴역 또는 강화 및 돌파 재료로 사용될 수 없습니다."
		},
		{
			info = "2. 이벤트 기간에 일반 난이도 메인 해역 제3장 이상 또는 이벤트 해역의 기함 격파 시, 임시 NPC 캐릭터 꼬마 엔터프라이즈의 호감도를 증가시킬 수 있습니다(대형 작전 제외)."
		},
		{
			info = "3. 꼬마 엔터프라이즈를 출격시켜 격침당하지 않는다면, 호감도가 2배로 증가합니다."
		},
		{
			info = "4. 이벤트 종료 전 호감도를 1000까지 누적 시, 보상을 수령할 수 있으며, 임시 캐릭터 「꼬마 엔터프라이즈」가 영구 캐릭터로 전환됩니다."
		},
		{
			info = "5. 이벤트 종료 후, 전환되지 않은 임시 캐릭터 「꼬마 엔터프라이즈」는 모항을 떠나며, 이미 소모한 강화, 돌파 등 육성 재료는 반환되지 않습니다."
		},
		{
			info = "6. NPC 캐릭터는 대형 작전에 참여할 수 없습니다."
		},
		{
			info = "7. NPC 캐릭터는 대함대 작전 내 사건 파견, 지원 파견, 보스전에 참여할 수 없습니다."
		}
	}
}
...
_G.pg.base.gametip.shan_luan_task_help = {
	tip = {
		{
			info = [[
진행 기간: <color=#92fc63>12.7 ~ 12.21 점검까지</color>

개요: 
등장하는 임무를 클리어하면 Pt 아이템 '닌자 지도'와 '비전 구슬'을 획득할 수 있습니다. 
각 캐릭터의 임무를 마지막까지 클리어하면, 한정 가구를 획득할 수 있습니다.

플레이 방법: 
1. 화면의 캐릭터 일러스트를 탭하면, 각 캐릭터의 한정 임무를 확인할 수 있습니다. 
2. 각 캐릭터의 한정 임무 화면에서는 임무 내용을 확인하거나, '닌자 지도' 등의 보상을 수령할 수 있습니다. 
3. 한정 임무 보상인 '비전 구슬'을 7개 모으면, '상세 확인'에서 콜라보 기념 가구 '풍운성 그림 두루마리'를 획득할 수 있습니다. 
4. 임무를 일정 수만큼 달성할 때마다 '상세 확인'에서 보상을 오픈할 수 있으며, 콜라보 진행 기간 중에 아군 함대에 적용하면 강화 효과를 얻을 수 있습니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
개요:
<color=#92fc63>12.7 ~ 12.21 점검</color> 콜라보 이벤트 '창섬인법첩' 진행!

■ 플레이 방법:
· 한정 해역(이벤트 해역) 및 임무를 클리어하면,Pt 아이템 '성 관람권'을 획득할 수 있습니다.
'성 관람권'은 '상점'에서 SSR 콜라보 캐릭터 '이카루가' 등의 보상으로 교환할 수 있습니다.
또한,'성 관람권'의 총 획득 수에 따라 '합계 보상'으로 SR 콜라보 캐릭터 '무라사키'를 획득할 수 있습니다.

· '패널 임무'에서는 7일 동안 매일 새로운 임무가 오픈됩니다. 임무를 클리어하면 Pt 아이템 '닌자 지도'와 한정 가구 '시노비 미닫이문'을 획득할 수 있습니다.

3.'비전인법서'에서는 각 캐릭터의 특별 임무를 클리어함으로써 Pt 아이템 '닌자 지도',콜라보 캐릭터 전용 장비, 기념 가구 '풍운성 그림 두루마리' 등의 보상을 획득할 수 있습니다.

4. '인술 지도장'에서는 획득한 Pt 아이템 '닌자 지도'를 소비하여 속성 레벨을 올릴 수 있으며, SSR 콜라보 캐릭터 '호무라'를 획득할 수 있습니다.

5.'스킨'을 탭하면,스킨 상점으로 이동합니다.

6.'한정 건조'를 탭하면,한정 건조 화면으로 이동합니다.]]
		}
	}
}
...
_G.pg.base.gametip.senran_pt_words_banjiu = {
	tip = {
		...
		{
			"1100002/pt3",
			"지휘관께서 잘 가르쳐주신 덕분입니다. 컨디션도 좋아지고 있고요."
		},
		{
			"1100002/pt4",
			"성과가 나오고… 있나요? 그거 기쁘네요."
...
_G.pg.base.gametip.senran_pt_words_yan = {
	tip = {
		...
		{
			"1100003/pt5",
			"수고했어. 강해지는 게 몸으로 느껴지는 건 다 지휘관 덕분이겠지."
		}
	}
}
...
_G.pg.base.gametip.senran_pt_words_xuequan = {
	tip = {
		...
		{
			"1100004/pt3",
			"더 엄격하게 지도해주셔도 저는 괜찮아요."
		},
		{
			"1100004/pt4",
			"다음은 무엇을 하실 건가요? 기대가 됩니다."
		},
		{
			"1100004/pt5",
			"고생 많으셨습니다. 같이 강해질 수 있어서 무척 기쁘답니다."
		}
	}
}
...
_G.pg.base.gametip.senrankagura_backhill_help = {
	tip = {
		{
			info = "개요:<color=#92fc63>12.7~12.21 점검</color>콜라보 이벤트 '창섬인법첩' 진행!■플레이 방법:한정 해역(이벤트 해역) 및 임무를 클리어하면,Pt 아이템 '성 관람권'을 획득할 수 있습니다.'성 관람권'은'상점'에서 SSR 콜라보 캐릭터'이카루가'등의 보상으로 교환할 수 있습니다.또한,'성 관람권'의 총 획득 수에 따라'합계 보상'으로 SR 콜라보 캐릭터 '무라사키'를 획득할 수 있습니다.'패널 임무'에서는 7일 동안 매일 새로운 임무가 오픈됩니다.임무를 클리어하면 Pt 아이템 '닌자 지도'와 한정 가구 '시노비 미닫이문'을 획득할 수 있습니다.3.'비전인법서'에서는 각 캐릭터의 특별 임무를 클리어함으로써 Pt 아이템'닌자 지도',콜라보 캐릭터 전용 장비,기념 가구 '풍운성 그림 두루마리' 등의 보상을 획득할 수 있습니다.4.'인술 지도장'에서는 획득한 Pt 아이템'닌자 지도'를 소비하여 속성 레벨을 올릴 수 있으며,SSR 콜라보 캐릭터'호무라'를 획득할 수 있습니다.5.'스킨'을 탭하면,스킨 상점으로 이동합니다.6. '한정 건조'를 탭하면, 한정 건조 화면으로 이동합니다."
		}
	}
}
...
_G.pg.base.gametip.vote_lable_title = {
	tip = "<size=32>인기 투표 진행 기간</size> <size=24>2025/12/25 ~ 2026/2/28 23:59</size>"
}
...
·이벤트 기간 동안 <color=#92fc63>기간 한정 이벤트</color>를 완료하면 <color=#92fc63>투표권</color>을 획득할 수 있습니다. 각 투표 단계마다 기간 한정 임무를 통해 획득할 수 있는 투표권은 제한이 있습니다.
	...
	D조: 200
		패자부활: 160
		결승: 280
·매 라운드 투표 종료 시 남은 <color=#92fc63>투표권</color>, <color=#92fc63>기간 한정 임무 진도</color>는 <color=#92fc63>전부 리셋</color>됩니다.
특별 투표 단계:
...
_G.pg.base.gametip.newyear2024_backhill_help = {
	tip = {
		{
			info = [[
진행 기간: <color=#92fc63>2024.1.4 ~ 2024.1.18 점검까지</color>
■ 개요
""신년 뒷산"" 이벤트는 다음 내용으로 구성되어 있습니다.
· 에마 기원
· 미니 게임
· 스킨
· 한정 건조
...
■ 에마 기원
· 이벤트 기간 중에는 매일 ""함선 에마"" 수가 1개씩 증가(최대 7개)합니다.
· ""함선 에마""를 가지고 있는 상태에서는 ""에마 기원""으로 함선의 에마를 장식할 수 있습니다.
· ""함선 에마""를 장식하면 함대에 강화 효과를 부여할 수 있고, 함선의 답례를 1개 획득할 수 있습니다.

■ 미니 게임
· 이벤트 기간 중에는 매일 게임 횟수가 1회씩 가산(최대 7회)됩니다.
· 미니 게임을 클리어하면 게임 횟수가 1회 소모됩니다.
· 미니 게임에서는 한정 가구 ""서프라이즈 라이트""와 ""스타일리시 라이트"", UR 함선 ""라피Ⅱ""로 교환할 수 있는 ""토끼 파손 비콘""을 획득할 수 있습니다.
...
_G.pg.base.gametip.help_chunjie2024 = {
	tip = {
		{
			info = [[
이벤트 기간: <color=#92fc63>2024.2.7-2024.2.29 23:59</color>
이벤트 소개:
<color=#92fc63>""미의연년""</color>: 이벤트 참여를 통해 <color=#92fc63> 타이위안</color> 전용 개조 아이템 획득
<color=#92fc63> ""새봄의 모험왕""</color>: 이벤트 참여를 통해 한정 캐릭터 <color=#92fc63> ""페이윈"" 획득</color> 
<color=#92fc63>""춘절 폭죽""</color>: 이벤트 참여를 통해 한정 캐릭터 <color=#92fc63> ""딩안"" 획득</color>
<color=#92fc63>""그림일기""</color>: 미니게임 참여를 통해 한정 캐릭터 <color=#92fc63>""안샨""</color> 획득
<color=#92fc63>""푸슌의 대모험""</color>: 이벤트 참여를 통해 한정 캐릭터 <color=#92fc63>""푸슌"" 획득</color>
<color=#92fc63>""쥬쥬 레스토랑""</color>: 세뱃돈을 열어 다이아와 풍부한 보상 획득
<color=#92fc63>""교환 상점""</color>: 2024년 설날 한정 스킨 구매
<color=#92fc63>""한정 건조""</color>: 2024년 설날 한정 캐릭터 건조]]
		}
	}
}
...
_G.pg.base.gametip.idol3rd_houshan = {
	tip = {
		...
		{
			info = "공명의 Passion은 이벤트 \"공명의 Passion\"의 메인 페이지에 있으며, 이곳에서 이벤트 각 화면으로 이동할 수 있습니다. \n"
		},
		{
			info = [[
■각 콘텐츠 설명
한정 해역:
이벤트 기간 중에 오픈되는 한정 해역. 이벤트 해역을 클리어하면, 아이템 "공명 휘장"을 모을 수 있습니다. 
 
상점:
"공명 휘장"을 각종 보상으로 교환할 수 있습니다. 
 
총 보상:
획득한 "공명 휘장"의 합계에 따라 함선 "르 테메레르(μ장비)" 등 다양한 보상을 획득할 수 있습니다. 
한정 건조:
건조의 "기간 한정 건조" 페이지로 이동합니다. 
...
기념장:
다양한 조건을 달성하면 "굿즈"를 모을 수
있습니다. "굿즈"를 전부 모으면, 한정 아이템 "공명의 미니 스테이지"를 획득할 수 있습니다. 
 
미니 게임:
리듬 게임을 플레이할 수 있습니다. 7일 동안 플레이하면, 한정 설비 "열정의 μ티켓"을 획득할 수 있습니다. ]]
		}
	}
}
...
_G.pg.base.gametip.idol3rd_collection = {
	tip = {
		...
		{
			info = "・5월 23일(목) 점검까지 \"공명의 Passion\" 이벤트에 참가하여 \"μ장비\" 함선들의 \"굿즈 아이템\"을 12종류 전부 모으면, 한정 가구 \"공명 무대 모형\" 획득 가능. "
		},
		{
			info = [[
・"굿즈 아이템"은 다음 방법으로 획득 가능
  ①이벤트 해역을 ☆3으로 클리어
  ②이벤트 한정 임무(이벤트 목록 & "한정 임무" 페이지) 완수
  ③이벤트 아이템 "공명 휘장"의 합계 보상]]
		},
		{
			info = "・모든 \"굿즈 아이템\"을 획득하면, 굿즈를 화면 위에 배치할 수 있게 됩니다. 또한 화면 우측의 \"공유\" 버튼으로 배치한 화면을 공유할 수 있습니다.\n\n・보상 수령 기한은 5월 29일(수) 23:59까지"
		}
	}
}
	...
	tip = {
		{
			info = [[
■레슨에 대해
해역 및 기간 한정 임무로 획득한 <color=#92fc63>"공명 휘장"</color>이
일정 수를 초과하면 이벤트 배너에서 "레슨"을
실시할 수 있습니다. 

"레슨"을 실시하면 "레슨 Lv"이 상승하며,
이벤트 기간 중 각종 해역 전투에 도움을 줍니다. 
또한 "레슨 Lv"을 최대치까지 상승시키면,
추가 보상을 획득할 수 있습니다. 

"레슨"에는 3종류가 있으며, "레슨 Lv"을 올리면
다음 효과가 각각 강화됩니다. 
어필 Vocal: 해역에서 아군 함대가 적 함대에게 주는
피해량이 상승함
인게이지 Dance: 해역에서 아군 함대가 적 함대에게
받는 피해량이 경감됨
메모리 Performance: 해역에서 아군 함대가 획득하는
경험치 상승

현재 "레슨 Lv"은 이벤트 배너 우측의 아이콘을
탭하면 확인할 수 있습니다. ]]
		}
	}
}
...
_G.pg.base.gametip.unique_ship_retire_protect = {
	tip = "단일 보유 함선 퇴역 실수 방지"
}


_G.pg.base.gametip.unique_ship_tip1 = {
	tip = "선택한 함선 중에 <color=#92fc63>한 척만 보유하고 있는 함선</color>이 있습니다."
}
...
_G.pg.base.gametip.unique_ship_tip2 = {
	tip = "<color=#92fc63>$1</color>(을)를 입력하여 계속해서 조작하십시오."
}
...
_G.pg.base.gametip.child2_mood_desc4 = {
	tip = "현재 기분: 행복； <color=#00c79b>보상 획득 +40%%</color>"
}
...
_G.pg.base.gametip.handbook_gametip = {
	tip = {
		...
		{
			info = "「지휘관 수첩」은 신병 임무, 개발 임무, 기능 안내의 세 가지로 구성되어 있습니다. "
		},
		{
			info = [[
<b>1. 신병 임무:</b>
·초보 지휘관을 위한 일련의 임무군입니다. 
·총 9단계로 구성되어 있으며, 각 단계마다 여러 임무가 존재합니다. 
·이전 단계의 임무를 6개 완료하면 다음 단계가 오픈됩니다. 각 단계의 모든 임무를 완료하면 단계 클리어 보상을 획득할 수 있습니다. 
·9단계까지의 임무를 모두 완료하면 「신병 임무 UR 교환 티켓」을 획득할 수 있습니다. 티켓을 사용하면 UR 함선 <color=#92fc63>「시나노」</color> 혹은 <color=#92fc63>「뉴저지」</color> 중 하나를 골라 획득할 수 있습니다. ]]
		},
		{
			info = [[
<b>2. 개발 임무:</b>
·지휘관 레벨 30 달성 시 오픈되며, 개발 도크에서 활용할 수 있는 데이터 팩 및 강화 유닛 등을 획득할 수 있는 임무군입니다. 
·지휘관은 특별 계획함의 기수를 선택하여 임무를 진행할 수 있습니다. 
·주의: 일단 특정 기수의 개발 임무를 선택하면 해당 기수의 개발 임무를 모두 완료하기 전까지는 다른 기수로 변경할 수 없습니다. ]]
		},
		{
			info = "<b>3. 기능 안내:</b>\n·신규 지휘관을 위한 기능 설명 및 튜토리얼 가이드입니다. \n·각 기능 그룹마다 각각 튜토리얼 임무와 설명이 존재하며, 해당 그룹의 임무를 모두 완료하면 성정 큐브를 획득할 수 있습니다."
		}
	}
}
...
_G.pg.base.gametip.handbook_research_final_task_desc_locked = {
	tip = "$1의 모든 임무 완료 시 본 단계의 최종 임무 오픈"
}
...
_G.pg.base.gametip.handbook_ur_double_check = {
	tip = "초대장은 1회만 사용할 수 있습니다. \n<color=#92fc63>$1</color>(을)를 초대하시겠습니까? \n초대한 함선과 기념 아이템을 획득할 수 있습니다."
}
...
_G.pg.base.gametip.holiday_tip_finish = {
	tip = "리조트 섬의 재건이 <color=#5f984d>모두 완료</color>되었습니다. 남은 재건 물자는 <color=#5f984d>재건 코인</color>으로 바꾸세요."
}


_G.pg.base.gametip.holiday_tip_trans_get = {
	tip = "재건 임무 완료 시 수송력 획득 가능"
}


_G.pg.base.gametip.holiday_tip_rebuild_not = {
	tip = "재건에 필요한 자재가 부족합니다."
}


_G.pg.base.gametip.holiday_tip_trans_not = {
	tip = "수송에 필요한 수송력이 부족합니다."
}


_G.pg.base.gametip.holiday_tip_task_finish = {
	tip = "리조트 섬의 재건이 완료되었습니다."
}
...
_G.pg.base.gametip.holiday_tip_trans_desc1 = {
	tip = "대형 크루저나 수송선이 정박할 수 있는 리조트 빌라의 메인 잔교. 입구에는 고양이 마크가 그려진 거대한 환영 문구와 안내판이 서 있다. \n——이 안내판이 가리키는 곳은 예상대로 녹색 고양이가 운영하는 고급 주스 가판대다."
}
	...
	tip = {
		{
			info = [[
플레이 방법: 
<color=#92fc63>6.5 ~ 6.26 점검 전까지</color> 기간 한정 이벤트 「다시 돌아온 한여름! 리조트 재건 계획! 」이 진행됩니다.
◆리조트 재건◆
이벤트 기간 중에 등장하는 한정 임무를 완료하면 「수송력」을 획득할 수 있습니다. 「수송 부두」에서 「수송력」을 소모하여 자원을 수송하면, 수송 수단에 따라 재건에 필요한 자재를 획득할 수 있습니다.
자재를 소모하여 리조트 섬의 6개 구역을 재건하면 관련 스토리와 기능이 개방됩니다. 
◆상점◆
이벤트에 참여하면 「재건 코인」을 획득할 수 있습니다. 이 코인을 이용하면 「재건 상점」에서 한정 채팅 테두리 등 다양한 보상을 획득할 수 있습니다. 
◆기타 기능◆
미니 게임 「"대"함선 합성」, 「쥬쥬 인양단」를 플레이하면 보상을 획득할 수 있습니다.
「휴일 목욕탕」에 캐릭터를 배치하면, 해당 캐릭터의 컨디션 회복 속도가 증가합니다. 
「"대"함선 합성」, 「쥬쥬 인양단」, 「휴일 목욕탕」은 재건이 진행됨에 따라 오픈됩니다. ]]
		}
	}
}
...
_G.pg.base.gametip.holiday_tip_spring = {
	tip = {
		{
			info = "플레이 방법: \n<color=#92fc63>6.5 ~ 6.26 점검 전까지</color> 「휴일 목욕탕」이 한정 기간 동안 오픈됩니다.\n캐릭터를 「휴일 목욕탕」에 배치하면, 해당 캐릭터의 컨디션 회복 속도가 증가합니다."
		}
	}
}
...
_G.pg.base.gametip.sure_exit_resolve_equip = {
	tip = "조작하지 않으면 모든 장비가 <color=#5f984d>창고</color>에 수납됩니다.\n 이전 화면으로 돌아가시겠습니까?"
}
...
_G.pg.base.gametip.tec_catchup_confirm = {
	tip = "이번 기수의 개발 임무를 시작하시겠습니까? \n확정하면 이번 기수의 개발 임무가 오픈되며, 모든 개발 임무를 완료해야 다른 개발 임무로 변경할 수 있습니다."
}
...
_G.pg.base.gametip.island_manage_buff_tip = {
	tip = "*영업이 시작되면, 동료들의 능력 변화와 강화 효과 변화는 경영 결과에 영향을 주지 않습니다."
}
...
<color=#39bfff>11/20(목) 점검 후</color>, 밸런스 조정 및 각종 시스템 개선·개편을 위해 현재 진행 중인 아일랜드 경영 개발 시즌에 초기화를 진행할 예정입니다. 
 초기화 후의 개발 시즌은 <color=#39bfff>2025년11월 20일(목) 점검 후 ~ 2026년 2월 26일(목) 점검</color>까지 진행됩니다. 
 ...
 4. 개발 상점: 개발 상점의 상품 구매 가능 횟수가 초기화됩니다. 또한 11/20(목) 점검 후에는 새로운 지휘관 스킨과 모션 판매가 시작됩니다. 11/20(목) 점검까지 판매할 예정이었던 지휘관 스킨과 모션만 2/26(목) 점검까지 기간이 연장됩니다(이미 구매했으면 다시 구매 불가). 
 5. 아일랜드 의뢰: 11/20(목) 점검 시점에 완료한 이벤트 의뢰 개수에 따라 <color=#39bfff>「아일랜드 시즌 Pt 교환 티켓」</color>이 지급됩니다. 「아일랜드 시즌 Pt 교환 티켓」은 아일랜드 개발 Pt로 변환할 수 있습니다. (예: 11/20 점검 후에 획득한 「아일랜드 시즌 Pt 교환 티켓」은 2/26 시즌 종료 시에 아일랜드 개발 Pt로 변환됨)
...
_G.pg.base.gametip.black5_bundle_popup = {
	tip = "다이아 <color=#92fc63>$1</color>개를 소비하여 <color=#92fc63>$2</color>(을)를 구매하시겠습니까?"
}
...
_G.pg.base.gametip.vote_help_2025 = {
	tip = {
		{
			info = [[
<color=#FFDD00>AZURLANE 인기 투표 2025 진행에 대해</color>

개요：
· AZURLANE 인기 투표 2025는 한정 임무 클리어를 통해 자동으로 얻을 수 있는 투표권으로 좋아하는 함선에게 투표하여, 투표 수에 따라 보상을 획득하는 이벤트입니다. 

· 메인 화면 우측 상단의 「인기 투표」에서 한정 임무 및 순위를 확인하거나, 각 항목에 투표할 수 있습니다.　

· 인기 투표 진행 기간: <color=#92fc63>2025년 12월 25일 ~ 2026년 2월 23일 23:59까지</color>입니다.

· 인기 투표의 「일정 결과」에서는 각 투표 항목의 전 서버 합계 투표 수가 표시됩니다. 

· 지난 인기 투표 이벤트에서 이미 TOP3에 오른 함선은 <color=#92fc63>명예의 전당</color>에 가입한 것으로 간주하여 이번 투표 이벤트에는 등장하지 않습니다. 또한 뒷산 화면의 「명예의 전당」에서 TOP3 함선들의 미니 스토리를 감상할 수 있습니다.

·전당에 가입한 함선을 제외하고 아래의 <color=#92fc63>2025년 11월 6일 이전에 추가된 함선 및 특별계획함</color>에게는 투표할 수 있습니다. (특별계획함 이외의 콜라보 캐릭터·μ형·Zwei형·Ⅱ형 의장 및 IF 함선은 인기 투표 대상에서 제외되며, META 및 꼬마 함선은 「특별 투표」 코너에서 투표할 수 있습니다) 



투표권 획득 방법:

지휘관 레벨이 25 이상에 도달하면, 다음 방법으로 <color=#92fc63>투표권</color>을 획득할 수 있습니다. 

인기 투표 본선(특별 투표 제외):

· 인기 투표 진행 기간 중에 등장하는 <color=#92fc63>한정 일간 임무</color>를 클리어하면 투표권이 자동으로 <color=#92fc63>가산</color>됩니다. 일간 임무로 얻을 수 있는 최대 투표권 수는 <color=#92fc63>하루에 20장까지</color>입니다. 

· 인기 투표 진행 기간 중에 등장하는 <color=#92fc63>1회 한정 임무</color>를 클리어하면, 투표권이 자동으로 <color=#92fc63>가산</color>됩니다. 각 투표 항목마다 투표권 획득 상한이 존재합니다. 
	투표권 획득 임무와 투표권 획득 상한에 대해서는 「한정 임무」에서 확인할 수 있습니다.　
...
· 각 항목의 투표 기한 종료 후, 남은 투표권은 <color=#92fc63>자동으로 삭제</color>되며, 한정 임무의 진척도 역시 <color=#92fc63>초기화</color>됩니다. 

특별 투표:

특별 투표 진행 기간 중에 게임에 로그인하면 하루에 1장 <color=#92fc63>투표권</color>을 획득할 수 있습니다. 



진행 일정: 

본선·특별 투표는 다음 일정에 따라 진행됩니다.

<color=#92fc63>예선</color>: 	
2025년 12월 25일(목) 점검 후 ~ 2026년 1월 5일(월) 23:59까지

<color=#92fc63>그룹전 A</color>: 	
2026년 1월 8일(목) 0시 ~ 2026년 1월 12일(월) 23:59까지

<color=#92fc63>특별 투표Ⅰ</color>: 2026년 1월 13일(화) 0시 ~ 2026년 1월 15일(목) 23:59까지

<color=#92fc63>그룹전 B</color>: 	
2026년 1월 17일(토) 0시 ~ 2026년 1월 21일(수) 23:59까지

<color=#92fc63>특별 투표Ⅱ</color>: 2026년 1월 22일(목) 0시 ~ 2026년 1월 24일(토) 23:59

<color=#92fc63>그룹전 C</color>: 	
2026년 1월 26일(월) 0시 ~ 2026년 1월 30일(금) 23:59까지

<color=#92fc63>특별 투표Ⅲ</color>: 2026년 1월 31일(토) 0시 ~ 2026년 2월 2일(월) 23:59까지

<color=#92fc63>그룹전 D</color>: 	
2026년 2월 4일(수) 0시 ~ 2026년 2월 8일(일) 23:59까지

<color=#92fc63>결승 부활전</color>: 2026년 2월 10일(화) 0시 ~ 2026년 2월 13일(금) 23:59까지

<color=#92fc63>결승전</color>: 	2026년 2월 17일(화) 0시 ~ 2026년 2월 23일(월) 23:59까지



각 항목의 투표 기간, 최종 결과는 뒷산의 <color=#92fc63>「일정 결과」</color>에서 확인할 수 있습니다. 
...
<color=#92fc63>예선</color>
<color=#92fc63>예선</color>은 투표 기한 중 캐릭터의 투표 수가 표시되지 않으며, 현재 순위만 표시됩니다. 

<color=#92fc63>예선</color>에는 명예의 전당 가입 함선, 콜라보 캐릭터(특별계획함 제외), META 함선, 꼬마 함선 이외의 모든 캐릭터가 참여합니다. 또한 μ형·Zwei형·Ⅱ형 의장 및 IF 함선은 본체와 같은 캐릭터로 취급됩니다. 

<color=#92fc63>예선</color>에서 투표 수 상위 240까지를 기록한 함선만 그룹전에 진출합니다. 그룹전의 각 그룹에는 함선이 60명씩 참여합니다. 



<color=#92fc63>그룹전</color>
<color=#92fc63>그룹전</color>은 <color=#92fc63>예선</color> 득표 수가 상위 240까지를 기록한 함선이 4개 그룹으로 나뉘어 실시됩니다. 

각 그룹전에서 득표 수 상위 5까지 오른 함선은 <color=#92fc63>결승전</color>에 진출합니다. 득표 수가 6위에서 15위까지인 함선은 <color=#92fc63>결승 부활전</color>에 진출합니다. 



<color=#92fc63>특별 투표</color>
<color=#92fc63>특별 투표</color>는 총 3개 항목으로 나뉘어, 각각 세이렌, META 함선, 꼬마 함선이 참여합니다. 특별 투표에 참여하는 함선은 본선에 참여할 수 없습니다. 



<color=#92fc63>결승 부활전</color>
<color=#92fc63>결승 부활전</color>에는 <color=#92fc63>그룹전</color>에서 각각 득표 수가 6위에서 15위였던 함선이 참여합니다. 

<color=#92fc63>결승 부활전</color>의 득표 수가 상위 15까지 오른 함선은 <color=#92fc63>결승전</color>에 진출합니다. 



<color=#92fc63>결승전</color>
<color=#92fc63>결승전</color>에는 그룹전에서 올라온 총 40명의 함선과 결승 부활전에서 올라온 15명의 함선이 참여합니다. 



득표 수가 동일한 경우:

<color=#92fc63>예선</color>에서 동표를 기록한 함선은 최종 결과 득표 수에 먼저 도달한 순으로 순위가 결정됩니다. 

<color=#92fc63>그룹전</color>, <color=#92fc63>결승 부활전</color>, <color=#92fc63>결승전</color>에서 동표를 기록한 함선은 <color=#92fc63>예선</color>에서의 최종 순위로 순위가 결정됩니다. 
]]
		}
	}
}
...
_G.pg.base.gametip.change_skin_asmr_desc_1 = {
	tip = "이전 화면으로 돌아갑니다. (음량에 주의하시기 바랍니다)"
}


_G.pg.base.gametip.change_skin_asmr_desc_2 = {
	tip = "이어폰을 끼고 감상하시기 바랍니다."
}
	...
	tip = {
		{
			info = [[
■ 이벤트 진행 기간
 2026.2.8(일) 0:00 ~ 2026.4.7(화) 23:59
	...
	tip = {
		{
			info = [[
플레이 방법:
<color=#92fc63>2.5 ~ 2.19 점검</color>까지 기간 한정 이벤트 '특집 사진, 촬영 진행 중! 」이 진행됩니다! 
...
_G.pg.base.gametip.battlepass_main_tip_2604 = {
	tip = "2026/4/8-2026/6/7 이벤트 기간 중, 월드 투어 누적 <icon name=pt w=0.5 h=0.5/> 획득 보상으로 <color=#854747>「쾰른·META」</color> 등을 획득 가능"
}
	...
	tip = {
		{
			info = [[
■ 이벤트 진행 기간
 2026.4.8(수) 0:00 ~ 2026.6.7(일) 23:59
...
_G.pg.base.gametip.multiple_endings_tip = {
	tip = {
		{
			info = "엔딩 오픈:\n스토리 중 일부분에서 <color=#92fc63>「중요 선택」</color>이 등장합니다. <color=#92fc63>「중요 선택」</color>은 도달 가능한 엔딩에 영향을 줍니다. 스토리를 다시 감상하며 <color=#92fc63>「중요 선택」</color>을 다시 고르면 다른 엔딩을 오픈할 수 있습니다. \n*<color=#92fc63>임의의 엔딩에 도달하면 </color>이벤트 기간 종료 시에 자동으로 다른 모든 엔딩이 오픈됩니다, 오픈된 엔딩은 「추억」에서 확인할 수 있습니다."
		}
	}
}
...
_G.pg.base.gametip.l2d_tip_on = {
	tip = "L2D 연출 tips 기능이 ON으로 설정되었습니다."
}
...
_G.pg.base.gametip.littleMusashi_npc = {
	tip = {
		{
			info = "■개요\n「아직 미숙한 수호자」는 이벤트 시작 시에 임시로 가입하는 [꼬마 무사시]의 「호감도」를 해역에 출격함으로써 쌓아, [꼬마 무사시]를 정식으로 가입시키는 이벤트입니다. "
		},
		{
			info = "■ 플레이 방법\n1. 이벤트 기간 중에 특정 이벤트를 수행하면 「호감도」를 획득할 수 있습니다. 획득한 「호감도」가 일정 수치에 도달하면 「호감도 보상」을 획득할 수 있습니다."
		},
		{
			info = "2. [꼬마 무사시]는 호감도 보상(7단계째)의 「정식 가입」을 달성하지 않으면 서약할 수 없으며, 퇴역 및 강화·한계 돌파 재료로 선택할 수 없습니다. "
		},
		{
			info = "3. 이벤트 종료 시까지 이벤트 페이지의 「호감도 보상」을 마지막까지 수령하면, [꼬마 무사시]를 「정식 가입」시킬 수 있습니다. 이벤트 종료 시, 「정식 가입」하지 않은 [꼬마 무사시]는 모항에서 사라집니다. "
		},
		{
			info = "4. 호감도 보상은 5/20(수)까지 매일 한 단계씩 오픈됩니다. "
		},
		{
			info = "5. 임시 가입 상태인 [꼬마 무사시]는 대형 작전(META전 포함)에는 참여할 수 없습니다. "
		},
		{
...
_G.pg.base.gametip.island_mecha_task_description = {
	tip = "6/25(목)까지 매일 오픈되는 임무를 클리어하면\n아일랜드 스킨 「코어 접속」 획득 가능"
}
	...
	tip = {
		{
			info = [[
■ 이벤트 진행 기간
 2026.8.8(토) 0:00 ~ 2026.10.7(수) 23:59

■ 개요
「월드 투어」란, 이벤트 진행 중에 임무를 클리어하고 「투어 PT」를 모아, 획득한 투어 PT 합계에 따라 보상을 얻을 수 있는 이벤트입니다. 
또한, 기본 투어 보상에는 추가적으로 「특허 투어 보상」이 존재하며, 상점 아이템 「특허 투어 패스」를 구매하면 특허 투어 보상을 획득할 수 있습니다. 
기본 투어 보상으로는 함선 「뉘른베르크·META」, 특허 투어 보상으로는 구축함 「퀸시」의 한정 스킨인 「거절할 수 없는 자습 타임」을 획득할 수 있습니다. 
