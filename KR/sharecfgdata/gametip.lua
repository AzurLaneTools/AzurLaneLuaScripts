...
_G.pg.base.gametip.coloring_help_tip = {
	tip = {
		...
		{
			info = [[
1. 각 그림 일기 칸에 해당하는 물감 번호가 표시되어 있으며, 오른쪽 번호에 해당하는 물감을 클릭하면 자동으로 색이 칠해집니다.
2. 그림 영역은 두 손가락으로 확대하거나 축소할 수 있습니다.
3. 색칠은 물감이 소진되거나 가득 찰 때까지 같은 색 셀에 자동으로 색칠됩니다.
4. 색칠에는 물감이 소모되기 때문에 물감이 0이 되면 더 이상 색칠이 불가능해집니다.
5. 물감은 이벤트 퀘스트에서 오일을 누적 소비하여 획득할 수 있습니다.
6. 색칠을 완료하면 보상을 획득할 수 있습니다.
7. 그림별 보상 내용은 아래와 같습니다:
	그림1 완료 후 T3 랜덤 교재 x2 획득
	그림2 완료 후 세뱃돈 x2 획득
	그림3 완료 후 T3 주포 개조 부품 x2 획득
	그림4 완료 후 세뱃돈 x2 획득
	그림5 완료 후 얏센의 설비·매화의 말 x1 획득
	그림6 완료 후 세뱃돈 x2 획득
	그림7 완료 후 안샨 x1, 세뱃돈 x1 획득
8. 이벤트 종료 후 사용하지 않은 물감은 모두 사라지게 됩니다.
9.<color=#92fc63>2월 13일</color>까지 매일 완성할 수 있는 그림이 오픈됩니다.]]
		}
	}
}
...
_G.pg.base.gametip.world_boss_help = {
	tip = {
		...
		{
			info = "이벤트 \"\"정신 없는 환창이네\"\"는 <color=#92fc63>\"\"연습 포인트\"\"</color>를 모아 작전을 진척시키면, 개인 합계 포인트 보상 및 작전 진척 보상을 얻을 수 있는 이벤트입니다."
		},
		{
			info = [[
	...
	tip = {
		{
			info = [[
이벤트 설명:
1. 이벤트 기간 동안 <color=#92fc63>""푸슌의 대모험 V""</color>, <color=#92fc63>""그림 일기""</color>, <color=#92fc63>""춘절 폭죽""</color>, <color=#92fc63> ""새봄의 모험왕""</color>을 통해 세뱃돈을 획득할 수 있으며, 세뱃돈 오픈 시 다이아 및 다른 풍부한 보상을 획득할 수 있습니다.
2. 세뱃돈은 보너스와 일반 세뱃돈으로 구분되며, <color=#92fc63>15</color>개 보너스 봉투를 제외하면 나머지는 전부 일반 세뱃돈입니다. 세뱃돈 오픈 시, 보너스 세뱃돈부터 오픈되며, 보너스 세뱃돈 오픈이 끝난 뒤 일반 세뱃돈이 오픈됩니다.
3. 총 <color=#92fc63>15</color>개의 세뱃돈을 오픈하면 <color=#92fc63>""푸슌"" 한정 스킨</color>을 획득할 수 있으며, 총 <color=#92fc63>25</ color>개의 세뱃돈을 오픈하면 < color=#92fC63>""와카츠키"" 한정 스킨</ color>을 획득할 수 있습니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1.<color=#92fc63>1월 4일</color>까지 0시마다 게임 <color=#92fc63>1</color>장씩 총 <color=#92fc63>7</color>장이 개방됩니다. 누적 가능. 7장 모두 완료 시 사우스햄튼 한정 스킨이 포함된 풍부한 보상을 획득할 수 있습니다.
게임 규칙:
...
2. 이벤트 진행 시에 해당 이벤트의 임무를 클리어하면, <color=#92fc63>「기념 스티커」</color>를 획득할 수 있으며, 스티커를 모으면, 기념장 가구 「저항군 본부 건물」과 훈장 「저항의 별 기념 훈장」을 획득할 수 있습니다. 
