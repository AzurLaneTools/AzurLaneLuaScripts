	...
	tip = {
		{
			info = [[
<size=31><color=#92fc63>TIPS:
기원 유효 횟수가 없을 시 기원할 수 없습니다.</color></size>
1. 이벤트 기간 동안 매일 <color=#92fc63>함선을 도와 에마를 걸어줄 기원 횟수를 1회</color> 얻습니다. 기원 횟수를 소모하여 신년의 축복과 기원 유효 횟수 2회를 획득할 수 있습니다. <color=#ff5c5c>기원 유효 횟수는 최대 14회 획득 가능합니다</color>.
2. 함선을 도와 에마를 걸면 해당 함선의 기원 보너스와 신년의 축복을 획득합니다. 신년의 축복을 7개 수집하면 「연하장」을 획득할 수 있습니다.
3. 기원 보너스는 동시에 한 함선에게서만 받을 수 있습니다.
4. 유효 횟수를 보유한 상황에서 물자*5를 소모하여 기원 시 각각의 버프 효과를 선택할 수 있습니다:
학업: 전술 학원 스킬 레벨업 시간 감소
사업: 메인, 어려움, 작전 문서 스테이지에서 아군대미지 증가
연애: 비서함 호감도 상승 속도 가속
위 세 가지 효과의 지속 시간은 1일입니다.
5. 학업 효과 획득 시 이미 진행 중인 스킬 레벨업 시간은 감소하지 않으며, 학업 효과가 사라질 시 이미 학업 효과로 감소한 스킬 레벨업 시간이 늘어나지 않습니다.
6. 이미 버프 효과를 보유한 상태에서 기원한다면, 새로 획득한 버프 효과가 이전의 효과를 덮어버리게 되며, 지속 시간은 초기화됩니다.
7. 기원 버프 효과는 동시에 한 가지만 적용됩니다.]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
1. <color=#92fc63>9월 28일</color>까지 매일 0시마다 게임이 <color=#92fc63>1</color>장씩 총 <color=#92fc63>7</color>장까지 오픈되며, 누적 가능합니다. 게임 완료 시 한정 가구가 포함된 풍부한 보상을 획득할 수 있습니다.

게임 규칙:
1. 캐릭터를 컨트롤하여 디저트를 획득하고 쥬쥬 심판에게 전달해야 합니다. 정확한 디저트는 1점 득점, 잘못된 디저트 1점 감점입니다. 시간 종료 시 점수가 높은 쪽이 승리합니다.
2. 디저트 대작전에 총 8명의 캐릭터가 있으며, 임의의 캐릭터를 선택해 팀원과 작전할 수 있습니다.
3. 시간이 소진되거나 게임 내 퇴장 버튼을 눌러 퇴장 시 게임을 완료한 것으로 간주합니다. 기타 원인으로 인하여 중도 퇴장 시 미완료한 것으로 간주합니다.]]
		}
	}
}
