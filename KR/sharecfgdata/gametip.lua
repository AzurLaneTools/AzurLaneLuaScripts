...
_G.pg.base.gametip.world_boss_help_meta = {
	tip = {
		{
			info = [[
<color=#92fc63>2023.9.14 ~ 2023.12.21</color>
...
■ 주의 사항
· 개방된 전투는 24시간 동안만 도전할 수 있습니다. 24시간이 지난 후에는 META전 표시가 사라져 도전이 불가능해집니다. 
...
· META전에 등장하는 적 함선이 변경된 후 31일이 경과하면, 지휘관은 자신이 개방한 META전에 도전할 시, 한 전투에 단 한 번 아군 지원 포격으로 META 함선에 피해(직접 피해 또는 지속 피해)를 줄 수 있습니다. 해당 피해량은 등장 함선이 변경된 후부터 시간이 흐르면 흐를수록 상승합니다.]]
		}
	}
}
