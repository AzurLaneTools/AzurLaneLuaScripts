...
1. <color=#92fc63>2023.6.29-2023.9.14점검 전</color>까지 「알제리·META」의 도전이 한정 개방됩니다. 「비콘·META」에 도전해 동기화 수치를 누적하여<color=#92fc63>「알제리·META」 캐릭터</color> 및 기타 풍부한 보상을 획득할 수 있습니다.
 <color=#ff5c5c>주의: 동기화 수치는 기간 종료 후 사라집니다.</color>

2. 「비콘 데이터」 획득 및 분석
·대형 작전을 통해 「비콘 데이터」를 획득할 수 있으며, 지정 데이터량 도달 후, 분석 및 특정 비콘을 발견할 수 있습니다.
·매일 최대 <color=#92fc63>200</color>까지 획득할 수 있으며, 0시마다 획득 가능량이 초기화됩니다. 사용하지 않은「비콘 데이터」는 보류됩니다.
...
6.화력 지원
비콘·META 도전 31일째부터, 즉 2023.6.29-2023.9.14  기간 동안, 함대가 「알제리·META」에 도전 시 추가 화력 지원을 얻을 수 있습니다. 화력 지원은 적에게 대미지를 입히며, 지속 대미지의 특수 상태를 부여합니다. (버프 효과의 영향은 받지 않습니다.) 이번 비콘·META의 개방 기간이 증가함에 따라, 화력 지원의 대미지도 증가합니다.
	...
	tip = {
		{
			info = [[
이벤트 규칙：
<color=#92fc63>8.03-8.17점검 전</color>까지 기간 한정 이벤트 「호광은 교차하는 세계에서」 오픈
1.특별 작전을 통해 「호광 결정」을 획득하여 「괴수 양성」과
「보급 상점」에서 풍부한 보상과 교환
2.「격전! 그리드맨 쥬 vs 괴수 쥬!」 제7회를 완료하여 한정 가구 그림 <color=#92fc63>「도시 격전!」 획득주의: 매일 1회씩 총 7회까지 개방됩니다.
