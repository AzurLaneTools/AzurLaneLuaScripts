	...
	tip = {
		{
			info = [[
※ 플레이 방법 ※
・""그림 그리기""에서는 색칠 영역으로 지정된 번호에 해당하는 물감을 선택하여 탭하면, 해당 영역에 색을 입힐 수 있습니다
;
・색칠 영역은 손가락 줌 조작으로 확대하거나 축소할 수 있습니다.
・색칠은 같은 색상의 영역이 완전히 채색되거나, 
물감이 모두 소진될 때까지 자동적으로 실시됩니다;
・색칠은 '물감'을 소모합니다. 물감의 잔량이 
0이 되면 해당 색상의 영역을 색칠할 수 없습니다.
・'물감'은 이벤트 기간 한정 임무 '총 연료 소비 수'를
 보상으로 획득할 수 있습니다;
...
・7월 5일(수)까지 매일 새로운 그림이 한 장씩 오픈됩니다.
]]
		}
	}
}
	...
	tip = {
		{
			info = [[
이벤트 규칙:
<color=#92fc63>2월 2일</color>까지 매일 0시마다 신규 게임이 <color=#92fc63>1</color>회씩 개방됩니다. 총 <color=#92fc63>7</color>회까지 개방되며, 누적 가능합니다. 7회 게임 완료 시 푸슌이 포함된 풍부한 보상을 획득할 수 있습니다.
게임 규칙:
1. 각 게임은 시간 제한이 없으며, 체력 4포인트를 잃거나 지붕에서 떨어지면 게임이 종료됩니다.
2. 좌측 점프 버튼을 누르면 푸슌이 점프하며, 우측 공격 버튼을 눌러 공격할 수 있습니다.
3. 점수는 푸슌의 이동에 따라 증가하며, 각 아이템 획득 시 다음의 효과가 있습니다.
금화: 50점 획득
옥패: 300점 획득
러닝화: 점프력&이동 속도 증가, 점프 후 연수쥬를 밟아서 처치 가능
유도탄: 공격 시 원거리 유도탄 발사
자석: 근처 아이템 자동 흡수
연수쥬 처치 시 500점 획득
4. 게임 완성 또는 게임 내 퇴장 버튼을 누룰 경우 게임을 완료한 것으로 간주됩니다. 기타 원인으로 인하여 중도 퇴장할 경우 게임을 미완료한 것으로 간주됩니다.]]
		}
	}
}
