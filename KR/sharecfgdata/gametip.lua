	...
	tip = {
		{
			info = [[
이벤트 규칙:
1. <color=#92fc63>10월 6일</color>까지 매일 0시마다 <color=#92fc63>1</color>장의 게임이 오픈됩니다. 총 <color=#92fc63>7</color>장이며 누적 가능합니다. 게임을 완료하여 고기를 누적 획득하면 유다치 한정 개조 아이템—고기 냄새 향수를 획득할 수 있습니다.
게임 규칙:
1. 화면에 스크롤 바가 나타납니다. 닭다리가 이동할 때 화면을 터치하여 닭다리를 정지시킬 수 있으며, 유다치가 닭다리를 더 빨리 먹을 수 있도록 녹색 구역에 닭다리를 정지시켜야 합니다. 녹색 구역에 누적 12회 정지시키면 대식가 대회에서 승리합니다.
2. 다른 색깔 구역에 닭다리를 정지시킬 시 획득 포인트가 다릅니다: 눅색 구역에 정지시킬 때 중심부에 가까울수록 높은 점수를 얻습니다. 황색 구역은 점수가 없으며, 홍색 구역은 감점입니다.
...
1. 사용 가능 횟수가 있을 경우, 쥬쥬 숨바꼭질 참여 시 사용 가능 횟수가 소모되며 출석 횟수를 얻습니다. 출석 <color=#92fc63>7</color>회 시 <color=#92fc63>「축제 초대장」</color>을 획득합니다.
2. 사용 가능 횟수는 축제 광장 화면 우측에서 확인할 수 있으며, 출석 진도는 축제 광장 화면에서 <color=#92fc63>「초대장」</color> 버튼을 터치하여 확인할 수 있습니다.
3. 사용 가능 횟수가 없는 경우, 쥬쥬 숨바꼭질 진행 시 출석 횟수를 얻지 못합니다.]]
		}
	}
}
