...
(function ()
	...
	pg.base.activity_event_building[31] = {
		...
		desc = {
			"전투 중 아군 캐릭터의 누적 피해량이 최대치의 40%에 도달하면, 1회 한정으로 내구가 최대치의 3%만큼 회복된다(캐릭터당 1회까지).",
	...
	pg.base.activity_event_building[36] = {
		...
		desc = {
			"전투 시작 후 10초 동안 아군 캐릭터의 장전이 15% 상승한다.",
