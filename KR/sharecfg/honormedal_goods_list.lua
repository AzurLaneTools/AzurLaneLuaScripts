...
pg.honormedal_goods_list = {
	...
	},
	{
		...
		group = 10036,
		num = 1,
		goods_name = "사르데냐 엠파이어 장비 개발 지원 상자",
		goods_type = 1,
		id = 51,
		is_ship = 0,
