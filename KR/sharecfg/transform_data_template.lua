...
무기 효율이 100%/150%/105%로 조정되었습니다.]],
	...
	[53411] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "근대화 개조 완료. 방공+35, 항공+25\n개조 후 <color=#92fc63>[제1 무기 슬롯에 전투기 장착 가능] [제1 무기 슬롯 함재기 수+2] </color>, <color=#92fc63>[제2 무기 슬롯에 모든 유형의 함재기 장착 가능] [제2 무기슬롯에 함재기 및 받침대 수+1] </color>",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			53409,
