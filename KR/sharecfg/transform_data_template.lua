...
(function ()
	...
	pg.base.transform_data_template[24211] = {
		level_limit = 85,
		name = "근대화 개수",
		descrip = "개조(근대화 개수) 완료. 포격 +30, 명중 +15\n개조 후 [주포 포좌 +1]\n주포 슬롯 위력 보정 120%로 변경",
		max_level = 1,
		skin_id = 403019,
		use_ship = 1,
		star_limit = 5,
...
(function ()
	...
	pg.base.transform_data_template[35711] = {
		level_limit = 85,
		name = "근대화 개수",
		descrip = "개조(근대화 개수) 완료, 명중 +10, 대공 +35\n 개조 후 <color=#92fc63>폭격기 슬롯에 모든 함재기 장착 가능</color>\n 스킬 [선전의 함]이 [선전의 함·改]로 변경됨",
		max_level = 1,
		skin_id = 107099,
		use_ship = 1,
		star_limit = 6,
