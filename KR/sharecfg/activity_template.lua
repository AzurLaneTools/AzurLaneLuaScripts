...
pg.activity_template = {
	...
	[20751] = {
		...
		config_id = 0,
		is_show = 0,
		config_data = "activity_drop_20751",
		title_res_tag = "",
		id = 20751,
		config_client = {
			id = 2,
			bg = "loadingbg/bg_build_2_act",
			buildship_tip = "타르투 출현 확률UP!",
			rate_tip = {
	...
	[20877] = {
		...
		config_id = 0,
		is_show = 0,
		config_data = "activity_drop_20877",
		title_res_tag = "",
		id = 20877,
		config_client = {
			id = 3,
			bg = "loadingbg/bg_build_3_act",
			buildship_tip = "가스코뉴(μ장비)、{namecode:176}등 캐릭터 건조 확률 UP!",
			rate_tip = {
				"<color=#ffde38>SSR</color>：7%",
				"<color=#d797ff>SR</color>：12%",
	...
	[20899] = {
		...
		config_id = 0,
		is_show = 0,
		config_data = "activity_drop_20899",
		title_res_tag = "",
		id = 20899,
		config_client = {
			id = 3,
			bg = "loadingbg/bg_build_3_act",
			buildship_tip = "포슈 건조 확률 UP!",
			rate_tip = {
				"<color=#ffde38>SSR</color>：7%",
				"<color=#d797ff>SR</color>：12%",
				"<color=#3dc6ff>R</color>：51%",
