...
pg.dorm3d_gift = {
	[1021001] = {
		display = "핑크색 토끼 인형.부드러운 소재로 만들어져 부드럽고, 안고 있으면 편안하다.",
		name = "토끼토끼 인형",
	...
	[1021002] = {
		display = "그윽하고도 매혹적인 향기를 풍기는 꽃다발.장미와 붉은색을 기조로 한 꽃들이 열정적이고 로맨틱한 느낌을 준다.",
		name = "로맨틱 만점",
	...
	[1021003] = {
		display = "섬세하게 포장된 상자와 맛있는 케이크 조각 모둠.자기가 먹어도 좋고, 다른 사람에게 주는 선물로도 모자람이 없다.",
		name = "케이크 선물상자",
	...
	[2022001] = {
		display = "집이나 직장의 청소와 정리에 빠뜨릴 수 없는 아이템.견고하고 튼튼한 케이스가 공구를 손상에서 보호해 준다.",
		name = "청소 공구함",
