...
(function ()
	...
	pg.base.strategy_data_template[1002] = {
		buff_id = 9729,
		name = "기선 제압",
		desc = "아군의 [야간 은폐 강도]가 대폭 상승하고, 적의 [야간 은폐 강도]가 대폭 저하",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 1002,
	...
	pg.base.strategy_data_template[1003] = {
		buff_id = 9733,
		name = "피할 수 없는 격돌Ⅰ",
		desc = "아군의 [야간 은폐 강도]가 상승하고, 적의 [야간 은폐 강도]가 저하",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 1003,
	...
	pg.base.strategy_data_template[1004] = {
		buff_id = 9737,
		name = "피할 수 없는 격돌Ⅱ",
		desc = "아군의 [야간 은폐 강도]가 조금 상승하고, 적의 [야간 은폐 강도]가 조금 저하",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 1004,
	...
	pg.base.strategy_data_template[1005] = {
		buff_id = 9741,
		name = "피할 수 없는 격돌Ⅲ",
		desc = "아군의 [야간 은폐 강도]가 근소하게 상승하고, 적의 [야간 은폐 강도]가 근소하게 저하",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 1005,
	...
	pg.base.strategy_data_template[1009] = {
		buff_id = 9754,
		name = "공중 지원Ⅰ(적)",
		desc = "전투 중에 적의 육상 항공 기지에서 항공 지원 출현",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 1009,
	...
	pg.base.strategy_data_template[1010] = {
		buff_id = 9755,
		name = "공중 지원Ⅱ(적)",
		desc = "전투 중에 적의 잔존 육상 항공 기지에서 항공 지원 출현",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 1010,
	...
	pg.base.strategy_data_template[1011] = {
		buff_id = 9756,
		name = "공중 지원Ⅲ(적)",
		desc = "적의 육상 항공 기지가 파괴되어 적의 항공 지원이 약화됨",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 1011,
...
장비·스킬[스크램블], [래빗 라스트 스탠드]가 무효화된다.]],
	...
	pg.base.strategy_data_template[200931] = {
		...
		name = "챌린지 모드",
		desc = [[
전투 시작 시 아군 함선이 <color=#92fc63>[수수께끼의 D장치]</color>를 장착하고 있는 경우, 전투가 챌린지 모드에 돌입하며 난이도가 상승하지만, 클리어하면 더욱 높은 점수를 얻을 수 있다. 

   챌린지 모드 특징:
 적이 주는 피해량이 <color=#ffc038>대폭 상승</color>한다. 또한 일부 적탄은 항공 공격으로 상쇄할 수 없고, 아군의 실드로도 무효화되지 않는다. 
 아군 선봉함대의 <color=#92fc63>명중 판정이 선봉함대의 선두 함선만으로 한정되어, 명중 판정 범위가 대폭 감소</color>한다. 
 함선이 피격되면 일정 시간 무적 상태가 된다. 

장비·스킬 [스크램블], [래빗 라스트 스탠드], [절체절명], [레인보우 프로젝트]가 무효화된다.]],
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 200931,
...
어려움 모드의 특징:
적이 주는 피해량이 대폭 상승한다. 적탄이 실드를 무시하고 사선 상에 있는 모든 아군 함선에게 피해를 입힌다.
 적이 일부 회피 불능 공격을 가할 때, 「아드미랄 히퍼·META」의 지원이 출현한다. 
...
[래빗 라스트 스탠드], [레인보우 프로젝트], [절체절명]]],
	...
	pg.base.strategy_data_template[201463] = {
		buff_id = 0,
		name = "챌린지 설명",
		desc = "보스는 <color=#92fc63>검은색과 흰색의 두 가지 형태가 있으며 </color>각각 내구와 전투 방법이 다릅니다. 검은 형태에서는 <color=#92fc63>받는 피해량이 1로 고정됩니다</color>. \n 현재 활성화된 보스 형태가 모든 공격을 마쳤을 때, 나머지 형태의 내구가 0이 아니라면 휴면 상태로 전환되고, 나머지 형태가 활성화됩니다. 또한, 활성화된 보스 형태의 내구가 0이 된 경우, 휴면 상태의 형태는 강제로 활성화되고 <color=#92fc63>광폭화</color> 상태가 되어 입히는 피해량과 받는 피해량이 100% 증가합니다(검은 형태의 경우, 받는 피해량이 2로 고정됨).",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201463,
	...
	pg.base.strategy_data_template[201464] = {
		...
		name = "챌린지 설명",
		desc = [[
보스는 <color=#92fc63>검은색과 흰색의 두 가지 형태가 있으며 </color>각각 내구와 전투 방법이 다릅니다. 검은 형태에서는 <color=#92fc63>받는 피해량이 1로 고정됩니다</color>. 
 현재 활성화된 보스 형태가 모든 공격을 마쳤을 때, 나머지 형태의 내구가 0이 아니라면 휴면 상태로 전환되고, 나머지 형태가 활성화됩니다. 또한, 활성화된 보스 형태의 내구가 0이 된 경우, 휴면 상태의 형태는 강제로 활성화되고 <color=#92fc63>광폭화</color> 상태가 되어 입히는 피해량과 받는 피해량이 100% 증가합니다(검은 형태의 경우, 받는 피해량이 2로 고정됨). 
...
[래빗 라스트 스탠드], [레인보우 프로젝트], [절체절명]]],
	...
	pg.base.strategy_data_template[201515] = {
		buff_id = 201515,
		name = "정신 동조Ⅰ",
		desc = "——「███ 해제: 22.8%」——\n시야에 정체 불명의 환상이 나타나기 시작했다. \n전투 중에 적과 아군을 가리지 않고 공격하는 탄막이 출현한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201515,
	...
	pg.base.strategy_data_template[201519] = {
		buff_id = 201519,
		name = "아마하라 가호 - 나비",
		desc = "아마하라 가호 결계: 나비\n전투 중에 아군이 투사 포격·항공 공격·어뢰 공격을 발동할 때마다 나비 형태의 특수 탄막이 출현한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201519,
	...
	pg.base.strategy_data_template[201525] = {
		buff_id = 201525,
		name = "아마하라 가호 - 깃털",
		desc = "아마하라 가호 결계: 깃털\n전투 중 20초마다 아군을 지원하는 하얀 봉황이 출현한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201525,
	...
	pg.base.strategy_data_template[201530] = {
		buff_id = 201530,
		name = "아마하라 가호 - 비늘",
		desc = "아마하라 가호 결계: 비늘\n전투 시작 시 아군을 지원하는 용이 출현하며, 일정 시간 후에 사라진다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201530,
	...
	pg.base.strategy_data_template[201531] = {
		buff_id = 0,
		name = "챌린지 모드",
		desc = "전투 중 보스와 함께 붉은 빛의 구체가 출현한다. 이 구체는 피해를 주지 않지만, 지속적으로 향기로운 연막을 살포한다. 함선이 이 연막 안에 있으면 그 영향을 받아 시간이 경과함에 따라 항속이 저하하고, 받는 피해량이 증가한다. 연막에 누적 1초 이상 머무르면, 기절 상태에 빠져 받는 피해량이 2배가 되며, 연막이 사라질 때까지 공격·이동이 불가능해진다. \n 연막에서 벗어나면, 그 안에서 받은 연막 영향은 절반 속도로 사라진다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201531,
	...
	pg.base.strategy_data_template[201532] = {
		...
		name = "챌린지 모드",
		desc = [[
전투 중 보스와 함께 붉은 빛의 구체가 출현한다. 이 구체는 피해를 주지 않지만, 지속적으로 향기로운 연막을 살포한다. 명중 판정이 유효한 아군 함선이 연막 안에 있으면 시간이 경과함에 따라 항속이 저하하고, 받는 피해량이 증가한다. 연막에 누적 1초 이상 머무르면, 기절 상태에 빠져 받는 피해량이 2배가 되며, 연막이 사라질 때까지 공격·이동이 불가능해진다. 
 연막에서 벗어나면, 그 안에서 받은 연막 영향은 절반 속도로 사라진다. 
...
[래빗 라스트 스탠드], [레인보우 프로젝트], [절체절명]]],
	...
	pg.base.strategy_data_template[201547] = {
		buff_id = 201547,
		name = "군도 유적 지원",
		desc = "전투 중 20초마다 아군에게 군도 유적에서 발사하는 지원 포격이 출현한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201547,
	...
	pg.base.strategy_data_template[201551] = {
		...
		desc = [[
「진정한 결투는 공평해야 해! 」
 라임은 전투에서의 「불공평」한 요소를 철폐하고자 한다.
 1. 전투 중 적, 아군 모두 <color=#92fc63>내구가 회복되지 않는다</color>. 
 2. 아군 중 하나라도 [완전 회피] 또는 [무적] 효과를 얻으면, 라임도 <color=#92fc63>받는 피해량을 1로 만드는</color> 실드를 얻는다. 
 3. 아군의 항공 공격으로 화면 전체의 적탄을 클리어하면, 1.5초 후에 라임도 <color=#92fc63>화면의 모든 탄을 클리어하고, 반격 탄막을 전개한다</color>. 아군이 항공 공격을 발동하면, 해당 효과는 5초 이내에 2회 이상 발동할 수 없다.]],
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201551,
...
[래빗 라스트 스탠드]]],
	...
	pg.base.strategy_data_template[201650] = {
		buff_id = 0,
		name = "스타 베일",
		desc = "스타 베일에서는 일부 [제1종 위상체]가 [제2종 위상체]로 변화한다. [제1종 위상체]의 증원이 억제되어 해역 맵에서 대규모 적 함대가 출현할 확률이 감소한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201650,
	...
	pg.base.strategy_data_template[201651] = {
		buff_id = 201651,
		name = "세이프티 컨트롤 익스피리언스",
		desc = "전투 중 아비터 인포서에 의한 지원이 출현한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201651,
	...
	pg.base.strategy_data_template[201654] = {
		buff_id = 0,
		name = "챌린지 모드",
		desc = "보스는 현재 내구 상태에 따라(<color=#92fc63>71% 이상·70% 이하·40% 이하</color>) 3종류의 적으로 의태하는 경우가 있다. 의태 상태의 보스는 받는 피해량이 <color=#92fc63>50% 감소</color>한다. \n의태 상태의 보스는 최대 내구가 고정되어 있으며 <color=#92fc63>내구가 0이 되면 의태 상태를 해제한 후, 8초 뒤에 다시 의태한다</color>. 보스의 장갑 타입은 의태 상태가 아니면 경장갑이며, 의장 상태에서는 중장갑이다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201654,
	...
	pg.base.strategy_data_template[201655] = {
		...
		name = "챌린지 모드",
		desc = [[
보스는 현재 내구 상태에 따라(<color=#92fc63>71% 이상·70% 이하·40% 이하</color>) 3종류의 적으로 의태하는 경우가 있다. 의태 상태의 보스는 받는 피해량이 <color=#92fc63>50% 감소</color>한다. 
의태 상태의 보스는 최대 내구가 고정되어 있으며 <color=#92fc63>내구가 0이 되면 의태 상태를 해제한 후, 8초 뒤에 다시 의태한다</color>. 보스의 장갑 타입은 의태 상태가 아니면 경장갑이며, 의장 상태에서는 중장갑이 된다.

하드 모드 사양:
적이 주는 피해가 <color=#ffc038>급격하게 증가</color>한다. 대형 탄막은 항공 공격이나 실드로 제거할 수 없다. 
 아군 선봉함대의 <color=#92fc63>명중 판정이 선봉함대의 선두 함선만으로 한정되어, 명중 판정 범위가 대폭 감소</color>한다. 
함선이 피격되면 일정 시간 무적 상태가 된다. 
...
[래빗 라스트 스탠드], [레인보우 프로젝트], [절체절명]]],
	...
	pg.base.strategy_data_template[201701] = {
		buff_id = 201701,
		name = "재물운 상승",
		desc = "전투 중 보화를 모티브로 한 지원 공격이 출현한다. ",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201701,
	...
	pg.base.strategy_data_template[201705] = {
		...
		name = "빛나는 메뉴!",
		desc = [[
전투 중 무작위로 메뉴 효과가 발동됩니다. 
1. 전투 시작 시 아군 전원의 내구가 1%만큼 회복됨
2. 전투 시작 후 30초간 아군의 항속이 10% 상승하고, 주는 피해량이 3% 증가
3. 아군 선봉함대가 반짝반짝 빛남 ]],
		type = 10,
		iconSize = "",
		buff_type = 0,
	...
	pg.base.strategy_data_template[201706] = {
		buff_id = 0,
		name = "챌린지 모드",
		desc = "전투 중 보스가 바둑돌을 대량으로 발사한다. 바둑돌은 파괴되지 않는다. \n하얀 바둑돌은 경장갑 타입의 함선에게 큰 피해를 주고, 검은 바둑돌은 중형장갑 및 중장갑 타입의 함선에게 큰 피해를 준다. ",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201706,
	...
	pg.base.strategy_data_template[201707] = {
		...
		name = "챌린지 모드",
		desc = [[
전투 중 보스가 바둑돌을 대량으로 발사한다. 
아군 함선이 바둑돌에 닿았을 때 자신이 <color=#92fc63>「색상 표식」을 가지고 있지 않다면</color>, 해당 바둑돌 색상의 「색상 표식」이 부여된다. <color=#92fc63>가지고 있는 「색상 표식」이 해당 바둑돌의 색상과 다를 경우</color>, 자신이 가진 「색상 표식」은 그 바둑돌의 색상으로 바뀐다. <color=#92fc63>바둑돌과 같은 색상의 「색상 표식」을 가지고 있다면</color>, 매우 높은 <color=#ffc038>고정 피해</color>를 입는다(이 고정 피해는 0.5초당 1회만 발생한다. 보스가 발사한 바둑돌은 파괴되지 않는다. 아군이 항공 공격을 실시하면 모든 「색상 표식」이 삭제된다.) 
...
[래빗 라스트 스탠드], [레인보우 프로젝트], [절체절명] ]],
	...
	pg.base.strategy_data_template[201741] = {
		...
		name = "챌린지 모드",
		desc = [[
보스는 자신으로부터 거리가 20 이상 떨어진 상대에게 받는 피해량이 경감된다<color=#92fc63>(거리 20을 기준으로 1 멀어질 때마다 받는 피해량 1% 경감, 최대 50%까지)</color>. 거리가 20 이상 떨어진 상대에게 주는 피해량이 증가한다<color=#92fc63>(거리 20을 기준으로 1 멀어질 때마다 주는 피해량 2% 증가, 최대 100%까지)</color>. 
보스가 <color=#92fc63>선봉함대에게 받는 포격 피해량이 100% 증가하고, 어뢰 피해량은 50% 증가한다</color>. 
보스는 접근하는 폭탄 투하형 함재기를 매우 빠르게 격추할 수 있다. 
<color=#ddf700>힌트: 보스의 초기 위치에서 아군 선봉함대가 이동 가능한 범위의 가장 좌측 끝까지의 거리는 약 70 정도</color>]],
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201741,
...
하드 모드 내용:
적이 가하는 피해량이 <color=#ffc038>대폭 증가</color>한다. 대형 탄막은 항공 공격이나 실드로 제거할 수 없다. 
 아군 선봉함대의 <color=#92fc63>명중 판정이 선봉함대의 선두 함선만으로 한정되어, 명중 판정 범위가 대폭 감소</color>한다. 
함선이 피격되면 일정 시간 무적 상태가 된다. 
...
[래빗 라스트 스탠드], [레인보우 프로젝트], [절체절명], [불굴의 의지]]],
	...
	pg.base.strategy_data_template[201743] = {
		...
		name = "챌린지 모드",
		desc = [[
임의의 보스가 격퇴되면, 다른 보스 하나가 [FEVER] 모드에 돌입하여 <color=#ffc038>공격 방식이 변경되고, 주는 피해량이 대폭 증가</color>한다. 어려움 모드의 특징:
적이 주는 피해량이 <color=#ffc038>대폭 상승</color>한다. 대형 탄막은 항공 공격이나 실드로 제거할 수 없다. 
 아군 선봉함대의 <color=#92fc63>명중 판정이 선봉함대의 선두 함선만으로 한정되어, 명중 판정 범위가 대폭 감소</color>한다. 
 함선이 피격되면 일정 시간 무적 상태가 된다. 
...
[래빗 라스트 스탠드], [레인보우 프로젝트], [절체절명], [불굴의 의지 ]]],
	...
	pg.base.strategy_data_template[201820] = {
		buff_id = 0,
		name = "몽광의 아스트라리움",
		desc = "아스트라리움에서 감정의 파편이 산산이 흩어져 있다. \n전투 중 「감정의 파편」이 출현하며, 격파되면 더 많은 「감정의 파편」을 생성할 수 있다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201820,
	...
	pg.base.strategy_data_template[201821] = {
		buff_id = 201821,
		name = "빗속의 꽃바다",
		desc = "전투 중 요크타운·META의 지원 탄막이 출현한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201821,
	...
	pg.base.strategy_data_template[201831] = {
		buff_id = 0,
		name = "챌린지 모드",
		desc = "전투 중, 본험 리차드 주변에 검붉은 돌풍이 출현하여 접근하는 아군을 빨아들인다. 돌풍에 지나치게 가까이 접근한 아군은 <color=#92fc63>지속적으로 피해를 받게 된다</color>. \n특정 상황에서는 전장에 풍향 안내가 나타나며, 아군이 본험 리차드의 좌측(서쪽) 또는 우측(동쪽)의 특정 범위 내에 있으면 [침식] 상태가 되어 <color=#92fc63>1초마다 내구 최대치의 0.5%만큼 피해를 받고, 적 탄환으로 받는 피해량이 20% 증가</color>한다.",
		type = 10,
		iconSize = "",
		buff_type = 0,
		id = 201831,
	...
	pg.base.strategy_data_template[201832] = {
		...
		name = "챌린지 모드",
		desc = [[
전투 중, 본험 리차드 주변에 검붉은 돌풍이 출현하여 접근하는 아군을 빨아들인다. 돌풍에 지나치게 가까이 접근한 아군은 <color=#ee0000>돌풍의 영향으로 전투 불능</color>에 빠진다. 
특정 상황에서는 전장에 풍향 안내가 나타나며, 아군 선봉함대의 선두 함선이 <color=#92fc63>본험 리차드의 좌측(서쪽) 또는 우측(동쪽)의 특정 범위 내에 있으면</color> <color=#92fc63>일정 시간마다 아군 선봉함대 전원에게 [침식]</color>을 1개 부여한다. [침식]은 최대 10개까지 중첩되며, 선봉함대의 선두 함선이 범위를 벗어나면, 일정 시간마다 1개씩 제거된다. 
[침식]이 있는 아군 함선에는 다음 효과가 적용된다.
META가 아닌 함선: 함선의 [침식]이 10개가 되면, 해당 함선은 돌풍의 영향으로 전투불능에 빠진다.
META 함선: [침식] 1개당 자신이 <color=#92fc63>받는 피해량과 주는 피해량이 10% 증가</color>하지만, [침식]이 10개가 되면 <color=#92fc63>1초마다 최대치의 2%만큼 내구를 잃는다</color>. 대형 탄막은 항공 공격이나 실드로 제거할 수 없다. 
 아군 선봉함대의 <color=#92fc63>명중 판정이 선봉함대의 선두 함선만으로 한정되어, 명중 판정 범위가 대폭 감소</color>한다. 
함선이 피격되면 일정 시간 무적 상태가 된다. 
