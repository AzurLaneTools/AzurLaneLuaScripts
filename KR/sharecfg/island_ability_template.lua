...
(function ()
	...
	pg.base.island_ability_template[46] = {
		...
		id = 46,
		cmd_icon = "IslandProps/gold",
		show_pop_text = "낚시|지도의 각 장소에 있는 <color=#7EBEFF>낚시 지점</color>에서 <color=#7EBEFF>낚시</color> 실시 가능",
		show_type = 1
	}
	pg.base.island_ability_template[47] = {
		...
		id = 47,
		cmd_icon = "IslandProps/gold",
		show_pop_text = "조과 도감|<color=#7EBEFF>메인 화면 - 도감</color>의 <color=#7EBEFF>조과 도감</color>에서 확인 가능",
		show_type = 1
	}
	pg.base.island_ability_template[50] = {
		...
		id = 50,
		cmd_icon = "IslandProps/gold",
		show_pop_text = "진주 거래|<color=#7EBEFF>항구</color>의 <color=#7EBEFF>피어리</color>와 진주 거래 가능",
		show_type = 1
	}
	...
	pg.base.island_ability_template[2017] = {
		...
		id = 2017,
		cmd_icon = "IslandProps/gold",
		show_pop_text = "츄츄 가두리|<color=#7EBEFF>부두 - 츄츄 가두리</color>의 <color=#7EBEFF>브리튼</color>에게서 확인 가능",
		show_type = 1
	}
