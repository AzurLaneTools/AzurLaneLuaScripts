...
(function ()
	pg.base.island_furniture_template[1] = {
		setNum = 1,
		describe = "숲에 위치한 조용한 은신처. 자연과 바로 맞닿아 있다.",
		name = "숲 속 오두막",
		type = 1,
		hierarchy = 5,
		rarity = 4,
	...
	pg.base.island_furniture_template[2] = {
		setNum = 999,
		describe = "불꽃처럼 화려한 입을 가진 단풍나무. 바람이 불면 사방을 다채로운 색깔로 물들인다.",
		name = "단풍나무",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[3] = {
		setNum = 999,
		describe = "넓은 잎들이 바람에 살랑살랑 소리를 내며, 얼룩덜룩한 그늘을 만든다.",
		name = "광엽수",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[4] = {
		setNum = 999,
		describe = "부채 모양의 잎이 바람에 흔들리며, 사방을 온통 황금빛으로 물들인다.",
		name = "은행나무",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[5] = {
		setNum = 999,
		describe = "빽빽한 푸른 관목. 가지 사이로 이따금 바스락거리는 소리가 난다.",
		name = "푸른 관목",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[6] = {
		setNum = 999,
		describe = "밝은 노란빛의 자그마한 꽃이 피는 관목. 가끔 나비가 가지에 앉아 있을 때도 있다.",
		name = "노란 꽃 관목",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[7] = {
		setNum = 999,
		describe = "키가 작은 꽃들. 옹기종기 모여 대화를 나누는 듯하다.",
		name = "작은 꽃들",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[8] = {
		setNum = 999,
		describe = "밝고도 노란 잎이 춤추며 땅에 그림을 드리운다. 햇빛 아래서 특히 더 눈에 띈다.",
		name = "명황목",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[9] = {
		setNum = 999,
		describe = "울창한 줄기가 바람에 살짝 흔들리면서 사각사각하는 소리를 낸다.",
		name = "벽개목",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10] = {
		setNum = 999,
		describe = "어리고 노란 묘목. 가느다란 가지에서 작은 잎이 자라나고 있다.",
		name = "노란 가지 묘목",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[11] = {
		setNum = 999,
		describe = "어리고 푸른 묘목. 잎에 아침 이슬이 촉촉하게 맺혀 있다.",
		name = "청록빛 묘목",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[12] = {
		setNum = 999,
		describe = "소박한 도기 타일. 수작업만의 독특한 아름다움이 느껴진다.",
		name = "도기 타일 (소)",
		type = 8,
		hierarchy = 6,
		rarity = 2,
	...
	pg.base.island_furniture_template[15] = {
		setNum = 999,
		describe = "관리하기 쉽도록 평탄화 작업을 거친 타일 바닥. 어디든 잘 어울린다!",
		name = "자기질 타일 (소)",
		type = 8,
		hierarchy = 6,
		rarity = 2,
	...
	pg.base.island_furniture_template[18] = {
		setNum = 999,
		describe = "불규칙한 석판을 조합하여 만든 섬세한 타일.",
		name = "모자이크 타일 (소)",
		type = 8,
		hierarchy = 6,
		rarity = 2,
	...
	pg.base.island_furniture_template[21] = {
		setNum = 999,
		describe = "차가운 느낌의 석재 타일. 차분한 분위기를 풍기며, 내구성이 뛰어나다.",
		name = "회색 석재 타일 (소)",
		type = 8,
		hierarchy = 6,
		rarity = 2,
	...
	pg.base.island_furniture_template[102] = {
		setNum = 1,
		describe = "금색과 흰색, 해바라기와 자스민으로 장식한 트로피. 여름의 반짝임을 한껏 담아냈다.",
		name = "여름 아일랜드 개발 트로피",
		type = 7,
		hierarchy = 5,
		rarity = 4,
	...
	pg.base.island_furniture_template[10201] = {
		setNum = 1,
		describe = "초대형 곰돌이 소파 세트. 캠핑에 필요한 건 전부 갖추고 있다.",
		name = "곰곰 소파 세트",
		type = 2,
		hierarchy = 5,
		rarity = 4,
	...
	pg.base.island_furniture_template[10301] = {
		setNum = 999,
		describe = "별빛 랜턴이 테이블과 의자를 은은하게 비춰, 근사한 분위기를 연출한다.",
		name = "야외 테이블 의자",
		type = 3,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[10302] = {
		setNum = 999,
		describe = "낚시 애호가 전용 세트. 이 의자라면 하루 종일 앉아 있어도 문제 없다!",
		name = "한가로운 낚시 의자",
		type = 3,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[10304] = {
		setNum = 999,
		describe = "이동식 작은 집. 언제든 출발할 수 있다!",
		name = "캠핑 카",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10305] = {
		setNum = 999,
		describe = "곰돌이 모양 해먹. 별빛을 받으며 잠을 청할 수 있다.",
		name = "곰돌이 해먹",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10306] = {
		setNum = 999,
		describe = "신속하게 설치할 수 있고, 휴대도 간편하여 실용적!",
		name = "캠핑 텐트",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10401] = {
		setNum = 999,
		describe = "오늘 고양이의 저녁 식사는 당신 손에 달렸다! 물고기를 한 마리 잡아주자!",
		name = "요트 낚시터",
		type = 4,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[10402] = {
		setNum = 999,
		describe = "모닥불을 둘러싸고 즐기는 바비큐와 수다 타임! 이것이 바로 캠핑의 묘미!",
		name = "캠핑 모닥불",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10403] = {
		setNum = 999,
		describe = "자, 비켜라~ 비켜! 두 사람도 충분히 들어갈 수 있다고~",
		name = "캠핑 욕조",
		type = 4,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[10404] = {
		setNum = 999,
		describe = "돌을 쌓아 만든 곰 모양 장식. 너무 귀엽다.",
		name = "곰곰 돌 장식",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10405] = {
		setNum = 999,
		describe = "곰돌이 모양의 버스 정류장. 기다리면서 주위 경치도 감상하자!",
		name = "곰곰 정류장",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10406] = {
		setNum = 999,
		describe = "겹겹이 쌓인 낙엽. 바람이 스치면 바삭거리는 소리가 들려온다.",
		name = "낙엽",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10407] = {
		setNum = 999,
		describe = "표준형 야외 바비큐용 도구 세트. 기본적인 것은 모두 갖추고 있다.",
		name = "휴대용 그릴 세트",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10408] = {
		setNum = 999,
		describe = "아이들을 위한 시소. 곰돌이 귀가 달린 모자를 쓰고 타보자!",
		name = "곰곰 시소",
		type = 4,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[10409] = {
		setNum = 999,
		describe = "쉽게 작동하는 펌프식. 언제든 물을 마실 수 있어서 편리하다!",
		name = "급수 장치",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10410] = {
		setNum = 999,
		describe = "위험 구역이므로 주의 바람. 늘 안전이 최우선!",
		name = "경고 표지판",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10411] = {
		setNum = 999,
		describe = "도끼, 그리고 그루터기. 막힘 없이 장작을 팰 수 있다!",
		name = "장작 패기 세트",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10412] = {
		setNum = 999,
		describe = "조명이 달린 울타리. 밤에도 밝아서 마음이 놓인다.",
		name = "조명 포함 울타리",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10413] = {
		setNum = 999,
		describe = "나무로 만든 바리케이드. 신뢰할 수 있는 안전성!",
		name = "목제 바리케이드",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10414] = {
		setNum = 999,
		describe = "금속제의 방호용 울타리. 수수하지만 든든하다!",
		name = "철제 울타리",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10415] = {
		setNum = 999,
		describe = "막 자라난 작은 침엽수. 생명력이 넘쳐 흐르고 있다.",
		name = "어린 삼나무",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10416] = {
		setNum = 999,
		describe = "쭉 뻗은 초록빛의 거목. 주변에 은은한 나무 향이 퍼진다.",
		name = "푸른 소나무",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10417] = {
		setNum = 999,
		describe = "부드러운 곰돌이 인형. 꼭 안고 있으면 마음이 편안해 진다.",
		name = "곰인형",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10418] = {
		setNum = 999,
		describe = "수작업으로 만든 작은 용기. 은은한 나무 향이 감돈다.",
		name = "작은 나무통",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10419] = {
		setNum = 999,
		describe = "야외 생존을 위한 장비와 자재를 비축할 수 있다.",
		name = "포레스트 하우스",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10420] = {
		setNum = 999,
		describe = "곧게 솟은 조명 기둥. 밤에도 따뜻한 불빛을 밝혀준다.",
		name = "가로등",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10421] = {
		setNum = 999,
		describe = "고성능 천체망원경. 심우주로의 여행을 함께해 줄 동반자.",
		name = "심우주 탐험가",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[10801] = {
		setNum = 999,
		describe = "간소하게 목판으로 만든 나무길. 이 위를 걸으면 마음이 여유로워진다.",
		name = "木制路面(小) ",
		type = 8,
		hierarchy = 6,
		rarity = 2,
	...
	pg.base.island_furniture_template[20101] = {
		setNum = 1,
		describe = "단풍이 어우러진 편안한 저택. 차분한 정취를 느껴보자.",
		name = "가을 달의 저택",
		type = 1,
		hierarchy = 5,
		rarity = 4,
	...
	pg.base.island_furniture_template[20201] = {
		setNum = 1,
		describe = "따뜻한 온천에 몸을 담그면 몸과 마음이 편안해진다. 짧게나마 고요함을 즐겨보자.",
		name = "온천욕장",
		type = 2,
		hierarchy = 5,
		rarity = 4,
	...
	pg.base.island_furniture_template[20301] = {
		setNum = 999,
		describe = "앉기만 해도 좋고, 차를 음미해도 좋고, 너구리들과 노는 것도 좋다.",
		name = "너구리 찻집",
		type = 3,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[20302] = {
		setNum = 999,
		describe = "춤도 공연도 개인기도 모두 OK. 당신의 재능을 뽐낼 차례!",
		name = "소나무 스테이지",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20304] = {
		setNum = 999,
		describe = "재료 준비 완료! 오늘 저녁은 호화로운 초밥 파티!",
		name = "초밥 한 상",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20305] = {
		setNum = 999,
		describe = "격식 있는 병풍. 장식으로도, 공간 분리용으로도 안성맞춤이다.",
		name = "병풍",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20306] = {
		setNum = 999,
		describe = "야외 찻자리용 우산. 비바람 속에서도 차를 즐길 수 있다.",
		name = "야외용 우산",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20402] = {
		setNum = 999,
		describe = "정면 베기? 아니면 일자 베기? 비스듬히 베기!",
		name = "짚단",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20403] = {
		setNum = 999,
		describe = "금붕어가 느긋하게 헤엄치는 개울. 조용히 감상하자.",
		name = "금붕어 개울",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20404] = {
		setNum = 999,
		describe = "검은 토끼토끼, 하얀 토끼토끼, 흑백 토끼토끼!",
		name = "검은 토끼토끼",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20405] = {
		setNum = 999,
		describe = "하얀 토끼토끼, 검은 토끼토끼, 백흑 토끼토끼!",
		name = "하얀 토끼토끼",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20406] = {
		setNum = 999,
		describe = "선물을 받고 싶다고? 그럼 소원부터 빌어야지~",
		name = "소원 성취 너구리",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20407] = {
		setNum = 999,
		describe = "초대형 사이즈라 너무 귀엽다! 온천을 즐긴 후에는 이 위에 누워서 쉬자!",
		name = "앞으로 누운 카피바라",
		type = 4,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[20408] = {
		setNum = 999,
		describe = "앞으로 눕든 뒤로 눕든, 원하는대로 바꿀 수 있다. 편한 자세로 기대서 쉬자.",
		name = "뒤로 누운 카피바라",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20409] = {
		setNum = 999,
		describe = "붉게 물든 단풍잎이 팔랑팔랑, 나비도 팔랑팔랑, 로맨틱한 가을.",
		name = "붉은 단풍 낙엽",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20410] = {
		setNum = 999,
		describe = "갈색 낙엽이 흩날린다. 가을의 운치에 고요함이라는 비장의 맛을 더한다.",
		name = "오동나무 낙엽",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20411] = {
		setNum = 999,
		describe = "황금빛 낙엽이 마당에 쌓이면, 따뜻함과 평온함이 느껴진다.",
		name = "은행나무 낙엽",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20413] = {
		setNum = 999,
		describe = "세월의 흔적을 담고 있는 그루터기. 거친 나뭇결이 유구한 자연의 관록을 잘 표현하고 있다.",
		name = "고목 그루터기",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20414] = {
		setNum = 999,
		describe = "가공을 거치지 않은 소나무 통나무. 은은한 송진 향이 풍긴다.",
		name = "소나무 통나무",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20415] = {
		setNum = 999,
		describe = "땅 위에 흩어진 작은 그루터기들. 숲 깊은 곳으로 이어져 있다.",
		name = "그루터기 길",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[20801] = {
		setNum = 999,
		describe = "굽이굽이 이어지는 석재 오솔길. 거친 맛이 자연의 미를 살려주고 있다.",
		name = "석재 오솔길 (소)",
		type = 8,
		hierarchy = 6,
		rarity = 2,
...
(function ()
	...
	pg.base.island_furniture_template[40002] = {
		setNum = 999,
		describe = "대나무로 만든 긴 의자. 앉으면 시원한 느낌이 들어, 여름밤 더위를 식히기에 좋다.",
		name = "대나무 긴 의자",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40004] = {
		setNum = 999,
		describe = "소박한 나무 문. 활기와 고요를 가르는 경계선.",
		name = "나무 정문",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40005] = {
		setNum = 999,
		describe = "들여다보면 먼 옛날의 물소리가 들려올 것만 같다.",
		name = "돌 우물",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40006] = {
		setNum = 999,
		describe = "자연석을 쌓아 만든 낮은 돌담. 공간을 구분하면서도 개방감은 그대로 살려 준다.",
		name = "낮은 돌담",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40007] = {
		setNum = 999,
		describe = "가느다란 나무로 만든 울타리. 소박하고 자연스러운 멋이 있다.",
		name = "우드 펜스",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40101] = {
		setNum = 1,
		describe = "공원 중앙에 우뚝 솟은 동화 속 성. 모든 신비로운 여행의 종착점.",
		name = "메르헨 캐슬",
		type = 1,
		hierarchy = 5,
		rarity = 4,
	...
	pg.base.island_furniture_template[40201] = {
		setNum = 1,
		describe = "구름 위에서 떨어지는 짜릿함. 무중력이 주는 스릴을 만끽하자.",
		name = "클라우드 타워",
		type = 2,
		hierarchy = 5,
		rarity = 4,
	...
	pg.base.island_furniture_template[40301] = {
		setNum = 999,
		describe = "동화 같은 알록달록한 아치. 그 너머에는 동화의 세계가 펼쳐진다.",
		name = "무지개 아치",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40302] = {
		setNum = 999,
		describe = "어서 오세요, 꿈의 유원지에! 걱정거리는 모두 밖에 두고 오세요.",
		name = "유원지 정문",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40303] = {
		setNum = 999,
		describe = "곳곳에서 볼 수 있는 하얀 벤치. 섬세한 무늬가 새겨져 있고, 부담 없이 쉬어 갈 수 있다.",
		name = "휴식용 벤치",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40304] = {
		setNum = 999,
		describe = "초승달 모양 의자. 누워서 별을 보기에도, 앉아 멍하니 쉬기에도 안성맞춤이다.",
		name = "초승달 쉼터",
		type = 3,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40401] = {
		setNum = 999,
		describe = "형형색색의 목마가 음악에 맞춰 오르내리며 회전한다. 유원지에서 쌓을 수 있는 대표적인 추억거리다.",
		name = "회전목마",
		type = 4,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[40402] = {
		setNum = 999,
		describe = "알록달록한 커피잔을 타고 빙글빙글 돌아 보자. 어지러움 또한 즐거움의 일부다.",
		name = "회전컵",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40403] = {
		setNum = 999,
		describe = "시원한 파도를 타고 마음껏 미끄러지자! 물보라가 주는 짜릿함을 만끽하자.",
		name = "파도 슬라이더",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40404] = {
		setNum = 999,
		describe = "거대한 커피잔이 구름 위로 떠오르며, 사람들의 웃음소리를 하늘에 널리 퍼뜨린다.",
		name = "관람컵",
		type = 4,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[40405] = {
		setNum = 999,
		describe = "물 위를 둥실둥실 떠다니는 하얀 오리 모양 보트. 동심으로 돌아가게 해준다.",
		name = "오리배",
		type = 4,
		hierarchy = 5,
		rarity = 3,
	...
	pg.base.island_furniture_template[40407] = {
		setNum = 999,
		describe = "동그란 방울 안에 귀여운 인형들이 새근새근 잠들어 있다.",
		name = "인형 버블",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40408] = {
		setNum = 999,
		describe = "조랑말의 날개를 만지면 소원이 이루어진다고 한다.",
		name = "포니 오브제",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40409] = {
		setNum = 999,
		describe = "어서 타! 구름 위를 가르는 정기 노선이 곧 출발한대!",
		name = "포니 벌룬",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40410] = {
		setNum = 999,
		describe = "형형색색의 가로등이 밤길에 꿈같은 색채를 더해 준다.",
		name = "별 가로등",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40411] = {
		setNum = 999,
		describe = "성은 오른쪽, 보트는 왼쪽. 안내판대로 따라가면 길을 잃을 걱정이 없다.",
		name = "유원지 표지판",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40412] = {
		setNum = 999,
		describe = "사진 촬영 스폿. 포즈를 취하며 환한 미소를 사진에 남기자.",
		name = "찰칵 코너",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40414] = {
		setNum = 999,
		describe = "분홍 장미가 하얀 울타리를 감싸고 있으며, 가까이 가면 달콤한 향기가 난다.",
		name = "로즈 펜스",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40415] = {
		setNum = 999,
		describe = "형형색색 풍선이 울타리에 묶여, 방문객을 환영하는 듯하다.",
		name = "벌룬 펜스",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40416] = {
		setNum = 999,
		describe = "분홍빛 잎을 가진 단풍나무. 유원지에 꿈같은 색채를 더해 준다.",
		name = "유원지의 단풍",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40417] = {
		setNum = 999,
		describe = "사탕과 별 장식이 달린 분홍빛 나무. 유원지에서 가장 달콤한 풍경.",
		name = "별빛 과자 나무",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40418] = {
		setNum = 999,
		describe = "동화책에서 튀어나온 듯한 캔디 트리. 꼭대기의 달이 주변을 부드럽게 비춰 준다.",
		name = "달빛 과자 나무",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40419] = {
		setNum = 999,
		describe = "하얀 장식 울타리로 둘러싸인 분홍 튤립 화단. 마치 섬세한 유화 같다.",
		name = "튤립 화단",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40420] = {
		setNum = 999,
		describe = "토끼 모양으로 꾸며진 화단. 꽃을 가꿀수록 귀여움이 배가 된다.",
		name = "토끼토끼 화단",
		type = 4,
		hierarchy = 5,
		rarity = 2,
	...
	pg.base.island_furniture_template[40801] = {
		setNum = 999,
		describe = "알록달록한 격자무늬 타일. 체스판 위를 걷는 듯한 기분이 든다.",
		name = "꽃무늬 타일 (소)",
		type = 8,
		hierarchy = 6,
		rarity = 2,
