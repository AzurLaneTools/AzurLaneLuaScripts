...
pg.ship_data_create_material = {
	...
	},
	{
		...
		rate_tip = {
			...
			"N：28.8%",
			" ",
			"<color=#ff5e39>시마카제</color>：1.2%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>카츠라기</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>치쿠마</color>：0.5%",
			" ",
			"<color=#d797ff>유라</color>：2.5%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#d797ff>우미카제</color>：2.5%(<color=#92fc63>up!</color>)"
		}
	},
	{
		use_gold = 1500,
