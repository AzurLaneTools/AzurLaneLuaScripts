...
(function ()
	...
	pg.base.ship_meta_breakout[9701061] = {
		breakout_view = "[구조의 이치·카스미] 스킬 습득 / 어뢰 보정 +5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 500,
	...
	pg.base.ship_meta_breakout[9701063] = {
		breakout_view = "[구조의 이치·카스미] 스킬 강화 / 무기 보정 +5%",
		item2 = 21001,
		pre_id = 9701062,
		repair = 0,
		gold = 2500,
	...
	pg.base.ship_meta_breakout[9702091] = {
		breakout_view = "[섬멸의 횃불·클리블랜드] 습득 / 주포 보정 +5%",
		item2 = 21055,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9702093] = {
		breakout_view = "[섬멸의 횃불·클리블랜드] 강화 / 주포 보정 +15%",
		item2 = 21055,
		pre_id = 9702092,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9702111] = {
		breakout_view = "[염추의 재 - 레겐스부르크] 습득 / 주포 보정 +5%",
		item2 = 21058,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9702113] = {
		breakout_view = "[염추의 재 - 레겐스부르크] 강화 / 무기 보정 +5%",
		item2 = 21058,
		pre_id = 9702112,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9702121] = {
		breakout_view = "[염추의 재·쾨니히스베르크] 습득 / 무기 보정 +2%",
		item2 = 21060,
		pre_id = 0,
		repair = 0,
		gold = 500,
	...
	pg.base.ship_meta_breakout[9702123] = {
		breakout_view = "[염추의 재·쾨니히스베르크] 강화 / 무기 보정 +5%",
		item2 = 21060,
		pre_id = 9702122,
		repair = 0,
		gold = 2500,
...
(function ()
	...
	pg.base.ship_meta_breakout[9703023] = {
		breakout_view = "[염추의 재] 스킬 강화 / 어뢰 보정 +15%",
		item2 = 21001,
		pre_id = 9703022,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9703033] = {
		breakout_view = "[염추의 재 - 포슈] 강화 / 어뢰 보정 +15%",
		item2 = 21001,
		pre_id = 9703032,
		repair = 0,
		gold = 2500,
	...
	pg.base.ship_meta_breakout[9703041] = {
		breakout_view = "[섬멸의 횃불 - 위치타] 습득 / 주포 보정 +5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9703043] = {
		breakout_view = "[섬멸의 횃불 - 위치타] 강화 / 무기 보정 +5%",
		item2 = 21001,
		pre_id = 9703042,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9703051] = {
		breakout_view = "스킬【염추의 재·아드미랄 히퍼】습득 / 주포 보정 + 5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9703053] = {
		breakout_view = "스킬【염추의 재·아드미랄 히퍼】강화/ 어뢰 보정 + 5%",
		item2 = 21001,
		pre_id = 9703052,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9703061] = {
		breakout_view = "[염추의 재 - 볼차노] 습득 / 주포 보정 +5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 500,
	...
	pg.base.ship_meta_breakout[9703063] = {
		breakout_view = "[염추의 재 - 볼차노] 강화 / 어뢰 보정 +15%",
		item2 = 21001,
		pre_id = 9703062,
		repair = 0,
		gold = 2500,
	...
	pg.base.ship_meta_breakout[9705071] = {
		breakout_view = "[염추의 재·줄리오 체사레] 습득 / 주포 포좌 +1 / 주포 보정 +5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 500,
	...
	pg.base.ship_meta_breakout[9705073] = {
		breakout_view = "[염추의 재·줄리오 체사레] 강화 / 주포 포좌 +1 / 주포 보정 +15%",
		item2 = 21001,
		pre_id = 9705072,
		repair = 0,
		gold = 2500,
	...
	pg.base.ship_meta_breakout[9705081] = {
		breakout_view = "[염추의 재·안드레아 도리아] 습득 / 주포 포좌 +1 / 주포 보정 +5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9705083] = {
		breakout_view = "[염추의 재·안드레아 도리아] 강화 / 주포 포좌 +1 / 주포 보정 +15%",
		item2 = 21001,
		pre_id = 9705082,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9705101] = {
		breakout_view = "【염추의 재·강구트] 습득 / 주포 포좌 +1 / 주포 보정 +5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9705103] = {
		breakout_view = "【염추의 재·강구트] 강화 / 주포 포좌 +1 / 주포 보정 +15%",
		item2 = 21001,
		pre_id = 9705102,
		repair = 0,
		gold = 10000,
...
(function ()
	...
	pg.base.ship_meta_breakout[9706053] = {
		breakout_view = "[염추의 재·엘베] 강화 / 함재기 수 +1 / 폭격기 보정 +10%",
		item2 = 21001,
		pre_id = 9706052,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9707061] = {
		breakout_view = "[섬멸의 횃불 - 호넷] 습득 / 전투기 수 +1 / 함재기 보정 +3%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9707063] = {
		breakout_view = "[섬멸의 횃불 - 호넷] 강화 / 함재기 수 +1 / 함재기 보정 +7%",
		item2 = 21001,
		pre_id = 9707062,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9707081] = {
		breakout_view = "[구조의 이치 - 요크타운] 습득 / 전투기 수 +1 / 함재기 보정 +3%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9707082] = {
		breakout_view = "격납고 +1 / 폭격기 수 +1 / 함재기 보정 +5%",
		item2 = 21001,
		pre_id = 9707081,
		repair = 0,
		gold = 3000,
	...
	pg.base.ship_meta_breakout[9707083] = {
		breakout_view = "[구조의 이치 - 요크타운] 강화 / 함재기 수 +1 / 함재기 보정 +7%",
		item2 = 21001,
		pre_id = 9707082,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9707091] = {
		breakout_view = "[섬멸의 횃불 - 빅토리어스] 습득 / 뇌격기 수 +1 / 함재기 보정 +2%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9707093] = {
		breakout_view = "[섬멸의 횃불 - 빅토리어스] 강화 / 함재기 수 +1 / 함재기 보정 +5%",
		item2 = 21001,
		pre_id = 9707092,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9707101] = {
		breakout_view = "[섬멸의 횃불 - 새러토가] 습득 / 전투기 수 +1 / 함재기 보정 +3%",
		item2 = 21064,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9707103] = {
		breakout_view = "[섬멸의 횃불 - 새러토가] 강화 / 함재기 수 +1 / 함재기 보정 +7%",
		item2 = 21064,
		pre_id = 9707102,
		repair = 0,
		gold = 10000,
