...
pg.base.pay_data_display = {
	...
	[73] = {
		...
		name = "드림 랜드 스킨 패키지I",
		first_pay_double = 0,
		name_display = "드림 랜드 스킨 패키지I",
		descrip = "아이템, 자원 및 랜덤 스킨 획득 가능",
		subject = "드림 랜드 스킨 패키지I",
		money = 36300,
		limit_arg = 1,
		tag = 2,
		gem = 0,
	...
	[75] = {
		...
		descrip_extra = "※복주머니는 구매 후 우편함으로 발송됩니다. \n이미 소지 중인 스킨을 획득한 경우에는 자동적으로 스킨 가치만큼의 무상 다이아로 변환됩니다.",
		type = 1,
		name = "가을 연회복 패키지(2024)",
		first_pay_double = 0,
		name_display = "가을 연회복 패키지(2024)",
		descrip = "아이템, 자원 및 랜덤 스킨 획득 가능",
		subject = "가을 연회복 패키지(2024)",
		money = 36300,
		limit_arg = 1,
		tag = 2,
		gem = 0,
	...
	[76] = {
		...
		descrip_extra = "※복주머니는 구매 후 우편함으로 발송됩니다. \n이미 소지 중인 스킨을 획득한 경우에는 자동적으로 스킨 가치만큼의 무상 다이아로 변환됩니다.",
		type = 1,
		name = "가을 연회복 패키지 복각(2023)",
		first_pay_double = 0,
		name_display = "가을 연회복 패키지 복각(2023)",
		descrip = "아이템, 자원 및 랜덤 스킨 획득 가능",
		subject = "가을 연회복 패키지 복각(2023)",
		money = 36300,
		limit_arg = 1,
		tag = 2,
		gem = 0,
	...
	[2032] = {
		...
		descrip_extra = "此处不会被看到",
		type = 0,
		name = "드림 레인보우 테마 패키지(기초)",
		first_pay_double = 0,
		name_display = "드림 레인보우 테마 패키지(기초)",
		descrip = "可获得战斗界面主题 梦幻霓虹*1",
		subject = "드림 레인보우 테마 패키지(기초)",
		money = 19000,
		limit_arg = 0,
		tag = 2,
		gem = 0,
	...
	[2034] = {
		...
		descrip_extra = "*礼包将发送到邮箱，请注意查收。",
		type = 0,
		name = "드림 레인보우 테마 패키지(럭셔리)",
		first_pay_double = 0,
		name_display = "드림 레인보우 테마 패키지(럭셔리)",
		descrip = "可获得战斗界面主题 梦幻霓虹*1,3060钻石",
		subject = "드림 레인보우 테마 패키지(럭셔리)",
		money = 56000,
		limit_arg = 1,
		tag = 2,
		gem = 0,
