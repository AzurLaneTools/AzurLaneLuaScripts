...
pg.base.pay_data_display = {
	...
	[69] = {
		...
		type = 1,
		first_pay_double = 0,
		name_display = "여름 수영복 복주머니 2024",
		descrip = "아이템, 자원 및 랜덤 스킨 획득 가능",
		subject = "여름 수영복 복주머니 2024",
		limit_arg = 1,
		money = 36300,
		tag = 2,
		name = "여름 수영복 복주머니 2024",
		gem = 0,
		type_order = 2,
		limit_type = 2,
		picture = "fudai13",
	...
	[70] = {
		...
		type = 1,
		first_pay_double = 0,
		name_display = "여름 수영복 복주머니 2023 (복각)",
		descrip = "아이템, 자원 및 랜덤 스킨 획득 가능",
		subject = "여름 수영복 복주머니 2023 (복각)",
		limit_arg = 1,
		money = 36300,
		tag = 2,
		name = "여름 수영복 복주머니 2023 (복각)",
		gem = 0,
		type_order = 2,
		limit_type = 2,
		picture = "lihecn6ss_l",
