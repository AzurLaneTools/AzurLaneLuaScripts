...
pg.base.ship_skin_template_14 = {
	...
	[601081] = {
		name = "화련한 Vivace",
		id = 601081,
		desc = "찾았다, 지휘관! 이 옷으로 갈아입은 내 모습 좀 평가해줄래? ……아니아니, 귀엽다던가, 예쁘다던가 그런 건 됐으니까, 우선은 '잘 소화하고 있는지'부터! 뭐, 귀엽다던가, 예쁘다는 말을 해주면, 그야 당연히 기쁘긴 하지만~",
		illustrator2 = -1,
		ship_group = 60108,
		group_index = 1,
	...
	[601091] = {
		name = "무대 뒤의 준비 시간",
		id = 601091,
		desc = "으앗! 왜, 왜 갑자기 양말을…… 그, 그만둬! 지, 지휘관, 부탁이야, 도와줘! 우앙……",
		illustrator2 = -1,
		ship_group = 60109,
		group_index = 1,
	...
	[601102] = {
		name = "구름 위에 내린 천사",
		id = 601102,
		desc = "동화 속 여주인공처럼 등장해 보고 싶었어. 어때, 지휘관? 하늘에서 내려온 아틸리오를 보고 운명의 단짝 같은 로맨틱함이 느껴졌어?",
		illustrator2 = -1,
		ship_group = 60110,
		group_index = 2,
		prefab = "adiliao_3",
	...
	[602020] = {
		name = "주세페 가리발디",
		id = 602020,
		desc = "두카 델리 아브루치급 경순양함 - 주세페 가리발디",
		illustrator2 = -1,
		ship_group = 60202,
		group_index = 0,
		prefab = "zhusaipei",
	...
	[602021] = {
		name = "검은 날개의 노빌멘테",
		id = 602021,
		desc = "나쁜 백조 오딜이야. 내 왕자님은 어디 계시려나~ …아니, 지휘관이잖아. 방금 대사는 일단 제쳐두고, 연기는 꽤 괜찮았지?",
		illustrator2 = -1,
		ship_group = 60202,
		group_index = 1,
		prefab = "zhusaipei_2",
