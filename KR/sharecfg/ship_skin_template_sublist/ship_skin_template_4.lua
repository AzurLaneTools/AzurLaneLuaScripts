...
pg.base.ship_skin_template_4 = {
	...
	[107140] = {
		name = "타이콘데로가",
		id = 107140,
		desc = "에식스급 항공모함—{namecode:194}, 현호 CV-14",
		illustrator2 = -1,
		ship_group = 10714,
		group_index = 0,
	...
	[107141] = {
		name = "검은 토끼의 무대 쇼",
		id = 107141,
		desc = "It's show time! 공연할 무대는 이미 준비가 끝났어~ 함께 이 아름다운 무대의 밤을 즐겨 보자구, 지휘관~",
		illustrator2 = -1,
		ship_group = 10714,
		group_index = 1,
	...
	[107142] = {
		name = "선샤인 프린세스",
		id = 107142,
		desc = "Hi! 지휘관, 이 수영복 어때? 취향에 잘 맞아? 후후, 다행이네. 그럼, 소감 한마디 부탁해. ……정말, 그렇게 애태우는 테크닉은 어디서 배웠대?",
		illustrator2 = -1,
		ship_group = 10714,
		group_index = 2,
	...
	[107171] = {
		name = "휴식 미션",
		id = 107171,
		desc = "미션은 끝났고, 이제 롱 아일랜드가 추천해 준 새로운 게임을 해볼까... 지휘관? 알아서 자리 찾아서 앉아, 따로 대접은 안 할게.",
		illustrator2 = -1,
		ship_group = 10717,
		group_index = 1,
		prefab = "bangkeshan_2",
