...
pg.base.ship_skin_template_4 = {
	[107063] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "「Happy anniversary！」…… 지휘관, 오늘은 제대로 축하하자고! 그리고 우리가 항상 승리하기를 같이 기도하자——",
		voice_actor = 31,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[107064] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "전쟁을 위한 삶에 대해 의문점은 전혀 없다. 벽람항로의 자유를 위하여——엔터프라이즈, 출격!",
		voice_actor = 31,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[107065] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "연회 드레스...? 평상시엔 이런 옷을 입을 기회가 없어서, 의외로 시간이 꽤 오래 걸렸다. 아, 어서 연회장으로 가지. 모두를 오래 기다리게하면 안되니까.",
		voice_actor = 31,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[107066] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "지휘관, 너도 구경하러 온 거야? 사실 이렇게 서있기보다 같이 경기에 참여하고 싶어. 바람을 손에 쥘 수 있을 것 같은 이런 느낌…… 레이싱과 항해는 사실 같은 것 아닐까?",
		voice_actor = 31,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[107067] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "겨우 여행을 가려고 모아둔 휴가를 써도 괜찮은 건가…. 더 높은 능률을 위해서는 휴식도 중요하다고? 그럼, 지휘관… 전력을 다해서 즐기자고!",
		voice_actor = 31,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[107068] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "어, 어떤가? 이상하진 않은가… 아니지, 별로 싫진 않군. 실은 나도 이걸 입는 걸 줄곧 동경해왔는걸. 단지… ",
		voice_actor = 31,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
