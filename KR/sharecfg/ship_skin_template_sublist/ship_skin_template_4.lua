...
pg.ship_skin_template_4 = {
	[106019] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "지휘관, 롱 아일랜드야── 달라졌다구? 유령은 변하지 않… 어라? 조금 시원한 느낌이 됐을지도…",
		voice_actor = 45,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[106029] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "지휘관, 그렇게 겁내지 않아도 괜찮아. 나의 공이 닿는 것은 둘──── 적과, 승리뿐이야! 아, 가끔은 창문에도 닿지만. 아하하…",
		voice_actor = 41,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[106550] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "카사블랑카급 호위 항공모함—카사블랑카, 현호 CVE-55 ",
		voice_actor = 226,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[106551] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "후… 휴식 시간에는 제대로 수분을 보충해야 계속 연습을…… 아. 안녕하세요, 지휘관님. 리허설을 보러 오신 건가요?",
		voice_actor = 226,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
