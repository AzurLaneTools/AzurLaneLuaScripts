...
pg.base.ship_skin_template_19 = {
	...
	[9600061] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "\"아하하하! 주인님… 드디어 찾았네! 자, 디너 준비는 끝났으니 나를 따라…… 식사할 기분이 아니라고? 모처럼 싱싱한 걸 손질해 뒀는데…\" ――지휘관? 왜 뒷걸음질 치는 거야…?",
		voice_actor = 387,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9701010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "지휘관, 안녕. 나는 헌터. 이름대로 '사냥감'을 쫓고 있지. 여기가 새로운 거점인가…?",
		voice_actor = 170,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9701020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "처음 뵙겠습니다, 지휘관님. 저는 포춘이라고 해요. …사, 사슬은 신경 쓰지 말아 주세요. 힘을… 힘을 제어하기 위해서는 필요한 거라서요….",
		voice_actor = 75,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9702010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "헬레나를 찾고 있는 거야? 내 힘을 너에게 빌려 줄 수 있어——하지만, 약속해, 나에게 그 무엇도 숨겨선 안 돼.",
		voice_actor = 34,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9702020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "멤피스야. 지휘관은 내가 낯선 사람처럼 느껴질지도 모르겠지만, 당신에 대해서는 잘 알고 있어. 걱정하지 마. 이상한 사람은 아니니까 믿어주길 바라. 앞으로 당신을 착실히 보좌하며 호위해줄게.",
		voice_actor = 159,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9702030] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "당신이 지휘관…… 즉 주인님이시로군요. 네. 알겠습니다. 셰필드라고 합니다. 해충에게 총구를 겨누는 건 익숙하오니, 방금 전 일은 너무 괘념치 마시길.",
		voice_actor = 88,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9702040] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "지옥에서 온 함선, 라 갈리소니에르! 네 목숨은 내가 받겠다! ……흐~음. 이래도 안 놀라다니 역시 산전수전 다 겪은 지휘관답네. 후훗, 다음에는 더 재밌는 얼굴을 보여줘♪",
		voice_actor = 238,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9702050] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "경순양함 진츠라고 합니다. 저를 부른 건 조력이 필요해선가요? …알겠습니다. 제 계책이 함대에 도움이 된다면 미력하나마 힘을 보태어 드리죠.",
		voice_actor = 77,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9703010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "중순양함 트렌토, 지휘관을 보좌하러 왔습니다. 제 등장으로 지휘관님이 더 성장할 수 있다면, 더할 나위 없겠죠.",
		voice_actor = 224,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9703020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "당신이 지휘관이겠네. 나는 중순양함 알제리야. 그나저나 여기서 어떤 즐거움을 맛볼 수 있나? 내게 실망시키지 마~ 후후훗.",
		voice_actor = 142,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9705040] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "네가 바로 지휘관이겠지? 흠, 좋아, 너의 배포와 지혜는 앞으로 모두 나를 위해서 쓰여질 것이다! ……뭘 아직도 멍하니 있는 거야? 이제 내 하인이 되었으니까 날 위해 충성을 맹세해야 하지 않겠어?",
		voice_actor = 28,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9706020] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "준요…예요. 지휘관, 지시할 것이 있으면 말해…주세요.",
		voice_actor = 136,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9706030] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "항공모함 프린스턴, 지금 막 착임했습니다. 죄송해요. 아직 좀 혼란스러워서… 지금 어떤 상황인지 설명을 부탁드려도 될까요?",
		voice_actor = 249,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9707030] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "사쿠라 엠파이어 2항전, 소류입니다. 만남에 대한 예절은 생략하고, 서둘러 본업을 시작하죠.",
		voice_actor = 15,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9708010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "바다의 퍼시벌 U-556이 왔어. 과연 내가 도와줄 수 있는 게 있기는 할까……. 폐만 끼칠 거 같은데, 잘 부탁해♪",
		voice_actor = 38,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
	...
	[9712010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "지휘관님…이신 것 같네요. 보기에 질병 걱정은 없으니 안심하세요. 저는 베스탈, 아픈 아이가 있으면 치료든 수리든 도와드릴 수 있을 거예요…",
		voice_actor = 365,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
