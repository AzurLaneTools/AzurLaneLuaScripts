...
pg.base.ship_skin_template_19 = {
	...
	[9704050] = {
		name = "히에이·META",
		id = 9704050,
		desc = "순양전함 히에이가 이렇게 달려왔습니다. 지휘관님, 다음은 어떻게 할까요? 순찰이든 전투든 모두 준비는 되어 있으니, 당장이라도 출격하죠♪",
		illustrator2 = -1,
		ship_group = 970405,
		group_index = 0,
		prefab = "birui_alter",
	...
	[9705050] = {
		name = "로드니·META",
		id = 9705050,
		desc = "여러 \"로드니\"를 대신해 인사드립니다. …\"저\"는 \"로드니\"라는 개념을 구현화한 것에 지나지 않습니다. 모쪼록 이해해 주시길……",
		illustrator2 = -1,
		ship_group = 970505,
		group_index = 0,
	...
	[9705060] = {
		name = "나가토·META",
		id = 9705060,
		desc = "나는 나가토. 「사쿠라 엠파이어」의 여우다. 왜 날 부른 게냐? 힘을 원하나? 아니면 내게 소원이라도 빌고 싶은 건가?",
		illustrator2 = -1,
		ship_group = 970506,
		group_index = 0,
