...
pg.base.ship_skin_template_10 = {
	...
	[307076] = {
		name = "비단결의 유희",
		change_skin = "",
		desc = "하아… 설마 지휘관님께서 다이호와의 「여흥」을 수락하실 줄은 몰랐어요♡ 이렇게 지휘관님이 「몸소」 다이호를 지도해주신다고 생각하니…… 우후후♡ 다이호, 끝까지 함께 할게요♪",
		illustrator2 = -1,
		ship_group = 30707,
		group_index = 6,
		purchase_offset = "",
	...
	[307084] = {
		name = "환몽의 꼭두각시",
		change_skin = "",
		desc = "번쩍이는 불빛과 함께 흔들리는 환몽처럼…… 그대를 위해 만든 꿈에 온 걸 환영한다. 찰나의 순간에 모습을 드러내는 요술… 궁금한가?",
		illustrator2 = -1,
		ship_group = 30708,
		group_index = 4,
		purchase_offset = "",
	...
	[307085] = {
		name = "녹아드는 꿈속의 포옹",
		change_skin = "",
		desc = "후우…… 함께 이 기이하고도 절묘한 술을 즐기자고 약조했는데, 취기에 젖어버렸군…… 입술에 몇 방울밖에 남지 않았구나… 그대도… 함께 즐길 텐가…?",
		illustrator2 = -1,
		ship_group = 30708,
		group_index = 5,
		painting = "xinnong_6",
	...
	[307158] = {
		name = "물빛 달의 화촉",
		change_skin = "",
		desc = "「기쁠 때나, 슬플 때나, 건강할 때나, 병들었을 때도……」 ——지휘관님? 후후, 무슨 흉조 같은 건 아니랍니다. 이제 더 이상 「당신의 아마기」는 그런 것들에 마음 쓰지 않아요.",
		illustrator2 = -1,
		ship_group = 30715,
		group_index = 8,
		purchase_offset = "",
	...
	[307161] = {
		name = "흐드러지게 피어나는 닌자의 여흥",
		change_skin = "",
		desc = "역시 하쿠호가 모시는 주인님 다우시군요. 닌자의 습격을 간단히 제압하는 실력뿐만 아니라, 덕으로 원한을 갚는 관대함까지 갖추고 계시다니…… 우후후, 그러니 이대로 모시고 싶은 이 하쿠호를 부디 거절하지 말아 주시길… 아시겠죠? 주·인·님♪",
		illustrator2 = -1,
		ship_group = 30716,
		group_index = 1,
		painting = "baifeng_2",
	...
	[307171] = {
		name = "야음영의",
		desc = "이 정도 임무쯤은 식은 죽 먹기예요. 물이 스며들지 못할 틈도 없고, 침투하지 못할 벽도 없어요. 잘 보세요, 지금 이 누님이 이 철벽 방어망을 뚫고 들어가 보일 테니♪",
		illustrator2 = -1,
		ship_group = 30717,
		group_index = 1,
		purchase_offset = "",
	...
	[317011] = {
		name = "방과 후의 관찰 숙제",
		change_skin = "",
		desc = "높다…! 그래도 괜찮아, 지휘관. 난 균형감각이 좋거든. 그것보다 이 아래 뭐가 있는지 같이 보자.",
		illustrator2 = -1,
		ship_group = 31701,
		group_index = 1,
		purchase_offset = "",
	...
	[317021] = {
		name = "화려한 붉은 실의 춤사위",
		desc = "지휘관! 어서 도와줘…… 화려하게 이 저택을 정복할 생각이었는데, 함정에 빠지다니… 정말 최악이야…!",
		illustrator2 = -1,
		ship_group = 31702,
		group_index = 1,
		purchase_offset = "",
	...
	[332210] = {
		name = "달빛 아래의 온천",
		change_skin = "",
		desc = "밤바람을 맞으며 달도 보고, 여름의 정취를 즐기면서 소중한 사람과 담소를 나눌 수 있다니… 정말 좋은 온천이에요. 그나저나…… 타월이 떨어진 것 같은데요?",
		illustrator2 = -1,
		ship_group = 30221,
		group_index = 10,
		purchase_offset = "",
