...
pg.base.ship_skin_template_11 = {
	...
	[319014] = {
		...
		change_skin = "",
		bg_sp = "",
		desc = "어, 어서 오세요… 목욕 후에 우유를 마시면 좋다던데, 수영 후 우유는 어떠신가요…? 우읏… 이 모습… 정말 괜찮나요? 지휘관님 얼굴… 많이 뜨거워진 것 같은데…",
		illustrator2 = -1,
		ship_group = 31901,
		group_index = 4,
		painting = "jianye_5",
	...
	[401091] = {
		...
		change_skin = "",
		bg_sp = "",
		desc = "지휘관님… 음… 새로운 음료 메뉴 어떠세요…? 달콤하고 마, 맛있어요…… 흑…… 왜 이렇게 긴장하는 거지…? 더 잘해야 하는데…",
		illustrator2 = -1,
		ship_group = 40109,
		group_index = 1,
		painting = "z9_2",
	...
	[401111] = {
		...
		change_skin = "",
		bg_sp = "",
		desc = "가게를 도와서 한정판 게임을 살 돈을 모으려던 것뿐인데, 어쩌다 변상금으로 빈털터리 신세가 된 걸까요… 지휘관님, 저 좀 도와주세요… 뭐든 다 할게요…",
		illustrator2 = -1,
		ship_group = 40111,
		group_index = 1,
		painting = "z11_2",
