...
(function ()
	...
	pg.base.world_item_data_template[2050] = {
		...
		item_transform_item_number = 0,
		log_text = "",
		display = "분석 후 파일 임무를 획득할 수 있으며, 해당하는 해역에서 임무 완성 시 총 10가지 파일(141-1~142-4)을 회수할 수 있다. <color=#ff5c5c>이 아이템은 1회만 구매할 수 있으며, 대형 작전 주기에 따라 초기화되지 않습니다. 구매 후 자동 사용됩니다. 파일 임무 진행 중에는 또 다른 파일 임무를 수령할 수 없습니다.</color>",
	...
	pg.base.world_item_data_template[2055] = {
		...
		item_transform_item_number = 0,
		log_text = "",
		display = "분석 후 파일 임무를 획득할 수 있으며, 해당하는 해역에서 임무 완성 시 총 12가지 파일(113-1~113-6, 133-1~133-6)를 회수할 수 있습니다. \"파일 해역 기록기·6\"은 1회만 구매할 수 있으며, 주기에 따라 초기화되지 않습니다. 파일 임무 진행 중에는 또다른 파일 임무를 수령할 수 없습니다.",
	...
	pg.base.world_item_data_template[2056] = {
		...
		item_transform_item_number = 0,
		log_text = "",
		display = "분석 후 파일 임무를 획득할 수 있으며, 해당하는 해역에서 임무 완성 시 총 10가지 파일(144-9~144-10, 146-1~146-8)를 회수할 수 있습니다. \"파일 해역 기록기·7\"은 1회만 구매할 수 있으며, 주기에 따라 초기화되지 않습니다. 파일 임무 진행 중에는 또다른 파일 임무를 수령할 수 없습니다.",
