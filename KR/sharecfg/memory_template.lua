...
pg.base.memory_template = {
	...
	[4421] = {
		...
		type = 1,
		title = "새로운 장비 연구",
		condition = "「DEATH의 의지」 3일차 임무 클리어",
	...
	[4432] = {
		...
		type = 1,
		title = "부서진 세상의 흔적",
		condition = "「환상의 도전」 ABRS-1 스테이지 출격",
	...
	[4433] = {
		...
		type = 1,
		title = "협력과 대립",
		condition = "「환상의 도전」 ABRS-2 스테이지 출격",
	...
	[4434] = {
		...
		type = 2,
		title = "이형의 존재",
		condition = "「환상의 도전」 ABRS-3 스테이지 클리어",
		story = "1929004",
		id = 4434,
		icon = "memory_huanyingmituzhe",
		is_open = 0
