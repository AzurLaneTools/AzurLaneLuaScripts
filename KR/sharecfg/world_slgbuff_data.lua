...
(function ()
	...
	pg.base.world_SLGbuff_data[311] = {
		...
		delete_move = 2,
		id = 311,
		trap_lua = "경고: 지휘관님, 이상 전자 교란을 받았습니다. G.M 시스템이 효력을 잃었습니다.",
		buff_attr = {},
		percent = {},
		buff_effect = {},
		buff_map_attr = {
	...
	pg.base.world_SLGbuff_data[315] = {
		...
		delete_move = 0,
		id = 315,
		trap_lua = "경고: 지휘관님, 함대 주변 해역이 연소 중입니다. 어서 위험 지역을 벗어나세요.",
		buff_attr = {},
		percent = {},
		buff_effect = {},
		buff_map_attr = {
	...
	pg.base.world_SLGbuff_data[317] = {
		...
		delete_move = 1,
		id = 317,
		trap_lua = "경고: 지휘관님, 함대가 소용돌이에 진입했습니다. 행동 능력에 제한을 받습니다.",
		buff_attr = {},
		percent = {},
		buff_effect = {},
		buff_map_attr = {
	...
	pg.base.world_SLGbuff_data[318] = {
		...
		delete_move = 3,
		id = 318,
		trap_lua = "경고: 지휘관님, 함대가 이상 해황의 영향을 받았습니다.",
		buff_attr = {},
		percent = {},
		buff_effect = {},
		buff_map_attr = {
