...
(function ()
	...
	pg.base.activity_ins_language.ins_655 = {
		value = "검은색이랑 하얀색 스타킹… 뭘로 할지 고민되네~"
	}
	pg.base.activity_ins_language.ins_discuss_655_1 = {
		value = "역시 검은색이지! 하얀색은 승산이 전혀 없어~"
	}
