...
(function ()
	...
	pg.base.island_chara_skill[1015] = {
		...
		desc = "기지 공장의 공업 생산 설비에 배치하면, 1회 작업 시마다 $1% 확률로 추가 생산 획득",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1016] = {
		...
		id = 1016,
		icon = "chara_all_skill_5",
		desc = "비옥한 농지에서 작업 시, 배치할 때마다 $1% 확률로 추가 생산 획득",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1017] = {
		...
		id = 1017,
		icon = "chara_all_skill_6",
		desc = "한가로운 목장에서 작업 시, 체력 소모가 $1% 경감됨",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1018] = {
		...
		desc = "츄츄 간편식의 직원으로 배치하면, 메뉴 한 슬롯의 용량 +1, 요리 판매 수익 $1% 증가",
		desc_add = {
			{
				{
					"4"
	...
	pg.base.island_chara_skill[1019] = {
		...
		id = 1019,
		icon = "chara_all_skill_4",
		desc = "츄카페에서 작업 시, 배치할 때마다 $1% 확률로 추가 생산 획득",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1020] = {
		...
		id = 1020,
		icon = "chara_all_skill_2",
		desc = "우거진 벌목장·석암 광산에서 작업 시, 작업 속도 $1% 상승",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1022] = {
		...
		id = 1022,
		icon = "chara_all_skill_5",
		desc = "비옥한 농지·향기로운 과수원·초록색 모밭에서 작업 시, 작업 속도 $1% 상승",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1023] = {
		...
		id = 1023,
		icon = "chara_all_skill_8",
		desc = "체력 회복이 $1% 늦어지지만, 작업 속도 $2% 증가",
		desc_add = {
			{
				{
					"10"
	...
	pg.base.island_chara_skill[1024] = {
		...
		id = 1024,
		icon = "chara_all_skill_9",
		desc = "초록색 모밭에서 작업 시, 배치할 때마다 $1% 확률로 추가 생산 획득",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1025] = {
		...
		id = 1025,
		icon = "chara_all_skill_1",
		desc = "석암 광산에서 작업 시, 배치할 때마다 $1% 확률로 추가 생산 획득",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1026] = {
		...
		id = 1026,
		icon = "chara_all_skill_13",
		desc = "오징어 구이의 직원으로 배치하면, 메뉴 한 슬롯의 용량 +1, 요리 판매 수익 $1% 증가",
		desc_add = {
			{
				{
					"4"
	...
	pg.base.island_chara_skill[1027] = {
		...
		desc = "기지 공장의 목재 가공 설비에 배치하면, 작업 속도 $1% 증가",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1028] = {
		...
		id = 1028,
		icon = "chara_all_skill_14",
		desc = "기지 공장의 수공 작업대에 배치하면, 배치할 때마다 $1% 확률로 추가 생산 획득",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1029] = {
		...
		id = 1029,
		icon = "chara_all_skill_8",
		desc = "우거진 벌목장에서 작업 시, 목재 산출 시간이 $1% 단축된다. 체력이 70 이하일 때 인사하면, 체력을 $2 회복한다(하루에 1회까지).",
		desc_add = {
			{
				{
					"1"
	...
	pg.base.island_chara_skill[1030] = {
		...
		id = 1030,
		icon = "chara_all_skill_12",
		desc = "임의의 가게 직원으로 배치하면, 체력 소모량이 $1% 경감된다. 배치된 가게 메뉴 슬롯의 출품 가능 수 +1.",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1031] = {
		...
		desc = "로열 포춘에게 인사하면 보상을 무작위로 획득할 수 있다($1). (하루에 1회까지)",
		desc_add = {
			{
				{
					"Lv1"
	...
	pg.base.island_chara_skill[1032] = {
		...
		id = 1032,
		icon = "chara_all_skill_4",
		desc = "츄카페에서 작업 시, 배치할 때마다 $1% 확률로 추가 생산물을 획득한다. 메뉴의 영업 이익이 $2% 상승한다.",
		desc_add = {
			{
				{
					"1"
