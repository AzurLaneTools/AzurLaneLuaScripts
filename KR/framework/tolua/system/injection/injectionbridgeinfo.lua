return {
	...
	BaseResourceMgr = {
		_loadAssetBundleAsync = 9761,
		_LoadAssetAsync = 9769,
		["LoadAssetAsync_AssetBundle_UnityAction<Object>_bool_bool"] = 9768,
		loadAssetBundleAsync = 9760,
		LoadAssetSync_AssetBundle_string_bool_bool = 9755,
		_loadAssetBundleTotallyAsync = 9759,
		ClearBundleRef_string_bool_bool = 9772,
		AssetExist = 9752,
		unloadUnusedAssetBundles = 9773,
		["LoadAssetAsync_AssetBundle_string_UnityAction<Object>_bool_bool"] = 9767,
		loadAssetBundleTotallyAsync = 9758,
		ClearBundleRef_AssetBundle_bool = 9770,
		getAssetSync_string_string_Type_bool_bool = 9756,
		["getAssetAsync_string_string_Type_UnityAction<Object>_bool_bool"] = 9762,
		CheckAsyncWaiting = 9765,
		Init = 9750,
		ClearBundleRefTotally = 9771,
		["getAssetAsync_string_string_UnityAction<Object>_bool_bool"] = 9763,
		dumpAssetBundles = 9774,
		getAssetSync_string_string_bool_bool = 9757,
		loadAssetBundleSync = 9753,
		_getAssetAsync = 9764,
		GetAllDependencies = 9751,
		LoadAssetSync_AssetBundle_string_Type_bool_bool = 9754,
		["LoadAssetAsync_AssetBundle_string_Type_UnityAction<Object>_bool_bool"] = 9766,
		Awake = 9749
	},
	BaseResourceMgrWrap = {
		op_Equality = 9486,
	...
	BilibiliCallBackListerner = {
		...
		InitFailed = 3080,
		OnBuglyInited = 9936,
		OnShowPrivateFailed = 9792,
		CloseAgreementView = 9793,
		OnFetchFreeHostFailed = 8100,
		OnFetchFreeHostSuccess = 8099,
		DeleteAccountFailed = 10193,
		DeleteAccountSuccess = 10191,
		OnShowPrivateSuccess = 9791,
		GameExit = 3088,
		OnShowLicenceSucces = 9789,
		OnShowLicenceFailed = 9790,
		PaySuccess = 3086,
		LoginOut = 3083
	},
	BilibiliSdkMgr = {
	...
	BrightnessHelper = {
		GetMode = 9638,
		SetScreenBrightness = 9640,
		SetBrightnessMode = 9641,
		GetValue = 9639
	},
	...
	ClickEffect = {
		...
		OnStandlone = 3167,
		UpdatePos_Vector3 = 9840
	},
	["Coffee.UIExtensions.UIMirrorReflection"] = {
		AddMirrorReflectedQuad = 9880,
		GetLerpFactor = 9881,
		get_etartColor = 9877,
		get_height = 9871,
		get_startColor = 9875,
		...
		set_startColor = 9876,
		set_spacing = 9874,
		MirrorReflectVertex = 9882,
		SetDirty = 9883,
		get_spacing = 9873,
		get_targetGraphic = 9870,
		ModifyMesh = 9879
	},
	["Coffee.UIExtensions.UIVertexUtil"] = {
		Bilerp_UIVertex_UIVertex_UIVertex_UIVertex_float_float = 9886,
		AddQuadToStream = 9884,
		Lerp = 9885,
		Bilerp_Vector2_Vector2_Vector2_Vector2_float_float = 9887,
		Bilerp_Vector3_Vector3_Vector3_Vector3_float_float = 9888,
		Bilerp_Vector4_Vector4_Vector4_Vector4_float_float = 9889,
		Bilerp_Color_Color_Color_Color_float_float = 9890
	},
	Collider2DFilter = {
		Awake = 3169,
	...
	DownloadUI = {
		SetCancelCallBack = 9702,
		UpdateProgressBar = 9707,
		UpdateProgressInfo = 9709,
		UpdateInfoPanel = 9713,
		SetCloseCallBack = 9701,
		get_Inst = 9700,
		ChangeBlur = 9714,
		DisplayUpdatePanel = 9711,
		DestroyUI = 9716,
		DisplayDialog_string = 9705,
		BackPress = 9715,
		SetConfirmCallBack = 9703,
		SetDialogCallBack = 9704,
		["DisplayDialog_string_Action<bool>_bool"] = 9706,
		DisplayProgress = 9710,
		UpdateProgressBarDirect = 9708,
		DisplayInfoPanel = 9712
	},
	DrawPolygon = {
		Awake = 3181,
		draw = 3182
	...
	Effect = {
		...
		Play = 3159,
		set_ps = 9834,
		UpdatePosition_Vector3_float = 9838,
		UpdatePosition_Vector3 = 9837
	},
	EffectScriptSample = {
		Start = 2130,
		CheckProperty = 2128,
	...
	FXMakerQuickMenu = {
		...
		Start = 1687,
		OnEnable = 1685,
		IsParticleEmitterOneShot_TempParticleEmitter = 9747,
	...
	MaskExtend = {
		OnTransformChildrenChanged = 9868,
		AddMaterial = 9866,
		get_material = 9859,
		AddChildsMaterial = 9867,
		OnDisable = 9869,
		set_material = 9858,
		Refresh = 9865,
		OnEnable = 9864,
		set_refValue = 9862,
		get_childMaterial = 9861,
		get_refValue = 9863,
		set_childMaterial = 9860
	},
	MaskRaycast = {
		Raycast = 8519
	},
	...
	NcParticleSystem = {
		Ng_GetProperty = 2573,
		["LegacyScaleParticle_TempParticle[]_bool_bool"] = 9748,
	...
	NgSerialized = {
		...
		IsMesh = 1140,
		SetEllipsoidSize_TempParticleEmitter_Vector3_float = 9744,
		IsValidCopy = 1135,
		IsEllipsoidParticleEmitter_TempParticleEmitter = 9740,
		IsEnableParticleMesh = 1139,
		CopySerialized = 1138,
		["GetEllipsoidSize_TempParticleEmitter_Vector3&_float&"] = 9743,
		SetPropertyValue_SerializedProperty_object = 1132,
		IsMeshParticleEmitter_TempParticleEmitter = 9739,
		CloneComponent = 1137,
		...
		SetMeshNormalVelocity_TempParticleEmitter_float_float = 9742,
		["GetMeshNormalVelocity_TempParticleEmitter_float&_float&"] = 9741,
	...
	["p10.sc_10801"] = {
		...
		set_url = 3887,
		get_url = 3886,
		get_monday_0oclock_timestamp = 9906,
		set_proxy_ip = 3890,
		set_proxy_port = 3892,
		get_timestamp = 9904,
		set_gateway_ip = 3883,
		...
		get_is_ts = 8341,
		get_gateway_ip = 3882,
		set_monday_0oclock_timestamp = 9907,
		get_version = 3888,
		set_timestamp = 9905,
		get_proxy_port = 3891,
	...
	StickController = {
		...
		ValidPosFunc = 3558,
		Awake = 3553,
		IsPointerOverUIObjectByTouch = 9856
	},
	...
	TxwyKrSdkCallback = {
		TxwyPayFailed = 9799,
		TxwyLoginOut = 9797,
		TxwyLoginSuccess = 9796,
		TxwyPaySuccess = 9798,
		TxwyQueryWithProduct = 9800,
		TxwyStoreReview = 9802,
		TxwyShareImg = 9801
	},
	TxwyKrSdkMgr = {
		set_isLocalExit = 9807,
		TryLoginGetway = 9809,
		OnShareImage = 9828,
		OnQueryProduct = 9827,
		callSdkApi = 8118,
		OnLoginGatewayFailed = 9812,
		set_lastTradeNO = 9804,
		get_loginType = 8114,
		get_isPlatform = 8115,
		PrintJson = 9824,
		SetServerId = 9829,
		LevelUp = 9822,
		SwitchAccount = 9823,
		get_lastTradeNO = 9805,
		ShareImg = 9818,
		QueryWithProduct = 9821,
		get_inst = 9803,
		get_channelUID = 9806,
		Login = 9810,
		GoLoginScene = 8117,
		...
		StoreReview = 9817,
		GetDeviceModel = 9826,
		CompletedTutorial = 9819,
		EnterServer = 9814,
		UserCenter = 9815,
		Log = 9825,
		BugReport = 9816,
		LocalLogout = 9813,
		UnlockAchievement = 9820,
		get_isLocalExit = 9808,
		OnGatewayLogined = 9811
	},
	TxwyKrSdkMgrWrap = {
		get_isPlatform = 7898,
		GoLoginScene = 7895,
	...
	["UnityEngine.UI.LScrollRect"] = {
		...
		RemoveLoadingItem_GameObject = 9847,
		...
		RemoveLoadingItem_GameObject_int = 9846,
		OnEnable = 3372,
		...
		SetContentAnchoredPositionOriginal = 9852,
		UpdateScrollbarLayout = 3404,
		ClearLoadingItem = 9848,
		LateUpdate = 3383,
		get_verticalScrollbarSpacing = 3334,
		GetContentAnchoredPositionOriginal = 9851,
	...
	["UnityEngine.UI.RichText"] = {
		...
		AddListener = 3532,
		["CalculateLayoutWithImage_string_IList<UICharInfo>&_IList<UIVertex>&"] = 9853,
		OnPointerClick = 3545,
		RichStringProjection = 9854,
	...
	VersionConn = {
		CheckUseBackgroundDownload = 9903,
		Send = 3873,
		GetVersionList = 9901,
		OnData = 3876,
		GetLuaHashes = 9902,
	...
	VersionMgr = {
		...
		["DisplayDialog_string_Action<bool>"] = 9785,
		OnProxyUsing = 2987,
		GetServerState = 2990,
		enableProgrees = 8051,
		get_Inst = 2974,
		...
		CheckUpdate = 2977,
		RequestVersion = 2978,
		RequestUIForUpdateD = 9787,
		WebRequest = 2991,
		DisplayDialog_string_Action = 2981,
		FetchVersion = 2984,
		RequestUIForUpdateF = 9786,
		ModifyHashStringArrayToOld = 9788,
		Init = 2976,
		StartCheck = 9784,
		Update = 2979,
		BackPress = 2982,
	...
	["YongShi.BundleWizardRuntime.BundleWizard"] = {
		...
		GetCdnUrlList = 9646,
		GetGroupMgr = 9649,
		CreateAllDownloadGroup = 9644,
		GetOriginalCdnUrlList = 9645,
		get_Inst = 9642,
		GetGroupMgrByFilePath = 9650,
		CheckUpdate = 9653,
		DeleteCacheFiles = 9655,
		SetCdnUrlList = 9647,
		Update = 9654,
		IsAnyGroupNeedD = 9657,
		SetSwitchPackageFlag = 9648,
		StartHotfix = 9652,
		Awake = 9643,
		CheckSingleRes = 9656
	},
	["YongShi.BundleWizardRuntime.DownloadBackgroundMgr"] = {
		Clear = 9664,
		get_IsAnyTaskFailed = 9662,
		SetAllTaskFinishTag = 9665,
		SingleTaskEvent = 9669,
		ClearProgressInfo = 9663,
		get_Inst = 9658,
		get_IsUseDownloadBackgrond = 9660,
		AllTaskEvent = 9670,
		ProgressEvent = 9671,
		Init = 9666,
		IsForceBGDownload = 9674,
		StartBGDownload = 9667,
		GetCurrentServer = 9673,
		GenDownloadFileList = 9672,
		set_IsUseDownloadBackgrond = 9659,
		get_IsAllTaskFinished = 9661,
		OnError = 9668
	},
	["YongShi.BundleWizardRuntime.DownloadMgr"] = {
		StartVerifyForLua = 9684,
		DoUpdateD = 9680,
		FindF = 9675,
		Clear = 9681,
		DoUpdateF = 9678,
		UpdateF = 9677,
		StartVerify = 9682,
		VerifyResources = 9683,
		UpdateD = 9679,
		CheckF = 9676
	},
	["YongShi.BundleWizardRuntime.DownloadMgrBase"] = {
		DoCheckD = 9694,
		UpdateFileDownloadStates = 9933,
		UpdateHashFile = 9697,
		SetV = 9688,
		CheckUpdateType = 9934,
		AppendHashFile = 9696,
		NeedD = 9692,
		RewriteHashFile = 9695,
		CloseCachedStreamWriter = 9698,
		FixVersion = 9689,
		CheckD = 9693,
		get_GroupData = 9685,
		GetCurrentServer = 9690,
		set_GroupData = 9686,
		UpdateVersionFile = 9699,
		OnError = 9691,
		get_CurrentVersion = 9687
	},
	["YongShi.BundleWizardRuntime.HashUtil"] = {
		Compare = 9717,
		CalcMD5_string = 9721,
		["CompareNew_string[]_string[]_string[]_string_List<string[]>&_List<string[]>&"] = 9718,
		HashFile = 9719,
		BytesToString = 9720,
		["CalcMD5_byte[]"] = 9722,
		["CompareNew_string[]_string[]_string[]_string_List<string[]>&_List<string[]>&_List<string[]>&"] = 9935
	},
	["YongShi.BundleWizardRuntime.PathUtil"] = {
		GetPlatformName_BuildTarget = 9736,
		GetLuaName = 9727,
		ReadAllLines = 9731,
		GetPlatformName = 9735,
		GetStreamingAsset = 9730,
		GetStreamAssetsPath = 9738,
		ReadAllBytes = 9732,
		GetAssetBundle = 9728,
		GetPlatformName_RuntimePlatform = 9737,
		GetInstance = 9724,
		GetLuaBundle = 9725,
		FileExists = 9734,
		GetShortAssetBundle = 9729,
		get_Is32Bit = 9726,
		ReadAllText = 9733,
		Init = 9723
	},
	...
	YongShi_BundleWizardRuntime_DownloadMgrBaseWrap = {
		set__cachedStreamWriter = 9615,
		get_cachedHashMap = 9589,
		set_cachedHashPath = 9599,
		set_downloadTotal = 9609,
		get_toUpdate = 9591,
		get__cachedStreamWriter = 9593,
		get_remoteHashFileName = 9576,
		get_downPath = 9585,
		set_serverVersion = 9601,
		set_downPath = 9607,
		set_cdnURLArr = 9602,
		set_localVersion = 9600,
		get_state = 9583,
		AppendHashFile = 9569,
		NeedD = 9566,
		set_maxRetryTimes = 9610,
		set_remoteHashFileName = 9598,
		set_toDelAndUpdate = 9932,
		get_toDelete = 9590,
		Register = 9562,
		get_serverVersion = 9579,
		op_Equality = 9573,
		get_downloadCount = 9586,
		set_GroupData = 9616,
		set_errorCode = 9606,
		get_localVersionFile = 9574,
		set_toDelete = 9612,
		get_useCacheVersion = 9581,
		set_toUpdate = 9613,
		set_useCacheVersion = 9603,
		SetV = 9563,
		get_webRequest = 9592,
		set_state = 9605,
		UpdateFileDownloadStates = 9929,
		set_localVersionFile = 9596,
		get_localVersion = 9578,
		UpdateHashFile = 9570,
		CheckD = 9567,
		get_cachedHashPath = 9577,
		get_localHashFile = 9575,
		GetCurrentServer = 9564,
		set_localHashFile = 9597,
		get_toDelAndUpdate = 9931,
		CheckUpdateType = 9930,
		get_switchPackageFlag = 9582,
		set_webRequest = 9614,
		get_cdnURLArr = 9580,
		RewriteHashFile = 9568,
		CloseCachedStreamWriter = 9571,
		get_CurrentVersion = 9595,
		set_downloadCount = 9608,
		get_GroupData = 9594,
		get_errorCode = 9584,
		set_cachedHashMap = 9611,
		get_downloadTotal = 9587,
		set_switchPackageFlag = 9604,
		UpdateVersionFile = 9572,
		OnError = 9565,
		get_maxRetryTimes = 9588
	},
	YongShi_BundleWizardRuntime_DownloadMgrWrap = {
		StartVerifyForLua = 9624,
		Clear = 9622,
		FindF = 9618,
		Register = 9617,
		op_Equality = 9625,
	...
	YongShi_BundleWizardRuntime_DownloadStateWrap = {
		...
		IntToEnum = 9637,
		get_CheckOver = 9632,
		get_UpdateFailure = 9636,
		get_None = 9629,
		get_UpdateSuccess = 9635,
		Register = 9626,
		get_Checking = 9630,
		CheckType = 9628,
		get_Updating = 9634,
		get_CheckFailure = 9633,
		get_CheckToUpdate = 9631
	},
	YongshiSdkMgr = {
		get_isPlatform = 8120,
		callSdkApi = 8123,
	...
	["YSToolCore.YsToolCallback"] = {
		getBrightnessMode = 9924,
		ShowLog = 9925,
		Awake = 9923
	},
	["YSToolCore.YsToolEvent"] = {
		get_Instance = 9926,
		HandleBrightMode = 9927
	},
