...
slot0.OnLoaded = function(slot0)
	...
	slot0.impeachconfirmBtn = slot0._tf:Find("frame/confirm_btn")
	slot0.impeachcancelBtn = slot0._tf:Find("frame/cancel_btn")
	slot0.impeachnameTF = slot0._tf:Find("frame/info/name/Text"):GetComponent(typeof(Text))
	slot0.impeachiconTF = slot0._tf:Find("frame/info/shipicon/icon"):GetComponent(typeof(Image))
	slot0.impeachduty = slot0._tf:Find("frame/duty"):GetComponent(typeof(Image))
	slot0.impeachstarsTF = slot0._tf:Find("frame/info/shipicon/stars")
	slot0.impeachstarTF = slot0._tf:Find("frame/info/shipicon/stars/star")
	slot0.impeachlevelTF = slot0._tf:Find("frame/info/level/Text"):GetComponent(typeof(Text))
