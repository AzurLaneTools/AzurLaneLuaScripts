...
function slot0.Ctor(slot0, slot1)
	...
	slot2 = slot0.hideBtn
	slot0.hideBtnImg = slot2:GetComponent(typeof(Image))
	slot2 = findTF(slot0.hideBtn, "Text")
	slot0.hideBtnTxt = slot2:GetComponent(typeof(Text))
	slot2 = findTF(slot0._tf, "panel/bg")
	slot0.bgImg = slot2:GetComponent(typeof(Image))
	...
	slot2 = findTF(slot0._tf, "panel/msg")
	slot0.msgTxt = slot2:GetComponent(typeof(Text))
	slot2 = findTF(slot0._tf, "panel/process/Text")
	slot0.processTxt = slot2:GetComponent(typeof(Text))
	slot2 = findTF(slot0._tf, "panel/slider")
	slot0.hpSlider = slot2:GetComponent(typeof(Slider))
	slot2 = findTF(tf(slot0.hpSlider), "hp")
	slot0.hpSliderTxt = slot2:GetComponent(typeof(Text))
	slot2 = findTF(slot0._tf, "panel/slider/Text")
	slot0.nameTxt = slot2:GetComponent(typeof(Text))
	slot0.maskTF = findTF(slot0._tf, "panel/mask")
	slot2 = findTF(slot0.maskTF, "Text")
	slot0.timerTxt = slot2:GetComponent(typeof(Text))
	slot0.msgPosition = slot0.msgTF.anchoredPosition
	slot2 = slot0.msgTF
	slot0.msgCG = slot2:GetComponent(typeof(CanvasGroup))
