...
slot0.OnLoaded = function(slot0)
	slot0.usageList = UIItemList.New(slot0._tf:Find("bg/frame/bg/talents/content"), slot0._tf:Find("bg/frame/bg/talents/content/talent"))
	slot0.usageCancelBtn = slot0._tf:Find("bg/frame/cancel_btn")
	slot0.usageConfirmBtn = slot0._tf:Find("bg/frame/confirm_btn")
	slot0.usageConfirmUpgrade = slot0._tf:Find("bg/frame/confirm_btn/upgrade")
	slot0.usageConfirmILearned = slot0._tf:Find("bg/frame/confirm_btn/learned")
	slot0.usageTalent = slot0._tf:Find("bg/frame/bg/talent")
	slot0.usageCostIconTF = slot0._tf:Find("bg/frame/consume/Image")
	slot0.usageCostTxtTF = slot0._tf:Find("bg/frame/consume/Text")
	slot0.usageCostTxt = slot0.usageCostTxtTF:GetComponent(typeof(Text))
	slot0.usageCloseBtn = slot0._tf:Find("bg/frame/close_btn")
	slot0.replacePage = CommanderReplaceTalentPage.New(slot0._parentTf.parent, slot0.event)

	setText(slot0._tf:Find("bg/frame/bg/title/Text"), i18n("commander_choice_talent_1"))
	setText(slot0._tf:Find("bg/frame/bg/talents/title/Text"), i18n("commander_choice_talent_2"))
	setText(slot0._tf:Find("bg/frame/consume/label"), i18n("word_consume"))
end
