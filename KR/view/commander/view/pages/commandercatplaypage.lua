...
slot0.OnLoaded = function(slot0)
	slot0.skillTF = slot0._tf:Find("skill/frame")
	slot0.skillNameTxt = slot0.skillTF:Find("name"):GetComponent(typeof(Text))
	slot0.skillIcon = slot0.skillTF:Find("icon/Image")
	slot0.skillLvTxt = slot0.skillTF:Find("level_container/level"):GetComponent(typeof(Text))
	slot0.skillAdditionTxt = slot0.skillTF:Find("level_container/addition"):GetComponent(typeof(Text))
	slot0.expTxt = slot0.skillTF:Find("exp/Text"):GetComponent(typeof(Text))
	slot0.descBtn = slot0._tf:Find("skill/frame/desc")
	slot0.descPage = slot0._tf:Find("skill_desc")
	slot0.descToggle = slot0.descPage:Find("tags")
	slot0.descToggleMark = slot0.descToggle:Find("sel")
	slot0.skillDescList = UIItemList.New(slot0.descPage:Find("content/list"), slot0.descPage:Find("content/list/tpl"))

	setActive(slot0.descPage, false)

	slot0.commanderLvTxt = slot0._tf:Find("select_panel/exp_bg/level_bg/Text"):GetComponent(typeof(Text))
	slot0.levelAdditionTxt = slot0._tf:Find("select_panel/exp_bg/level_bg/addition"):GetComponent(typeof(Text))
	slot0.preExpSlider = slot0._tf:Find("select_panel/exp_bg/slider"):GetComponent(typeof(Slider))
	slot0.expSlider = slot0._tf:Find("select_panel/exp_bg/slider/exp"):GetComponent(typeof(Slider))
	slot0.sliderExpTxt = slot0._tf:Find("select_panel/exp_bg/slider/Text"):GetComponent(typeof(Text))
	slot0.uilist = UIItemList.New(slot0._tf:Find("select_panel/frame/list"), slot0._tf:Find("select_panel/frame/list/commandeTF"))
	slot0.consumeTxt = slot0._tf:Find("select_panel/consume/Text"):GetComponent(typeof(Text))
	slot0.confirmBtn = slot0._tf:Find("select_panel/confirm_btn")
	slot0.animation = CommanderCatPlayAnimation.New(slot0.expSlider)

	setText(slot0._tf:Find("select_panel/title"), i18n("commander_confirm_tip"))
	setText(slot0._tf:Find("skill_desc/title"), i18n("commander_skill_effect"))
end
