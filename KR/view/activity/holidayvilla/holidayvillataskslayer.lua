...
slot0.UpdateList = function(slot0, slot1, slot2, slot3)
	...
	setText(slot2:Find("go_btn/text"), i18n("other_world_task_go"))
	setText(slot2:Find("get_btn/text"), i18n("other_world_task_get"))
	setText(slot2:Find("got_btn/text"), i18n("other_world_task_got"))
