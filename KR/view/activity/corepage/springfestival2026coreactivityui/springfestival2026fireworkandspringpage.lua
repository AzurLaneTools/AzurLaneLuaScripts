slot0 = class("SpringFestival2026FireworkAndSpringPage", import("view.activity.CorePage.CoreActivityBackHillTemplate"))
slot0.edge2area = {
	default = "_SDPlace"
}
slot0.EffectPoolCnt = 3
slot0.Id2EffectName = {
	[65842.0] = "yanhua_xiaojiajia",
	[65841.0] = "yanhua_xinxin",
	[65840.0] = "yanhua_jiezhi",
	[65839.0] = "yanhua_huangji",
	[65838.0] = "yanhua_chuanmao",
	[65837.0] = "yanhua_hongbao",
	[65836.0] = "yanhua_denglong",
	[65835.0] = "yanhua_maomao",
	[65834.0] = "yanhua_02",
	[65833.0] = "yanhua_01",
...
slot0.OnInit = function(slot0)
	...
	slot0._map = slot0._tf:Find("BG/map")
	slot0._shipTpl = slot0._tf:Find("BG/ship")
	slot0.fireworksTF = slot0._tf:Find("BG/fireworks")
	slot1 = slot0._tf
	slot0._SDPlace = slot1:Find("BG/SDPlace")
	slot0.containers = {
		slot0._SDPlace
	}
	slot0.graphPath = GraphPath.New(import("GameCfg.BackHillGraphs.FireworkAndSpringGraph"))
	slot0.backBtn = slot0._tf:Find("BG/panel/btn_back")
	slot0.tipBtn = slot0._tf:Find("BG/panel/btn_tip")
	slot0.ptBtn = slot0._tf:Find("BG/panel/btn_pt")
	slot0.stage = slot0._tf:Find("BG/panel/btn_pt/stage")
	slot0.pt = slot0._tf:Find("BG/panel/btn_pt/pt")
	slot0.taskBtn = slot0._tf:Find("BG/panel/btn_task")
	slot0.fireworkBtn = slot0._tf:Find("BG/panel/btn_firework")
	slot0.springBtn = slot0._tf:Find("BG/panel/btn_spring")
	slot0.subPanel = slot0._tf:Find("BG/subPanel")
...
slot0.OnUpdateFlush = function(slot0)
	...
	slot0:SetFireWorkPanel()

	if isActive(slot0.springPanel) then
		slot0:UpdateSpringActivityAndUI()
	end
end

slot0.InitData = function(slot0)
	slot0.ptActId = ActivityConst.HorseYearSpringFestival2026_ID_1
	slot0.taskActId = ActivityConst.HorseYearSpringFestival2026_ID_2
	slot0.fireworkActId = ActivityConst.HorseYearSpringFestival2026_ID_4
	slot0.springActId = ActivityConst.HorseYearSpringFestival2026_ID_3
		...
		onButton(slot0, slot4:Find("btn_get"), function ()
			...
			seriesAsync(slot0, function ()
				uv0:emit(ActivityMediator.ON_ACTIVITY_TASK_LIST_SUBMIT, {
					activityId = uv0.taskActId,
					ids = uv0.canGetTaskIds
				})
			end)
		end, SFX_PANEL)
	else
	...
	slot0.springList:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			...
			onButton(uv0, slot2, function ()
				...
				uv3:emit(CoreActivityMainMediator.OPEN_CHUANWU, uv3.springActId, uv4 + 1, slot0, uv3.springUnlockSlotCount)
			end, SFX_PANEL)
			...
			setScrollText(slot2:Find("ship/name/Text"), slot6:getName())
		end
	end)
