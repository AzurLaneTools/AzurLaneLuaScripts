slot0 = class("DOAYearHotSpringShipSelectLayer", import("view.base.BaseUI"))
slot1 = import("view.activity.BackHills.NewYearFestival.NewYearHotSpringFormationCard")
...
slot0.AddCard = function(slot0, slot1, slot2, slot3)
	...
	if slot2 == 0 and slot3 then
		...
		onButton(slot0, slot5, function ()
			uv0:emit(DOAYearHotSpringShipSelectMediator.OPEN_CHUANWU, uv1, uv2)
		end, SFX_PANEL)
		...
		slot7.onLongPressed:AddListener(function ()
			...
			uv1:emit(DOAYearHotSpringShipSelectMediator.LOOG_PRESS_SHIP, uv2, uv0)
		end)
		...
		if slot2 == 0 then
			onButton(slot0, slot5, function ()
				uv0:emit(DOAYearHotSpringShipSelectMediator.OPEN_CHUANWU, uv1)
			end, SFX_PANEL)
		elseif slot2 == 1 then
			onButton(slot0, slot5, function ()
				uv0:emit(DOAYearHotSpringShipSelectMediator.EXTEND, uv1)
			end, SFX_PANEL)
		elseif slot2 == 2 then
			-- Nothing
		end
