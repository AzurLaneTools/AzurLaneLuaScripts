slot0 = class("TianYuTianYuanCoreActivityUI", import("view.activity.CorePage.CoreActivityMainScene"))
				...
				if uv0.pageDic[slot3.id] ~= nil then
					...
					onToggle(uv0, slot2, function (slot0)
						if slot0 then
							...
							if uv2 ~= uv1.id then
								quickPlayAnimation(uv3, "Anim_TianYuTianYuanCoreActivityUI_select")
							end
