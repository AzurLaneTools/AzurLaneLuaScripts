...
slot0.Ctor = function(slot0, slot1, slot2)
	...
	slot0._go = slot1
	slot0._tf = tf(slot1)
	slot0.ptTxt = slot0._tf:Find("bg1/pt_panel/slider/Text"):GetComponent(typeof(Text))
	slot0.phaseTotalTxt = slot0._tf:Find("bg1/pt_panel/total_progress"):GetComponent(typeof(Text))
	slot0.phaseTxt = slot0._tf:Find("bg1/pt_panel/progress"):GetComponent(typeof(Text))
	slot0.progress = slot0._tf:Find("bg1/pt_panel/slider")
	slot0.getBtn = slot0._tf:Find("bg1/pt_panel/get")
	slot0.awardTF = slot0._tf:Find("bg1/pt_panel/item")
	slot0.awardOverView = slot0._tf:Find("bg1/pt_panel/award_overview")
	slot0.bg = slot0._tf:Find("bg"):GetComponent(typeof(Image))
	slot0.returnerList = UIItemList.New(slot0._tf:Find("bg1/returners/content"), slot0._tf:Find("bg1/returners/content/tpl"))
	slot0.help = slot0._tf:Find("bg1/help")
	slot0.pushBtn = slot0._tf:Find("bg1/push_btn")
	slot0.pushedBtn = slot0._tf:Find("bg1/pushed_btn")
	slot0.pushDisBtn = slot0._tf:Find("bg1/push_btn_dis")
	slot0.codeTxt = slot0._tf:Find("bg1/code"):GetComponent(typeof(Text))
	slot0.taskLockPanel = slot0._tf:Find("bg1/task_lock_panel")

	setText(slot0.taskLockPanel:Find("Text"), i18n("word_sell_lock"))

	slot0.taskPanel = slot0._tf:Find("bg1/task_panel")
	slot0.taskItemTF = slot0._tf:Find("bg1/task_panel/item")
	slot0.taskProgress = slot0._tf:Find("bg1/task_panel/progress")
	slot0.taskDesc = slot0._tf:Find("bg1/task_panel/desc")
	slot0.taskGoBtn = slot0._tf:Find("bg1/task_panel/go")
	slot0.taskGotBtn = slot0._tf:Find("bg1/task_panel/got")
	slot0.taskGetBtn = slot0._tf:Find("bg1/task_panel/get")
	slot0.taskProgressTxt = slot0._tf:Find("bg1/task_panel/p"):GetComponent(typeof(Text))

	setText(slot0._tf:Find("bg1/pt_panel/title"), i18n("activity_return_reward_pt"))
	slot0:Init()
end
