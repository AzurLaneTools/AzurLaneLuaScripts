slot0 = class("XiaoAiJiErPage", import(".TemplatePage.PtTemplatePage"))
...
slot0.OnUpdateFlush = function(slot0)
	...
	setText(slot0.step, setColorStr(slot1, "#f0d1c6") .. " / " .. slot2)
	setText(slot0.progress, (slot6 >= 1 and setColorStr(slot4, COLOR_GREEN) or setColorStr(slot4, "#f0d1c6")) .. "/" .. slot5)
...
slot0.tryClaimTaskReward = function(slot0)
	slot1 = {}
...
slot0.updateTaskList = function(slot0, slot1, slot2, slot3, slot4)
	...
	if slot4.subType ~= 33 then
		setText(findTF(slot14, "pahase"), setColorStr(slot7, "#957b01") .. "/" .. slot6)
	else
