...
slot0.init = function(slot0)
	...
	slot0.paintingTr = slot0._tf:Find("main/mask/painting")
	slot0.chatTf = slot0._tf:Find("main/chat")
	slot0.chatTxt = slot0.chatTf:Find("Text"):GetComponent(typeof(Text))
	slot0.toggleUIItemList = UIItemList.New(slot0._tf:Find("main/tag"), slot0._tf:Find("main/tag/tpl"))
	slot0.wordUIItemList = UIItemList.New(slot0._tf:Find("main/list/content"), slot0._tf:Find("main/list/content/tpl"))
	slot0.tabItemList = UIItemList.New(slot0._tf:Find("tab/list"), slot0._tf:Find("tab/list/tpl"))
