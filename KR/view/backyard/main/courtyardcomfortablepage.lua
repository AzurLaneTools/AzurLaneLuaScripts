...
slot0.OnLoaded = function(slot0)
	...
	slot0.subTitleTxt = slot0._tf:Find("frame/view/subtitle2/Text"):GetComponent(typeof(Text))

	setText(slot0._tf:Find("frame/view/subtitle1/Text"), i18n("backyard_backyardScene_comforChatContent1"))

	slot0.expressionTxt = slot0._tf:Find("frame/view/express/Text"):GetComponent(typeof(Text))
	slot0.comfortableImg = slot0._tf:Find("frame/view/express/icon"):GetComponent(typeof(Image))
	slot0.comfortableBg = slot0._tf:Find("frame/view/express"):GetComponent(typeof(Image))
	slot0.uiItemList = UIItemList.New(slot0._tf:Find("frame/view/list/content"), slot0._tf:Find("frame/view/list/content/tpl"))
	slot0.animation = slot0._tf:Find("frame/view"):GetComponent(typeof(Animation))
	slot0.dftAniEvent = slot0._tf:Find("frame/view"):GetComponent(typeof(DftAniEvent))
	slot0.foldBtn = slot0._tf:Find("frame/view/fold")
	slot0.arr = slot0._tf:Find("frame/view/fold/up")
	slot0.subTitle = slot0._tf:Find("frame/view/subtitle2")
	slot0.expAdditionTxt = slot0._tf:Find("frame/exp/Text"):GetComponent(typeof(Text))

	setText(slot0._tf:Find("frame/exp"), i18n("courtyard_label_comfortable_addition"))
	setText(slot0._tf:Find("frame/title"), i18n("word_comfort_level"))
end
