...
slot0.OnInit = function(slot0)
	...
	slot0.appleLoginBtn = slot0.jpLoginCon:Find("apple_login")
	slot0.amazonLoginBtn = slot0.jpLoginCon:Find("amazon_login")
	slot0.twitterLoginBtn = slot0.jpLoginCon:Find("twitter_login")
	slot0.transcodeLoginBtn = slot0.jpLoginCon:Find("transcode_login")
	slot0.touristLoginBtn = slot0.jpLoginCon:Find("tourist_login")
	slot0.yostarLoginBtn = slot0.jpLoginCon:Find("yostar_login")
	slot0.firstAlertWin = slot0.airijpPanel:Find("empty_alert")
	slot0.appleToggleTf = slot0.firstAlertWin:Find("window/content_bg/apple_toggle")
	slot0.amazonToggleTf = slot0.firstAlertWin:Find("window/content_bg/amazon_toggle")
	slot0.twitterToggleTf = slot0.firstAlertWin:Find("window/content_bg/twitter_toggle")
	slot0.transcodeToggleTf = slot0.firstAlertWin:Find("window/content_bg/transcode_toggle")
	slot0.touristToggleTf = slot0.firstAlertWin:Find("window/content_bg/tourist_toggle")
	slot0.yostarToggleTf = slot0.firstAlertWin:Find("window/content_bg/yostar_toggle")
	slot0.alertCloseBtn = slot0.firstAlertWin:Find("window/top/btnBack")
	slot0.alertCancelBtn = slot0.firstAlertWin:Find("window/button_container/custom_button_2")
	slot0.alertSureBtn = slot0.firstAlertWin:Find("window/button_container/custom_button_1")
