...
slot0.OnLoaded = function(slot0)
	slot0.backBtn = slot0._tf:Find("return")
	slot0.scrollrect = slot0._tf:Find("left/scrollrect")
	slot0.uilist = UIItemList.New(slot0._tf:Find("left/scrollrect/conent"), slot0._tf:Find("left/scrollrect/conent/tpl"))
	slot0.resTicketTr = slot0._tf:Find("res/ticket")
	slot0.resGiftTr = slot0._tf:Find("res/gift")
	slot0.resTicket = slot0._tf:Find("res/ticket/Text"):GetComponent(typeof(Text))
	slot0.resGift = slot0._tf:Find("res/gift/Text"):GetComponent(typeof(Text))
	slot0.ticketTr = slot0._tf:Find("main/ticket")
	slot0.ticketMarkTr = slot0._tf:Find("main/ticket/finish")
	slot0.giftTr = slot0._tf:Find("main/gift")
	slot0.giftImg = slot0.giftTr:Find("icon"):GetComponent(typeof(Image))
	slot0.giftMarkTr = slot0._tf:Find("main/gift/finish")
	...
	slot0.painting = slot0._tf:Find("main/painting"):GetComponent(typeof(Image))
	...
	slot0.homeBtn = slot0._tf:Find("home")
end
