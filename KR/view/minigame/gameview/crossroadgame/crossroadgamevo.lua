slot0 = class("CrossRoadGameVo")

slot0.Ctor = function(slot0, slot1)
	slot0._gameId = slot1
	slot0._hubId = pg.mini_game[slot1].hub_id
...
slot0.Prepare = function(slot0)
	slot0._gameTime = CrossRoadGameConst.GAME_TIME
	...
	slot0._life = CrossRoadGameConst.LIFE_COUNT
	slot0._roleWentCnt = 0
end
...
slot0.GetRoleCnt = function(slot0)
	return slot0._roleWentCnt
end

slot0.AddRoleCnt = function(slot0)
	slot0._roleWentCnt = slot0._roleWentCnt + 1
end
