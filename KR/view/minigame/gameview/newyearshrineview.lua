...
slot0.findUI = function(slot0)
	slot0.noAdaptPanel = slot0._tf:Find("noAdaptPanel")
	slot0.buffTF = slot0.noAdaptPanel:Find("Buff")
	slot0.buffRope = slot0.buffTF:Find("BuffRope")
	slot0.buffImg = slot0.buffTF:Find("BuffTypeImg")
	slot0.buffText = slot0.buffTF:Find("BuffText")
	slot0.buffEffectAni = GetComponent(slot0.buffImg, "Animator")
	slot0.buffDftAniEvent = GetComponent(slot0.buffImg, "DftAniEvent")
	slot0.bgImg = slot0._tf:Find("BGImg"):GetComponent(typeof(Image))
	slot0.bgImg.color = Color.New(1, 1, 1)
	slot1 = slot0.noAdaptPanel:Find("Top")
	slot0.topTF = slot1
	slot0.backBtn = slot1:Find("BackBtn")
	slot0.helpBtn = slot1:Find("HelpBtn")
	slot0.timesText = slot1:Find("Times/Text")
	slot0.goldText = slot1:Find("Gold/Text")
	slot2 = slot0._tf:Find("Main")
	slot0.clockTF = slot2:Find("Clock")
	slot0.clockBtn = slot2:Find("ClockBtn")
