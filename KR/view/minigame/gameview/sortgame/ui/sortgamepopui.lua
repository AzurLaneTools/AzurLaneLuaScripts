...
slot0.UpdateSettlementUI = function(slot0)
	...
	slot3 = nil
	slot3 = (slot0._gameVo:GetConfig("game_room") <= 0 or getProxy(GameRoomProxy):getRoomScore(slot0._gameVo:GetConfig("game_room"))) and (getProxy(MiniGameProxy):GetHighScore(slot0._gameVo:GetGameId()) and #slot4 > 0 and slot4[1] or 0)
	...
	setText(findTF(slot0.settlementUI, "ad/currentText_1"), slot2)
