slot0 = class("GameRoomHalloweenView", import("..BaseMiniGameView"))
slot1 = 1
slot2 = 2
slot3 = 1
slot4 = 2
...
slot0.initUI = function(slot0)
	...
	onButton(slot0, findTF(slot0.menuUI, "ad/btnStart"), function ()
		setActive(uv0.menuUI, false)
		uv0:openCoinLayer(false)
		uv0:gameReadyStart()
	end, SFX_CANCEL)
	onButton(slot0, findTF(slot0.menuUI, "ad/btnBack"), function ()
		uv0:closeView()
	end, SFX_CANCEL)
	onButton(slot0, findTF(slot0.menuUI, "ad/btnRule"), function ()
...
slot0.gameOver = function(slot0)
	...
	slot0:SendSuccess(slot0.scoreNum)
