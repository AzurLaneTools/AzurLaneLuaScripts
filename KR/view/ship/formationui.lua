...
function slot0.loadAllCharacter(slot0)
	...
	if slot0._currentFleetVO:getFleetType() == FleetType.Normal then
		slot5(slot0._currentFleetVO.vanguardShips, TeamType.Vanguard)
		slot5(slot0._currentFleetVO.mainShips, TeamType.Main)
	elseif slot6 == FleetType.Submarine then
		slot5(slot0._currentFleetVO.subShips, TeamType.Submarine)
	end
