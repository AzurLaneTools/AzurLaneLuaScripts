...
function slot0.InitData(slot0)
	...
	slot0.contextData.autoSkipFlag = NewBattleResultDataExtender.GetAutoSkipFlag(slot0.contextData.system)
	slot0.contextData.needVibrate = NewBattleResultDataExtender.NeedVibrate(slot0.contextData.system)
