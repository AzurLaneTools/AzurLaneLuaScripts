...
slot0.initUITip = function(slot0)
	slot1 = slot0._tf:Find("frame/bg/title_bg/title")

	setText(slot0._tf:Find("frame/buttons/detail_btn/Image"), i18n("meta_tactics_detail"))
	setText(slot0._tf:Find("frame/buttons/unlock_btn/Image"), i18n("meta_tactics_unlock"))
	setText(slot0._tf:Find("frame/buttons/switch_btn/Image"), i18n("meta_tactics_switch"))
end

slot0.initUI = function(slot0)
	slot0.bg = slot0._tf:Find("print")
	slot1 = slot0._tf:Find("frame")
	slot0.skillTpl = slot1:Find("skilltpl")
	slot0.skillContainer = slot1:Find("skill_contain/content")
	slot2 = slot1:Find("buttons")
	slot0.detailBtn = slot2:Find("detail_btn")
	slot0.unlockBtn = slot2:Find("unlock_btn")
	slot0.switchBtn = slot2:Find("switch_btn")
...
slot0.updateSkillTF = function(slot0, slot1, slot2)
	...
	slot4 = slot3:Find("skillInfo")
	slot5 = slot3:Find("empty")
	slot6 = slot3:Find("mask")
	slot9 = slot4:Find("next_contain/label")
	slot10 = slot4:Find("next_contain/Text")
	slot13 = slot3:Find("Tag/learing")
	slot14 = slot3:Find("Tag/unlockable")
	...
	setImageSprite(slot4:Find("icon"), LoadSprite("skillicon/" .. slot16.icon))
	setText(slot4:Find("descView/Viewport/desc"), getSkillDesc(slot2, slot15 > 0 and slot15 or 1))
	setText(slot4:Find("name_contain/name"), getSkillName(slot16.id))
	setText(slot4:Find("name_contain/level_contain/Text"), slot15)
