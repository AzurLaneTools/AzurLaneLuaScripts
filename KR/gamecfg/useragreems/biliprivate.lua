...
版本更新提示：
感谢您下载并使用《碧蓝航线》游戏（以下称“本游戏”或“产品”）。我们依据《中华人民共和国网络安全法》、《信息安全技术个人信息安全规范》（GB/T 35273-2020）以及其他相关法律法规和技术规范更新了本《隐私政策》，其中主要包括如下内容：增加了我们使用您个人信息以及授权权限的场景描述（见第四部分4.2条和4.2条）；更新了《第三方SDK目录》（见第五部分1.5条）；增加查询、更正/修改、删除个人信息的内容（见第八条）；增加《儿童隐私保护政策》（见第九部分4条）。
...
一、引言
1.本《隐私政策》（以下称“本隐私政策”）仅适用于本游戏下的OS端应用程序及安卓端应用程序。
...
（3）访问电话权限：在您使用哔哩哔哩游戏时，为了保障您的游戏账号安全，识别账号异常状态，了解产品适配性，维护基础功能的正常运行，同时也为了营造健康及安全的游戏环境，我们将需要使用您的电话权限。如您拒绝提供上述权限，您也可以随时撤回您的电话权限授权。
...
（5）相机及相册权限：当您使用拍照和上传图片的功能时，您需要授权我们获取您的相机权限、相册权限、照片权限，收集您提供的图片信息，以便您可以使用上传、分享功能。如您拒绝提供上述信息以及权限仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的相机及相册访问权限授权。
...
（7）通讯录权限：当您使用哔哩哔哩游戏中的社交功能，我们会获取您的设备通讯录权限，并收集相关通讯录信息（包括联系人姓名及对应的联系方式、通讯录好友列表），用以提供展示、推荐、邀请好友服务。通讯录信息属于个人敏感信息，请您谨慎考虑是否授权。我们亦会高度对待和谨慎处理您的通讯录信息（包括高强度加密保护）。如您拒绝提供该信息仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的的通讯录权限授权。
（8）蓝牙信息权限：当您在哔哩哔哩游戏中使用语音功能或其他需要开启蓝牙的功能时，您需要授权我们获取及访问蓝牙信息权限。如您拒绝提供该信息仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的蓝牙信息权限授权。
（9）通知权限：当您使用哔哩哔哩游戏中提醒功能时，您需要授权我们获取您的通知权限，用以提供提醒服务。如您拒绝授权仅会使您无法使用该提醒功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的通知权限授权。
（10）日历权限：当您使用哔哩哔哩游戏中预约（如上线预约、活动预约）提醒功能或提示您需要日历权限的功能时，您需要授权我们获取您的的设备日历权限，我们需要收集您的日历信息。如您拒绝提供仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的日历访问权限。
（11）请求使用数据来跟踪用户或设备的权限：当您使用哔哩哔哩游戏产品应用程序时，为了广告归因和数据统计，我们会向您申请使用数据来跟踪用户或设备的权限。若您授权应用程序跟踪您的活动，我们将会访问您设备的广告标识符。若您拒绝授权应用程序跟踪您的活动，我们将无法访问您设备的广告标识符（此前由设备上的“限制广告跟踪”设置控制），但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的跟踪权限授权。
（12）访问应用安装列表权限：当您使用哔哩哔哩游戏产品应用程序时，我们会向您申请访问应用安装列表的权限，用于判断玩家设备是否安装了可能影响游戏平衡的第三方辅助软件，以保障游戏的公平性。若您授权应用程序访问您的应用安装列表，我们将会在您游戏过程中定时访问您设备的应用安装列表。若您拒绝授权应用程序访问您的应用安装列表，我们将无法访问您设备的应用安装列表，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的应用访问权限授权。
（13）读写剪贴板权限：当您在使用哔哩哔哩游戏的过程中，主动复制、粘贴游戏内ID、文字信息时，您的剪贴板功能权限可能会被调用。剪贴板信息仅会在您的设备上进行处理，我们不会存储您的剪贴板信息用于任何其他途径。如您拒绝提供该信息仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的读写剪贴板权限授权。
