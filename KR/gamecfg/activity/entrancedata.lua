return {
	...
	},
	{
		...
		isShow = function ()
			return getProxy(MetaCharacterProxy):getMetaProgressVOByID(970710) and slot1:isInAct()
		end,
		isTip = function ()
			if getProxy(MetaCharacterProxy):getMetaProgressVOByID(970710):isPassType() then
				return false
			end
