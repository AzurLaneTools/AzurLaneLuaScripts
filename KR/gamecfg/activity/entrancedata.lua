return {
	...
	},
	{
		...
		isShow = function ()
			return getProxy(ActivityProxy):getActivityById(20945) and not slot1:isEnd()
		end,
		isTip = function ()
			slot0 = 970401
			slot1 = getProxy(MetaCharacterProxy):getMetaProgressVOByID(970401)
			...
			if slot2 == false then
				slot2 = getProxy(MetaCharacterProxy):getRedTag(970401)
			end
