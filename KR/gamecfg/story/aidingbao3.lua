return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "——서포크, 제가 싱크대도 잘 정리해야 한다고 여러번 강조했을 텐데요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……에. 그럼 서둘러 주세요. 서포크에게 청소에 관해 알려줘야 하니까요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "지휘관님이 에든버러를 비서함으로 삼은 건, 아마 에든버러만의 독특한 가치를 보셨기 때문일 거예요. \"준비 작업\" 같은 게 전혀 아니라.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "네. 아마도——\"에든버러도 에든버러의 능력이 있네\" 같은.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "메이드장도 아무 도움도 되지 않는 사람을 메이드대에 억지로 넣을 수는 없겠죠?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "음…… 이해가 안된다면 이해될 때까지 잘 생각해 보세요. 가죠, 서포크.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
