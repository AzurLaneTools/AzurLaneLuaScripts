return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "괜찮아. 계속 아카기와 이야기 나누느라 시간이 가는 줄도 몰랐거든.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그럼 우리가 마시고 있는 이 꽃차에도 무사시가 직접 만든 꽃잎이 들어있을지 궁금한걸?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "미카사",
			hidePaintObj = true,
			say = "오는 길에 무사시가 대체 어떤 판을 준비했길래 5명의 함선이 필요할까 생각했어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
