return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			dialogueBgAlpha = 0.6,
			say = "안개가 끼었을 때 환상이 그녀를 잠식한 모양이다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			dialogueBgAlpha = 0.6,
			say = "케비르 섬 성당 시설 때와 마찬가지로 리슐리외의 깃발에는 무수한 빛이 모여 있었다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "기도를 올리면 심상이 반영되어 '개념'으로 나타나.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "방금 분명 나는 환상 속에서 기도를 올리고 있었어…….",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "……역시 심판정 성당에는 이런 장치가 공통적으로 되어 있는 건가?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "아니, 성당뿐만 아니라 더 넓은 범위의 '개념'에 의한 공격….",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "그걸 물리적으로 응용한 것이 '묵시록의 네 기사'였다면, 방금 건……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dialogueBgAlpha = 0.6,
			say = "멀리서 울리는 포격의 굉음이 리슐리외의 사고를 중지시켰다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "심판정, 아니... 아이리스의 비적에 대해 언젠가는 꼭 답을 얻고 말겠어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
