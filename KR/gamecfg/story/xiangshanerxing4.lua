return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(이건 내 꿈…? 아니, 시나노나 다른 누군가의 꿈일 가능성도 있어.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――그러고 보니 지중해 때 고맙다는 말도 못했지. 그 때 도와줘서 정말 고마워.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――그리고 '헬레나'가 내게 위해를 가할 사람이 아니라는 건 알고 있으니까.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――남극 대륙에서 의장 연구에 돌파구를 가져다 줄 특수한 광물이 발견되어…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――상층부에서 전력을 파견하여 해당 해역으로 향하고 있다……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――새러토가를 비롯한 함선들도 이 해역으로 향하고 있다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――상층부에서 파견하는 전력은 함선들이 아니야. 공공연하게 간섭하는 건 현명하지 않지만…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――왜 새러토가와 다른 함선들이 그곳으로 향하고 있는지 아무래도 신경이 쓰여.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――나를 포함한 각 진영의 함선들이 아이리스에 모여 있는 이 타이밍에 일을 벌이는 게 도저히 우연으로는 보이지 않아.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――만약 상층부가 이를 손에 넣어 그것을 이용해 '재현'을 다시 반복한다면, '벽람항로' 재결성은 또다시 어려워지고 말 거야.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
