return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "지휘부와 연락이 되는 즉시 지원군을 파견하도록 하지.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "………벽람항로 소속 함대 전원이 즉각 방향을 틀어 아비터와의 접촉을 피했다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707020,
			dir = 1,
			say = "너무 뻔하잖아… 특히 지휘관을 유인한 도발 행동, 빙빙 돌려서 말하는 건 네 스타일이 아니니까.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707020,
			dir = 1,
			say = "짧은 시간이었어도 '지휘관'이 너와 내게 '영향'을 끼쳤어?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "너희들의 초심이 어떠하든지 너희들의 목표가 어떠하든지 상관없어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "나에게 있어 너흰 내 주변의 모든 아름다움과 희망을 망쳐 버린 적이야.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actorName = "아크로열.META",
			dir = 1,
			say = "온 힘을 다한 이 한방을 어디 한번 잘 느껴봐라!",
			effects = {
				{
					active = true,
					name = "speed"
