return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "후훗, 그러니까 아무 걱정할 필요 없다는 거지. 안심하고 휴가를 마음껏 즐겨!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "엔터프라이즈는 좋겠다~ 세이렌을 두들겨 패줄 기회가 많아서~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "뭐, 그런 게 다시 나타나지 않도록 이렇게 매일 순찰하고 있는 거고 말이야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "여기는 로열 네이비 소속 전한 킹 조지 5세. 지휘관, 이글 유니온 함대 여러분, 다들 안녕하신가?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "별말씀을, 지휘관이 유로파로 간다고 하잖는가. 로열 네이비 함대로 이 정도 대접은 당연하지.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "세계박람회가 끝나도 로열 네이비의 파빌리온은 당분간 해체하지 않고 남겨둘 예정이다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "일반인에게 개방은 하지 않지만, 특별히 하인을 위해서 통째로 대절해서 영업할 테니 꼭 보러 오라고…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그리고 폐하는 공무 때문에 폐막식에는 참석이 힘들어, 하인에게 미안하다고 전해달라고 하셨지.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "로열 네이비 파빌리온에 대해서는 일러스트리어스에게 물어보면 된다. 모든 건 그녀가 담당하고 있으니.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			side = 2,
			say = "거울 해역 건으로 개막식에 늦었다고는 들었지만, 폐막식까지 참가하지 못하게 되다니 재앙이나 다름없군.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			side = 2,
			say = "엘리자베스이니만큼 이런 떠들썩한 행사에는 반드시 참가할 거라고 생각했는데…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "물론 굉장히 참가하고 싶어 하셨지. 그걸 위해 여러모로 준비하고 계셨던 만큼 상심도 크신 모양이다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "어쨌든 우리도 지휘관만큼은 박람회를 마음껏 즐겨주었으면 하는 바람이다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "나도 마찬가지야! 지휘관에게 잊지 못할 멋진 휴가가 되었으면 해!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "과하긴 뭘, 지휘관이 제대로 쉬는 게 대체 얼마 만인지 알아?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "혹시 모르니까 내가 행사장까지 꼭 붙어서 호위해 줄까?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "유로파와 남쪽 대륙 해협까지는 워스파이트가, 행사장까지는 일러스트리어스가 안내와 호위를 겸하기로 했으니.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "우리 또한 전력을 다해 지휘관의 안전을 지킬 거고.",
			painting = {
				alpha = 0.3,
				time = 1
			},
