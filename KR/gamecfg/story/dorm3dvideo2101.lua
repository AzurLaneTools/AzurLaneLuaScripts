return {
	...
	scripts = {
		...
		},
		{
			...
			wait = 1,
			say = "아… 이 시간이면 지휘관 업무에 방해되진 않지……?",
			options = {
				{
					content = "나히모프의 목소리가 듣고 싶었으니까 괜찮아",
					flag = 1
				}
			},
			dispatcher = {
		...
		},
		{
			...
			wait = 1,
			say = "그럼 다행이야…… 단말기의 영상 통화 기능을 조정하던 중이었어.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "원래는 나중에 지휘관의 업무에 방해가 안 되는 시간에 걸려고 했는데",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "사실…… 전화하기 전까지 단말기를 어디다 둘지 고민했거든.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "어디에 놓아야 가장 예쁘게 찍힐까…… 연결되면 무슨 얘길 할까……"
		},
		{
			voice = "event:/dorm/dorm3d_nakhimov_telephone9/dorm3d_nakhimov_telephone9",
			wait = 2,
			say = "전에 지휘관이 점검을 부탁했던 설비 이야기라도 할까 했는데",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 2,
			say = "이미 다 고쳤고, 더는 말을 이어 나갈 만한 건덕지가 없더라.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "그럼 차라리 아직 모르는 게 있는 척을 하면…… 조금은 더 길게 얘기할 수 있지 않을까 했어……",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "대화 내용 말고도…… 어떤 자세로, 어떤 표정으로 말해야 할까……라든가……",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "윽…… 생각했던 것보다 어렵네. 묘하게 긴장되기도 하고.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 2,
			say = "화면 너머인데 직접 마주 보고 있을 때보다…… 더 두근거려.",
			options = {
				{
					content = "그렇게 수줍어하는 모습도 귀여워",
					flag = 1
				}
			},
			dispatcher = {
		...
		},
		{
			...
			wait = 0.5,
			say = "그, 그래?…… 그럼 다음부터는 준비 같은 거 안 할게.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
