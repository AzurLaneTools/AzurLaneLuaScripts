return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――이렇게 온천을 즐길 수 있는 건 다 TB 덕분이야",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_172",
			hidePaintObj = true,
			say = "바로 한번에 온천 여행에 당첨되다니, TB는 천운을 타고난 것 같다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_172",
			hidePaintObj = true,
			say = "…그런데 갑자기 그 부드러운 미소가 갑자기 당황한 표정으로 바뀌고 말았다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_172",
			hidePaintObj = true,
			say = "그 후 아무일도 없었던 것처럼 TB와 느긋하게 휴일을 보냈다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
