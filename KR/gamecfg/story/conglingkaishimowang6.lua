return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "왕궁도 지금 엉망진창이 된 상황이라, 다행히 여기까지는 안 쫓아오네.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "얼리 액세스 특전 임무인 거 아니야?",
					flag = 1
				},
				{
					content = "고작 동전 10개로 마왕을 토벌시킬 순 없잖아?",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			options = {
				{
					content = "1000살 먹은 엘프라던가…?",
					flag = 1
				},
				{
					content = "수해 안쪽은 위험하지 않아…?",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "괜찮아! 아무래도 밖보다는 위험하겠지만, 마물이래봤자 만쥬 슬라임 정도일걸! 충분해!",
			painting = {
				alpha = 0.3,
				time = 1
			},
