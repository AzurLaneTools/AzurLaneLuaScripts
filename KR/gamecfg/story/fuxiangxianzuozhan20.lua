return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "결론부터 말하면 우리도, 하인리히도 체스말이 아니야. 다 속은 거라고.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "다음 계획...? 잠시만, 하인리히. 페터가 무슨 명령을 내렸지?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "이상한 메탈 블러드와 사쿠라 엠파이어 함대를 한쪽으로 몰고 다음 지시를 기다리라고 했어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "오? 그런가... 하지만 그렇다면... 하인리히! 일단 페터와 연락하는 건 그만둬.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "다들 계속 움직이자~ 뉘른베르크가 선봉에서고 하인리히는 뒤에 있어. 계속 추격하는 척하면서 사쿠라 엠파이어 함대 쪽으로 가보자!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
