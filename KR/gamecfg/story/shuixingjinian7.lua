return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "그럼 우선 길가의 벤치에 앉아서 좀 쉴까?",
					flag = 1
				},
				{
					content = "일단 항구로 돌아가는 게 좋겠어.",
					flag = 2
				}
			}
		},
		{
			...
			hidePaintObj = true,
			optionFlag = 1,
			say = "파먀티와 함께 길가의 벤치에 앉았고 그녀는 습관적으로 어깨에 머리를 기댔다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "평소에 날 그렇게 부려먹더니, 쉬는 날엔 이렇게 몇 배로 돌려줄 거라구.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "앞으로도… 이렇게 계속 지휘관 곁에 있는 걸 한번 고민해볼 수도 있다구.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "오늘 나 때문에 고생도 많이 한 것 같아서 상이라도 주려고 했더니만 말이야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "됐다. 이런 상황을 대비해서 다른 시나리오도 생각해뒀지.",
			painting = {
				alpha = 0.3,
				time = 1
			},
