return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 9707020,
			dir = 1,
			say = "지휘관은 계략에 능한 세이렌과 달리 중요한 때에 예상치 못한 결정을 내렸네.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "다만… 우리가 남는다고 해도 전세가 악화되는 걸 막을 순 없을 거야. 지원군이 오기를 기다리기 위해 조금만 버텨줘.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
