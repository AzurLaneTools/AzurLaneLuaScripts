return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "네가 아직까지 살아있다는 게 오히려 더 신기한데….",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "제 생명 유지 스킬 '가구라 춤'이 있어서 살 수 있었던 거죠! 아니였으면 순식간에 퇴장 당했을 거라구요!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "방금 그건 어떤 상황이에요? 왜 갑자기 세 명이나 사라진 거죠!?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "잘 알지도 못하는 상황에서 무작정 제 뒤를 쫓은 결과죠, 후후후~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 301040,
			nameColor = "#A9F548FF",
			say = "아카기님, 정말 죄송해요. 근처는 전부 다른 선수들의 통제 구역이 있는 탓에 아직 돌아갈 수 없을 것 같습니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "대형을 재정비한다면… 이번 라운드는 다른 거점을 공격하지 않는 건가요?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "싫어요, 싫어. 역시 모두 회복 시간을 갖는 편이 좋겠어요. 회복한 뒤에 다시 공격하는 걸로 해요!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "후후후, 그럼 이 일은 당신에게 맡기도록 하죠, 류호.",
			painting = {
				alpha = 0.3,
				time = 1
			},
