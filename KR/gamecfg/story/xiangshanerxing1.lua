return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actor = 601060,
			say = "오오… 대단해! 비품도 깔끔하게 테이블에 놓여 있어!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 601060,
			say = "음… 그러고 보니… 굉장히 신경 쓰이는 게 있는데 말이야…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 601060,
			say = "사르데냐 엠파이어에서 발안하고 주최하는 진영 대회인데, 왜 개최지는 아이리스인 거지?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 601060,
			say = "사르데냐 엠파이어에서 하면 식재료 조달도 어렵지 않을 텐데.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "듣던 중 반가운 소리네. 최악의 경우에는 비행기로 식재료를 조달할 생각까지 했었으니까 말이야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그나저나 베네토, 내일 진영 대회의 주최자 인사 원고는 준비 됐어?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "맞아요… 진영 대회 개회식에서 인사를 하기로 했었죠…",
			painting = {
				alpha = 0.3,
				time = 1
			},
