return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "미성년자는 음주 금지야!",
					flag = 1
				},
				{
					content = "술을 마시면 사고에 지장을 줄 수 있으니, 역시 마시지 않는 게 좋겠어.",
					flag = 2
				},
				{
					content = "그럼 한 잔 할까.",
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "사실 나도 장난친 거야. '술'이라고 말했지만 사실은 특별히 제조된 맥아맛 음료라고.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "걱정하지마, '술'이라고 말했지만 사실은 특별히 제조된 맥아맛 음료일 뿐이니까.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "'술'이라고 말했지만 사실은 특별히 제조된 맥아맛 음료야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "만약 괜찮다면, 에기르와 함께 비를 맞을게.",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "달빛...? 이렇게 짙은 먹구름에 대체 달빛이 어딨다는 거야…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "서, 설마 또 사쿠라 엠파이어의 무슨 고전같은 거야!?",
			painting = {
				alpha = 0.3,
				time = 1
			},
