return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			oldPhoto = true,
			say = "책더미에 숨어 기쁜 듯한 목소리로 말하는 여자가 한 명 보였다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "뭐, 그렇지만 뭐라도 손을 써둬야 한다는 건 사실이지.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "\"언어를 하나로 이룬 자들은 성읍과 탑을 건설하였고, 이는 하늘마저 넘으려 했나니\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "후후후, 내게 협력해 준 은혜는 절대 잊지 않을게.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dialogueBgAlpha = 0.6,
			say = "빛을 발하고는 있지만 열은 느껴지지 않는, 마치 속이 텅빈 검은 동굴과도 같은…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
