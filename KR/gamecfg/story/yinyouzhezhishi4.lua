return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "마왕만 무찌르면 이 마을을 버리고 도망치지 않아도 되잖아!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "맞아! 모험하면서 실력을 갈고 닦으면 더 많은 사람을 구할 수 있을 거야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "끝나지 않는 윤회는 우리 손으로 직접 끊을 거예요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "괜찮아? 이걸 우리한테 주면… 노래 부를 때 불편하잖아.",
			painting = {
				alpha = 0.3,
				time = 1
			},
