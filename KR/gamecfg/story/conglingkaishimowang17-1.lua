return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "폐허가 됐지만 불길은 미치지 않아, 다행히 거리의 구조는 크게 변하지 않았어요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…이상하군요. 자이틀리츠, 언데드가 하나도 보이지 않아요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600030,
			nameColor = "#A9F548FF",
			say = "후후후, 무슨 일이야? 왕성 폐허에서 보물이라도 찾으려고~?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600040,
			nameColor = "#FF9B93",
			say = "도적단이라니 무례하긴! 우리는 어엿한 해적들이라고!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600040,
			nameColor = "#FF9B93",
			say = "후후, 이젠 처음이 아니지! …아니, 이게 아니라! 윽… 이야기까 딴 데로 셀 뻔했군…",
			painting = {
				alpha = 0.3,
				time = 1
			},
