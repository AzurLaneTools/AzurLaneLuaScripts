return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "그래서 이 문은 저와 호무라 씨, 아카츠키 씨와 리노 씨가 맡게 되었습니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "그렇지만 세이렌을 상대하게 되면 저희의 시노비 기술이 어디까지 통할지 모릅니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "게다가 의장을 다루는 데 있어서도 저희는 이제 막 익숙해졌을 뿐으로 아직 미숙합니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "그래서 아무래도 아카츠키 씨나 리노 씨께 도움을 많이 받을 것 같습니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_kagura_2",
			nameColor = "#A9F548FF",
			say = "분명 여러모로 폐를 끼치게 되겠지만, 모쪼록 잘 부탁드립니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "인술 교실을 여는 것도 재밌을 것 같네요. 뭐, 그것도 이 사태가 전부 끝난 후가 되겠지만 말이죠.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actor = 11000020,
			say = "지금은 후부키 씨를 구출하는 데 전력을 쏟자구요!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
