return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――그나저나 아카시 말로는 곧 TB를 만날 수 있다던데…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			optionFlag = 1,
			say = "하지만 어디를 둘러봐도 어질러진 곳 하나 없이 잘 정리 정돈되어 있어, 치울 필요는 전혀 없었다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
