return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…이곳이 바로 옛 전장을 그대로 재현한 가상 세계...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "...둘째, 허가가 나기 전까지 무선 침묵 상태를 유지하며 발포도 금지한다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "강제로 튕겨져 나간다고? 위험하게 들리는데... 우리 부서였다면 훈련 사고로 처리될 문제야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "저희 쪽에서도 흔한 상황은 아니에요... 이번 작전이 예외적이라고 볼 수 있어요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "이 미소녀의 레이더에 뭔가 안 좋은 예감이 느껴져...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "이곳은 컴퓨터가 만들어낸 가상 세계일뿐, 현실이 아니니 절대 현혹되서는 안 돼요!",
			painting = {
				alpha = 0.3,
				time = 1
			},
