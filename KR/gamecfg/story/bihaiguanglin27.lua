return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "우리가 소란을 피워서... 자리를 비운 걸 수도 있어요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "여러분, 결계 안에 있는 사람이 깨어난 것 같아요...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
