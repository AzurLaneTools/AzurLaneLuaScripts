return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "하지만 크리스마스 장식은 아직이었죠… 지금 당장 쇼핑하러 가요!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_151",
			hidePaintObj = true,
			say = "내가 미처 대답하기도 전에 TB는 내 손을 잡고 밖으로 끌어냈다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_151",
			hidePaintObj = true,
			say = "집으로 들어서자마자 나는 기진맥진한 채로 그대로 소파에 쓰러지고 말았다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "star_level_bg_151",
			hidePaintObj = true,
			say = "한편 TB는 어디서 그런 기운이 솟아나는지 쉬지도 않고 어느새 온 집안을 척척 꾸미기 시작했다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "전혀요? 그러니까 말했잖아요. 이게 다 평소에 운동을 안 해서 그런 거라고~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_151",
			hidePaintObj = true,
			say = "그렇게 말하고 TB는 바람처럼 또 다른 방 안으로 사라졌다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_151",
			hidePaintObj = true,
			say = "잠이 덜 깬 상태로 멍하니 있는데 문득 TB의 목소리가 귓가에 들려왔다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "헤헷, 어때요? 크리스마스 느낌 물씬 나죠? 괜찮지 않아요?",
		...
		},
		{
			...
			bgName = "bg_project_tb_cg19",
			hidePaintObj = true,
			say = "TB는 예쁘게 포장된 작은 상자를 내게 내밀었다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "여러 준비를 하는 것만으로 용돈을 거의 써버려서… 이것밖에 못 샀어요.",
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "그렇지만 열심히 골랐다구요! 싸다고 마음이 안 담겨있는 건 아니니까요!",
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――그래, 고마워. 산타 TB가 선물한 거니까 소중하게 간직할게.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
