return {
	...
	scripts = {
		...
		},
		{
			...
			factiontag = "지휘관",
			nameColor = "#A9F548FF",
			say = "――어쩔 수 없겠어. 쓸 수 있는 아이템은 아끼지 않고 다 쓰자.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
