return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "으으, 주인님이랑 기념 사진 찍고 싶어! 찍고 싶지만…!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "유니콘은 견습 프리스트니까 저기 가면 새로운 스킬을 배워서 더 강해질지도 몰라…!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "응? 그러고 보니 나도 프리스트였지. 나도 배울 수 있겠다!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "지휘관",
			nameColor = "#A9F548FF",
			say = "(신전, 상업 지구, 장인들의 거주 지역에 모험가 길드까지…)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "후후후. 어서 오렴~ 모험가들. 왕성엔 다들 처음 온 거니?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그걸 통과하려면 우선 왕성에서 지정한 구역으로 가서 등록해야 해~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "어머, 내 정신 좀 봐. 자기소개를 잊고 있었네. 난 프리드리히 카를… 강철 교회에 소속된 정비사란다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――그럼 우선 왕을 알현하러 가보자. 안내 좀 부탁할게.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "마왕을 토벌하고자 하는 그 마음가짐과 각오… 존경스럽군.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "음? 무슨 일이냐, 충성스러운 프리스트여. 사양 말고 말해보아라.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "하지만 며칠 전, 우리 궁중 마법사가 그 마법을 순간적으로 깨뜨리는 데 성공하여, 잠시나마 그 모습을 볼 수 있었지.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 201360,
			nameColor = "#A9F548FF",
			say = "후훗, 잘들 보라구. 이게 왕국 궁정 마법의 지혜의 결정체인 '스냅샷'이라는 거야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "지휘관",
			nameColor = "#A9F548FF",
			say = "(여기서 '정보 분석'을 사용해서 마왕의 특수 능력을 알아 두면, 다음에 만날 때 조금이나마 유리하겠지…)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "이게 무슨…… '스냅샷'의 안정성이 떨어지고 있다! 무슨 일이 생긴 거지?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "지휘관",
			nameColor = "#A9F548FF",
			say = "――다들 다친 데는 없는 것 같아 정말 다행이야. 왕성 위병의 보호 덕분에 무사한 것 같아.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
