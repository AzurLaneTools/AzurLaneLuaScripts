return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "지금은 그렇게 비탄에 잠겨 있을 때가 아니에요, 베네토 님.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			hidePaintObj = true,
			say = "케르생, 지금 바로 비시아 성좌의 모든 함선을 박람회 행사장에서 내보내줘.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(그 드로이드를 마르코 폴로가 부른 거라면… 비시아 성좌, 아니 왜 심판정이……)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "알겠습니다. 아무것도 하지 않고 현 상황을 유지하는 것보다는 변화로써 상황을 타개하는 편이 낫겠지요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "지휘관님처럼 저도 비시아 성좌는 우리의 아군이라고 믿고 싶으니까요.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
