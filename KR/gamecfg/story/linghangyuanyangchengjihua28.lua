	...
	scripts = {
		{
			...
			hidePaintObj = true,
			say = "상점가의 추첨 행사에서 온천 여행에 당첨되었다. 마침 쌀쌀해지는 시기였기도 해서 바로 TB와 온천에 왔다.",
			bgm = "qe-ova-9",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "통째로 빌린 거고, 뜨거운 물을 뿌리면 안 된다는 규칙은 어디에도 없잖아요?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_172",
			hidePaintObj = true,
			say = "기대감으로 눈을 반짝이는 TB를 보자 나도 모르게 머리가 아파왔다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_172",
			hidePaintObj = true,
			say = "어쩌다가 이런 말괄량이가 되었는지… 아무리 생각해도 짐작조차 가질 않는다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_172",
			hidePaintObj = true,
			say = "슬슬 눈싸움 아닌 물싸움에 응전하려던 참이었는데, 아무래도 TB는 다른 무언가에 정신을 빼앗긴 모양이다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
