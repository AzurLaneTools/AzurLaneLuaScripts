return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_115",
			hidePaintObj = true,
			say = "마지막으로 옷매무새를 다듬고, TB가 기다리고 있는 곳으로 향했다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "이 드레스 어때요? 진짜 예쁘죠? 우아하죠? 센스가 넘치죠?!",
		...
		},
		{
			...
			bgName = "bg_project_tb_cg25",
			hidePaintObj = true,
			say = "TB는 날 보자마자 한 바퀴 빙그르르 돌며 자신의 모습을 자랑했다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "그래도 TB를 오래 기다리게 했으니까, 그만큼 오랫동안 같이 춤 춰주셔야 해요!",
		...
		},
		{
			...
			bgName = "bg_project_tb_cg25",
			hidePaintObj = true,
			say = "미처 대답하기도 전에 TB는 내 손을 잡고 회장쪽을 향해 달리기 시작했다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_project_tb_cg25",
			hidePaintObj = true,
			say = "입 바로 앞까지 올라온 \"졸업 축하해\"라는 말은 그녀의 환한 웃음소리에 지워지고 말았다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
