return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "좋아! {namecode:175}, 그쪽은 문제없냐는 거다!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "뭐, 어차피 이런 거리에서 난전이 벌어지면 누가 무슨 일을 하던 들키지 않을 테니 나로서는 편한 셈인가——",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "들으셨나요, {namecode:97}! 기함의 권한을 전부 넘기겠습니다! 우리 측 포격이 끝난 뒤, 모든 폭격기를 이쪽으로 보내세요!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "{namecode:175}! 너! 설마 혼자서 지휘관의 주력 함대 쪽으로 돌진하려는 생각이냐?!?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
