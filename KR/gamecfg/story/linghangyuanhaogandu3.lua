return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_project_tb_room1",
			hidePaintObj = true,
			say = "요즘 TB는 이야기에 관심을 가지기 시작한 모양이다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_project_tb_room1",
			hidePaintObj = true,
			say = "평소에는 자기 전에만 이야기를 읽어주고는 했는데……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_project_tb_room1",
			hidePaintObj = true,
			say = "최근에 자주 읽어주는 그림책을 몇 권 가지고 왔지만, TB는 큰 관심을 보이지 않았다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "(그럼, TB를 주인공으로 하는 이야기를 즉흥적으로 만들어 보자.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "(그래. TB가 '개성'을 찾아다니는 걸 이야기로 만들어서 들려주자.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "bg_project_tb_room1",
			hidePaintObj = true,
			say = "이야기가 진행됨에 따라 TB도 점차 꿈나라로 빠져들기 시작했다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
