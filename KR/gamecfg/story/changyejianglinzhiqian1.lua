return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "'카멜로의 정원'의 전송 장치를 통한 게 아니라, 거울 해역 속에서 갑자기 나타난 것 같아요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "리펄스, 적의 침입 경로는 '문' 말고는 없는 거 맞죠?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "역시 적이 어떻게 침입한 건지 알아내지 않으면 언젠가는 시설과 장비 모두 위험한 상황에 빠지고 말 거예요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "침입한 적은 아직 위협적이지 않지만, 그 침입 경로와 목적을 아직 파악하지 못한 상태입니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "적의 겉모습과 움직임을 봐서는… '본험 리차드'를 본뜬 적의 첨병일 가능성이 있습니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
