return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…뭐랄까, 온천 마을이 통째로 다른 마을로 변해버린 것 같은…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "노시로 씨, 잠깐만요. 다들 떨어져서 행동하는 것보다는 함께 행동하는 편이 좋을 것 같아요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "유라… 내가 잘못 본 거야? 아니면 새로운 마술 같은 걸까?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "음… 이거 혹시 폴터가이스트? 아니면 심령 현상인가?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 302070,
			nameColor = "#A9F548FF",
			say = "실체화할 수 없을 정도로 약해진 탓에 보이지 않는 모양이에요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
