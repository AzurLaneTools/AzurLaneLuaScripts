return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "star_level_bg_704",
			hidePaintObj = true,
			say = "그나저나 이런 모습의 TB를 보고 있자니, 아무래도 조금 현실과 동떨어진 느낌이 든다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "간식이랑 음료를 가지고 왔으니까 언제든 말씀하세요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_704",
			voice = "event:/educate/tb/educate-tb-31-doubt3",
			dir = 1,
			tbActor = true,
			actor = 1100,
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "아, 맞다. 먼저 타고 싶은 놀이기구 같은 거 있으세요?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――오늘은 TB가 즐겁게 놀라고 데리고 온 거니까, 신경 써 줄 필요 없어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_704",
			voice = "event:/educate/tb/educate-tb-31-answer1",
			dir = 1,
			tbActor = true,
			actor = 1100,
			nameColor = "#A9F548FF",
		...
		},
		{
			...
			side = 2,
			bgName = "star_level_bg_704",
			voice = "event:/educate/tb/educate-tb-31-shock2",
			dir = 1,
			tbActor = true,
			actor = 1100,
			nameColor = "#A9F548FF",
		...
		},
		{
			...
			bgName = "star_level_bg_704",
			hidePaintObj = true,
			say = "자기 입으로 \"회전목마를 타고 싶다\"고 말하다니, 모항의 TB에게는 상상도 할 수 없는 일이다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
