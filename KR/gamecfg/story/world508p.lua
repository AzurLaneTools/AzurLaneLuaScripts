return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "특이점 내에서 이런 규모의 폭발을 견디는 것은 우리에게도 엄청난 피해야. 반대로 폭발을 일으키는 쪽은 더 큰 피해를 받게 되겠지. 적어도 잔불는 여기서 끝이다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			dir = 1,
			say = "아크로열은 여전히 차가운 태도를 유지하며 고개를 돌리지 않고 떠났다. 하지만 잔불의 히류는——",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			dir = 1,
			say = "잔불의 히류는 태연한 표정으로 말했지만, 바로 서지 못한 채 갑자기 휘청 거리며 부딪혀 왔다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
