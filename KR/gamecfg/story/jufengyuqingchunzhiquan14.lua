return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "게다가 '푸른 늑대단' 깃발까지… 그 트레저 헌터의 깃발을 완전히 자기들 것인 양 내걸고 있군.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "저 함대의 항행 방향은… 이거, 위험한걸~ 신세계의 항구를 노리고 있는 것 같네.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "야간 항행에 대응할 수 있는 시설이 부족해서, 아침까지는 원군을 기대하기 힘들 거야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그러니까 이대로 공격당하면 하룻밤도 채 버티지 못한다고 봐야겠지.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "항구에서 멀리 끌어내는 것 정도라면 가능하겠지만, 우리 힘만으로 물리치기는 어려울 거야~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "원군이 필요해. 지휘관님, 우리가 적을 유인하는 동안 좀 해줬으면 하는 게 있는데――",
			painting = {
				alpha = 0.3,
				time = 1
			},
