return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "하늘을 나는 이 강철 독수리는 사르데냐 엠파이어의 적이 아닙니다!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "안 들리나 봅니다… 휴우… 지휘관님, 죄송합니다. 나중에 다시 연락드릴게요!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "'신'이 만들어 낸 소형의 적은 선봉 함대가 이미 섬멸했어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "작전대로 선봉 함대가 거짓된 '신'에게 공격을 가했어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "후속 전력이 공격 위치에 도달했어. 지휘관, 지시를 내려줘.",
			painting = {
				alpha = 0.3,
				time = 1
			},
