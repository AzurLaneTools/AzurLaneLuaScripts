return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "탑이 보이지 않는 건 스승님이 마법으로 숨겨둬서 그래~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "스승님은 방해 받지 않고 조용히 사는 걸 좋아하니까.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "지혜의 마녀, 아르한겔스크 스승님~ 당신의 제자, 약사 누비안이 왔어!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "후후후, 걱정 마! 저건 어디까지나 스승님의 취향일 뿐! 마왕군이랑은 일절 관련 없어!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "무슨 그런 바보 같은 말을… 지혜의 마녀니까 뭐든 알고 있는 게 당연하지!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 705062,
			nameColor = "#FEF15E",
			say = "이렇게 하지. 사실 내게 도움을 줄 수 있는 사람이 너희 파티에 섞여 있어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 705062,
			nameColor = "#FEF15E",
			say = "그렇지? 여기서는 다양한 지식과 마법을 배울 수 있고, 이 세상의 비밀까지 알 수 있어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "백년 후에 스승님이 내는 초급 시험을 돌파해야 겨우 나올 수 있어!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 705062,
			nameColor = "#FEF15E",
			say = "그렇군… 억지를 부릴 순 없겠네. 그럼 자신의 가치를 증명할 수 있는 기회를 줄게.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 705062,
			nameColor = "#FEF15E",
			say = "하지만 너희 지휘관이 가진 '정보 분석' 스킬의 힘이라면 어떤 퀴즈든 쉽게 풀 수 있을 테니… 의미가 없겠지.",
			painting = {
				alpha = 0.3,
				time = 1
			},
