return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(벌써 세 번째 실험인데 아직도 \"μ장비\"는 수수께끼투성이다. 아직 생각만큼 실태를 파악하지 못하고 있다는 거겠지…)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "――모두를 기쁘게 해주는 일이지만, 조금 머리가 아파오네…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(차례가 정해질 때까지는… 오늘 업무를 조금 더 처리할 수 있겠지.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			layout = {
				...
				},
				{
					3,
					{
						"(μ장비)장비 실험 테스트 특설 제1항공함대",
						"(μ장비)장비 실험 테스트 특설 제2항공함대",
						"(μ장비)장비 실험 테스트 특설 제3항공함대",
						"(μ장비)장비 실험 테스트 특설 제4항공함대",
						"(μ장비)장비 실험 테스트 특설 제5항공함대",
						"(μ장비)장비 실험 테스트 특설 제6항공함대",
						"(μ장비)장비 실험 테스트 특설 제7항공함대"
					},
					1,
					"#FFFFFF"
				},
