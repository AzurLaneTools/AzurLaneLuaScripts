return {
	...
	scripts = {
		...
		},
		{
			...
			factiontag = "질서와 규칙의 신",
			actor = 900284,
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "1회용 긴급 연락 아이템 사용을 확인했습니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "용사 의상 최종 결정안이 제출되지 않았습니다. 또한, TB에게는 자주적으로 이를 판단할 권한이 없습니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "게임의 정상적인 진행을 우선적으로 고려하여 기본 의상 소스를 사용했습니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "음… 견습 프리스트의 클래스 설명에 \"이제 막 신성 마법을 배우기 시작한, 강력한 힘을 가진 마법사. 예전에 사용한 마법도 일부 사용 가능하다\"고 적혀 있더라…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그래서 유니콘, 소환 마법도 쓸 수 있어… 이러면 유우랑도 같이 모험할 수 있잖아?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "파티의 지휘관이라면, 주인님이랑 합류하는 임무 아니야?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
