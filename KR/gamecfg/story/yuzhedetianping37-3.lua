return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "무슨 말을 하는 건지는 모르겠지만, 지휘관을 데려가면 곤란한데.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "현실에서 대개념 무기를 방어하기 위해, 막대한 에너지를 써서 강제로 다른 '개념' 공간에 정신을 접속시킨다…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "사용법에 따라서는 방어가 아니라, 상대방의 정신에도 영향을 줄 수 있다…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "(이건 아비터와 똑같은 기술인데… 그리고 이 공간이 다른 곳과 연결되어 있지 않을 거라는 보장은…)",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dialogueBgAlpha = 0.6,
			say = "이 꿈의 정체는 정신의 이공간…이라고 이해하면 되는 걸까요?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "둘 다 아니야. 그 홀장… 그리고 '개념'을 인식하고 지배할 수 있는 특성……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "저 공격은 빈틈도 크고, 사거리도 짧을 거야… 지휘관! 양산함으로 주의를 끌면서, 특별 계획함 위주로 다시 편성을 짜줘!",
			painting = {
				alpha = 0.3,
				time = 1
			},
