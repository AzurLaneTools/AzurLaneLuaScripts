return {
	...
	scripts = {
		...
		},
		{
			...
			wait = 1,
			say = "너무 늦어서 하늘에 있는 별이란 별은 다 세어버렸잖아.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "너무 안 받길래, 직접 가서 묶어서 끌고 올까도 생각했는데……",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "내가 모처럼 먼저 연락했는데… 할 말이 그렇게도 없어?",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "……먼저 시작한 건 난데, 결국은 내가 두근거리고 있잖아.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 0.5,
			say = "……웃지 마! 방금 느낀 설레임이… 조금 신선해서 그런 것뿐이야…",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
