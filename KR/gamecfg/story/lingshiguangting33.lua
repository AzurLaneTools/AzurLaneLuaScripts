return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "지금 난 처음으로 로열의 기사로서 로열을 위해 싸우고 있어…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "하핫, 좋아. 하지만 우선 우릴 방해하는 이 적들을 모두 없애버려야겠군~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "이제 상황이 많이 좋아진 것 같으니, 나가서 그녈 없애는 건 어떨까요?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "엷은 안개와 맑은 구름, 밝은 달이 하늘 높이 떠 있다. 도시의 야경은 이전과 같은 평화를 되찾았다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
