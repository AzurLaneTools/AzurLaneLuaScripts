return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "무슨 소릴! 이번엔 카페의 쾌적함을 고려해서 소음을 억제하는 방향으로 설계할 거라구!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "지휘관, 불쌍하게도… 내 '딱딱 어깨 주무르기 머신' 때문에 트라우마가 생긴 건가….",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "당연하지. 아무리 나라도 멋대로 일을 벌일 순 없으니까.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…………뭐, 사람에 따라서는 안 물어보는 편이 나을 때도 있지만.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "'자동 발열 따끈따끈 수영복'이 무사히 완성되면 같이 입고 수영하러 가자!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "헉, 맞아! 감전될 위험이...! 주변 사람까지 위험하겠네….",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "으음… 역시 화학 반응으로 열을 내는 편이 좋겠어….",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "훗훗! 지휘관 맘에 들면 집무실 칠판에도 붙여 줄게!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그 칠판은 신형 모니터가 생긴 다음부턴 쓴 적이 없는 것 같기는 하지만…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "훗… 그야 의도치 않게 칠판에 쓴 모든 게 다 사라지겠지!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…그런 일이 발생하지 않도록 2단계 확인 장치를 추가해 둘게.",
			painting = {
				alpha = 0.3,
				time = 1
			},
