return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "지휘관 여기 앉아서 좀 쉬어, 내가 홍차 따라 줄게.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "지휘관이 폐하한테 이미 들었다면 잘 됐네. 사실 이 로열 대표가 바로 나야.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "——이 편지를 읽고 있다면, 체이서의 얘기를 이미 들었겠지? 간단히 말해서, 이번 교류의 목적은 바로 서로의 이해 강화야.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "솔직히 말해서, 그렇게 엄중한 일도 아니고, 단지 각 진영이 서로 참관하는 것 같은 느낌이겠지.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "체이서는 입을 막으면서 눈을 동그랗게 뜨고 투덜거렸다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
