return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "왜 산호해에서 회수된 데이터 블록이 왕관 주변 해역의 정보를 기록했을까…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "컨스텔레이션, 큰일났어요. 네비게이터의 안내가 연결되지 않아 통제실과 연락이 두절된 상황이에요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "잠깐... 지난번 지휘관이 앵커리지의 작전을 조사하던 중에도...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "왕관을 활성화하려는 시도가 실패하자 그녀는 이곳을 포기했고,",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "설마... 그동안 우리가 알고 있던 기록이 잘못된 건가요?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "정상적으로 작동하는 극지의 특이점을 세이렌이 몇 해동안 통제해왔다는 소리인데...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "아니야, 진정해, 아닐 거야... 특이점의 작동 에너지는 숨길 수 없잖아?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그리고… 네비게이터가 이전에 언급했던 연대가 일치하지 않는 데이터는 또 어떻게 생겨난 건지...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "경고: 리얼리티 렌즈에서 악성 데이터가 나타났습니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "경고: 보호 시스템이 마운트 임계값에 도달하여 악성 데이터가 유출될 위험이 있습니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "네비게이터... 이게 무슨 상황이지...? 뭘 어떻게 해야 하는 거야!?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "앵커리지, 별의 바다의 심장 시스템이 악성 프로그램의 공격을 받았습니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "하지만 내부에서 빠른 속도로 침입이 일어나고 있기 때문에 기존 방어 시스템이 곧 붕괴될 예정입니다. 즉시 위기 대응 모드로 전환이 필요합니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "...당신의 오른손 바로 아래에 위치한 패널에 빨간색 프레임의 유리를 깨뜨린 후 가장 큰 버튼을 눌러주세요.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "확인 완료: 지금부터 비상 지령이 시행되어 시스템 전체가 위기 대응 모드로 전환되고 있습니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
