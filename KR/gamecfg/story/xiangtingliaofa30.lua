return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "…너흰 대체 뭐지, 대체 뭘 하려는 거냐, 왜 뉴욕항을 습격했지!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "공격을 멈춰, 어서 공격을 멈춰!",
					flag = 1
				},
				{
					content = "잘했어, 그녀에게 숨돌릴 틈을 주지 마",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "특이점이란 거…이렇게 쉽게 닫을 수 있는 그런 거였어?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "으, 어쨌건간에 끝나긴 했다…순간, 진짜로 \"이번엔 끝장이야\"란 느낌 들었다구!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "다들 집중~! 버뮤다 삼각지대에 출현한 \"특이점\"은 이미 성공적으로 닫혔어! (우리가 한 건 아니지만)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "그렇단 건 목표 달성했단 얘기, 다들 당당히 돌아갈 수 있단 소리지~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "(....그런 강적이 있다니, 언젠가는…난 더 강해져야 해!)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
