return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "디테일한 것에서는 차이가 좀 있지만, 그래도 나는 오딘이 우리와 같은 「함선」이라고 생각해.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "정보 수집은 확실하네~ 맞아. 오딘은 계획함이라고 불리는 함선이야.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "자자~ 적은 해치웠지만 기관은 아직 움직이고 있어. 계속 뒀다간 적이 다시 나올지도 모른다고.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
