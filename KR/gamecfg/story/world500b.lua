return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "이번 작전이 시작된 이후 지금까지 전투는 순조롭게 진행되고 있어. 세이렌도, 새로 나타난 애쉬도, 우리는 모두 연거푸 승리하고 있지.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "즐겁다라… 분명 매번 애쉬 쪽에서 싸움을 회피해서 우리가 무사히 돌아올 수 있는 거 아니었어?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 102160,
			dir = 1,
			say = "애쉬의 실력과 위압감은… 아무리 들어도 직접 경험해 보지 않으면 실감 나지 않을 테니까.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
