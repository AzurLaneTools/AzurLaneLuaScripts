return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "각 함대 예정 지역 집결 완료. 작전 시간은 채 10분도 남지 않았네.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "따라서 이번에는 속전속결이 아니라 차근차근 해역 청소를 진행하게 될 것이다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "양측의 실력 차이에 따라 지휘부에선 동시다발적인 압박을 가할 것을 결정했어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "양동 작전 없이… 6개의 전초전에서 출발한 함대는 모두 공격 임무를 수행하라니. 지휘부는 정말 오버해…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "물론 배치상으로는 우리 쪽 함대의 규모도 주공(主攻) 방향에 있었어. 제일 큰 게..",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "세이렌의 방어종심을 파악하기 전까진 차분하게 움직이자.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "절대적인 실력으로 세이렌이 마지막으로 지키고 있는 외딴섬을 부숴버리자~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			paintingNoise = true,
			dir = 1,
			say = "마침내 NA 해역의 사이렌이 혼돈에 빠졌고, 폭풍으로부터 보호받는 핵심 해역에 남은 함대를 배치해 험준한 지형에 의지하여 완강하게 저항하고 있습니다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
