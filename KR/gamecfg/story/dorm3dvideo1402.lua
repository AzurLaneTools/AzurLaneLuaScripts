return {
	...
	scripts = {
		...
		},
		{
			...
			wait = 1,
			say = "……설마 계속 응답 버튼에 손가락이라도 올려두고 있었던 거야?",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "솔직하게 말해 봐. 내 전화가 오기만을 히죽히죽 웃으면서 기다렸지?",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 2,
			say = "네 목소리가 듣고 싶어졌어. 평소보다 더…… 그것뿐이야.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "설마 일하면서 나랑 찍은 투샷 사진 같은 거 보고 있던 거 아니야?",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "물론 네가 올지, 아니면 내가 만나러 갈지는 선택하게 해줄게.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "고르기 전에 잘 생각하고 결정하는 편이 좋을 거야."
		},
		{
			voice = "event:/dorm/dorm3d_aegir_telephone41/dorm3d_aegir_telephone41",
			wait = 1,
			say = "어느 쪽을 골라야 벌이 아닌 보상을 받을 수 있을지 말이야……",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
		...
		},
		{
			...
			wait = 1,
			say = "그 선택지가 보상일지 벌일지는 직접 만나서 알려 줄게.",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
