return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "자, 됭케르크. 1년이나 지났잖아. 이제 와서 슬퍼해도 소용 없어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "미안. 1년을 도크에서 쉬는 바람에 너희를 도와주지도 못했네.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 900236,
			actorName = "보클랭",
			say = "(타르투, 도와줘! 얼른 됭케르크를 위로할 방법을 좀 찾아보란 말이야. 나 이런거 잘 못해!)",
			dialogShake = {
				speed = 0.09,
				x = 10,
				number = 2
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "알겠어요. 듣고 있으니까 흔들지 말아요. 때와 장소는 구분한다고 분명히 말을 했는데……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
