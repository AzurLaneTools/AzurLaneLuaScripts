return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "흐응… 아직 문제가 있는 것 같은데… 그래도 일단 소리는 들려!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "극지 폭풍 작전이 종료되었다. 무전기를 해제하고 즉시 응답해!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "확실한 것은 상트페테르부르크 전체와 연락이 두절됐다는 점이야.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "하지만 극지 해역의 함대와 주변 기지와의 연락은 원활해.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…어쨌든 세베르나야젬랴 제도 기지를 함대 집결지로 삼았어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "모두 침착하게 세이렌 함대의 추격에서 벗어나는 데 집중해줘.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "위험 지역을 벗어나 집결지로 돌아온 뒤 다음 계획을 세우겠다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
