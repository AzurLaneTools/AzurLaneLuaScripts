return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――…지금은 잠자코 기다리는 수밖에 없나. 일단은 TB를 마중하러 가야지.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			say = "집으로 돌아오는 길에 TB가 내쪽을 힐끔힐끔 쳐다보는 게 느껴졌다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			say = "집에 돌아와서 TB에게 어울릴 듯한 귀여운 옷을 옷장에서 몇 벌 꺼내 보았다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
