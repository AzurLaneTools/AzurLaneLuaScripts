return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "유니크한 디저트라… 도대체 어떻게 해야 유니크한 느낌을 낼 수 있을까요?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "후훗, 마침 맛을 바꿔주는 마법약을 몇 개 가지고 있어.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "만쥬 슬라임육을 재료로 쓰면… 분명 유니크한 느낌을 낼 수 있을 거야!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "――색깔과 맛에 향기까지 갖춰야지! 음식의 냄새가 곧 맛을 좌우한다고 해도 과언이 아니야!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "역시 지휘관! 계획의 결점을 이렇게 쉽게 알아차릴 줄이야!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "저는 연기에 자신이 없으니, 이번 작전은 불참하겠습니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "그 대신 요새의 동태를 엿보고 오지요. 주인님, 행운을 빕니다.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			actorName = "엘빙",
			say = "당신들, 엘빙의 영지를 지나가려는 밀수 상인이라고 했지…?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			actorName = "엘빙",
			say = "아니, 잠깐…… 그냥 그대로 들고 있어. 바로 맛보고 싶어…!",
			painting = {
				alpha = 0.3,
				time = 1
			},
