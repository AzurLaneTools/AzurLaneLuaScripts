return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "… 이 정도 피해는 다반산걸, 시간만 걸리면 고칠 수 있어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "지휘관, 우리도 이제 그만 헤어질 시간이야. 아비터는 이미 철수했고, 우리의 임시 협력 관계도 끝났어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "특이점을 떠나고 싶으면 날 따라와, 내가 통로를 열어줄게.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "아크로열은 여전히 차가운 태도를 유지하며 고개를 돌리지 않고 떠났다. 하지만 애쉬의 히요는——",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "난 지금 부상자라고. 부상자는 천천히 조심히 행동해야 하는 거 몰라?... 전투가 끝났으니 빨리 꺼지라는 뜻이야?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "하하, 그냥 해본 말이야. 시간, 장소, 신분 모두 다르지만 넌 정말 뭔가 익숙한 느낌을 준다니까… 이상하단 말이지.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "만약 다음에 다시 만날 때는 적대적인 입장에서 만나지 말자, 그럼 안녕~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "어라… 기억력이 좋네. 한 가지 질문에 대답하는 일 말이지...…?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "하지만… 지금은 마음 편히 앉아서 이야기 나눌 수 있는 상태가 아니야...…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "애쉬의 히요는 태연한 표정으로 말했지만, 바로 서지 못한 채 갑자기 휘청 거리며 부딪혀 왔다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "아, 미안, 방금 다친 상처가 갑자기 아파서, 잠깐 휘청했어.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "(이 일은 우리 둘 사이의 비밀이야. 나는 너의 교신 비밀과 모항의 네 위치도 알고 있으니까, 꼭 비밀 지켜.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 9707010,
			dir = 1,
			say = "즐거웠어~ 이번 합동 작전은 즐거웠어, 난 이제 간다, 조심히 가 봐~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "우여곡절 끝에 핵심 지역의 사이렌 문제가 해결됐다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			dir = 1,
			side = 2,
			say = "행동이 오리무중인 메탈 블러드 함대와 동향이 불분명한 애쉬… 앞으로 처리해야 할 일이 산더미처럼 쌓여 있다.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
