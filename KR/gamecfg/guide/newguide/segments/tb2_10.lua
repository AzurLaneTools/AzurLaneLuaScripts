return {
	...
	events = {
		...
		},
		{
			...
			style = {
				text = "각 턴 예정을 결정하기 전에 로라를 마을에 데리고 갈 수 있습니다.",
				mode = 2,
				char = 1,
				posY = 0,
				dir = 1,
		...
		},
		{
			...
			style = {
				text = "로라를 「관광 여행」에 데리고 가면, 기분을 대폭 상승시킬 수 있을 뿐만 아니라, 귀중한 「순간」을 획득할 기회도 얻을 수 있습니다.",
				mode = 2,
				char = 1,
				posY = 0,
				dir = -1,
		...
		},
		{
			...
			style = {
				text = "한편, 「생활 체험」에서는 로라에게 노동을 시켜 보상을 얻을 수 있습니다.",
				mode = 2,
				char = 1,
				posY = 0,
				dir = 1,
