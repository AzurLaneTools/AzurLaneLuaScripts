return {
	...
	events = {
		...
		},
		{
			...
			style = {
				text = "예정 화면입니다. 지휘관님께서는 각 턴마다 로라에게 최대 5개까지 수업을 설정할 수 있습니다.",
				mode = 2,
				char = 1,
				posY = 0,
				dir = 1,
		...
		},
		{
			...
			style = {
				text = "여기에는 현 단계에 로라가 가지고 있는 파라미터 수치의 합계가 표시됩니다.",
				mode = 2,
				char = 1,
				posY = 0,
				dir = 1,
		...
		},
		{
			...
			style = {
				text = "로라의 어빌리티와 육성 방침을 토대로 적절한 수업을 선택하시기 바랍니다.",
				mode = 2,
				char = 1,
				posY = 0,
				dir = -1,
		...
		},
		{
			...
			style = {
				text = "또한 로라의 「기분」은 수업 효과에 영향을 줍니다. 높을수록 획득하는 능력 상승치가 높아집니다.",
				mode = 2,
				char = 1,
				posY = 0,
				dir = 1,
