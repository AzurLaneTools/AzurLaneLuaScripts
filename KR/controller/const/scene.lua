...
slot0 = {
	...
	[SCENE.SHIP_GIFT] = function (slot0, slot1)
		slot0.mediator = ShipGiftMediator
		slot0.viewComponent = ShipGiftScene
	end,
	...
	[SCENE.BOSSRUSH_PASSED_COMBATLOAD] = function (slot0, slot1)
		slot0.mediator = ChallengePassedCombatLoadMediator
		slot0.viewComponent = BossRushConst.GetPassedLayer(slot0.data.actId)
	end,
	...
	[SCENE.DOAReLINK_ISLAND] = function (slot0, slot1)
		slot0.mediator = DOALinkIslandReMediator
		slot0.viewComponent = DOALinkIslandReScene
	end,
	...
	[SCENE.BOSSRUSH_DAL_COLLAB] = function (slot0, slot1)
		...
		slot0.viewComponent = BossRushDALCollabScene
	end,
	...
	[SCENE.LiquorFloor] = function (slot0, slot1)
		slot0.mediator = LiquorFloorMapMediator
		slot0.viewComponent = LiquorFloorMapScene
	end,
