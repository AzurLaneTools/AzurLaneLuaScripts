...
slot0 = {
	...
	[SCENE.EQUIPDEV] = function (slot0, slot1)
	...
	[SCENE.EQUIPSYNTHESIS] = function (slot0, slot1)
	...
	[SCENE.ACT_BOSS_BATTLE] = function (slot0, slot1)
		...
		slot0.viewComponent = ActivityBossJofferScene
	end,
	...
	[SCENE.ACT_BOSS_BRISTOL] = function (slot0, slot1)
		slot0.mediator = ActivityBossMediatorTemplate
