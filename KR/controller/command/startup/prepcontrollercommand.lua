...
function slot0.execute(slot0, slot1)
	...
	slot0.facade:registerCommand(GAME.RANDOM_FLAG_SHIPS, RandomFlagshipCommand)
	slot0.facade:registerCommand(GAME.RANDOM_FLAG_SHIP_SKINS, RandomFlagshipSkinCommand)
	slot0.facade:registerCommand(GAME.CHANGE_RANDOM_SHIP_AND_SKIN_SETTING, ChangeRandomShipAndSkinSettingCommand)
