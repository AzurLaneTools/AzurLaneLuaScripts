...
slot0.SHIP_SKILL_STATE_CHANGE = "IslandCharacterAgency:SHIP_SKILL_STATE_CHANGE"
...
slot0.ResetShipSkillUsed = function(slot0)
	for slot4, slot5 in pairs(slot0.ships) do
		slot5:GetSkill():UpdateUsedToday(false)
	end
end
