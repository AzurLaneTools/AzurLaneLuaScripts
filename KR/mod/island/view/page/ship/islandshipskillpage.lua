...
slot0.OnLoaded = function(slot0)
	slot0.skillIcon = slot0._tf:Find("adapt/attr_panel/skill/icon")
	slot0.skillName = slot0._tf:Find("adapt/attr_panel/skill/name"):GetComponent(typeof(Text))
	slot0.skillLv = slot0._tf:Find("adapt/attr_panel/skill/level"):GetComponent(typeof(Text))
	slot0.descTxt = slot0._tf:Find("adapt/attr_panel/desc/Text"):GetComponent(typeof(Text))
	slot0.descList = UIItemList.New(slot0._tf:Find("adapt/attr_panel/desc/list"), slot0._tf:Find("adapt/attr_panel/desc/list/tpl"))
	slot0.consumeList = UIItemList.New(slot0._tf:Find("adapt/attr_panel/consume/list"), slot0._tf:Find("adapt/attr_panel/consume/list/tpl"))
	slot0.upgradeBtn = slot0._tf:Find("adapt/attr_panel/consume/upgrade")
	slot0.tipTxt = slot0._tf:Find("adapt/attr_panel/consume/tip"):GetComponent(typeof(Text))
	slot0.goldTr = slot0._tf:Find("adapt/attr_panel/consume/label")
	slot0.goldTxt = slot0._tf:Find("adapt/attr_panel/consume/label/Text"):GetComponent(typeof(Text))
	slot0.goldIco = slot0._tf:Find("adapt/attr_panel/consume/label/icon")

	setText(slot0._tf:Find("adapt/attr_panel/consume/label/label1"), i18n("island_ship_breakout_consume"))
end
