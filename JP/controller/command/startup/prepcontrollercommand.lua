...
slot0.execute = function(slot0, slot1)
	...
	slot0.facade:registerCommand(GAME.START_WORLD_CHAPTER_AUTO, StartWorldChapterAutoCommand)
	...
	slot0.facade:registerCommand(GAME.PREV_CRUSING_CMD, ActivityPrevPeriodCrusingOPCommand)
