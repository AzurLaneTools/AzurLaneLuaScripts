...
slot0.execute = function(slot0, slot1)
	...
	slot2:Send(13505, {
		...
		for slot5, slot6 in ipairs(slot0.remap_count_list) do
			if slot1[slot6.act_id or 0] and slot1[slot7][slot6.chapter_id] and slot1[slot7][slot6.chapter_id][slot6.pos] then
				slot1[slot7][slot6.chapter_id][slot6.pos].count = slot6.count
				slot1[slot7][slot6.chapter_id][slot6.pos].receive = slot6.flag > 0
			end
		end
