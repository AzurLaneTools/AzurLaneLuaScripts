return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "敵じゃないとは分かっていても、本当に味方なの？と聞かれたらぐぬぬ～って感じがするし。昨日のよくわからないやつは今日もよく分からないってね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "昨日の敵じゃないにしろ、今日の友とも言えません、ですね～",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "私はまだ希望があると思っていますよ？だって皆セイレーンに対抗するために各々で戦っていますもの",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（たとえ陣営や組織が異なろうとも、今は皆同じ目的で動いています）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "私達は今、私達のなすべきことをすれば大丈夫――そう信じているだけです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "私にもわかりません。でもソユーズが言ってた「異界資材」……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ここにあるのは不自然、「違和感」を感じるもの…多分この「フネ」がそれに違いありませんわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "クーちゃん、量産艦を出してこの子を北方連合の海域まで曳航しましょう！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まずは私たちの手で調べておきませんと…！上層部にかすめ取られてしまう前に！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
