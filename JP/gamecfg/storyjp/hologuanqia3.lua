return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "瑞鶴さん、鏡面海域の気象状況がまたさっきと変わっていて、脱出するにはこのエリアを探索する必要がありそうだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まあ、そんなの鏡面海域に迷い込んだ時点でわかりきってたことよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "大丈夫、なるようになる。悩んだり怖がったりするより、前向きに頑張ったほうがマシだって",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ふふん、来たからにはセイレーンの企みも調査しておくからね！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
