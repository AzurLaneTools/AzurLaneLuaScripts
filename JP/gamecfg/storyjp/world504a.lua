return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "各艦隊は既に予定エリアに集結済みよ。行動開始まであと10分ぐらいね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そして作戦海域が広大なため、指揮ユニットを狙って速戦即決する戦法ではなく、同じく大戦力を投入して正面対決――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ええ、双方の戦力を鑑み、上層部も全方向からの総攻撃作戦を決行させてくれたわね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ああ、陽動部隊なしで全前哨基地からの戦力投入、つまり全艦隊による一斉攻撃。よくこんな編成を作れたものだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そして数々の艦隊が編成された中でも、この指揮官がいる艦隊は主力中の主力って感じかしら",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "とは言っても、事前偵察の限界もあるし、いずれにしてもNA海域の中心部の最奥に進むには…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "NA海域の最深部に全員集合してセイレーンをお仕置き！ってこと！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
