return {
	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				{
					"<size=34>アラーム音が街中に響く。</size>",
					1.5
				},
				{
					"<size=34>シティのありとあらゆるモニターから光が消えた。</size>",
					3
				},
				{
					"<size=34>全てが終わり、そして……</size>",
					4.5
				},
				{
					"<size=34>不夜城という存在が地上から消滅した。</size>",
					6
				},
				{
					"<size=34>そこに残されたのは、瓦礫と廃墟のみ――</size>",
					7.5
				}
			}
		},
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=34>今日も無数の命が不夜城へとその旅路を進んでいる。</size>",
					6
				},
				{
					"<size=34>優雅にして低俗。浪費と吝嗇が共存するネオンの街へ――</size>",
					7.5
				},
				{
					"<size=34>飼いならされた秩序もまた、悪いことではないかもしれない……</size>",
					9
				}
			}
		},
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=34>シティの全ては、神のもの。</size>",
					6
				},
				{
					"<size=34>神の思し召しで、シティのルールが変えられる――</size>",
					7.5
				},
				{
					"<size=34>神は孤独だ。</size>",
				...
				{
					"<size=34>まだ多くの街にはその轟く御名が届いていない――</size>",
					10.5
				}
			}
		},
