return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			side = 0,
			say = "あーあ、鉄血の盟友と聞いてあきれるわ。まさか重桜の最新鋭軽巡がこの程度じゃ重桜の力なんてたかが知れてるわね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			side = 0,
			say = "あら、ようやく本気出す気になった？いいわね。その表情よ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
