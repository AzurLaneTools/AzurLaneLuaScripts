return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "量産艦は潜水指揮艦を除いて全滅、と…まあもともと数が少なかったし、このポンコツたちは私たちのように動き回れないわね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "弱気なことを言うな。絶望的な状況だが、希望の糸はたしかに見えている――あとは私たちがそれを掴めるかどうかだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "この鉄球だけになっても守ってやるからね。うん、そんなとこ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
