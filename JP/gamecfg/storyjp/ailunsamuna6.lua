return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ちなみにアフターサービスの参考のために聞くけど、これは誰が座るのかにゃ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "支払ったのは指揮官だからちょっと変な気がするけど深く考えないでおくにゃ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
