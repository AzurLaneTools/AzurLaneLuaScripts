return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "通信機、レーダー、ナビシステムが全部ダメ。目視ではお互いぶつからないようにするのが精一杯",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "んじゃあ逆に考えますと、この霧の正体さえ分かれば、ボルチモアたちを救出できる可能性も高いですよね？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "要塞の防衛が先か、エンタープライズ先輩たちの救出が先か……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ダメ、そんな話じゃないの。せめて運河要塞の位置か脱出ルートを確保しないと。このまま探しては危険よ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
