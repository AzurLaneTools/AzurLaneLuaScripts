return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "セ、セイレーンに助けられたなんて…！指揮官にはどう報告すれば……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まずはピュリっちの艤装で着地して…ん？あれは…壁？それと巨大な壁画…？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "やっぱり、今までの私たちが出会った「駒」とは違いますね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "艦船としてセイレーンを倒すのが私たちの役目だけど、あなた達にまでそれを強要するつもりはないわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
