return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――あの結晶だが、確かに「共鳴」効果があっても、とても実用的なレベルではなかった",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――リュウコツの治療にはとてもじゃないが使えないし、シェルターでの生産が止まった以上入手も望めない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――だけどソユーズはそれで艤装を「再構成」することができた",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――そうか。「META」のあの「再彫刻」とは別物と見ていいのか",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「素体」か…それに関してなら、闇靄に攻撃された時にリュウコツの情報空間に飛ばされたんだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――今回は「パーミャチ・メルクーリヤ」の「概念の集合体」と出会った",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――思えば、風鈴の音も、情報空間ももう何度も体験しているのにほとんど何も知らない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――アビータの脅威なら備えはある。もちろん「META」に対しても",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
