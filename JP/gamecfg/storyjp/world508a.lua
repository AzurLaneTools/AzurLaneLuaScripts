return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "片方はセイレーンのようだけど、もう片方は……まあ、大方余燼でしょうね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "観測範囲を縮めるためにセンサーでの「観測」も禁止、だっけ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "かしこまりました。……資料を参照し、約5体のシルエットは特定できました",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "三つの異質な存在はセイレーンの上位個体で間違いないとして、残りの二つは艦船……いいえ、「余燼」でしょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "単体でも凄まじい戦力を持つ「余燼」だからこそ、セイレーンと対峙できるのですね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "セイレーンの上位個体、かつて遭遇したテンパランス、ストレングス、ハーミットで、余燼側は飛龍と…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "しかもあのときはまだ座標を補足できる技術が上層部から渡されていなかったので、捜索しようにも手も足も出なくて…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "この残骸の海で戦うのはあまり得策じゃないわね。指揮官、ここはやはり一度撤退して身を隠したほうがいいと思う",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "邀撃でセイレーンと戦ってきたぼくたちですけど、流石に本陣に攻め入るときは、戦力が多いに越したことはありません",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "ここで確実にアビータを撒くなら「指揮官」と協力した方がいい",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "「余燼」がどういう立場かまだわかりませんが、少なくとも話は通じます、それに対してセイレーンは紛れもない敵、ですね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "「余燼」及び異常個体を撃破し、実験場の機能を修正・維持する",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "敵性体の撃破または現ボディの撃破をもって行動限界とする",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
