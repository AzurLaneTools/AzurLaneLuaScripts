return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "つまり、セイレーンの主力艦隊は既に特異点で「喪失」した、とでも？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そう仮定して考えれば、総力戦が始まる前の軍備縮小も、総力戦においての抵抗の弱さや形だけの防御線も…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そしてその主戦場…セイレーンが全戦力を投じて抵抗していたのはおそらくここかと",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あれがセイレーンの最後の足掻きだったとすれば…私たちは幸運にも敵が一番弱まっているところで攻められたのか",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "それに、明らかに我々の量産艦と思わしきものもある。現在見つかってる数は多くないが、全体に占める割合で考えると決して小さい数字ではない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "いや、それでもだ。NA海域での戦いがどれだけ激しかったとしても数が合わない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "我々はまるで果てしない残骸の海にぽつんと置かれた小舟みたいだ。…艦船でこう例えるのも妙だが",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "特異点というのは…ええと…「固定された体積を持つ三次元空間ではなくて、もっと複雑な性質が備わっていて」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まあ、その仮説を最初に立てたのはロイヤルの研究者だけどね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "な、何よ！早く続けてちょうだい！手柄を横取りしないでって言ったのはあんたでしょ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "つまり…この残骸の海が果てしないように見えるのは、私達が遠くまで観測しすぎたせいかもしれないの。このままじゃ、空間と質量がどんどん膨張して恐ろしいことが起きるかもしれないわ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
