return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "「μ兵装」実験テストのイベントを通して、各陣営間の交流を促す。目的は至って単純だ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			bgName = "bg_story_task",
			dir = 1,
			say = "妙なことに、それぞれの艤装には別々の型番がついているため、なぜかユニットメンバーの決定が回りくどいことになってしまった。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 312010,
			nameColor = "#a9f548",
			say = "な、なんにゃ！？「μ兵装」を使った「演習」ではにゃく…今にもドンパチ始めそうな雰囲気にゃ！？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307110,
			nameColor = "#a9f548",
			say = "戦うも何も、ステージで「誰が一番輝く」かを決めるのではありませんか？ですから、このステージで勝負を決めようとしています",
			flashout = {
				dur = 0.5,
				black = true,
				alpha = {
		...
		},
		{
			...
			dir = 1,
			actor = 307110,
			say = "ほかの子も観客も消してしまえば、輝きがわかる人なんていないでしょう？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "だがこっちもこのまま退くわけにはいかないな。ライブは戦いではないにしても、もっと盛り上げさせてもらうよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
