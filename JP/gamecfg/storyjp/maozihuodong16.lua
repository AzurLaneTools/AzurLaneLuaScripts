return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Здравствуй！キーロフだ！指揮官同志、北方連合の艦隊を見るのは初めてか？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "驚いているなら素直に感想を述べればいい！ここはユニオンではなく北方連合だ！指揮官同志のどんな感想も受け入れよう！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "と、ここは仲間たちのほうを紹介するのが筋かな？…私ではなく、この艦隊のリーダーが紹介するべきだが――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ああ、儀礼的なものだが承ろう。同志指揮官、私はこの艦隊を率いる「ソビエツカヤ・ロシア」だ、よろしく",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まずはキーロフだ。今回限りの参加になっているが、ひとまず顔見せだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "タシュケントだ。サディア生まれの子だが、私達の大切な仲間だ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
