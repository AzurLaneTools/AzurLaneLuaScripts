return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "違うの！これはその……考え事をするより手を動かす方が私の性に合っているというか…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "整理するのはいいですが、細かい確認も決裁もすべて指揮官様に丸投げしているではありませんか…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官様おひとりでこなすのは大変です。このレナウンもお力になりましょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "少しだけですよ。レパルスは引き続き整理と掃除をよろしくお願いします",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "提出された設備の補修における項目に不備が見られました……ええ、実はこの箇所が――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "レパルスも秘書艦ですから、少しずつでいいので、事務仕事を覚えたほうがいいのでは？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "うーん。そうなんだけど、私は姉さんみたいにこうやってテキパキとこなせる自信がないしな～",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "二人を見てたら、それこそ私がかえってお邪魔になっちゃうんじゃない――なんてね。あははは",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
