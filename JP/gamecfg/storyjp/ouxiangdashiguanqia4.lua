return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そうね…一回特訓して万全な準備をしてからまた挑めば勝てるはずよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ライブで決着をつける設定にしたのは明石のアイデアではないにゃ～",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "この展開は誰も想定できん。明石はなぜあの「街」が出来たかの解析に集中しろ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "このままあのニセモノに勝てないなら、特訓してもう一度挑むまでよ！それもμ兵装の他のユニットも動員してね！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "いきなり何を言い出すかと思えば…この子たちはアズールレーン所属でもないし、いきなり異世界から飛ばされてきたんだぞ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "分かっているわ！でもあの場所を調査しないとこの子たちも元の世界に戻れないでしょ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "なにより、ロイヤルが今回のライブのスポンサーなのよ！このままあのライブ海域を放置するわけにはいかないわ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
