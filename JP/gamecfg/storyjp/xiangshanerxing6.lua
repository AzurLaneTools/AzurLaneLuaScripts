return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "パーミャチさん、アヴローラさん、陣営大会お疲れ様でした",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "審判廷の極秘通信回線を使ってはいますが、絶対に傍聴されないという保証はありませんよ。アヴローラさん",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "このまま放置すれば、セイレーンか上層部かに利用される可能性が高いでしょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "アヴローラさん、パーミャチさん、大会のほうは引き続きよろしくお願いします",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "クロンシュタットから、審判廷の通信に「南極」という単語の出現頻度が急激に増えている、との連絡がありました",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
