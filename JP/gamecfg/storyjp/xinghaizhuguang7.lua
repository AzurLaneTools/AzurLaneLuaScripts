return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "じゃあレギュレーションをちゃんと教えなくちゃ…うん、規則厳守…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "強制射出って、危なそう…普通の訓練で起きたら始末書レベルだよ…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "こ、こっちでも射出なんてされないよ……というより、今回は特別…？",
			painting = {
				alpha = 0.3,
				time = 1
			},
