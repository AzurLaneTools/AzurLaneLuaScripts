return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ねえ、駿河ってば、いつになったら私と100％本気の全開で勝負してくれるの？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "私はいま、秘書艦も兼任しているので。明日も他の仕事がつかえてるからね。面倒ごとは基本パスよ。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "どうせ負けるって、運命が決まってたら、悔しくもないのにね……バカみたい……！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "見計らったように執務室へ入って来た島風によって、外へ連れ出されてしまった……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
