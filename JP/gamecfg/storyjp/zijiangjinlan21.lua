return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "そして深雪たちですが、神通が戦闘不能で退場したほか、三笠大先輩も演習場に入って武蔵さんの攻撃を阻止しています",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "大先輩が自ら出撃した以上、もはや合流は避けられないわね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "加賀、龍鳳、艦載機を発信させて中心拠点の「塔」に威力偵察を仕掛けるわ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "重桜の艦載機…あれは赤城たちの攻撃隊に間違いありませんわ！大先輩、私たちも行きます？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "それもあるが、おそらくは中心拠点で何かを見つけたのかもしれんな",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "それであえてあてたちに攻撃経路を開けてくれた、ということか",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "もしくは私たちに突入させ、漁夫の利を狙っているのかもしれないぞ？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "赤城のことだから何かしらの企みがある、と考えても良いだろうが、ここで我らも何もしないというわけにはいかないだろう",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "羽黒はこのまま待機して武蔵と赤城の動きを監視するのだ。もしまた攻めてきたら我に連絡せよ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "それに、我もこの演習場に入った以上、「塔」での決戦の前に色々と連携を固めないと不安だからな",
			painting = {
				alpha = 0.3,
				time = 1
			},
