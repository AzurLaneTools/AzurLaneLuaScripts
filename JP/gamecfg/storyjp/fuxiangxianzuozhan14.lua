return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "はいはい～…しかし、「駒」の艦載機とは思えないほどの強さですね…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ここに鉄血の空母がいるってこと…？でも赤城先輩、グラーフ・ツェッペリンなら鉄血本土にいるって…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そもそも、鉄血の空母がなんでいきなりこちらを襲ってくるの！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そこはほら、重桜の「駒」と遭遇したんじゃない？もしかしたら鉄血も私達のことを「駒」だと勘違いしているのかも？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……さっぱり分からないわね…隣に妙な島と建物があるし、どう見てもセイレーンの実験場だけど、ここらへんの航行記録にそんなの載っていないし",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あとの作戦のために戦力を温存しようというのでしたら、一刻も早く脱出経路を探すことに集中すべきですわ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "金剛の言う通りね。ごめん翔鶴姉、やっぱり鉄血艦載機を撒くのを優先して！鏡面海域から脱出する！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
