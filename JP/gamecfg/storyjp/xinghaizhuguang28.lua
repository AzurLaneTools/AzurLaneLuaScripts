return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "指揮官が転送してきた鉄血の資料に書いてあった内容だと…あいつらはアビータⅥ「ラバーズ」のエンフォーサーだ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "クリオネっぽいのは支援とジャミングが得意なエンフォーサーⅥ「Combination」",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "そしてもう一種類はエンフォーサーⅥ「Attraction」、たしか火力タイプね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "プロトコルウォーフェア「フォートレス」",
			say = "試行はした。戦闘端末との交信はできず、また制御を移行させることもできない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "プロトコルウォーフェア「フォートレス」",
			say = "向こうが使っているプロトコルと本機は違うものと推測する",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "プロトコルウォーフェア「フォートレス」",
			say = "…本機が監視に出したドローンも撃墜された。敵性存在と判断する",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
