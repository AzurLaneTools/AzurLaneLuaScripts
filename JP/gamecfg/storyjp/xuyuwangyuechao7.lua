return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "そうなの？尾張さんは出かける前、顔色が悪そうだったよ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actor = 900402,
			say = "口では言っていないけど、聖域での任務にとっても真剣に臨んでるんだから！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "「もう大自然ってカンジ？見渡す限りヒトもいない草木と小動物だけ！」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			withoutActorName = true,
			nameColor = "#A9F548FF",
			say = "走りながら喋っているのか、初月の声は荒い息遣いで途切れ途切れだった。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			withoutActorName = true,
			nameColor = "#A9F548FF",
			say = "艤装で航行しているにも関わらず、その姿はむしろ全力疾走に近い。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "今度瑞鳳もやってみ…はわわ！今はそんなこと言ってる場合じゃないよ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			withoutActorName = true,
			nameColor = "#A9F548FF",
			say = "詰所の外の浜辺に近づいてきた頃、初月は急停止し慣性で岸に乗り上がった。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			withoutActorName = true,
			nameColor = "#A9F548FF",
			say = "……が、その前に初月が手を伸ばし、もう大丈夫と瑞鳳を静止した。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "とにかく艦載機を飛ばして長門さまが今どこにいるのかを確認して…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "初月ちゃんは中に入ってちょっと休んでっ！朝凪さん、名取ちゃんを起こして…あと部屋も片付けさせて！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "で、でも今準備しても長門さまたちが来た頃にはまだアツアツで―――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "瑞鳳",
			say = "（も、もしかして尾張さんのことと何か関係が？一体何が起きてるの……？）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
