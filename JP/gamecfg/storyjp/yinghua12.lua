return {
	...
	scripts = {
		...
		},
		{
			dir = 1,
			side = 2,
			say = "今まで威厳を出そうとして強張っていた長門も急に気恥ずかしそうにモジモジし始めた。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "余は人間より作られたがゆえに、人間と同じく友を、絆を欲する。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "民草に憧れられる存在たるがゆえに、威容だけでなく時に笑顔も必要とする。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "「ソウゾウシュ」よ、どうかその申し子に一度、真に信じられるものを見出すための新生を――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
