return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…大型作戦？この指揮官の私ですら聞いたことないですけど",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "この前書類を作ったとき、この名前がかっこいいと思って…作戦コードネームをつけちゃった★",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "まぁ作戦だから、物資の準備が必要となってくるし…多ければ多いほどいいと思って～",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "しょせん書類仕事ってのは、大人のツゴウ！みんな真剣に確認しないから、テキトウでいいじゃん！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			side = 2,
			bgName = "bg_story_task_2",
			factiontag = "しがない発明家（嘘）",
			dir = 1,
			actor = 608020,
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "指揮官、スペシャルオーダー届いたよ！秒速80メートルで移動できる掃除ロボット、出来上がりよん♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "いや、そんな爆速で動ける掃除ロボットを作ってどうするんですか！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "あれ…そんな速さのわけ…いや…入力ミスだったわねこれ、えへ☆算数ってやっぱムズい！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "電卓は使いづらいよぉ…大丈夫よ指揮官、ほら超スピード掃除ロボットもめっちゃクールじゃない！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "——って、これが先週の日曜日に執務室で収録したやつだな？",
					flag = 1
				}
			}
		},
