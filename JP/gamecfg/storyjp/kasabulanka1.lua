return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（指揮官からの直々のご指名ということですが……そもそもなぜ私だったのでしょう？）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "さっそくですが、今日の仕事に入らせていただきます。まずは書類の整理からでよろしいでしょうか？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（指揮官の指示の通りに、書類を各ファイルごとにまとめて整理していく）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "コホン。どうやら指揮官のそのお顔から察するに、以前から私のこうした仕事ぶりを評価してくださっていたようですね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
