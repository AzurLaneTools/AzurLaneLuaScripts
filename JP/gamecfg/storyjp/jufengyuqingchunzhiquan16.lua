return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ゴールデン・ハインド、この子が本当に「偉大なウィダーさま」なの？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "と、とにかく！このウィダーが呼びかけに応じてやってきた！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "話はわかった。要はポリスを襲う残響艦隊の目的を突き止めたいって？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "新世界が騒がしくなったと思ったら、残響艦隊まで出しゃばってきて…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "このままじゃウィダーも安心して休めなくなる…あーしんど……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "この間戦ったときは７割近く沈めてようやく逃げ出したのに",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "ふぇええええ…ちっちゃいのを追い返したら今度は大きいのが出た……！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ウィダーちゃんと指揮官だけでも先に逃したほうがいいんじゃないか？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "「偉大なウィダーさま」は伊達じゃないのっ。たとえこんなデカブツが相手でも打てる手はあるよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
