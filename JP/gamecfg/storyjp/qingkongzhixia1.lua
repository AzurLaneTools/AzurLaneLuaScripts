return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――まあ、折衝と言ってもほとんどは社交辞令みたいなものだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――……なんだか仕事をしているというより、休暇を取っている気分だな",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――休暇、か…前にもこんな感じでゆっくりできたことがあったような",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "――以上が艦載機の艤装モジュールについての紹介よ！授業が終わるまでまだ時間があるけど…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「……大艦巨砲主義のものとは違い、新しい攻撃方法を実行できる軍艦であり……」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「……空母が現れたことで、大洋の空はもはやセイレーンのものではないことを……」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「……特徴としては、1隻のみではなく複数の空母を1箇所に集中して運用することが多く……」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「……空母を中心とした機動艦隊に護衛艦隊を随伴させれば、より長所を発揮でき、戦力は単なる加算ではなく……」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actor = 105170,
			say = "あー、そのことだけど別に好きでやってきたわけじゃないわよ？だってミズーリが――",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「Ⅱ」型艤装の力を使ってヨークタウンのリュウコツ侵食を無事食い止められたが、レキシントンはそう上手くいかなかった",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――そして「Ⅱ」型艤装を広める努力もなかなか成果が出せていない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――あの「再現」で倒れたレキシントンといえば、未だに生命維持装置の中……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「星の海」にいる仲間たちの研究が無事に進むことを願おう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
