return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#a9f548",
			say = "「セイレーン残党の掃討を行った艦隊は、エリアの西側に重桜艦船の信号をキャッチした」",
			flashin = {
				delay = 1,
				dur = 1,
				black = true,
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#a9f548",
			say = "「また、セイレーンと大規模艦隊の間で戦闘が発生した痕跡が観測されている」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#a9f548",
			say = "「同エリアにおいてはユニオン艦隊は東側にのみ展開していたことから、セイレーンと交戦したのは――」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#a9f548",
			say = "赤城に加賀、そして蒼龍……ううん、飛龍もいたわね。しかもみんな結構ダメージを食らっていたわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#a9f548",
			say = "「重桜の空母艦隊のほか、同エリアではセイレーンの指揮ユニットの存在が観測された」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#a9f548",
			say = "「指揮ユニット――人型セイレーンは重桜艦隊に攻撃する行動が見受けられなかった」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#a9f548",
			say = "（あの衝撃波が発生したとき、たしかほかの「誰か」が急に現れたわね…）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
