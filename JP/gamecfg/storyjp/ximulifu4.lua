return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ふん、ロイヤルと鉄血の威信を賭けたパーティーだもの、参加者が多くて当然だわ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そして鉄血の優雅さがロイヤルにも負けてないことを示すがいいわ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あ、大丈夫、ドレスについてないよ。むしろ夕暮ちゃんのほうは大丈夫なの？なんかすごく慌ただしくしてるけど",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
