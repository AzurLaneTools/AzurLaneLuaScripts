return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actorName = "？？？",
			say = "別に構いませんよ。ここの通路はだいぶ入り乱れていますから",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "？？？",
			say = "しかし、人除けの結界をくぐり抜け、すべての可能性をも乗り越えてたどり着くとは流石ですね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "？？？",
			say = "宴会で随分と苦労なさっていますね。ふふふ、心中をお察しします",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "？？？",
			say = "それだけではありませんよ。あなたはいろんな意味で特別な存在ですから",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――今は「雲遊」中の身でね。今度またどこかで会えるといいな、という意味だ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――もちろん「一期一会」の言葉もあるけど、それでもヒトは未来に期待を抱いたほうがいい",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――こうして自分が通路と結界を乗り越えて、あなたと出会えたように",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
