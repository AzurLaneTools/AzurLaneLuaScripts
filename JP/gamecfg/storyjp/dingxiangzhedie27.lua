return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 101500,
			nameColor = "#A9F548FF",
			say = "指揮官こっちよ！えへへへ！ハムマンのすごいところをちゃんと見てた！？",
			painting = {
				alpha = 0.3,
				time = 1
			},
