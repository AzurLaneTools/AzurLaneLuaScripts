return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "「ダンスパーティーのこぼれ話」",
					flag = 1
				},
				{
					content = "「激写！ダンスパーティーのマル秘ファイル！」",
					flag = 2
				}
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "うーん、それっぽくはあるけど、ちょっとありきたりすぎるかも？ぱっと目を引くような感じじゃないね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "うちがつけるとしたら――「激写！ダンスパーティーのマル秘ファイル！」",
			painting = {
				alpha = 0.3,
				time = 1
			},
