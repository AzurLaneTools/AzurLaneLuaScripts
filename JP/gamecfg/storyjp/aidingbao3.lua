return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "――サフォーク、ちゃんとシンクの掃除をしたのかを何回も注意したはずですが",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "う～～……二人とも、少しでいいから私の愚痴に付き合ってもらえないかしら？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……やれやれ。手早くお願いしますね。掃除のことでサフォークにお説教がありますので",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あなたにしかないもの――指揮官はそこに価値を見出しただけのことですよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "はい、もと統括に言わせておけば、「エディンバラにもエディンバラの素質がある」とのことです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "メイド長も役に立てない人をメイド隊に無理してまで起用するとは思えません",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "わからなければわかるまで考えてください。ほら、行きますよサフォーク",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
