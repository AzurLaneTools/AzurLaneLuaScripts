return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ロシアたちが動いているのにまだこんなに戦力を寄越してくれるなんて…まあ、「秘密領域」のほうに被害はないわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "私達が初めてここに入ったときに受けたインパクトを味わってもらいたくてな。タリン、指揮艦の準備はできたか？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "同志指揮官！空を眺めるんじゃなくて、氷の下に注目だよ！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
