return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "——あ…えっと…まだちょっと残っていてね。気にしないで先に帰っていい",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "（仕事に対する熱意が大事だし、能力の底上げは…まあ、堅実にやっていこう）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "えへへ、仕事は逃げないけど、お弁当が冷めちゃうよね！指揮官、ええと…仕事するのは食べてからでもいい？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Of course——not.指揮官、やりかた教えてちょうだい♥",
			painting = {
				alpha = 0.3,
				time = 1
			},
