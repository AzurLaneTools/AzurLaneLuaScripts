return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "ああ！リュウコツの中のエネルギーが制御を失っているようだ……！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "何を言っているか分からないけど…指揮官を連れ去られては困るわ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "現実での対概念兵器の防御として、莫大なエネルギーを使って強引に別の「概念」の空間に精神を接続させる",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "使い方によっては防御ではなく、相手の精神に影響を与えられる…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "（アビータと同じ技術を使うのね。というかこの空間がほかのところと接続していない保証は…）",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dialogueBgAlpha = 0.6,
			say = "黒い太陽の夢の正体は精神の異空間…ということでいいかしら？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "どっちも違うわ。あの笏杖、そして「概念」を認識し支配できる特性……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "あの攻撃は隙も大きいし射程も短いはず…指揮官、量産艦をぶつけながら特別計画艦たち中心に再編成を！",
			painting = {
				alpha = 0.3,
				time = 1
			},
