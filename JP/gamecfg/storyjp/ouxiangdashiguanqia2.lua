return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 102240,
			nameColor = "#a9f548",
			say = "ああ。実はこの母港で「海上ライブ大会」というものをやろうとしていて、この海域にはそのためのステージを建設中だったんだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "全く関係のないところに異世界からの客人に関わる現象が発生した、ということは…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 202250,
			nameColor = "#a9f548",
			say = "ええ、ご主人様が戻ってくるまでには片付けさせていただきます",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
