return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "（これは自分の夢か…いや、信濃か誰かの夢である可能性もあるか）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――地中海の時は礼を言えなかった。あのときは助けてくれてありがとう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――「ヘレナ」がこっちに危害を与えないことも分かっているし、そりゃ落ち着くよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――南極大陸に、艤装研究にブレイクスルーをもたらす特殊鉱物が見つかり",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――上層部が出せる戦力は艦船たちじゃない。表立って横槍を入れるのも得策ではないが…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――自分も含めて各陣営の艦船たちがアイリスに集まっているこのタイミングで事を起こすのが、とても偶然とは思えない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――もし上層部がこれを手に入れ、それを利用して「再現」をまた繰り出したら、「アズールレーン」の再結成は夢のまた夢になる",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
