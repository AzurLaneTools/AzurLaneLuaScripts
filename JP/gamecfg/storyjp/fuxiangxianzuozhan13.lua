return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "うん。ここの装置を操作できるのは私たち以外だと、作った張本人のセイレーンしかないわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "D13区画の制御権限はまだこちらが握っているわ。ヴェーザー、あの量産艦たちをうまく誘導できるかしら？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ええ、卿の思っている通りよ。…フフフ、この実験場の主が誰か、決めようじゃない…！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
