return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#DFDFDF",
			say = "「ラバーズ」か～。確かに戦ったことはないね！えへへ、大した自信だね～",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#DFDFDF",
			say = "ちょっと当てさせて？あなたの作戦ってできるだけ持ちこたえて、消耗戦に持ち込んで根性比べさせるつもりでしょ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
