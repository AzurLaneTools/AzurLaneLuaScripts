return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官、ちょっといいか。先ほどの会議で言い忘れていたことがあったんだが",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……落ち着いて聞け。あてが今からそこの窓を開けに向かう。それまで身動きせず大人しくしているんだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "いいか指揮官。スズメバチは振り払おうとすると攻撃対象にされる。だから動かなければ危険はない――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "全くお前、肝が据わっているのか、狼狽えているのかよくわからんな",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "このまま窓の方に向かって、と。さぁどこへでも飛んで行け",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "……多くの艦船を指揮する立場として、確かに彼女の言うことも一理ある。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
