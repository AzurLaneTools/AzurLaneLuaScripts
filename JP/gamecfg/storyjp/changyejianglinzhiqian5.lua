return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			optionFlag = 2,
			say = "休んでいる間にも、仕事はどんどん積み上がっていくのだ。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ふふん、つまるところ何の心配の必要もないってこと。安心して休暇を満喫して！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "エンタープライズはいいなぁ～。セイレーンを叩くチャンスが多くて～",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "まあ、あんなのがまた来ないように、こうしてあたしは毎日パトロールしているわけ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "こちらロイヤル所属、戦艦キング・ジョージ5世。指揮官とユニオン艦隊に挨拶申し上げる",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "なに、指揮官がエウロパに行くのだ。ロイヤル艦隊として全力でもてなすほかない",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "世界博覧会が終わってもロイヤルのパビリオンはしばらく解体せず残す予定だ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "一般開放はしないが、下僕のために特別に貸し切り営業にしてやるから絶対見に来なさい",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "そして、陛下は公務のため閉幕式に参加できなくなった、下僕には申し訳ない――とのことだ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "ロイヤルパビリオンのことはイラストリアスに聞けばいい。すべては彼女に任せてある",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			side = 2,
			say = "鏡面海域の件で開幕式に間に合わなかったとは聞いたが、閉幕式も参加できなくなるとはまさに災難だ。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			side = 2,
			say = "エリザベスのことだから、こんな賑やかな行事には絶対に参加すると思っていた…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "もちろん参加したがってたとも。登場のために色々準備していただけに本当に残念でならない",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "とりあえず、我々としても指揮官には博覧会を楽しんでもらいたい",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "あたしもそう願うよ！指揮官にとって良い休暇になりますように！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "大げさではないよ。指揮官がちゃんと休みを取れたのはいつぶりなの？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "いざというときに備えて、あたしが会場までずっと護衛するのはどう？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			paintingNoise = true,
			say = "エウロパと南大陸の海峡まではウォースパイトが、そして会場まではイラストリアスが案内と護衛を務める手筈になっている",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
