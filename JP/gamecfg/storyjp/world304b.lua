return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "これがクリーブランドたちがさっき報告してきた「ゴーストシグナル」？クーパーの言う通り確かに幽霊っぽいわね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（こちらを遅滞させたいのなら、もっとスマートな方法がありますし…分割誘導するなら、さっきのセイレーン廃墟は大掛かり過ぎます）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "どうするも何もエリアを確保していくだけよ。それに敵は逃げることはあっても消えてなくなることはないし、いずれ戦場で相見えることになるわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "…各艦隊の体力がまだ十分あるうちに、エリアを探索してジャミング元を探しましょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
