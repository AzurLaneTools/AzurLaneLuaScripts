return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "いいの？私たちに預けたら…歌うときに不便になるんじゃ？",
			painting = {
				alpha = 0.3,
				time = 1
			},
