return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff0000",
			dir = -1,
			say = "ちなみにお主の戦意は今まで見たことのないほど高揚しているようだな",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "時代は変わっていっていますし、毎年演習で同じような戦い方では、将来的に実戦の中で通用しなくなる恐れもあります",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "新しく考案した戦い方が通用するかどうか…艦隊全員に関わる課題を演習を通じて検証することができれば、",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
