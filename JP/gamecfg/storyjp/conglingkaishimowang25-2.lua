return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "Z23",
			hidePaintObj = true,
			say = "くっ、また！？深手を負わされると判断したらほかの魔物を身代わりにして、本体は逃げて回復してる！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actorName = "ヌビアン",
			hidePaintObj = true,
			say = "わたしも！ふふん、こんなに盛り上がってるんだし、大事な魔法薬も出し惜しみなしだ！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "でも戦闘はもう膠着状態です。メガフレイムドラゴンの魔力量を考えると、このままでは味方がジリ貧になります",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "指揮官がこんな切り札を持っているとは…ジョブの見かけによらず、です",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "えへへ、倒される前に敵を全部やっつければ大丈夫ですよ！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "それに、ずっと4人だけのパーティーではありませんでしたよ？",
			painting = {
				alpha = 0.3,
				time = 1
			},
