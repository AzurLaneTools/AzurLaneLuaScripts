return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "それ楽しそう！よし決まり！リシュリューの説得頑張ってね！ヴォークラン先生♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "まずは海上戦力。敵は戦艦だけでなく空母も2隻と勢揃いだから、セイレーンや量産型のフネを計算に入れても、戦力差があまりにも絶望的だわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "ええ、枢機卿の艦隊をヴィシアに引き込められないか説得してみるわ。仮にできなかったとしても要塞の防衛施設で引き上げさせられる",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			dir = 1,
			say = "私たちはあくまで聖堂を守るためにここにいる――それをアイリスの子たちに分かってもらえるわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "そして例の「秘密兵器」――考えることがまだいっぱいありそうだ。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
