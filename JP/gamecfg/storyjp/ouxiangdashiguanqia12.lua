return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "いよいよラストステージって感じね。私たちはステージに上がればいいのかしら？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ああ、エネルギー源を調べるにしても、あのニセモノたちをライブバトルで蹴散らすのが先だ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "トンネルがまだ開いているならそのまま元の世界に送りかえすわ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ええ、アイドルの方々がこちらにいらっしゃったあの日の感覚に近いです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "μ兵装が装備されていない艦船はステージに上がれないわけじゃないし、ライブの力にもなれるよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
