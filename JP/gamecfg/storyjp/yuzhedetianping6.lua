return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "そ、そうだ！落ち着け落ち着け…これはシャッターチャンス！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 601080,
			side = 2,
			say = "何が起きたか全然わからないけど、危機的な瞬間もカメラに収めてこそのジャーナリスト！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
