return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "うぅ、ご主人さまと記念写真を撮りたぁい！撮りたいのにぃ！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "異世界の王都にやってきた！はぁい、ご主人さまも～スマイル☆",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ユニコーンは見習いプリーストだから、あそこに行けば新しいスキルが覚えられて、強くなれるかも……！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ん？そういえば私もプリーストだから、同じスキルを覚えられるかも！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ふふふ、いらっしゃ～い冒険者たち。王都に来るのは初めて？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "それを解除するにはまず、王都の指定エリアに行って登録しないと～",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "あら、ごめんなさい。自己紹介を忘れてたわ。私はフリードリヒ・カール、鋼鉄教会所属のメカニックよ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "魔王を討伐しようとするその心意気と覚悟、敬意に値する",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "ん？どうした忠誠なるプリーストよ。遠慮せず言うがいい",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "が、数日前に我が宮中の魔法使いがその魔法を一瞬破って、ようやくその姿を目にすることができた",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 201360,
			nameColor = "#A9F548FF",
			say = "ふふん、よーく見てご覧なさいな。これが王国宮廷魔法の知恵の結晶「スナップショット」よ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "どういうことだ…「スナップショット」の安定性が下がっている？！何があった？！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "もしかしてさっき「情報分析」を使ったせい…？うっわ…大変……",
			painting = {
				alpha = 0.3,
				time = 1
			},
