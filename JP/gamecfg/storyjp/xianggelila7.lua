return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "昨夜はまた徹夜したのですか？はあ…徹夜は体に触ると何回も言いましたよね……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "やっぱり記録とか、相手のこととか、きちんと調べておけばよかったなぁって思わせてくれたから！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "観戦してた指揮官、そしてみんなに手伝ってもらいました。私的にはやはり記録をちゃんと残しておかないと",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "シャングリラにとって、この母港で初めての「仲間」が出来た瞬間の記録だった――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
