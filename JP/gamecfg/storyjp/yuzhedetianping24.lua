return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "本当は閉幕式の前に一度挨拶したかったけど、まさかこんなことになるなんて",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "世界博覧会の主催として、あなたに今回の異変の説明を強く求めます",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "そうしないで「黙示録の騎士」を呼び出してたら、あの子が何をしでかすかわからなかったし",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ほら、指揮官には分かるでしょ？「神穹の壁」がある限り、「神の機械」の攻撃なら防げるし",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "クレマンソー、今の話だけで皆が納得できるとは思わないでください",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "私の知っているマルコ・ポーロはこんな危ない計画を思いつくはずがありません",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "それを知った上で協力したのであれば、あなたも共犯者…いいえ、事態の悪化を放置していた分余程たちが悪いですよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "いずれにしても、この様子じゃ「マルコ・ポーロ」が起こした異変はまだ解決していないわね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "待たせちゃって申し訳ないわ～。なにせこの道を歩くのは大変で――",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "指揮官、そして世界博覧会の代表の方々、ご無事で何よりです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "港周辺の敵を掃討し、整備と補給を行った後、そちらに向かい合流する予定です",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "そこで審判廷の秘密要塞の資材を点検したところ、セイレーン技術に関する大量の研究資料を発見しました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "双方向の転送経路によって構成された「網辻（ネットワーク）」のことです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "そしてこの「網辻」のために世界中に膨大な数の装置が配置されており、ほぼ半永久的に作動しているようです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "「海霧」がある鏡面海域でのセイレーンの兵力はおそらく、この「網辻」でやりくりしているのでしょう",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "本来はこんな技術を私たちが使えるはずがなかったのですが…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "世界博覧会の異変を知り、すぐにこれを使ってテリブルをロイヤル艦隊に合流させ、指揮官との通信を回復できましたが…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ここまで大規模な艦隊移動を実現できたのは、尊きアイリスが祝福してくださったためでしょう",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "マルコ・ポーロを阻止するだけでなく、アイリスとヴィシアがこの危機でまた心を一つにすること",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "そうですね。ジャン・バールたちの修理、弾薬その他物資の補給を考えると――",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "すみません指揮官、どうやらもう少し時間がかかりそうです",
			painting = {
				alpha = 0.3,
				time = 1
			},
