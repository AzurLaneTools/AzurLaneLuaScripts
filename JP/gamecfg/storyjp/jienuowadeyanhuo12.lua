return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あれ？あーそれはリットリオに向けて投げてたのさ。ほら",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あら、長い目で大局を見るのはむしろストラテジストである貴方が得意としてることじゃない？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あれは特注品だし、たしかに今日はこのぼくのアイデアで無事に撤収できたけど…アルジェリーまた無理していない？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=51>「我らが力振われる未来は平和なり」</size>",
					3
				},
				{
					"<size=51>「炎に包まれようとも――」</size>",
					4
				},
				{
					"<size=51>「我らが進む足、留まること無く」</size> ",
					5
				}
			}
		},
