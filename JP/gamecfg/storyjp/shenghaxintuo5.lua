return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "（だからといって一緒に出かけることだけだったら、さすがにちょっと適当すぎるな…）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "——明日のデートはご褒美ではなく、サン・ジャシントへのお願いなんだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "——秘書艦として仕事だけでなく生活面でもちゃんとサポートしてくれたんだ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "——明日なにかしてほしいことがあったら、予め言ってもらえると助かる",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
