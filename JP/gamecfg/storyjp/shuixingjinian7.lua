return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			optionFlag = 1,
			say = "ベンチに腰掛けると、クーちゃんは可愛くこちらの肩に寄り掛かってきた。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "だ・か・ら…指揮官の秘書艦として、クーちゃんがずっと傍にいてあげてもいいわよ……？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "もちろんタダ働きはしないし、あまりにもこき使うのは禁止だけど♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…よぉし、クーちゃんからも指揮官に「ご褒美」をあげるわ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "さっきのスノードームは最近の「ご褒美」、これからあげるのは今日付き合ってくれた分の「ご褒美」ね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ふん、そんな分からず屋の指揮官は、クーちゃんがおしおきをしてあげるわ！",
			painting = {
				alpha = 0.3,
				time = 1
			},
