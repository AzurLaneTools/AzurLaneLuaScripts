return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = "main1",
			say = "…改めて自己紹介させてください。私は「レジスタンス」のエージェント、ソビエツキー・ソユーズ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = true,
			say = "ブロック33セキュリティ局のタリンから依頼されました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = true,
			say = "ええ。詳細はわかりませんが、セキュリティはたしかに情報を流してくれました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = "main2",
			say = "「ナノサーキット」がなければ、あなたの居場所をこうも簡単に突き止められるはずがありません",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = true,
			say = "それとセキュリティは暴動の火を「饅頭タワー」に延焼させると約束してくれました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = true,
			say = "このままタワーの最上階まで突っ走ります。準備してください",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = true,
			say = "このままエレベーターに乗り込めば、頂上にあるデータセンターにたどり着けましょう",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			live2d = true,
			say = "これで最後です。あとはあなたの手で、不夜城を作り直して……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 702012,
			nameColor = "#FF9B93",
			say = "もう状況を飲み込んだのですか。さすがに私の自慢の部下です",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 702012,
			nameColor = "#FF9B93",
			say = "「グレイトォ」は最初から私たち「レジスタンス」こそが街の主だと気づいていません",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 702012,
			nameColor = "#FF9B93",
			say = "私たちが街の人々に与えた「希望」こそが、この街を一つにしているんです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 702012,
			nameColor = "#FF9B93",
			say = "ポルタヴァの野心が、あの程度の利益で満たされるわけがないことも知らずに……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 702012,
			nameColor = "#FF9B93",
			say = "まあいいです。この劇もそろそろ終わりが近づいているのですから",
			painting = {
				alpha = 0.3,
				time = 1
			},
