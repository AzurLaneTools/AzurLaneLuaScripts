return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "やはり何者かが私たちに「主機」を攻撃させるためにここに引き込まれたのか",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "こっちの情報も送るわ。今置かれている状況を知るのに役立つから",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "残念だけど、外部からヴェスタルがいる場所に侵入するなんて不可能よ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "主機の近くにハーミットのスペアボディがあるはず。それを早く破壊して",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			hidePaintObj = true,
			say = "ごめんなさい。こうなっちゃって……ヴェスタルに行かせた私のミスよ",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "では、ハーミットの主機を破壊すればそいつを倒せるというわけか？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "悪夢、リュウコツ侵食、そして記録の再生操作もすべてデビルの仕業…か",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "それについては同意だ。私たちはすでに一度ハーミットのスペアボディを撃退している",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "……しかしその口ぶりからすれば、あの時は本気じゃなかったかもな",
			painting = {
				alpha = 0.3,
				time = 1
			},
