return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "廃墟になっていても、当時の激しい戦火から免れたため、街の構造はそんなに変わっていません",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "…妙ですね。ザイドリッツ、アンデッドの姿がどこにも見当たりませんが",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600030,
			nameColor = "#A9F548FF",
			say = "ふふふ、どうしたの？王城の廃墟で宝探しにでも来たのかしら？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600040,
			nameColor = "#FF9B93",
			say = "ふふ、じゃあこれで初めてじゃなくなったろ？…って違うだろ！あぶない…流されてしまったところだ！",
			painting = {
				alpha = 0.3,
				time = 1
			},
