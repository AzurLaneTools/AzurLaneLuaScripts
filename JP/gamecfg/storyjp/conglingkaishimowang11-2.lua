return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "聖女様、どうしてこんな少ない手勢で魔王軍と戦ってるの！？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "見張り要塞に向かう途中、魔物に襲われている村人を見かけたので、手助けをしただけです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "しかし、数日前の大規模な戦いで、見張りの長城に穴が開いてしまいました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "今回王都を離れたのも、その穴を修復しに向かうため。…しかしまさか魔王軍が周辺まで来るとは想定していませんでした",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "どうやら魔王もこの千載一遇のチャンスに、何らかの行動を起こそうとしているようです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "これらの避難民はみな、穴の近くのフリード村から来たのです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "だから今この瞬間も、魔物がフリード村で暴れまわっていると思うと……",
			painting = {
				alpha = 0.3,
				time = 1
			},
