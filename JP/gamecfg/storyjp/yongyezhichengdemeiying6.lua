return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 1,
			say = "がぶっと嚙まれた。血が吸われていくにつれ、ゆっくりと意識が薄れていった…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "なんか心外そうな顔してるけど、ほら、ここに書いてある通り、「人間が反応できない間に、わがままなヴァンパイアのお嬢様に吸いつかれる」って部分を演じただけだよ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "普通ならここでゲームオーバーだが、まあ今回はプレイ継続だな",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "リュッツォウに襲われようとしたその瞬間、十字架をリュッツォウに向けてかざした。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "その瞬間、二人のヴァンパイアはまるで彫像のように固まり動かなくなった。よし、これで拘束からは逃れ――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "…妙なことに、リュッツォウが体ごと押しかけてきて、逆に下手に身動きが取れなくなった…これは一体？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "リュッツォウ、脚本通りに進めてくれ。大人しく効いたふりをして指揮官を離しなさい",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "えぇー、だってせっかく指揮官を捕まえたのに、手放すなんてもったいないよ。ね、指揮官？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "そうか。なら直接止めはしないが、この出来事は報告させてもらう。それでオイゲンがNPCを変えるかどうかは…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "むぅ。わかったよぉ…「うっわーそんなー（とてつもない棒読み）」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "ううぅ…こんな力を持っているなんて。じゃ我慢して道案内するしかないよねー",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "出口はすぐそこだよ。にんげ…じゃなくて眷属よ、一緒にがんばろう♪",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
