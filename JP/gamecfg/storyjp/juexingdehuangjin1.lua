return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actorName = "サラトガちゃん",
			say = "今は「アイアンクローの悪魔」とだけ呼ばれるようになったの",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "サラトガちゃん",
			say = "たったの一撃で、海域全体のお菓子輸送船を撃沈させた、恐ろしい力の持ち主だったとか",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "サラトガちゃん",
			say = "被害者のリトル・チェシャーは、「あまりにも速い襲撃でチェシャーすら見逃したにゃ」、と",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "サラトガちゃん",
			say = "あの重桜の軍師天城ちゃんは、「一陣営で彼女を阻止するにはムリムリです」、と",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "サラトガちゃん",
			say = "そうして各陣営が全艦隊を集結させ、前代未聞の規模の連合作戦を発動したの",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "サラトガちゃん",
			say = "それでようやく彼女を追い詰め、略奪したお菓子とともに海に沈めた",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "サラトガちゃん",
			say = "……そうして神出鬼没の「アイアンクローの悪魔」になったという！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
