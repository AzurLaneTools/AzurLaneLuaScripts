return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "ふふふ、ずいぶんと好戦的じゃない。「戦争」の名を表しているわね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "それじゃあロイヤル、女王陛下のご加護で戦ってみなさいよ♪",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "一緒に戦うとは言ったけど、別にそのタイミングと戦い方の指定まではしてなかったでしょ？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "ここまで来たら引くという選択肢はありません。私たちだけで戦いましょう",
			painting = {
				alpha = 0.3,
				time = 1
			},
