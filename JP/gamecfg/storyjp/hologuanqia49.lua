return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "いつも一緒に戦ってくれた江風、瑞鶴、ラフィー、綾波、ジャベリン、Z23、ピュリファイアー",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			side = 2,
			dir = 1,
			say = "最後になりましたが、ホロライブの一員として、みなさまの今後の活躍をお祈り申し上げます。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
