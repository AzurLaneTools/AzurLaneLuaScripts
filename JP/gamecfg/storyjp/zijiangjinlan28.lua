return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "分かりました。拠点の制圧が終わったら私たちも中央拠点に反転しますか？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "やっぱり仲間と戦うんですね…山城、てっきりもう一緒に中心拠点を攻める流れだと思ってました…！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "そうですか？良かった……じゃあ山城、引き続き修理をしてきます！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "（長門さまも大先輩もそう易々と目論見通りにはいかせてくれないはず…どうする？武蔵）",
			painting = {
				alpha = 0.3,
				time = 1
			},
