return {
	...
	scripts = {
		...
		{
			say = "まあ面白いかどうかというより、学園で戦技を勉強し実力を上げるのも重要な任務ですね。",
			side = 0,
			bgName = "star_level_bg_103",
			nameColor = "#a9f548",
			dir = 1,
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まあ安心しな。妹を心配しない姉なんていないって。Zクラスの俺が保証するぜ。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
