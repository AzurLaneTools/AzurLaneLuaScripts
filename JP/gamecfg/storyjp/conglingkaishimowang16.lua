return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "皆さんが攻略しようとしている魔王軍の拠点は、「永夜の闇」という強力なバリアで守られています",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "吸血鬼の秘伝の術式で、解除方法を知らなければ絶対に進入できません",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "長く戦ってきました私たちですら、どの拠点も攻略できなかったのはそれのせいです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "拠点の防備ですが、3つの拠点の中で中央拠点の戦力が最も強力です",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "なにせ見張り要塞の出入り口に最も近いこの拠点ですから、魔王も特に注力しました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "要塞の門から出てすぐにこの最強の要塞に直接向かったパーティーもいましたが……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "運も実力のうちです。…時には運が実力よりも重要になることだってあるでしょう",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "ザイドリッツ",
			say = "はい。ですがみんな「天冠城壁遺跡」と呼ぶようにしています",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "あなたたちにとっては遠い昔のことかもしれませんが、私たちにとっては……昨日の出来事のようなものです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ふふ、わかっていますよ。では冒険者の方々、拠点の中に入りましょう。ここで立ち話をしても仕方ありませんから",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ずっと生活してきた場所を適当にするわけにはいきませんから",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "我々ヴァンパイアハンターは——旧王城が陥落する前から存在していました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "今、魔王の配下になっている大吸血鬼たちは、もともと人間の王国の貴族でした",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "王都が戦力の大部分を魔王軍との前線に回した頃、卑劣にも吸血鬼たちが反乱を起こしました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "この反乱により、人間の王国の王都は滅び、バラード城はその日、歌も聞こえない城となりました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "我々はまさしく、あの日王都の厄災から生き残った者たちです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "こちらはてっきり、魔王が武力だけで旧王都を攻め落としたのだと…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "人間が数百年も生きられるはずがありません。あなた方はどうやって長く生きられるようになったのですか？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "王都陥落の大災厄はあまりにも恐ろしく、何人かの神々が憐れみに思ってくれたのかもしれません",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "多くの人々は魔法の毒霧を吸い込み、吸血鬼の言いなりになるしかない不死の魔物に変えられました",
			painting = {
				alpha = 0.3,
				time = 1
			},
