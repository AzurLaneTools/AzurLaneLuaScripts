return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "いつも私たちの前に現れては、意味深長なことばかり言って……今度は何を企んでるのですか！？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "このオホーツク海域、いつもと様子が全然違うと思ったら……つまり、そういうことにゃ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "話を聞いてますと、私たちの世界にも手を出しているみたいですし……放置するのも決まりが悪そうですね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
