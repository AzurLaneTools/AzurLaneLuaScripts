return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			dialogueBgAlpha = 0.6,
			say = "ケビール島の聖堂施設の時と同じように、リシュリューの旗に無数の光が集まっていることに気づく。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "祈りを捧げれば、心象が反映され「概念」として現れます",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "………やっぱり審判廷の聖堂にはこの仕掛けが共通してあるのですね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "いいえ、聖堂だけでなく、もっと広い範囲での「概念」による攻撃…",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "それを物理的に応用したのが「黙示録の四騎士」でしたら、今のは……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dialogueBgAlpha = 0.6,
			say = "遠くから響く砲撃の轟音がリシュリューの思考を中断させた。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#92fc63",
			hidePaintObj = true,
			say = "審判廷、いいえ、アイリスの秘蹟――いつか絶対にちゃんと説明してもらいます",
			painting = {
				alpha = 0.3,
				time = 1
			},
