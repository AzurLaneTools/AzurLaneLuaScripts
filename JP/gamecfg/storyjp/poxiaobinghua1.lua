return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "予定より早く来てくれるとは…ご苦労だベラルーシア、急がせてしまってすまなかったな。損傷のほうは大丈夫か？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "最前線から最大速力で戻ってきたんだ、多少の損傷もやむなしさ。動力系統と砲塔は要点検だが……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "今回の行動には支障なしと見た。そういえば、私を呼び戻した張本人は？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "大洋でセイレーンが後退している情報もあって、むしろこの機に乗じて反攻作戦をやろうという話が出ているわね。北方連合としてどこまで参加するかも含めて話し合いで解決しなくては",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "戦いに参加しながら、こういう政治の話にも参加せねばならないとな",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ああ。北方連合に滞在している間に、同志指揮官の指揮能力と思想に関する調査が完了した",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "すべてにおいて同志指揮官は北方連合の秘密を知ってもらう存在にふさわしい、という結論に至った",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=51>「お宝以外にね、ゲームを成り立たせるために配役が要るんだ」</size>",
					2.5
				},
				{
					"<size=51>「『探索』をするもの、『観察』をするもの」</size>",
					4
				},
				{
					"<size=51>「お宝の隠し場所を『作る』者――」</size> ",
					5.5
				},
				{
					"<size=51>「そして、一番大事なのは」</size>",
					7
				},
				{
					"<size=51>「それぞれの人を出会わせないことだよ」</size>",
					8.5
				}
			}
		},
