return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			nameColor = "#A9F548FF",
			say = "――企画委員会のメンバーは…撫順、綾波、雷、電、ロング・アイランド、フリードリヒ・カール、クーちゃん、ブリストル、ロイヤル・フォーチュン……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "bg_story_task_2",
			nameColor = "#A9F548FF",
			say = "――クレマンソー、ヴァリアント、オイゲン、マルコ・ポーロ、カサブランカ、海天、ダヴィンチ、イングラハム、夕張……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "明石",
			say = "むふふふふ……あ！システム稼働バッチリにゃ！いつでもどうぞにゃ！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_177",
			nameColor = "#A9F548FF",
			say = "――ついさっきまで会議室でフリードリヒ・カールから報告を受けていたはず……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_177",
			nameColor = "#A9F548FF",
			say = "――そしたら次の瞬間にはここに……母港にこんな場所なんてあっただろうか？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "明石",
			say = "遠い場所からやってきた冒険者よ。饅頭神殿へようこそにゃ～",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "――自分が今ここで倒れたら、締切が今日の報告書と締切が明日の計画表はどうなるのか！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "――あれか？これはこの間話した『母港バーチャルリアルプロジェクト』か？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "――企画委員会にカールがいるし、ここに飛ばされる前に打ち合わせをしていた…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "――ふむ。つまり「大型バーチャル体験ゲーム」が完成していたのか",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_177",
			nameColor = "#A9F548FF",
			say = "――ええと、たしかこの手のゲームだと先に出身地・オリジン・開始時の所持スキルを選ぶんだろ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
