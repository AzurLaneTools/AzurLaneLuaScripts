return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "い、依頼書を持ってるってことは……害虫駆除してくれるの？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "それで？害虫が出るのは倉庫の中ってことでいいんだよね？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "正義のために害虫を駆逐しなきゃと思って、倉庫内をくまなく見たんだけど、どこにも見つからな……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "うーん。思っていたよりもずっと狡猾そうな相手ね。誘い出すのも難しそうだし……は！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ふぅ。でもこの様子じゃまだまだ数十匹は覚悟したほうがいいかもね。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官、助言に感謝する！やっぱりどんなに勇ましい騎士でも、指揮官の助言は必要だね！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
