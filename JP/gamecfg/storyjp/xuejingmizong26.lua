return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "料理に合うお酒だけまだ見つかってないの～。酒蔵から良さそうなものを見繕ってもらえる？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "今日はアイリス料理を準備したから、いつもと違う感じのにしたいなぁって",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			oldPhoto = true,
			say = "月夜の下で、傷ついたフネは静かに見張りの役目を果たしている。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			oldPhoto = true,
			say = "寒くて寂しくても、希望への喜びと、偉大なる戦争を戦い抜いた尊き誇りを感じ取れた。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――もちろん。なんとなくだが、これが最後の扉だって感じたな",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――南極大陸だな。もっともソユーズがいたところではないが……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "――ソユーズたち…南極にいる仲間たちはちゃんと勝利できたか？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "ドロイドの消滅も確認できており、どうやらアビータの侵略はなんとか未然に防ぐことができたようです",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "南極大陸での作戦行動は「南極条約」の履行だけでなく、各陣営が一致団結して敵に対処するいい例になりました",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "改めて、北方連合を代表して同志指揮官に感謝申し上げます",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "北方連合はあなたの力となって、あなたと共に歩んでいきます",
			painting = {
				alpha = 0.3,
				time = 1
			},
