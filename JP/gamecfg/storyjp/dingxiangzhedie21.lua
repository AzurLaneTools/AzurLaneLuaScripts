return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "性能向上もいいけど、支援ドローンが一番役に立つのは敵の弱点探知と状態の分析ね",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "あの支援ドローンは艦載機をどれくらい強化してくれるの？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "どこまでできるのやら…楽しみ！指揮官、開始の合図をお願い！",
			painting = {
				alpha = 0.3,
				time = 1
			},
