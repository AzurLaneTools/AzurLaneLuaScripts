...
版本更新提示：
感谢您下载并使用《碧蓝航线》游戏（以下称“本游戏”或“产品”）。我们依据《中华人民共和国网络安全法》、《信息安全技术个人信息安全规范》（GB/T 35273-2020）以及其他相关法律法规和技术规范更新了本《隐私政策》，其中主要包括如下内容：增加了我们使用您个人信息以及授权权限的场景描述（见第四部分4.2.2条）；调整游戏账号注销的功能说明（见第八条第5项）。
...
儿童特别说明：
若您是未满14周岁的未成年人（以下简称“儿童”），请通知您的监护人共同阅读本《隐私政策》，特别是《儿童隐私保护政策》，在您取得您的监护人对本隐私政策全部条款，特别是《儿童隐私保护政策》全部条款的同意之后使用我们提供的游戏及服务。您点击同意本隐私政策，或者您使用或继续使用我们提供的游戏及服务、提交个人信息，都表示您已获得您的监护人的许可，且您的监护人也同意我们按照本隐私政策使用和处理您的相关信息。

二、关于我们
1.本游戏由芜湖享游网络技术有限公司（以下称“本公司”）及其关联公司提供运营服务。
...
4.2使用游戏
4.2.1当您下载并使用本游戏过程中，为向您提供最佳的游戏使用体验，我们可能会收集您的如下个人信息。
（1）当您注册或使用哔哩哔哩游戏服务时，我们会收集您的网络身份标识信息及个人常用设备信息，用于标记您为哔哩哔哩游戏的用户。
（2）为满足相关法律法规政策及相关主管部门的要求，我们施行网络游戏用户账号实名注册制度，全面接入国家新闻出版署实名认证系统，哔哩哔哩游戏用户需进行实名认证以继续使用和享受哔哩哔哩游戏的服务。为了完成实名认证服务，您需要提供您的个人身份信息、个人生物识别信息，包括如下：姓名、身份证件号码（个人敏感信息）等信息，具体以国家新闻出版署实名认证系统的要求为准。我们向您承诺，上述信息仅用于实名认证之目的，但是，为了完成实名认证以及履行存储注册信息义务，我们将存储您提供的姓名（个人敏感信息）、身份证件号码（个人敏感信息）等信息。如您拒绝提供实名身份信息可能会导致您无法登录哔哩哔哩游戏或在使用哔哩哔哩游戏过程中受到相应限制。
（3）为保障您正常使用我们的服务，维护游戏基础功能的正常运行，保障您的游戏账号安全，识别账号异常状态，了解产品适配性，维护基础功能的正常运行，同时也为了营造健康及安全的游戏环境，我们会收集您的设备信息：包括游戏应用信息、设备信息（设备ID、设备序列号、设备制造商、设备名称、设备类型和版本、设备型号、设备样式、设备识别符（如IDFA、 IMEI、IMSI、MAC地址））、网络类型、系统版本、IP地址、网络身份识别信息、操作系统及进程信息、网络环境信息以及游戏崩溃记录信息。
（4）当您使用哔哩哔哩游戏服务时，我们会收集您的游戏日志信息，例如登录日志录等，以便用于游戏运营统计分析、客服投诉处理及其他游戏安全分析，我们会把前述信息同步至该游戏后续版本或您正在使用的我们提供的其他产品中。
（5）当您使用哔哩哔哩游戏产品的消费功能时，我们会收集您的充值记录、消费记录等信息，以便您查询您的交易记录，同时尽最大程度保护您的虚拟物品安全。充值记录、消费记录属于敏感信息，收集上述信息为实现哔哩哔哩游戏产品的消费功能所必须，否则将无法完成交易。
4.2.2同时为了收集上述信息，我们将会申请访问您的设备信息的如下权限：
（1）本地储存及读写权限：在哔哩哔哩游戏产品应用程序运行时，为对数据进行缓存和读取，我们将获取您的本地存储及读写权限。
（2）网络访问权限：在哔哩哔哩游戏产品应用程序运行时，为了正常联网使用游戏服务，我们将需要使用您的网络访问权限。
（3）相机及相册权限：当您使用拍照和上传图片的功能时，您需要授权我们获取您的相机权限、相册权限、照片权限，收集您提供的图片信息，以便您可以使用上传、分享功能。如您拒绝提供上述信息以及权限仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的相机及相册访问权限授权。
（4）麦克风权限：当您使用游戏内语音功能，我们会要获取您的设备麦克风权限，收集您的语音信息，用以提供语音形式的社交功能服务。如您拒绝提供该信息仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的麦克风权限授权。
（5）通知权限：当您使用哔哩哔哩游戏中提醒功能时，您需要授权我们获取您的通知权限，用以提供提醒服务。如您拒绝授权仅会使您无法使用该提醒功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的通知权限授权。
（6）地理位置权限：当您希望与您附近的哔哩哔哩游戏产品的其他用户互动，或参与您附近的线上线下游戏周边活动，或参与哔哩哔哩游戏产品中的地区排行榜时，您需要授权我们获取您的地理位置权限，用于为您寻找附近的其他用户或参与活动，在您授权同意后，我们会收集您的地理位置信息。地理位置信息属于敏感信息，拒绝提供该信息只会导致您无法使用该功能，但不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的地理位置信息授权。
（7）控制震动器权限：在哔哩哔哩游戏产品应用程序运行时，为优化我们的服务体验我们将获取您的震动器控制权限，您可以享受到部分功能及提醒的震动反馈。如您拒绝提供该权限仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的震动器控制授权。
...
4.7出于其他合理且必要的目的
（1）消息通知与营销推广。我们可能会通过您在使用产品/服务过程中所提供的联系方式（如电话号码），向您发送一种或多种类型的通知，用于用户消息告知、身份验证、安全验证、用户使用体验调研；此外，我们也可能会通过短信、拨打电话的方式向您提供您可能感兴趣的服务、功能或活动等商业性信息。如您不愿接收我们的商业性信息，您可通过我们为您提供的退订方式进行退订，您也可以联系我们退订（第十条“联系我们”）。
（2）如前文所述，如果某一需要收集您的个人信息的功能或产品/服务未能在本隐私政策中予以说明的，或者我们超出了与收集您的个人信息时所声称的目的及具有直接或合理关联范围的，我们将在收集和使用你的个人信息前，通过更新本隐私政策、页面提示、弹窗、私信、网站公告或其他便于您获知的方式另行向您说明，并为您提供自主选择同意的方式，且在征得您明示同意后收集和使用。
（3）您理解并同意，在以下情况下，我们无需取得您的授权同意即可收集和使用您的个人信息：
a)与国家安全、国防安全有关的；
...
（5） 当我们终止服务及运营时。
4.您有权撤回您对个人信息的授权
如前文所述，我们提供的产品和服务的部分功能需要获得您使用设备的相关权限（您向我们授权的权限见第四部分详述，具体以产品实际获取的功能为准）。您可以在授权后随时撤回（或停止）对该权限的继续授权。如果您希望撤销同意我们收集、使用和披露您的其他个人信息或希望我们删除您的个人信息，可通过本隐私政策中的联系方式与我们联系。例如您可以通过安卓设备中的“设置-应用和通知-权限管理”来关闭您对相机及相册权限的授权。
您也可以通过注销账号的方式，永久撤回我们继续收集您个人信息的全部授权。您需理解，当您撤回授权后，我们无法继续为您提供撤回授权所对应的特定功能和/或服务。但您撤回授权的决定，不会影响此前基于您的授权而开展的个人信息处理。
5.您有权注销您的账号
（1）您可以通过在线申请注销或联系客服或通过其他我们公示的方式申请注销您的账号。当您注销账号后，您将无法再以该账号登录和使用本游戏；且该账号在本游戏的使用期间已产生的但未消耗完毕的权益及未来的逾期利益等全部权益将被清除；该账号在本游戏下的内容、信息、数据、记录、游戏道具、等级等将会被删除或匿名化处理，但法律法规另有规定或监管部门另有要求的除外，如依据《中华人民共和国网络安全法》规定，您的网络操作日志将至少保留六个月的时间）；账号注销完成后，将无法恢复。
更多关于账号注销的流程、条件等事项请详见《账号注销协议》。
如您在谨慎考虑后仍执意决定注销您的账号的，您可以在您使用的我们的产品与/或服务的相关功能设置页面或根据操作指引向我们提交注销申请，例如ios端APP的账号注销路径为：“我的—设置—隐私权限设置-账号注销”。
如果您在处置您的个人信息时有任何疑问，您可以通过本隐私政策第十条“联系我们”中公示的联系方式与我们沟通解决。在收到信息后，我们将在15个工作日内响应您的请求。
（2）由于您登录本游戏使用的账号与哔哩哔哩平台（bilibili.com）账号具有关联性，若您注销了哔哩哔哩平台（bilibili.com）账号则会导致您的游戏账号被同步注销。除了通过第（1）项提示您的方式注销本游戏账号，您也可以通过注销哔哩哔哩APP账号的方式申请注销您的游戏账号。当您注销哔哩哔哩APP账号账号后，您将无法再以哔哩哔哩APP账号登录和使用本游戏以及哔哩哔哩旗下的其他产品与服务；且哔哩哔哩APP账号在本游戏和哔哩哔哩及旗下的其他产品与服务使用期间已产生的但未消耗完毕的权益及未来的逾期利益等全部权益将被清除。哔哩哔哩APP账号注销的流程、条件等事项请详见哔哩哔哩APP相关功能设置页面或根据哔哩哔哩APP操作指引提交注销申请，例如安卓端哔哩哔哩APP的账号注销路径为：“我的—设置—隐私权限设置-账号注销”。
（3）若您使用第三方账号登录本游戏，且您选择注销您的账号，我们提醒您：您应自行至第三方平台解除使用该第三方账号登录本游戏的授权，解除授权的流程、条件等事项均以该第三方平台的要求为准。
