...
pg.ship_data_create_material = {
	...
	},
	{
		...
		rate_tip = {
			...
			"ノーマル：28.8%",
			" ",
			"<color=#ff5e39>ウルリッヒ・フォン・フッテン</color>：1.2%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>プリンツ・アーダルベルト</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>マクデブルク</color>：0.5%",
			" ",
			"<color=#d797ff>エルベ</color>：2.5%(<color=#92fc63>up!</color>)"
		}
	},
	{
		use_gold = 1500,
