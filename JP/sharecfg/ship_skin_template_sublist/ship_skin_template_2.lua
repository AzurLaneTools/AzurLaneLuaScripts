...
pg.base.ship_skin_template_2 = {
	...
	[102080] = {
		name = "{namecode:524}",
		change_skin = "",
		desc = "亚特兰大级轻巡洋舰—{namecode:524}，舷号CL-53",
		illustrator2 = 19,
		ship_group = 10208,
		group_index = 0,
		purchase_offset = "",
	...
	[102081] = {
		name = "圣诞亚哥！",
		change_skin = "",
		desc = "圣诞快乐！偶像之{namecode:524}闪亮登场！指挥官，我的演唱会，一定要来噢！……地址！？那是什么？",
		illustrator2 = 19,
		ship_group = 10208,
		group_index = 1,
		purchase_offset = "",
	...
	[102088] = {
		...
		change_skin = "",
		desc = "只要有指挥官的爱之力，{namecode:524}一定能成为港区的No.1！…什么的No.1？不太清楚！总之一定可以的！",
		illustrator2 = 19,
		ship_group = 10208,
		group_index = 8,
		purchase_offset = "",
	...
	[102089] = {
		name = "{namecode:528}",
		change_skin = "",
		desc = "欸嘿⭐虽然搞不清楚发生了什么，不过{namecode:524}好像变厉害了呢！指挥官看到我的闪闪发光的“气场”了吗~",
		illustrator2 = 19,
		ship_group = 10208,
		group_index = 9,
		purchase_offset = "",
	...
	[102091] = {
		name = "恶魔降临之夜",
		change_skin = "",
		desc = "这个南瓜可以坐两个人哦，快坐上来吧……啊，对了！我还有南瓜派，指挥官，要吃吗？",
		illustrator2 = -1,
		ship_group = 10209,
		group_index = 1,
		purchase_offset = "",
	...
	[102092] = {
		name = "骑士之夜",
		change_skin = "",
		desc = "大家都穿着漂亮的礼服，为什么只有我是男装啦…算了，穿着还挺轻便的。指挥官，我们出发吧！要去参加宴会不是吗？",
		illustrator2 = -1,
		ship_group = 10209,
		group_index = 2,
		purchase_offset = "",
	...
	[102098] = {
		name = "心动一刻",
		change_skin = "",
		desc = "果然还是很让人害羞啊……指挥官觉得呢？我，我这幅样子，那个，怎，怎么样……",
		illustrator2 = -1,
		ship_group = 10209,
		group_index = 8,
		purchase_offset = "",
	...
	[102121] = {
		name = "阳伞下的同桌",
		change_skin = "",
		desc = "大家都看老师的话，就没人会注意到我的胸部了……在教室中打开伞遮住自己会不会有点显眼……但、但是不想被后面的同学看到自己……",
		illustrator2 = -1,
		ship_group = 10212,
		group_index = 1,
		purchase_offset = "",
	...
	[102123] = {
		name = "大胆(?)的麋鹿小姐",
		change_skin = "",
		desc = "路易斯那家伙，说什么穿着驯鹿服能和海伦娜搞好关系，我也真是信了她的邪…………哇啊啊啊啊啊，指挥官，你进来干什么，快给我出去！",
		illustrator2 = -1,
		ship_group = 10212,
		group_index = 3,
		purchase_offset = "",
	...
	[102131] = {
		name = "春之华",
		change_skin = "",
		desc = "指挥官，这身异国的衣服怎么样？嘻嘻，再一次对我一见钟情了吗？",
		illustrator2 = -1,
		ship_group = 10213,
		group_index = 1,
		purchase_offset = "",
	...
	[102132] = {
		name = "雪下之饮",
		change_skin = "",
		desc = "重樱的服装穿起来果然别有一番风味呢，呵呵……指挥官，别在那傻站着，不冷吗？过来喝一杯吧",
		illustrator2 = -1,
		ship_group = 10213,
		group_index = 2,
		purchase_offset = "",
	...
	[102181] = {
		name = "红色苹果糖",
		change_skin = "",
		desc = "苹果糖、鲷鱼烧、炒面～重樱的“庙会”还真是不错呢～嘻嘻，指挥官也要舔一口苹果糖吗？喏，给你～",
		illustrator2 = -1,
		ship_group = 10218,
		group_index = 1,
		purchase_offset = "",
	...
	[102240] = {
		name = "克利夫兰(μ兵装)",
		change_skin = "",
		desc = "轻巡洋舰克利夫兰前来报到！虽然对这块不是很熟悉，但是既然要做了自然会全力配合大家！指挥官，应援也拜托啦！",
		illustrator2 = -1,
		ship_group = 10224,
		group_index = 0,
		purchase_offset = "",
	...
	[102254] = {
		name = "罗密欧or朱丽叶？",
		change_skin = "",
		desc = "你问这个面具是什么？是用在舞会的剧目上的道具哦。……对了，指挥官，能陪我练习吗？——那就，“您愿意与我共舞一曲吗？”",
		illustrator2 = -1,
		ship_group = 10225,
		group_index = 4,
		purchase_offset = "",
	...
	[102272] = {
		name = "魅惑的缤纷雪夜",
		change_skin = "",
		desc = "哇！从这边看出去风景还真好…看来指挥官还是有点选地方的眼光的嘛~嘻嘻~那就正式地来一句…圣诞快乐♡",
		illustrator2 = -1,
		ship_group = 10227,
		group_index = 2,
		purchase_offset = "",
	...
	[102290] = {
		name = "{namecode:197}",
		change_skin = "",
		desc = "布鲁克林级轻巡洋舰—{namecode:197}，舷号CL-47",
		illustrator2 = -1,
		ship_group = 10229,
		group_index = 0,
		purchase_offset = "",
	...
	[102320] = {
		name = "{namecode:197}(μ兵装)",
		change_skin = "",
		desc = "Cyanidin（花青素）所属，轻巡洋舰{namecode:197}。呼~哈~这个打扮变得更引起指挥官的注意了吗？……那就好……",
		illustrator2 = -1,
		ship_group = 10232,
		group_index = 0,
		purchase_offset = "",
	...
	[103069] = {
		name = "波特兰.改",
		change_skin = "",
		desc = "初次见面，我是印第安纳波特兰——欸？印第？她是我最重要的妹妹，也是我挚爱的……",
		illustrator2 = -1,
		ship_group = 10306,
		group_index = 9,
		purchase_offset = "",
	...
	[103091] = {
		name = "炎夏凉风",
		change_skin = "",
		desc = "大家都充满了活力呢……指挥官，累了的话就坐这里休息下吧？",
		illustrator2 = -1,
		ship_group = 10309,
		group_index = 1,
		purchase_offset = "",
	...
	[103131] = {
		name = "野性派学生",
		change_skin = "",
		desc = "课本、铅笔、橡皮擦…唔，学生就一定要待在教室认真听课吗…指挥官，能不能多安排一些课外实践的活动啊？",
		illustrator2 = -1,
		ship_group = 10313,
		group_index = 1,
		purchase_offset = "",
	...
	[103141] = {
		name = "Funny Bunny！",
		change_skin = "",
		desc = "呼哈~灯光！音乐！美食！都很到位，不错！嘻嘻，欢迎来到兔女郎{namecode:195}的快乐派对！来享受快乐吧！",
		illustrator2 = -1,
		ship_group = 10314,
		group_index = 1,
		purchase_offset = "",
	...
	[103142] = {
		name = "It's showtime!",
		change_skin = "",
		desc = "晚上好呀小布丁！欢迎来到{namecode:195}的表演秀！今晚在你彻底被我迷倒之前，我是不会放你走的哦♪",
		illustrator2 = -1,
		ship_group = 10314,
		group_index = 2,
		purchase_offset = "",
	...
	[103242] = {
		name = "功夫少女！",
		change_skin = "",
		desc = "“到此为止了，坏蛋们！在这里遇到我算你们倒霉，该到清算你们罪恶的时候了！”……唔，果然想要有个充满魄力的登场还是挺难的啊。",
		illustrator2 = -1,
		ship_group = 10324,
		group_index = 2,
		purchase_offset = "",
	...
	[103260] = {
		name = "北安普敦II",
		change_skin = "",
		desc = "俄勒冈城级重巡洋舰—北安普敦II，舷号CA-125",
		illustrator2 = -1,
		ship_group = 10326,
		group_index = 0,
		purchase_offset = "",
