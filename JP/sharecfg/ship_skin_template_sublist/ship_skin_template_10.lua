...
pg.base.ship_skin_template_10 = {
	...
	[307085] = {
		name = "溶け合う夢に相擁す",
		change_skin = "",
		desc = "ふぅ……共にこの珍妙な酒を楽しむと約束したのに、つい飲み耽けて……残されたのは唇に何滴か…汝も…楽しむ…？",
		illustrator2 = -1,
		ship_group = 30708,
		group_index = 5,
		painting = "xinnong_6",
	...
	[307158] = {
		name = "水月の花燭（空母）",
		change_skin = "",
		desc = "「喜びのときも、悲しみのときも、健やかなるときも、病めるときも…」――指揮官様？ふふふ、何かの兆しなどではございません。「あなたの天城」にもうそのような心配は要りませんわ",
		illustrator2 = -1,
		ship_group = 30715,
		group_index = 8,
		purchase_offset = "",
	...
	[307171] = {
		name = "夜陰影儀",
		desc = "この程度の任務なんてお茶の子さいさいよ。水が入り込めない隙間なんてありませんし、染み込めない壁もありません。見ていなさい、今お姉さまがこの鉄壁の防御網に浸透してみせますわ♪",
		illustrator2 = -1,
		ship_group = 30717,
		group_index = 1,
		purchase_offset = "",
	...
	[317011] = {
		name = "放課後の観察日記",
		change_skin = "",
		desc = "たかーい……でも大丈夫よ、指揮官、あたしバランス感覚はいいから。それより、この下に何があるか見てみない？",
		illustrator2 = -1,
		ship_group = 31701,
		group_index = 1,
		purchase_offset = "",
