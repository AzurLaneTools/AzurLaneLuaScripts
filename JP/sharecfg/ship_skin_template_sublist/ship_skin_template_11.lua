...
pg.base.ship_skin_template_11 = {
	...
	[305131] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "ハンモックとかウォーターベッドとか、なんとなくいつも波に揺られているようで、疲れもとれるし気分もリフレッシュできるからめっちゃ最高♪指揮官も一度乗ってみない？",
		voice_actor = 295,
		gyro = 0,
		rarity_bg = "",
		time = "",
	...
	[307122] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "んん～暑い季節になると涼しい場所を求めるのは艦船だけでなくヒトの常ではあるけどまあ普通に考えれば山か海なんだよね～。でもここはあえて屋上プールにすることで高い山の眺めとひんやりとした水を両立させられるってわけだけれど、指揮官はどう思う？おーい、聞いてる？",
		voice_actor = 286,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
