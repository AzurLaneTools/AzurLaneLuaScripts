...
装備・スキル【スクランブル】【ウサウサラストスタンド】が無効になる]],
	...
	pg.base.strategy_data_template[200931] = {
		...
		name = "チャレンジモード",
		desc = [[
戦闘開始時味方艦船が<color=#92fc63>【謎のD装置】</color>を装備している場合、戦闘はチャレンジモードに入り難易度が上昇しますが、クリアするとより高いスコアが狙えるようになります。
...
【ウサウサラストスタンド】、【レインボー・プラン】、【絶対絶命】 ]],
	...
	pg.base.strategy_data_template[201741] = {
		...
		name = "チャレンジモード",
		desc = [[
ボスは自身から距離が20以上離れた相手から受けるダメージを軽減する<color=#92fc63>（距離が20より1離れる度に受けるダメージを1％軽減する。最大50％まで）</color>；距離が20以上離れた相手に与えるダメージが増加する<color=#92fc63>（距離が20より1離れる度に受けるダメージが2％増加する。最大100％まで）</color>。
...
<color=#ddf700>ヒント：ボスの初期位置から味方前衛艦隊の移動できる範囲の最左端までの距離は約70</color>]],
	...
	pg.base.strategy_data_template[201742] = {
		...
		name = "チャレンジモード",
		desc = [[
ボスは自身から距離が20以上離れた相手から受けるダメージを軽減する<color=#92fc63>（距離が20より1長くなる度に受けるダメージを1％軽減する。最大50％まで）</color>；距離が20以上離れる相手に与えるダメージが増加する<color=#92fc63>（距離が20より1長くなる度に受けるダメージを2％増加する。最大100％まで）</color>。
ボスが<color=#92fc63>前衛艦隊から受ける砲撃ダメージが100％アップし、雷撃ダメージが50％アップする</color>。
ボスは接近してくる爆弾を投下できる艦載機を極めて速く撃墜できる。
<color=#ddf700>ヒント：ボスの初期位置から味方前衛艦隊の移動できる範囲の最左端までの距離は約70</color>
...
【ウサウサラストスタンド】、【レインボー・プラン】、【絶対絶命】、【決して屈さぬぞ！】]],
	...
	pg.base.strategy_data_template[201743] = {
		...
		name = "チャレンジモード",
		desc = [[
任意のボスが撃破されると、もう一人のボスが【FEVER】モードになり、<color=#ffc038>攻撃方法が変更し、与えるダメージが大幅にアップ</color>。 ハードモード仕様：
 敵が与えるダメージが<color=#ffc038>極大アップ</color>。大きなサイズの敵弾は航空攻撃・シールドによって消されない。
 味方前衛艦隊の<color=#92fc63>当たり判定が前衛艦隊先頭艦だけになり、さらに当たり判定の大きさが大幅に小さくなる</color>。
 艦船が被弾した時、一定時間無敵になる。
 ...
 【ウサウサラストスタンド】、【レインボー・プラン】、【絶対絶命】、【決して屈さぬぞ！】]],
	...
	pg.base.strategy_data_template[201765] = {
		...
		name = "チャレンジモード",
		desc = [[
戦闘中味方が受ける回復効果はボスに奪われ、一度につきボスの耐久が<color=#92fc63>上限の1％分回復される</color>。ボスの黒い弾幕は航空攻撃によって消すことができない。
 ...
 【ウサウサラストスタンド】、【レインボー・プラン】、【絶対絶命】、【決して屈さぬぞ！】]],
	...
	pg.base.strategy_data_template[201832] = {
		...
		name = "チャレンジモード",
		desc = [[
戦闘中、ボノム・リシャールの周りに赤黒い竜巻が出現し、接近する味方を吸い込み、竜巻に近づき過ぎた味方は<color=#ee0000>竜巻の影響で戦闘不能</color>になる。
