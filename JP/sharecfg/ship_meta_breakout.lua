...
(function ()
	...
	pg.base.ship_meta_breakout[9701111] = {
		breakout_view = "【焔追の灰-カラビニエーレ】習得/主砲補正+5%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 500,
	...
	pg.base.ship_meta_breakout[9701113] = {
		breakout_view = "【焔追の灰-カラビニエーレ】強化/武器補正+5%",
		item2 = 21001,
		pre_id = 9701112,
		repair = 0,
		gold = 2500,
	...
	pg.base.ship_meta_breakout[9702101] = {
		breakout_view = "【焔追の灰-ケルン】習得/武器補正+2%",
		item2 = 21059,
		pre_id = 0,
		repair = 0,
		gold = 500,
	...
	pg.base.ship_meta_breakout[9702103] = {
		breakout_view = "【焔追の灰-ケルン】習得/武器補正+5%",
		item2 = 21059,
		pre_id = 9702102,
		repair = 0,
		gold = 2500,
	...
	pg.base.ship_meta_breakout[9702111] = {
		breakout_view = "【焔追の灰-レーゲンスブルク】習得/主砲補正+5%",
		item2 = 21058,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9702113] = {
		breakout_view = "【焔追の灰-レーゲンスブルク】強化/武器補正+5%",
		item2 = 21058,
		pre_id = 9702112,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9702121] = {
		breakout_view = "スキル【焔追の灰・ケーニヒスベルク】習得/武器補正+2%",
		item2 = 21060,
		pre_id = 0,
		repair = 0,
		gold = 500,
	...
	pg.base.ship_meta_breakout[9702123] = {
		breakout_view = "スキル【焔追の灰・ケーニヒスベルク】強化/武器補正+5%",
		item2 = 21060,
		pre_id = 9702122,
		repair = 0,
		gold = 2500,
	...
	pg.base.ship_meta_breakout[9702133] = {
		breakout_view = "スキル【焔追の灰・ニュルンベルク】強化/武器補正+5%",
		item2 = 21060,
		pre_id = 9702132,
		repair = 0,
		gold = 2500,
...
(function ()
	...
	pg.base.ship_meta_breakout[9707091] = {
		breakout_view = "スキル【炬火の力-ヴィクトリアス】習得/攻撃機数+1/艦載機補正+2%",
		item2 = 21001,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9707092] = {
		breakout_view = "攻撃隊上限+1/爆撃機数+1/艦載機補正+3%",
		item2 = 21001,
		pre_id = 9707091,
		repair = 0,
		gold = 3000,
	...
	pg.base.ship_meta_breakout[9707093] = {
		breakout_view = "【炬火の力-ヴィクトリアス】強化/艦載機数+1/艦載機補正+5%",
		item2 = 21001,
		pre_id = 9707092,
		repair = 0,
		gold = 10000,
	...
	pg.base.ship_meta_breakout[9707101] = {
		breakout_view = "スキル【炬火の力-サラトガ】習得/戦闘機数+1/艦載機補正+3%",
		item2 = 21064,
		pre_id = 0,
		repair = 0,
		gold = 1000,
	...
	pg.base.ship_meta_breakout[9707103] = {
		breakout_view = "【炬火の力-サラトガ】強化/艦載機数+1/艦載機補正+7%",
		item2 = 21064,
		pre_id = 9707102,
		repair = 0,
		gold = 10000,
