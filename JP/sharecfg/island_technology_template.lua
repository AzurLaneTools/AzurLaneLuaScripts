...
pg.base.island_technology_template = {
	...
	[410301] = {
		...
		tech_chara = 1,
		auto_finish = 1,
		complete_tips = "<color=#1E8FFE>朝露農場のアメリゴ</color>でのコッコートリの最大飼養数が増えました",
		island_level = 6,
	...
	[420302] = {
		...
		tech_chara = 1,
		auto_finish = 1,
		complete_tips = "<color=#1E8FFE>朝露農場のアメリゴ</color>でのブーブーブタの最大飼養数が増えました",
		island_level = 8,
	...
	[430302] = {
		...
		tech_chara = 1,
		auto_finish = 1,
		complete_tips = "<color=#1E8FFE>朝露農場のアメリゴ</color>でのモーモーウシの最大飼養数が増えました",
		island_level = 10,
	...
	[440302] = {
		...
		tech_chara = 1,
		auto_finish = 1,
		complete_tips = "<color=#1E8FFE>朝露農場のアメリゴ</color>でのメェメーヒツジの最大飼養数が増えました",
		island_level = 12,
