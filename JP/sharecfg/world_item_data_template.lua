...
pg.world_item_data_template = {
	...
	[2052] = {
		...
		name = "秘密情報任務開放・Ⅲ",
		item_transform_item_id = 0,
		display = "購入すると、追加情報を獲得できる「情報任務」「情報エリア」を開放できます。任務をクリアすると新しい10個（115-1,115-4,131-1から131-6まで）の秘密情報が閲覧できるようになります。「秘密情報任務開放・Ⅲ」は一回しか購入できず、また関連任務をすべてクリアしていないと、「秘密情報任務開放」を新たに購入できません",
		log_text = "",
		sort_priority = 1,
		usage = "usage_undefined",
		grid_num = 1,
