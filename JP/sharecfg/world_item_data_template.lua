...
pg.world_item_data_template = {
	...
	[2057] = {
		...
		item_transform_item_number = 0,
		log_text = "",
		display = "購入すると、追加情報を獲得できる「情報任務」「情報エリア」を開放できます。任務をクリアすると新しい10個（116-1から116-9まで,144-11から144-12まで,146-9）の秘密情報が閲覧できるようになります。「秘密情報任務開放・Ⅷ」は一回しか購入できず、また関連任務をすべてクリアしていないと、「秘密情報任務開放」を新たに購入できません",
