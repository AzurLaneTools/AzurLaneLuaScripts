...
(function ()
	...
	pg.base.world_item_data_template[2058] = {
		...
		item_transform_item_number = 0,
		log_text = "",
		display = "購入すると、追加情報を獲得できる「情報任務」「情報エリア」を開放できます。任務をクリアすると新しい10個（150-4、151-5から151-6まで、180-1、190-1から190-6まで）の秘密情報が閲覧できるようになります。「秘密情報任務開放・Ⅷ」は一回しか購入できず、また関連任務をすべてクリアしていないと、「秘密情報任務開放」を新たに購入できません",
