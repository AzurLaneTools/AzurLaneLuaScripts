...
pg.base.island_item_data_template = {
	...
	[3016] = {
		pt_num = 0,
		name = "フィッシュ&チップス",
		desc = "外はサクサク中はふっくらのフィッシュフライに、香ばしくておいしいフライドポテト。多くの人に愛されているグルメ！",
		type = 1,
		group_max = 0,
		manage_influence = 120,
		usage = "usage_undefined",
	...
	[3031] = {
		pt_num = 0,
		name = "レモンシュリンプ",
		desc = "エビのプリプリ感とレモンの甘酸っぱさが組み合わさり、さっぱりとしていて食欲をそそる。",
		type = 1,
		group_max = 0,
		manage_influence = 120,
		usage = "usage_undefined",
	...
	[100000] = {
		pt_num = 0,
		name = "職責の星",
		desc = "無限の可能性を拓いてくれる職責の星。使用するとキャラの能力上限を上げることができる",
		type = 2,
		group_max = 0,
		manage_influence = 0,
		usage = "usage_undefined",
