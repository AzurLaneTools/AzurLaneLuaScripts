...
(function ()
	...
	pg.base.commander_skill_template[41023] = {
		name = "海のエードゥル",
		desc_world = "参謀ニャとして装備されている場合、装備艦隊の潜水艦の潜航力が5アップ",
		next_id = 0,
		exp = 0,
		prev_id = 41022,
		desc = "支援範囲Lv＋1",
	...
	pg.base.commander_skill_template[960011] = {
		name = "果てへレッツゴー",
		desc_world = "装備艦隊の戦艦・巡洋戦艦・航空戦艦・風帆Mの火力を上昇させる（効果中、効果は指揮ステータスによる）",
		next_id = 960012,
		exp = 0,
		prev_id = 0,
		desc = "装備艦隊の戦艦・巡洋戦艦・航空戦艦・風帆Mの火力を上昇させる（効果中、効果は指揮ステータスによる）",
		id = 960011,
		icon = "96001",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960012] = {
		name = "果てへレッツゴー",
		desc_world = "装備艦隊に風帆艦船がいる場合、味方旗艦が受けるダメージを軽減する（効果は戦術ステータスによる）",
		next_id = 960013,
		exp = 0,
		prev_id = 960011,
		desc = "装備艦隊に風帆艦船がいる場合、味方旗艦が受けるダメージを軽減する（効果は戦術ステータスによる）",
		id = 960012,
		icon = "96001",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960013] = {
		name = "果てへレッツゴー",
		desc_world = "装備艦隊の風帆V、風帆Mの回避を上昇させる（効果大、効果は戦術ステータスによる）",
		next_id = 0,
		exp = 0,
		prev_id = 960012,
		desc = "装備艦隊の風帆V、風帆Mの回避を上昇させる（効果大、効果は戦術ステータスによる）",
		id = 960013,
		icon = "96001",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960021] = {
		name = "私掠らいせんしー",
		desc_world = "装備艦隊の軽巡・重巡・超巡・風帆Vの命中を上昇させる（効果中、効果は指揮ステータスによる）",
		next_id = 960022,
		exp = 0,
		prev_id = 0,
		desc = "装備艦隊の軽巡・重巡・超巡・風帆Vの命中を上昇させる（効果中、効果は指揮ステータスによる）",
		id = 960021,
		icon = "96002",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960022] = {
		name = "私掠らいせんしー",
		desc_world = "装備艦隊から3マス以内の距離に敵偵察艦隊がいる場合、装備艦隊の風帆Vの回避がアップ（効果小、効果は指揮ステータスによる）",
		next_id = 960023,
		exp = 0,
		prev_id = 960021,
		desc = "装備艦隊から3マス以内の距離に敵偵察艦隊がいる場合、装備艦隊の移動力+1",
		id = 960022,
		icon = "96002",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960023] = {
		name = "私掠らいせんしー",
		desc_world = "装備艦隊に風帆艦船がいる場合、味方軽巡・重巡・風帆Vが受けるダメージを軽減する（効果は戦術ステータスによる）",
		next_id = 0,
		exp = 0,
		prev_id = 960022,
		desc = "装備艦隊に風帆艦船がいる場合、味方軽巡・重巡・風帆Vが受けるダメージを軽減する（効果は戦術ステータスによる）",
		id = 960023,
		icon = "96002",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960031] = {
		name = "さむ・ざ・らっしゅ",
		desc_world = "潜水艦隊の指揮ニャとして装備されている場合、装備艦隊の潜航力+5",
		next_id = 960032,
		exp = 0,
		prev_id = 0,
		desc = "支援範囲+1",
	...
	pg.base.commander_skill_template[960032] = {
		name = "さむ・ざ・らっしゅ",
		desc_world = "潜水艦隊の指揮ニャとして装備されている場合、戦闘開始時味方の風帆艦船の耐久が上限の2％分回復する",
		next_id = 960033,
		exp = 0,
		prev_id = 960031,
		desc = "潜水艦隊の指揮ニャとして装備されている場合、戦闘開始時味方の風帆艦船の耐久が上限の2％分回復する",
		id = 960032,
		icon = "96003",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960033] = {
		name = "さむ・ざ・らっしゅ",
		desc_world = "潜水艦隊の指揮ニャとして装備されている場合、装備艦隊の潜水艦、潜水母艦、風帆Sの命中がアップ（効果中、効果は戦術ステータスによる）",
		next_id = 0,
		exp = 0,
		prev_id = 960032,
		desc = "潜水艦隊の指揮ニャとして装備されている場合、装備艦隊の潜水艦、潜水母艦、風帆Sの命中がアップ（効果中、効果は戦術ステータスによる）",
		id = 960033,
		icon = "96003",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960041] = {
		name = "ファンシーりゃくだつー",
		desc_world = "艦隊に風帆艦船がいる場合、味方前衛艦隊が受けるダメージを軽減する（効果は指揮補助ステータスによる）",
		next_id = 960042,
		exp = 0,
		prev_id = 0,
		desc = "艦隊に風帆艦船がいる場合、味方前衛艦隊が受けるダメージを軽減する（効果は指揮補助ステータスによる）",
		id = 960041,
		icon = "96004",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960042] = {
		name = "ファンシーりゃくだつー",
		desc_world = "指揮ニャとして装備されている場合、艦隊全員の火力がアップする（効果中・効果は戦術補助ステータスによる）",
		next_id = 960043,
		exp = 0,
		prev_id = 960041,
		desc = "指揮ニャとして装備されている場合、艦隊全員の火力がアップする（効果中・効果は戦術補助ステータスによる）",
		id = 960042,
		icon = "96004",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960043] = {
		name = "ファンシーりゃくだつー",
		desc_world = "艦隊メンバーが戦闘中ダメージを受け耐久が上限の30％を下回った場合に1度だけ、その艦の耐久を上限の5％分回復する",
		next_id = 0,
		exp = 0,
		prev_id = 960042,
		desc = "艦隊メンバーが戦闘中ダメージを受け耐久が上限の30％を下回った場合に1度だけ、その艦の耐久を上限の5％分回復する",
		id = 960043,
		icon = "96004",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960051] = {
		name = "こつこつルール",
		desc_world = "潜水艦隊の艦船に装備されている場合、艦隊の潜水艦の潜航力が5アップ",
		next_id = 960052,
		exp = 0,
		prev_id = 0,
		desc = "支援範囲Lv+1",
	...
	pg.base.commander_skill_template[960052] = {
		name = "こつこつルール",
		desc_world = "潜水艦隊に装備されている場合、戦闘開始時艦隊の風帆Sの火力、潜水艦・潜水空母の雷装を上昇させる（効果中・効果は指揮補助ステータスによる）",
		next_id = 960053,
		exp = 0,
		prev_id = 960051,
		desc = "潜水艦隊に装備されている場合、戦闘開始時艦隊の風帆Sの火力、潜水艦・潜水空母の雷装を上昇させる（効果中・効果は指揮補助ステータスによる）",
		id = 960052,
		icon = "96005",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960053] = {
		name = "こつこつルール",
		desc_world = "所属艦隊に「ロイヤル・フォーチュン」がいる場合、戦闘開始時に1度だけ特殊弾幕を展開する",
		next_id = 0,
		exp = 0,
		prev_id = 960052,
		desc = "所属艦隊に「ロイヤル・フォーチュン」がいる場合、戦闘開始時に1度だけ特殊弾幕を展開する",
		id = 960053,
		icon = "96005",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960061] = {
		name = "未了のれじぇんど",
		desc_world = "装備艦隊の戦艦・巡洋戦艦・航空戦艦・風帆Mの火力を上昇させる（効果中、効果は戦術ステータスによる）",
		next_id = 960062,
		exp = 0,
		prev_id = 0,
		desc = "装備艦隊の戦艦・巡洋戦艦・航空戦艦・風帆Mの火力を上昇させる（効果中、効果は戦術ステータスによる）",
		id = 960061,
		icon = "96006",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960062] = {
		name = "未了のれじぇんど",
		desc_world = "主力艦隊と交戦する時、装備艦隊の戦艦・正規空母・風帆Mの命中を上昇させる（効果中、効果は戦術ステータスによる）",
		next_id = 960063,
		exp = 0,
		prev_id = 960061,
		desc = "主力艦隊と交戦する時、装備艦隊の戦艦・正規空母・風帆Mの命中を上昇させる（効果中、効果は戦術ステータスによる）",
		id = 960062,
		icon = "96006",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960063] = {
		name = "未了のれじぇんど",
		desc_world = "装備艦隊にクイーン・アンズ・リベンジがいる場合、戦闘開始時に一度だけ特殊弾幕を展開する",
		next_id = 0,
		exp = 0,
		prev_id = 960062,
		desc = "装備艦隊にクイーン・アンズ・リベンジがいる場合、戦闘開始時に一度だけ特殊弾幕を展開する",
		id = 960063,
		icon = "96006",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960071] = {
		name = "海賊紳士の伝説",
		desc_world = "参謀にゃとして装備されている場合、装備艦隊の軽巡・重巡・超巡・風帆Vの回避を上昇させる（効果小、効果は補助ステータスによる）",
		next_id = 960072,
		exp = 0,
		prev_id = 0,
		desc = "装備艦隊が待ち伏せを受ける確率をダウンさせる（補助ステータスによる）",
		id = 960071,
		icon = "96007",
		lv = 1,
		effect_tactic = {
...
(function ()
	pg.base.commander_skill_template[960072] = {
		name = "海賊紳士の伝説",
		desc_world = "参謀にゃとして装備されている場合、装備艦隊の前衛艦隊の火力を上昇させる（効果小、効果は補助ステータスによる）",
		next_id = 960073,
		exp = 0,
		prev_id = 960071,
		desc = "参謀にゃとして装備されている場合、装備艦隊の前衛艦隊の火力を上昇させる（効果小、効果は補助ステータスによる）",
		id = 960072,
		icon = "96007",
		lv = 1,
		effect_tactic = {
	...
	pg.base.commander_skill_template[960073] = {
		name = "海賊紳士の伝説",
		desc_world = "装備艦隊の旗艦か前衛艦隊先頭艦が戦闘中にダメージを受け、耐久が上限の50％を下回った場合に1度だけ、耐久が上限の5％分回復する",
		next_id = 0,
		exp = 0,
		prev_id = 960072,
		desc = "装備艦隊の旗艦か前衛艦隊先頭艦が戦闘中にダメージを受け、耐久が上限の50％を下回った場合に1度だけ、耐久が上限の5％分回復する",
		id = 960073,
		icon = "96007",
		lv = 1,
		effect_tactic = {
