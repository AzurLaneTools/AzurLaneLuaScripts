...
指揮官は行動力を消費し、予め編成した潜水艦隊をエリアに呼び出せます。潜水艦隊がエリアマップに配置されている場合、通常海域同様、漸減邀撃や戦闘中の支援が行え]]
	...
	world_boss_help_meta = {
		tip = {
			{
				info = [[
<color=#92fc63>2021.6.10-2021.9.9</color>
META戦・ヘレナ(META)が開催中です。META戦で解析Ptを集め、META艦船を手に入れましょう。
...
※夢幻の封印を追え！]]
	...
	help_monopoly = {
		tip = {
			...
			{
				info = [[
4.サイコロはイベント期間中、毎日4つ自動で加算されます。また
...
揮官のバナーの右側に表示されます。
現役指揮官が「カムバック召集」をタップすると、カ
ムバック・新人指揮官の「現役指揮官検索」で自分
のUIDを表示させることが可能です。
■カムバック指揮官・新人の目標について
カムバック・新人指揮官は、現役指揮官のUIDをイベ
ントバナーに入力することで、「カムバックミッショ
ン」に参加可能になります。
カムバックミッションに参加すると、毎日解禁される
専用任務をクリアすることで、様々な報酬を入手でき
ます。
一つのUIDは最大2回まで入力できます。また、UIDは
...
<color=#FF5C5C>（※2021年3月25日まで常設建造した艦しか出現し
ません）</color>]]
			},
			{
				info = [[
...
※<color=#92fc63>2021.6.10-2021.9.9</color>ヘレナ(META)META戦開放期間は「ヘレナ・META」の解析Ptを入手できます。
