return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "このあたりは鉄血とヴィシアの間の緩衝地帯、ということでしょうか",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（「セイレーンは港に近づけさせない」――トゥーロンでも、あの子はそうみんなに命じてましたね）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（鉄血の味方をしていないのでしたら、交渉できるかもしれません）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（鉄血に本国を占領されては、ヴィシアの勢力丸ごとの反転は困難……）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……ロイヤルとしても、その日が来ることを心待ちにしています",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
