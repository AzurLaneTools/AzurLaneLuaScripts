return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ああ、それね。別に感謝されるほどのことはしていないわ。あと、ザラでいいわよ？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あの子ほかの陣営の友達が出来たんだけど、一緒に非番の日に遊びに出かけるとなったのに服がないって悩んでて",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "そこで私に相談してきたわ。ヴェネトが「普段と違う服がいいわ」ってアドバイスしたって",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "なんか気恥ずかしいし、話が脱線する前に仕事に戻ることにした。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
