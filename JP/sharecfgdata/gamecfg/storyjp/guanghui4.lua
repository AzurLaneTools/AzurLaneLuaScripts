return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ふふ、ユニコーンちゃんとても嬉しそうですね。さっきのことでしょんぼりしてたのがウソみたいです",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "愛らしくて、本当に私の妹のような存在です。ちゃんとお姉さんができているか不安もありますが……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "でも、まだ幼いあの子が至らない部分をこの私がうまく補っていけたら――",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "さて他に必要なものは――と、そういえば当日に使うカップの手配も済ませなければ……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……ずっと重いものを運んでくださっていたのですから、お疲れなのは当然ですよね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "あの、もしよろしければ私が軽いマッサージをしてあげましょうか？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "肩のマッサージです。初めてですので、あまりうまくないかもしれませんが……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "んっしょ……あっ…んん……指揮官さま、力の具合はいかがでしょうか……？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "さすがにこのままではマズイーーイラストリアスに謝りマッサージの気持ちよさ（？）から逃げ出してしまった",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
