return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "また、秘書艦として抜擢された以上、ご主人様を奉仕する意味ではメイドとしての実力も身につける必要があります」",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "普段のメイド業務はシリアスの担当ではないかもしれませんが、状況が状況です",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "ここは普段の担当関係なく、一人ずつ順に皆さんから説明するとしましょう",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "まあ、そこまで堅苦しくならなくてもいいから、とりあえずこれがオッケー、これがダメーというところから覚えておきましょう？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
