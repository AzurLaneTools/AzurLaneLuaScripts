...
_G.pg.base.gametip.island_chara_attr_help = {
	tip = [[
1.仲間の<color=#39bfff>能力（ステータス）</color>が高いと、対応の<color=#39bfff>グレード</color>も上昇します
...
_G.pg.base.gametip.island_urgent_notice = {
	tip = {
		...
		{
			info = [[
在<color=#39bfff>11/6（木）メンテナンス後</color>、バランス調整や各種システムの改善・改修のため、現在開催中の離島経営の開発シーズンについては、開発シーズンのリセットを行わせていただきます。
...
_G.pg.base.gametip.vote_help_2025 = {
	tip = {
		{
			info = [[
<color=#FFDD00>アズールレーン2025開催について</color>
