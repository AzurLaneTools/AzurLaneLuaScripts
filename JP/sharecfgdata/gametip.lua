...
_G.pg.gametip.world_boss_help = {
	tip = {
		...
		{
			info = "イベント「共闘秘密事件調査」\nとは、<color=#92fc63>「演習Pt」</color>を集めて作戦進捗を進めると、個人累計Pt\n報酬と作戦進捗報酬が得られるイベントになります。"
		},
		{
			info = [[
イベント期間中、ブリストルが率いる艦隊を相手に戦う「演習作戦」特別ステージが
登場します。
...
<color=#FF5C5C>（※2021年7月15日まで常設建造した艦しか出現し
ません）</color>]]
		},
		{
			info = [[
...
※<color=#92fc63>2022.3.10-2022.6.1</color>シャルンホルスト(META)META戦開放期間は「シャルンホルスト・META」の解析Ptを入手できます。
	...
	tip = {
		{
			info = [[
■概要
「母港大食い競争」とは、10/6（水）まで7日分毎日開放されるゲームをクリアし「お肉」を集め、夕立の改造素材アイテムを入手出来るイベントになります。
...
_G.pg.gametip.littleEugen_npc = {
	tip = {
		...
		{
			info = "■遊び方\n1.イベント期間中、イベントページで表示される限定任務をクリアすると、「ケーキPt」を入手できます。さらにイベントページ右下の「変換」ボタンをタップすると、「ケーキPt」を友好度に変換できます"
		},
		{
			info = "2.【プリンツ・オイゲンちゃん】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。"
		},
		{
			info = "3.【プリンツ・オイゲンちゃん】を編成に入れている艦隊で上記ステージの敵中枢艦隊を撃破し、かつ勝利時【プリンツ・オイゲンちゃん】が戦闘可能な状態の場合、獲得できる「友好度」が2倍になります。"
		},
		{
			info = "4.イベント終了までにイベントページの「友好度報酬」を最後まで受け取ると、【プリンツ・オイゲンちゃん】を「正式加入」させることができます（友好度が10000必要）。イベント終了時、「正式加入」していない【プリンツ・オイゲンちゃん】は母港からいなくなります。"
		},
		{
			info = "5.友好度報酬は5/13（金）まで毎日1段階ずつ解放されます。"
		},
		{
			info = "6.仮加入状態の【プリンツ・オイゲンちゃん】はセイレーン作戦（META戦含む）に参加できず、またセイレーン作戦では友好度を獲得できません。"
		},
		{
			info = "7.仮加入状態の【プリンツ・オイゲンちゃん】は大艦隊作戦には参加できません。"
		}
	}
}
