...
報酬が変化します。昞n3 特別ステージは通常の艦隊とは違う<color=#92fc63>「特別演習編成」</color>
を使用します(ステージ出撃時に編成可能)。
4 特別ステージは出撃/勝利時には通常海域の出撃と同
じく燃料コンディションを消費します。また、勝利時昞nに経験値通常クリア報酬の獲得と、コンディションが昞n増減します。
　特別ステージの「旹X」では作戦制限時間は<color=#92fc63>【60秒】</color>
になります。60秒経過敵を撃破晻味方旗艦大破すると
クリア扱いになります
　特別ステージでは艦船が戦闘不能になっても、コン昞nディションは低下しません
　「旹X」ステージの「模擬戦」に出撃する場合、燃
料コンディション晻特別戦闘券（後述）は増減せず、
経験値報酬も入手できません昞n5 特別演習編成では潜水艦オフニャを配置できます。昞n戦闘中に潜水支援を行う場合、燃料を消費します。
...
出撃を「ボーナス出撃」に変更できます。
上記のボーナス出撃を途中で中止した場合、昞n特別戦闘券は消費されません。
