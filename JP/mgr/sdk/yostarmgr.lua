...
return {
	...
	InitJP = function ()
		...
		uv0.LoginPlatform = PLATFORM_YOSTARJP
		uv0.SDK_PID_TEST = "JP-AZURLANE-TEST"
		uv0.SDK_PID_RELEASE = "JP-AZURLANE"
		uv0.SDK_SERVER_URL = "https://jp-sdk-api.yostarplat.com"
		uv0.SDK_TRANS_URL = "https://migration.yostar.co.jp?pid=JP-AZURLANE"
	end,
	InitUS = function ()
