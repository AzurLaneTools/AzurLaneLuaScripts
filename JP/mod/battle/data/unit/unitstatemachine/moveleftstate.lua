...
slot0.Battle.MoveLeftState = class("MoveLeftState", slot0.Battle.IUnitState)
slot0.Battle.MoveLeftState.__name = "MoveLeftState"
slot2 = slot0.Battle.MoveLeftState
