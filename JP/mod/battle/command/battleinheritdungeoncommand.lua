...
slot3 = class("BattleInheritDungeonCommand", slot0.Battle.BattleSingleDungeonCommand)
slot0.Battle.BattleInheritDungeonCommand = slot3
...
slot3.onInitBattle = function(slot0)
	...
	slot0._specificEnemyList = uv1.Battle.BattleDataFunction.GetSpecificEnemyList(slot1.ActID, slot1.StageTmpId)
end
