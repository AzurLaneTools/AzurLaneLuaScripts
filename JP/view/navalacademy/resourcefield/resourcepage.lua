...
slot0.OnLoaded = function(slot0)
	slot0.titleTxt = slot0._tf:Find("frame/title/text"):GetComponent(typeof(Text))
	slot0.iconImg = slot0._tf:Find("frame/title/icon"):GetComponent(typeof(Image))
	slot0.closeBtn = slot0._tf:Find("frame/btnBack")
	slot0.descTxt = slot0._tf:Find("frame/content/describe/class"):GetComponent(typeof(Text))
	slot0.levelTxt = slot0._tf:Find("frame/title/icon/current"):GetComponent(typeof(Text))
	slot0.currentLevelTxt = slot0._tf:Find("frame/content/info/level/curr"):GetComponent(typeof(Text))
	slot0.nextLevelTxt = slot0._tf:Find("frame/content/info/level/next"):GetComponent(typeof(Text))
	slot0.costTxt = slot0._tf:Find("frame/content/upgrade_btn/cost"):GetComponent(typeof(Text))
	slot0.spendTimeTxt = slot0._tf:Find("frame/upgrade_duration/Text"):GetComponent(typeof(Text))
	slot0.upgradeBtn = slot0._tf:Find("frame/content/upgrade_btn")
	slot0.upgradingBtn = slot0._tf:Find("frame/content/upgrading_block")
	slot0.attrUIlist = UIItemList.New(slot0._tf:Find("frame/content/info/conent"), slot0._tf:Find("frame/content/info/conent/tpl"))

	setText(slot0.upgradeBtn:Find("Image"), i18n("word_levelup"))
	setText(slot0.upgradingBtn:Find("Image"), i18n("class_label_upgrading"))
	setText(slot0._tf:Find("frame/content/upgrade_btn/costback/label"), i18n("text_consume"))
	setText(slot0._tf:Find("frame/upgrade_duration/Image/Text"), i18n("class_label_upgradetime"))
end
