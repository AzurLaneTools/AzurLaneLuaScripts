...
slot0.OnLoaded = function(slot0)
	...
	slot0.icon = slot0._tf:Find("frame/icon"):GetComponent(typeof(Image))
	slot0.goBtn = slot0._tf:Find("frame/go_btn")
	slot0.joinBtn = slot0._tf:Find("frame/join_btn")
	slot0.descTxt = slot0._tf:Find("frame/desc"):GetComponent(typeof(Text))
	slot0.consumeTF = slot0._tf:Find("frame/consume")
	slot0.consumeTxt = slot0._tf:Find("frame/consume/Text"):GetComponent(typeof(Text))
	slot0.cntTF = slot0._tf:Find("frame/cnt")
	slot0.cntTxt = slot0._tf:Find("frame/cnt/Text"):GetComponent(typeof(Text))
	slot0.nameTxt = slot0._tf:Find("frame/title/Text"):GetComponent(typeof(Text))
	slot0.scaleTxt = slot0._tf:Find("frame/title/scale"):GetComponent(typeof(Text))
	slot0.scaleCntTxt = slot0._tf:Find("frame/title/scale/Text"):GetComponent(typeof(Text))
	slot0.progressTF = slot0._tf:Find("frame/cnt/progress")
	slot0.progressTxt = slot0._tf:Find("frame/cnt/progress/Text"):GetComponent(typeof(Text))
	slot0.missionList = UIItemList.New(slot0._tf:Find("frame/events/icons"), slot0._tf:Find("frame/events/icons/tpl"))
	slot0.awardList = UIItemList.New(slot0._tf:Find("frame/award/displays"), slot0._tf:Find("frame/award/displays/item"))

	setText(slot0._tf:Find("frame/events/Text"), i18n("guild_word_may_happen_event"))
	setText(slot0._tf:Find("frame/award/Text"), i18n("guild_battle_award"))
	setText(slot0._tf:Find("frame/consume/label"), i18n("guild_word_consume"))
	setText(slot0._tf:Find("frame/cnt/label"), i18n("guild_join_event_cnt_label"))
	setText(slot0._tf:Find("frame/cnt/progress/label"), i18n("guild_join_event_progress_label"))
end
