...
slot0.OnLoaded = function(slot0)
	...
	slot0.fireconfirmBtn = slot0._tf:Find("frame/confirm_btn")
	slot0.firecancelBtn = slot0._tf:Find("frame/cancel_btn")
	slot0.firenameTF = slot0._tf:Find("frame/info/name/Text"):GetComponent(typeof(Text))
	slot0.fireiconTF = slot0._tf:Find("frame/info/shipicon/icon"):GetComponent(typeof(Image))
	slot0.fireduty = slot0._tf:Find("frame/duty"):GetComponent(typeof(Image))
	slot0.firestarsTF = slot0._tf:Find("frame/info/shipicon/stars")
	slot0.firestarTF = slot0._tf:Find("frame/info/shipicon/stars/star")
	slot0.firelevelTF = slot0._tf:Find("frame/info/level/Text"):GetComponent(typeof(Text))
