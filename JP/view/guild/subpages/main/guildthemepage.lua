...
slot0.OnLoaded = function(slot0)
	...
	slot0.battleReport = slot0._tf:Find("bottom/battle_report")
	...
	slot0.shopBtn = slot0._tf:Find("bottom/battle_shop")
	slot0.nameTxt = slot0._tf:Find("top/name/Text"):GetComponent(typeof(Text))
	slot0.modifyBtn = slot0._tf:Find("top/name")
	slot0.levelImg = slot0._tf:Find("top/level/Text"):GetComponent(typeof(Text))
	slot0.factionTxt = slot0._tf:Find("top/policy/label"):GetComponent(typeof(Text))
	slot0.policyTxt = slot0._tf:Find("top/policy/Text"):GetComponent(typeof(Text))
	slot0.idTxt = slot0._tf:Find("top/id/Text"):GetComponent(typeof(Text))
	slot0.numberTxt = slot0._tf:Find("top/id/number"):GetComponent(typeof(Text))
	slot0.expImg = slot0._tf:Find("top/exp/bar")
	slot0.levelTxt = slot0._tf:Find("top/exp/lv/Text"):GetComponent(typeof(Text))
	slot1 = 300
