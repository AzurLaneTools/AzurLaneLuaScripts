...
slot0.OnLoaded = function(slot0)
	slot0.statement = slot0._tf:Find("detail/statement")
	slot0.statement.localScale = Vector3(1, 0, 1)
	slot0.talentSkill = slot0._tf:Find("detail/talent_skill")
	slot1 = slot0.talentSkill:Find("talent/content")
	slot0.talentList = UIItemList.New(slot1, slot1:GetChild(0))
	slot0.abilityAdditionTF = slot0.statement:Find("atttrs/content")
	slot0.talentAdditionTF = slot0.statement:Find("talents/scroll/content")
	slot0.talentAdditionList = UIItemList.New(slot0.talentAdditionTF, slot0.talentAdditionTF:GetChild(0))
	slot0.skillIcon = slot0.talentSkill:Find("skill/icon/Image")
	slot0.lockTF = slot0._tf:Find("info/lock")
	slot0.commanderInfo = slot0._tf:Find("info")
	slot0.expPanel = slot0.commanderInfo:Find("exp")
	slot0.commanderLevelTxt = slot0.commanderInfo:Find("exp/level"):GetComponent(typeof(Text))
	slot0.commanderExpImg = slot0.commanderInfo:Find("exp/Image"):GetComponent(typeof(Image))
	slot0.commanderNameTxt = slot0.commanderInfo:Find("name_bg/mask/Text"):GetComponent("ScrollText")
	slot0.modifyNameBtn = slot0.commanderInfo:Find("name_bg/modify")

	setActive(slot0.modifyNameBtn, pg.gameset.commander_rename_open.key_value == 1)

	slot0.line = slot0.commanderInfo:Find("line")
	slot0.fleetnums = slot0.commanderInfo:Find("line/numbers")
	slot0.fleetTF = slot0.commanderInfo:Find("line/fleet")
	slot0.subTF = slot0.commanderInfo:Find("line/sub_fleet")
	slot0.leisureTF = slot0.commanderInfo:Find("line/leisure")
	slot0.labelInBattleTF = slot0.commanderInfo:Find("line/inbattle")
	slot0.rarityImg = slot0.commanderInfo:Find("rarity"):GetComponent(typeof(Image))
	slot0.abilityTF = slot0.commanderInfo:Find("ablitys")
	slot0.skillBtn = slot0.commanderInfo:Find("skill_btn")
	slot0.additionBtn = slot0.commanderInfo:Find("addition_btn")
	slot0.otherBtn = slot0.commanderInfo:Find("other_btn")
	slot0.otherCommanderNameTxt = slot0._tf:Find("detail/other/name/Text"):GetComponent(typeof(Text))
	slot0.otherCommanderSkillImg = slot0._tf:Find("detail/other/skill/Image")
	slot0.otherCommanderTalentList = UIItemList.New(slot0._tf:Find("detail/other/talent"), slot0._tf:Find("detail/other/talent/tpl"))
	slot0.otherCommanderDescTxt = slot0._tf:Find("detail/other/desc/mask/Text"):GetComponent(typeof(ScrollText))
	...
	setText(slot0._tf:Find("detail/statement/atttrs/title/Text"), i18n("commander_subtile_ablity"))
	setText(slot0._tf:Find("detail/statement/talents/title/Text"), i18n("commander_subtile_talent"))
end
