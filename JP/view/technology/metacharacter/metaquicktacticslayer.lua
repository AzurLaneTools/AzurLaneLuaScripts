...
slot0.initUITextTips = function(slot0)
	setText(slot0._tf:Find("Content/SkillInfo/UseTip"), i18n("metaskill_up"))
end
...
slot0.initUI = function(slot0)
	...
	slot0.tpl = slot0._tf:Find("TacticsTpl")
	slot1 = slot0._tf:Find("Content")
	slot0.closeBtn = slot1:Find("Title/CloseBtn")
	slot2 = slot1:Find("SkillInfo")
	slot3 = slot2:Find("Skill")
	slot0.skillNameText = slot3:Find("Name")
	slot0.skillLevelText = slot3:Find("LevelNum")
	slot0.skillLevelUpText = slot3:Find("LevelUp")
	slot4 = slot2:Find("Exp")
	slot0.curExpText = slot4:Find("CurExp")
	slot0.addExpText = slot4:Find("AddExp")
	slot0.totalExpText = slot4:Find("TotalExp")
	slot0.progressBar = slot2:Find("Slider")
	slot0.containerTF = slot1:Find("Container")
	slot5 = slot1:Find("Action")
	slot0.clearBtn = slot5:Find("ClearBtn")
	slot0.onestepBtn = slot5:Find("OneStepBtn")
	slot0.confirmBtn = slot5:Find("ConfirmBtn")
end
...
slot0.updateTpl = function(slot0, slot1, slot2)
	...
	slot4 = slot2:Find("Name")
	slot5 = slot2:Find("MinusTenBtn")
	slot6 = slot2:Find("AddTenBtn")
	slot7 = slot2:Find("MinusBtn")
	slot8 = slot2:Find("AddBtn")
	slot9 = slot2:Find("TextBG/UseNum")
