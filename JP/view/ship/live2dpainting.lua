...
slot17 = function(slot0, slot1, slot2)
	if slot1 == Live2DPainting.EVENT_ACTION_APPLY then
		...
		if slot11 then
			...
			if uv1(slot0, slot4, slot8 or false) then
				print("id = " .. slot3 .. " 触发成功")
				slot0:onListenerHandle(Live2DPainting.ON_ACTION_PLAY, {
					action = slot4
				})
	...
	elseif slot1 == Live2DPainting.EVENT_ADD_PARAMETER_COM then
		slot0.liveCom:AddParameterValue(slot2.com, slot2.start, uv2[slot2.mode])
	elseif slot1 == Live2DPainting.EVENT_REMOVE_PARAMETER_COM then
...
slot19 = function(slot0)
	...
	slot0.destinations = slot0.liveCom.Destinations:ToTable()
end
...
slot0.changeIdleIndex = function(slot0, slot1)
	...
	slot0:onListenerHandle(Live2DPainting.ON_ACTION_CHANGE_IDLE, {
...
slot0.setSortingLayer = function(slot0, slot1)
	slot1 = slot1 or LayerWeightConst.L2D_DEFAULT_LAYER

	slot0:updateL2dSortMode()

	slot0._go:GetComponent(typeof(CubismRenderController)).SortingOrder = LayerWeightConst.L2D_DEFAULT_LAYER
end

slot0.updateL2dSortMode = function(slot0)
	slot0._go:GetComponent(typeof(CubismRenderController)).SortingMode = CubismSortingMode.BackToFrontOrder
end

slot0.setSortingModeFrontZ = function(slot0)
	slot0._go:GetComponent(typeof(CubismRenderController)).SortingMode = CubismSortingMode.BackToFrontZ
end
...
slot0.clearMaskTexture = function(slot0, slot1)
	...
	if GetComponent(slot1, "CubismMaskController") and slot2.MaskTexture then
...
slot0.SetL2dSortingLayer = function(slot0, slot1)
	...
	slot0:GetComponent(typeof(CubismRenderController)).SortingOrder = slot1
end

slot0.UpdateL2dSortMode = function(slot0)
	slot0:GetComponent(typeof(CubismRenderController)).SortingMode = CubismSortingMode.BackToFrontOrder
end

slot0.SetSortingModeFrontZ = function(slot0)
	slot0:GetComponent(typeof(CubismRenderController)).SortingMode = CubismSortingMode.BackToFrontZ
end
