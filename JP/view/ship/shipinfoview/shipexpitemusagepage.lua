...
slot0.OnLoaded = function(slot0)
	slot0.backBtn = slot0._tf:Find("frame/top/btnBack")
	slot0.confirmBtn = slot0._tf:Find("frame/buttons/confirm")
	slot0.recomBtn = slot0._tf:Find("frame/buttons/recom")
	slot0.clearBtn = slot0._tf:Find("frame/buttons/clear")
	slot0.levelTxt = slot0._tf:Find("frame/content/level/Text"):GetComponent(typeof(Text))
	slot0.expTxt = slot0._tf:Find("frame/content/level/exp"):GetComponent(typeof(Text))
	slot0.currentProgress = slot0._tf:Find("frame/content/level/y"):GetComponent(typeof(Slider))
	slot0.tipProgress = slot0._tf:Find("frame/content/level/w"):GetComponent(typeof(Slider))
	slot0.previewProgress = slot0._tf:Find("frame/content/level/g"):GetComponent(typeof(Slider))
	slot0.itemIds = slot0:GetAllItemIDs()

	if #slot0.itemIds <= 3 then
		slot0.uiItemList = UIItemList.New(slot0._tf:Find("frame/content/items"), slot0._tf:Find("frame/content/items/tpl"))
	else
		slot0.uiItemList = UIItemList.New(slot0._tf:Find("frame/content/scrollrect/content"), slot0._tf:Find("frame/content/items/tpl"))
	end

	setActive(slot0._tf:Find("frame/content/items"), slot1)
	setActive(slot0._tf:Find("frame/content/scrollrect"), not slot1)
	setText(slot0._tf:Find("frame/top/bg/infomation/title"), i18n("ship_exp_item_title"))
	setText(slot0._tf:Find("frame/content/label"), i18n("coures_level_tip"))
