...
slot0.init = function(slot0)
	slot0.title = slot0._tf:Find("main/right_panel/title/main"):GetComponent(typeof(Text))
	slot0.titleBg1 = slot0._tf:Find("main/right_panel/title/title_bg1")
	slot0.titleBg2 = slot0._tf:Find("main/right_panel/title/title_bg2")
	slot0.titleBg3 = slot0._tf:Find("main/right_panel/title/title_bg3")
	slot0.subTitle = slot0._tf:Find("main/right_panel/title/Text"):GetComponent(typeof(Text))
	slot0.tagtimeTF = slot0._tf:Find("main/right_panel/title/main/sub"):GetComponent(typeof(Text))
	slot0.backBtn = slot0._tf:Find("blur_panel/adapt/top/back_btn")
	slot0.helpBtn = slot0._tf:Find("main/right_panel/title/help")
	slot0.filterBtn = slot0._tf:Find("main/right_panel/filter_bg/filter_btn")
	slot0.filterSel = slot0._tf:Find("main/right_panel/filter_bg/filter_btn/Image")
	slot0.scheduleBtn = slot0._tf:Find("main/right_panel/title/schedule")
...
slot0.didEnter = function(slot0)
	...
	slot0.shipsPage = slot1[slot2][1].New(slot0._tf:Find("main/right_panel"), slot0.event, slot0.contextData)
	...
	slot0.rankPage = slot1[slot2][2].New(slot0._tf:Find("main/left_panel"), slot0.event, slot0.contextData)
