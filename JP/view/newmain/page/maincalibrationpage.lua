...
slot0.OnLoaded = function(slot0)
	...
	slot0.setBtn = slot0._tf:Find("set")
	slot0.scaleSetBtn = slot0._tf:Find("scale_set")
	slot0.backBtn = slot0._tf:Find("back")
	slot0.scaleContent = slot0._tf:Find("scale_content")
	slot0.resetBtn = slot0._tf:Find("reset")
	slot0.saveBtn = slot0._tf:Find("save")
