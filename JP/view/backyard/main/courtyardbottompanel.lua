...
slot0.init = function(slot0)
	slot0.granaryBtn = slot0._tf:Find("bottomleft/feed_btn")
	slot0.stockBar = slot0.granaryBtn:Find("progress"):GetComponent(typeof(Slider))
	slot0.stockTimeTxt = slot0.granaryBtn:Find("time"):GetComponent(typeof(Text))
	slot0.stockTxt = slot0.granaryBtn:Find("Text"):GetComponent(typeof(Text))
	slot0.stampBtn = slot0._tf:Find("stamp")
	slot0.shopBtn = slot0._tf:Find("bottomright/shop_btn")
	slot0.decorateBtn = slot0._tf:Find("bottomright/decorate_btn")
	slot0.templateBtn = slot0._tf:Find("bottomright/theme_template_btn")
	slot0.shareBtn = slot0._tf:Find("bottomright/share_btn")
	slot0.shopTip = slot0.shopBtn:Find("tip")
	slot0.trainBtn = slot0._tf:Find("bottomleft/train_btn")
	...
	slot0.icon1 = slot0._tf:Find("bottomleft/train_btn/icon")
	slot0.icon2 = slot0._tf:Find("bottomleft/train_btn/icon_1")
