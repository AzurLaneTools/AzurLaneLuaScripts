...
slot0.OnLoaded = function(slot0)
	...
	slot0.cancelBtn = slot0._tf:Find("frame/control/cancel_btn")
	slot0.deleteBtn = slot0._tf:Find("frame/control/delete_btn")
	slot0.saveBtn = slot0._tf:Find("frame/control/save_btn")
	slot0.applyBtn = slot0._tf:Find("frame/control/set_btn")
	slot0.input = slot0._tf:Find("frame/bound/input")
	slot0.inputField = slot0._tf:Find("frame/bound/input/InputField")
	slot0.desc = slot0._tf:Find("frame/bound/desc"):GetComponent(typeof(Text))
	slot0.icon = slot0._tf:Find("frame/bound/mask/Icon"):GetComponent(typeof(Image))
	slot0.iconRaw = slot0._tf:Find("frame/bound/mask/Icon_raw"):GetComponent(typeof(RawImage))
	slot0.title = slot0._tf:Find("frame/title"):GetComponent(typeof(Text))
	slot0.closeBtn = slot0._tf:Find("frame/close")
	slot0.innerMsgbox = slot0._tf:Find("msg")
	...
	slot0.innerCloseBtn = slot0._tf:Find("msg/close")
