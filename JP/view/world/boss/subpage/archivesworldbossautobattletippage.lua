...
slot0.OnLoaded = function(slot0)
	...
	setText(slot0._tf:Find("window/msg_panel/highest_damage/label"), i18n("world_boss_title_highest_damge"))
	setText(slot0._tf:Find("window/msg_panel/label"), i18n("world_boss_title_estimation"))
	...
	setText(slot0._tf:Find("window/msg_panel/time/label"), i18n("world_boss_title_spend_time"))
	setText(slot0._tf:Find("window/btns/cancel/pic"), i18n("word_cancel"))
	setText(slot0._tf:Find("window/btns/start/pic"), i18n("word_start"))

	slot0.highestDamageTxt = slot0._tf:Find("window/msg_panel/highest_damage/Text"):GetComponent(typeof(Text))
	...
	slot0.timeTxt = slot0._tf:Find("window/msg_panel/time/Text"):GetComponent(typeof(Text))
end
