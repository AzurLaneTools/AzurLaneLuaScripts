...
slot0.InitUI = function(slot0)
	...
	slot0.equipmentPanel = slot0.rightPanel:Find("EquipmentPanel")
	slot0.equipmentPanelTitleStrengthen = slot0.equipmentPanel:Find("Title/Strengthen")
	slot0.equipmentPanelTitleUpgrade = slot0.equipmentPanel:Find("Title/Upgrade")
	slot0.equipmentPanelTitleComposite = slot0.equipmentPanel:Find("Title/Composite")
	slot0.equipmentPanelIcon1 = slot0.equipmentPanel:Find("Container/Equiptpl")
	slot0.equipmentPanelIcon2 = slot0.equipmentPanel:Find("Container/Equiptpl2")
	slot0.equipmentPanelArrow = slot0.equipmentPanel:Find("Container/Slot")
	slot0.craftTargetCount = slot0.equipmentPanel:Find("TotalCount")
	slot0.materialPanel = slot0.rightPanel:Find("MaterialPanel")
	slot0.materialPanelAttrList = slot0.materialPanel:Find("ScrollView/List")
	slot0.materialPanelExpLv = slot0.materialPanel:Find("ExpLv")
	slot0.materialPanelExpLvText = slot0.materialPanel:Find("ExpLv/Number")

	setActive(slot0.materialPanelExpLvText, false)

	slot0.materialPanelExpFullText = slot0.materialPanel:Find("ExpFull")
	slot0.materialPanelExpBar = slot0.materialPanel:Find("ExpBar")
	slot0.materialPanelExpBarFill = slot0.materialPanel:Find("ExpBar/Fill")
	slot0.materialPanelExpBarFull = slot0.materialPanel:Find("ExpBar/Full")

	setText(slot0.materialPanel:Find("ExpFull"), i18n("spweapon_ui_levelmax"))

	slot0.materialPanelExpTotalText = slot0.materialPanel:Find("ExpTotal")
	slot0.materialPanelExpCurrentText = slot0.materialPanel:Find("ExpTotal/ExpCurrent")
	slot0.materialPanelMaterialList = slot0.materialPanel:Find("Materials/List")
	slot0.materialPanelMaterialListLimit = slot0.materialPanel:Find("Materials/Limit")
	slot0.materialPanelMaterialItems = CustomIndexLayer.Clone2Full(slot0.materialPanelMaterialList, 3)

	setText(slot0.materialPanel:Find("Materials/Title"), i18n("spweapon_ui_need_resource"))
	setText(slot0.materialPanel:Find("Materials/Limit/text"), i18n("spweapon_ui_levelmax2"))

	slot0.materialPanelCostText = slot0.materialPanel:Find("Cost/Consume")
	slot0.materialPanelButton = slot0.materialPanel:Find("Button")
	slot0.materialPanelButtonUpgrade = slot0.materialPanel:Find("Button/Upgrade")
	slot0.materialPanelButtonStrengthen = slot0.materialPanel:Find("Button/Strengthen")
	slot0.materialPanelButtonCreate = slot0.materialPanel:Find("Button/Create")
	...
	slot0.leftPanelAutoSelectButton = slot0.leftPanel:Find("Title/AutoSelect")
	slot0.leftPanelClearSelectButton = slot0.leftPanel:Find("Title/ClearSelect")
	slot0.leftPanelItem = slot0.leftPanel:Find("Items")
	slot0.leftPanelItemRect = UIItemList.New(slot0.leftPanel:Find("Items/Content"), slot0.leftPanel:Find("Items/EquipItem"))

	setText(slot0.leftPanel:Find("Items/Top/TextName"), i18n("spweapon_ui_ptitem"))
	setText(slot0.leftPanelAutoSelectButton:Find("On/Text"), i18n("spweapon_ui_autoselect"))
	setText(slot0.leftPanelAutoSelectButton:Find("Off/Text"), i18n("spweapon_ui_autoselect"))
	setText(slot0.leftPanelClearSelectButton:Find("On/Text"), i18n("spweapon_ui_cancelselect"))
	setText(slot0.leftPanelClearSelectButton:Find("Off/Text"), i18n("spweapon_ui_cancelselect"))

	slot0.LeftPanelEquip = slot0.leftPanel:Find("Equips")
	slot0.leftPanelEquipScrollComp = GetComponent(slot0.leftPanel:Find("Equips/Scroll View"), "LScrollRect")

	setText(slot0.leftPanel:Find("Equips/Top/TextName"), i18n("spweapon_ui_spweapon"))

	slot0.leftPanelFilterButton = slot0.leftPanel:Find("Equips/Top/Filter")

	setText(slot0.leftPanel:Find("TipText"), i18n("spweapon_ui_helptext"))
	setText(slot0.equipmentPanel:Find("Ship/Detail"), i18n("spweapon_tip_view"))
	setText(slot0.equipmentPanel:Find("Ship/Title"), i18n("spweapon_tip_ship"))
	setText(slot0.equipmentPanel:Find("ShipType/Title"), i18n("spweapon_tip_type"))
