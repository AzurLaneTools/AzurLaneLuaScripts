slot0 = class("ReMapTransformationScene", import("view.base.BaseUI"))
...
slot0.init = function(slot0)
	...
	onButton(slot0, slot0.confirmBtn, function ()
		...
		seriesAsync(slot0, function ()
			uv0:emit(ReMapTransformationMediator.ON_USE_ITEM, uv0.itemVO.id, uv0.count, uv0.itemVO:getConfig("usage_arg")[uv0.selectedIndex])
		end)
	end, SFX_PANEL)
end
...
slot0.didEnter = function(slot0)
	...
	slot0:update(slot0.contextData.itemVO)
end
...
slot0.update = function(slot0, slot1)
	...
	slot0.ulist:make(function (slot0, slot1, slot2)
		...
		if slot0 == UIItemList.EventUpdate then
			...
			if uv1 and slot3.type == DROP_TYPE_SHIP and CheckShipExist(slot3.id) then
