slot0 = class("HolidayVillaShopMediator", import("..base.ContextMediator"))
slot0.OPEN_GOODS_WINDOW = "HolidayVillaShopMediator.OPEN_GOODS_WINDOW"
...
slot0.initNotificationHandleDic = function(slot0)
	slot0.handleDic = {
		[GAME.ISLAND_SHOPPING_DONE] = function (slot0, slot1)
			...
			slot0.viewComponent:refreshAllGoodsCard()
