...
slot0.init = function(slot0)
	slot0._dayTF = slot0._tf:Find("day")
	slot0._nightTF = slot0._tf:Find("night")
	...
	slot0._log_tip = slot0._tf:Find("top/btn_log/tip")
	slot0._unlock = slot0._tf:Find("top/unlock_info")
...
slot0.didEnter = function(slot0)
	...
	onButton(slot0, slot0._tf:Find("top/btn_help"), function ()
	...
	onButton(slot0, slot0._tf:Find("top/btn_log"), function ()
		if uv0 then
...
slot0.UpdateView = function(slot0)
	...
	setActive(slot0.day_btn_game:Find("tip"), uv0.MiniGameTip())
	setActive(slot0.night_btn_game:Find("tip"), uv0.MiniGameTip())
	setActive(slot0.day_btn_cruise:Find("tip"), uv0.CruiseTip())
	setActive(slot0.night_btn_cruise:Find("tip"), uv0.CruiseTip())
end
