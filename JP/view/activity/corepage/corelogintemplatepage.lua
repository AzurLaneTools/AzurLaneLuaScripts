slot0 = class("CoreLoginTemplatePage", import("view.activity.CorePage.CoreActivityPage"))

slot0.OnInit = function(slot0)
	slot0.bg = slot0:findTF("AD")
	slot0.dayTF = slot0:findTF("total_progress/day", slot0.bg)
	...
	slot0.progressLabel = slot0:findTF("total_progress/label", slot0.bg)
