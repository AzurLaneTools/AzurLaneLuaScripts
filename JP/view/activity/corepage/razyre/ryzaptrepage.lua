slot0 = class("RyzaPtRePage", import("view.activity.CorePage.CorePtTemplatePage"))
slot1 = 9
...
slot0.OnDestroy = function(slot0)
	if isActive(slot0.clickMask) then
		setActive(slot0.clickMask, false)
		pg.UIMgr.GetInstance():UnOverlayPanel(slot0.clickMask, slot0.bg)
	end
end
