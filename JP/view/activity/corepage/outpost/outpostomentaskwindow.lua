slot0 = class("OutPostOmenTaskWindow", import("view.base.BaseSubView"))
...
slot0.UpdateListItem = function(slot0, slot1, slot2)
	...
	slot7 = findTF(findTF(slot2, "lock"), "desc")
	slot12 = slot1 + 1

	setText(findTF(slot3, "day"), "DAY " .. slot12)

	for slot12 = 0, findTF(slot3, "tasks").childCount - 1 do
		slot0:UpdateTaskItem(slot8, slot12, slot5:GetChild(slot12))
	end

	slot10 = slot0:isTaskLock(slot8) ~= 0

	setActive(slot6, slot10)

	GetOrAddComponent(slot3, typeof(CanvasGroup)).alpha = slot10 and 0.5 or 1
