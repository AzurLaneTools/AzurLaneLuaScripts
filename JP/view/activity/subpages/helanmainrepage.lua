slot0 = class("HeLanMainRePage", import("...base.BaseActivityPage"))
slot1 = 71132
slot2 = 5901
slot3 = 5901
...
slot0.updateUI = function(slot0)
	slot1 = false
	slot2, slot3 = slot0.timeMgr:inTime(ShopConst.GetShopConfig(uv0).time)
	slot4 = nil
	...
	slot0.btnFuncList = {
		...
		fight = function (slot0)
			onButton(uv0, slot0, function ()
				if pg.activity_template[uv0.activity.id].config_client.fightLinkActID then
					uv0:emit(ActivityMediator.SKIP_ACTIVITY_MAP, slot1)
				else
