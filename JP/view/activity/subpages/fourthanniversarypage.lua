...
slot0.initBtnList = function(slot0, slot1)
	...
	onButton(slot0, slot1[3], function ()
		uv0:emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.ACTIVITY_TYPE_RETURN_AWARD_ID4)
	end, SFX_PANEL)
	...
	onButton(slot0, slot1[5], function ()
		uv0:emit(ActivityMediator.EVENT_GO_SCENE, SCENE.AMUSEMENT_PARK)
	end, SFX_PANEL)
	onButton(slot0, slot1[6], function ()
		uv0:emit(ActivityMediator.GO_MINI_GAME, 23)
	end, SFX_PANEL)
end
