slot0 = class("LaFeiUrExchangeTemplatePage", import(".TemplatePage.UrExchangeTemplatePage"))
slot0.SP_FIRST = 1
slot0.SP_DAILY = 2
...
slot0.UpdateTask = function(slot0, slot1, slot2)
	...
	setText(slot2:Find("count"), slot7)
	setActive(slot2:Find("complete"), slot8 == nil)
	setActive(slot2:Find("btn_go"), slot8 ~= nil)
