slot0 = class("LittleMusashiPage", import(".TemplatePage.PtTemplatePage"))
...
slot0.OnUpdateFlush = function(slot0)
	...
	setText(slot0.step, setColorStr(slot1, "#838fff") .. " / " .. setColorStr(slot2, "#666176"))
	setText(slot0.progress, (slot6 >= 1 and setColorStr(slot4, COLOR_GREEN) or setColorStr(slot4, "#7780d3")) .. "/" .. setColorStr(slot5, "#666176"))
...
slot0.updateTaskList = function(slot0, slot1, slot2, slot3, slot4)
	...
	if slot4.subType ~= 33 then
		setText(findTF(slot14, "pahase"), setColorStr(slot7, "#19383") .. "/" .. setColorStr(slot6, "#5c5967"))
	else
	...
	if not slot9 then
		...
		onButton(slot0, findTF(slot14, "go"), function ()
			if uv0.taskProxy:getTaskById(uv1.id) or Task.New({
				id = uv1.id
			}) then
