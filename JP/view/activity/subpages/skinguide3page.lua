slot0 = class("SkinGuide3Page", import("...base.BaseActivityPage"))
...
slot0.OnInit = function(slot0)
	...
	slot0.countTF = slot0.bg:Find("count")
...
slot0.OnFirstFlush = function(slot0)
	...
	slot0.itemList:make(function (slot0, slot1, slot2)
		...
		if slot0 == UIItemList.EventUpdate then
			setActive(slot2:Find("get"), slot4:getTaskStatus() == 1 and uv0.remainCnt > 0)
...
slot0.OnUpdateFlush = function(slot0)
	...
	setText(slot0.countTF, string.format("%02d", slot0.remainCnt))
