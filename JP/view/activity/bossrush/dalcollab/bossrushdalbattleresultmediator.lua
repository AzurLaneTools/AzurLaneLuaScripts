slot0 = class("BossRushDALBattleResultMediator", import("view.base.ContextMediator"))
slot0.ON_SETTLE = "BossRushDALBattleResultMediator:ON_SETTLE"
slot0.BEGIN_STAGE = "BossRushDALBattleResultMediator:BEGIN_STAGE"

slot0.register = function(slot0)
	slot0:bind(uv0.ON_SETTLE, function ()
		if not uv0.contextData.win then
...
slot0.ShowTotalAward = function(slot0, slot1)
	slot4, slot5 = getProxy(ContextProxy):getContextByMediator(_G[getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB) and slot2:getConfig("config_client").mediator or "BossRushDALCollabMediator"])
