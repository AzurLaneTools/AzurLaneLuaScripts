...
slot0.Ctor = function(slot0, slot1)
	...
	slot2 = findTF(slot0._tf, "name/en")
	slot0.enName = slot2:GetComponent(typeof(Text))
	slot0.tags = {
...
slot0.Update = function(slot0, slot1, slot2)
	...
	if pg.ship_skin_template[slot0.skin.id].skin_type == ShipSkin.SKIN_TYPE_TB then
		...
		slot0.enName.text = ShipGroup.getDefaultShipConfig(slot8.ship_group).english_name
	end
