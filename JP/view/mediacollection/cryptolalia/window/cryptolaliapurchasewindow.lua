...
slot0.OnLoaded = function(slot0)
	slot0.icon = slot0._tf:Find("window/cover/icon"):GetComponent(typeof(Image))
	slot0.signature = slot0._tf:Find("window/cover/signature"):GetComponent(typeof(Image))
	slot0.name = slot0._tf:Find("window/cover/name"):GetComponent(typeof(Text))
	slot0.shipname = slot0._tf:Find("window/cover/shipname"):GetComponent(typeof(Text))
	slot0.gemToggle = slot0._tf:Find("window/gem")
	slot0.ticketToggle = slot0._tf:Find("window/ticket")
	...
	slot0.exchangeBtn = slot0._tf:Find("exchange")
