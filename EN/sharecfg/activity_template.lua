...
pg.activity_template = {
	...
	[4233] = {
		...
		config_client = {
			...
			buildship_tip = "Increased odds of building Bristol, Charybdis, and Chen Hai!",
			rate_tip = {
				"<color=#ffde38>Super Rare:</color> 7%",
				"<color=#d797ff>Elite:</color> 12%",
				"<color=#3dc6ff>Rare:</color> 26%",
				"Normal: 55%",
				"<color=#ffde38>Bristol:</color> 2.0% (<color=#92fc63>UP!</color>)",
				" ",
				"<color=#ffde38>Charybdis:</color> 2.0% (<color=#92fc63>UP!</color>)",
				" ",
				"<color=#d797ff>Chen Hai:</color> 2.5% (<color=#92fc63>UP!</color>)"
			}
		}
	},
	[4234] = {
