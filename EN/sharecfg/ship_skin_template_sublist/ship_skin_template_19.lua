...
pg.ship_skin_template_19 = {
	...
	[9703010] = {
		...
		main_UI_FX = "",
		special_effects = "",
		desc = "I am Trento, first heavy cruiser of the Sardegna Empire, here to help out. I'll support everyone in my own special little way, so please do look forward to that, Commander♪",
		voice_actor = 224,
		spine_offset = "",
		gyro = 0,
		rarity_bg = "",
