...
pg.world_joint_boss_template = {
	...
	},
	{
		...
		description = {
			{
				"Pillar of Sin\",3,\"When the battle starts: summons 4 [Pillars of Sin] that reduces DMG taken by Algérie META by 40.0%.\nWhen any [Pillar of Sin] takes DMG: 20.0% of that DMG is instead redirected to Algérie META.\"},{\"Expurgating Flame\",1,\"Algérie META's attacks inflict a special [Expurgating Flame] Burn status that deals high fixed DMG over a short duration.\nAdditionally, every 8s: inflicts [Expurgating Flame] on the target with the lowest HP percentage. This effect ignores the Main Fleet's Detection status."
			}
		},
		state = {
			{
