...
· The skills "Quick Takeoff" and "Fiercer When Cornered" are rendered ineffective.]],
	...
	pg.base.strategy_data_template[200931] = {
		...
		name = "Challenge Mode",
		desc = [[
The battle will initiate in challenge mode if your fleet has the Enigmata "D" equipped when the battle starts. This will increase the difficulty, but also increase the score you gain.
...
· The skills "Operation Rainbow" and "Fiercer When Cornered" are rendered ineffective.]],
	...
	pg.base.strategy_data_template[201321] = {
		...
		desc = [[
The following effects activate based on your Exploration Count on this stage:
