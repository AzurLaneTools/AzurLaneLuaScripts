...
slot0.Battle.BattleSkillDamage.Ctor = function(slot0, slot1)
	...
	slot0._ignoreInvincible = slot0._tempData.arg_list.ignoreInvincible or false
...
slot0.Battle.BattleSkillDamage.DoDataEffect = function(slot0, slot1, slot2)
	...
	slot0._proxy:HandleDirectDamage(slot2, math.floor(slot4 * slot0._maxHPRate) + math.floor(slot3 * slot0._currentHPRate) + slot0._number, slot1, slot0._ignoreInvincible or nil, false, slot0._ignoreInvincible)
