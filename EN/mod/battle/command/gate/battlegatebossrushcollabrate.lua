slot0 = class("BattleGateBossRushCollabrate")
ys.Battle.BattleGateBossRushCollabrate = slot0
slot0.__name = "BattleGateBossRushCollabrate"

slot0.Entrance = function(slot0, slot1)
	slot3 = getProxy(PlayerProxy)
	slot4 = getProxy(FleetProxy)
	slot5 = getProxy(BayProxy)
	slot7 = pg.battle_cost_template[SYSTEM_BOSS_RUSH_COLLABRATE].oil_cost > 0
	...
	BeginStageCommand.SendRequest(SYSTEM_BOSS_RUSH_COLLABRATE, slot19, {
		slot11
	}, function (slot0)
		if uv0 then
			uv1:consume({
...
slot0.Exit = function(slot0, slot1)
	slot2 = pg.battle_cost_template[SYSTEM_BOSS_RUSH_COLLABRATE]
