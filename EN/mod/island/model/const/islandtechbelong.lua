...
slot0.Names = {
	...
	[slot0.GATHER] = i18n("island_ship_attrName_4"),
	[slot0.COOK] = i18n("island_ship_attrName_6"),
	[slot0.FEED] = i18n("island_ship_attrName_3"),
	[slot0.PLANT] = i18n("island_ship_attrName_2"),
	[slot0.MECHINE] = i18n("island_ship_attrName_5")
}
