...
slot0.OnLoaded = function(slot0)
	...
	slot0.dressUpConfireBtn = slot0._tf:Find("adapt/confire")
	slot0.dressUpConfireText = slot0._tf:Find("adapt/confire/Text")

	setText(slot0.dressUpConfireText, i18n("island_dress_initial_makesure"))

	slot0.colorList = slot0._tf:Find("adapt/left_color_panel/colorList")
	slot0.colorItem = slot0._tf:Find("adapt/left_color_panel/colorList/item")
	slot0.color_listPanel = slot0._tf:Find("adapt/left_color_panel")
	slot0.color_bg_unlock = slot0._tf:Find("adapt/left_color_panel/bg1")
	slot0.color_bg_locked = slot0._tf:Find("adapt/left_color_panel/bglocked")
