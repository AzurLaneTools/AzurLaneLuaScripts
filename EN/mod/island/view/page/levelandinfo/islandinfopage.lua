...
slot0.OnLoaded = function(slot0)
	...
	slot0.levelTxt = slot0._tf:Find("frame/left/level"):GetComponent(typeof(Text))
	slot0.expTxt = slot0._tf:Find("frame/left/objective/exp"):GetComponent(typeof(Text))
	slot0.goldTxt = slot0._tf:Find("frame/left/objective/gold"):GetComponent(typeof(Text))
	slot0.expProgress = slot0._tf:Find("frame/left/exp/bar")
	slot0.preViewBtn = slot0._tf:Find("frame/left/preview")
	slot0.prosperityLevel = slot0._tf:Find("frame/right/prosperity/level"):GetComponent(typeof(Text))
	slot0.prosperityExp = slot0._tf:Find("frame/right/prosperity/exp"):GetComponent(typeof(Text))
	slot0.prosperityIcon = slot0._tf:Find("frame/right/prosperity/icon")
	slot0.nameTxt = slot0._tf:Find("frame/left/name/Text"):GetComponent(typeof(Text))
	slot0.editNameBtn = slot0._tf:Find("frame/left/name")
	slot0.uiShipList = UIItemList.New(slot0._tf:Find("frame/right/ships/list"), slot0._tf:Find("frame/right/ships/list/tpl"))
	slot0.upgradePreviewPanel = slot0._tf:Find("frame/left/upgrade_preview")
	slot0.upgradeAwardList = UIItemList.New(slot0._tf:Find("frame/left/upgrade_preview/content/awards/list/content"), slot0._tf:Find("frame/left/upgrade_preview/content/awards/list/content/tpl"))
	slot0.upgradeUnlockList = UIItemList.New(slot0._tf:Find("frame/left/upgrade_preview/content/unlock/list/content"), slot0._tf:Find("frame/left/upgrade_preview/content/awards/list/content/tpl"))
	slot0.prosperityLevelList = UIItemList.New(slot0._tf:Find("frame/right/prosperity/objective/content"), slot0._tf:Find("frame/right/prosperity/objective/content/tpl"))
	slot0.prosperityAwardList = UIItemList.New(slot0._tf:Find("frame/right/prosperity/objective/awards"), slot0._tf:Find("frame/right/prosperity/objective/awards/tpl"))
	slot0.getProsperityBtn = slot0._tf:Find("frame/right/prosperity/objective/get_btn")
	slot0.goProsperityBtn = slot0._tf:Find("frame/right/prosperity/objective/go_btn")
	slot0.goProsperityBtnTxt = slot0._tf:Find("frame/right/prosperity/objective/go_btn/Text"):GetComponent(typeof(Text))

	setText(slot0._tf:Find("frame/left/preview/Text"), i18n("island_upgrade_preview"))
	setText(slot0._tf:Find("frame/left/objective/label_exp"), i18n("island_upgrade_exp"))
	setText(slot0._tf:Find("frame/left/objective/label_gold"), i18n("island_upgrade_res"))
	setText(slot0._tf:Find("frame/left/upgrade_preview/content/awards/label"), i18n("island_word_award"))
	setText(slot0._tf:Find("frame/left/upgrade_preview/content/unlock/label"), i18n("island_word_unlock"))
	setText(slot0._tf:Find("frame/right/prosperity/objective/get_btn/Text"), i18n("island_word_get"))
end
