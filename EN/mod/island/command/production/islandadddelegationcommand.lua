...
slot0.execute = function(slot0, slot1)
	...
	pg.ConnectionMgr.GetInstance():Send(21537, {
		...
		if slot0.result == 0 then
			...
			slot7:UpdateEnergy(slot7:GetCurrentEnergy() - math.max(math.floor(slot5.stamina_cost * (1 - IslandProductCostHelper.GetReducePercentInPlace(slot3.ship_id, uv1))), 1) * uv5)
