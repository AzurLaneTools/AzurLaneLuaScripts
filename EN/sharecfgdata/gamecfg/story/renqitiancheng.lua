return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 307010,
			actorName = "???",
			say = "Would you believe what that woman said to me, dear sister? How terribly rude of her!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307010,
			actorName = "???",
			say = "I was able to resolve the little problem I had with the Eagle Union thanks to your help, but things haven't been any less troublesome since then...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307010,
			actorName = "???",
			say = "And I'm not so lacking in self-awareness as to trouble the Commander over it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 304050,
			actorName = "??",
			say = "Now now, Akagi, there's no need to get so worked up... This time, why not try to talk things through instead of resorting to fighting...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307010,
			actorName = "???",
			say = "Not again with that \"kiss and make up\" deal...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 304050,
			actorName = "??",
			say = "I'm sure you and Kaga will learn to get along just fine. Hehe~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 307010,
			actorName = "???",
			say = "Oh no, I need to get to the meeting soon... I wonder if the Commander is still asleep?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 304050,
			actorName = "??",
			say = "Please don't disturb the Commander's rest. Last night's work was arduous after all.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I know you've been quite busy recently, so I was wondering if you'd like me to do more to tend to your health.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Come to think of it, since you do have the day off... Let's take advantage of the opportunity and have a little outing.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			options = {
				{
					content = "\"How are you doing, Amagi?\"",
					flag = 1
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Commander, if you like the taste, you're welcome to have more~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Please don't forget, Commander.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
