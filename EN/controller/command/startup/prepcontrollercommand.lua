...
slot0.execute = function(slot0, slot1)
	...
	slot0.facade:registerCommand(GAME.START_CHAPTER_AUTO, StartChapterAutoCommand)
	slot0.facade:registerCommand(GAME.END_CHAPTER_AUTO, EndChapterAutoCommand)
	slot0.facade:registerCommand(GAME.ADD_CHAPTER_AUTO_TIME, AddChapterAutoTimeCommand)
	...
	slot0.facade:registerCommand(GAME.FETCH_NPC_SHIP_ACTIVITY, FetchNpcShipActivityCommand)
	...
	slot0.facade:registerCommand(GAME.BACKYARD_REQUEST_POP_EVENT, BackYardRequestPopEventCommand)
	slot0.facade:registerCommand(GAME.BACKYARD_REQUEST_SHIP_EXP, BackYardRequestShipExpCommand)
	...
	slot0.facade:registerCommand(GAME.SUBMIT_TASK_V2, SubmitTaskV2Command)
	...
	slot0.facade:registerCommand(GAME.ACTIVITY_PERMANENT_STOP, ActivityPermanentStopCommand)
	...
	slot0.facade:registerCommand(GAME.SUBMIT_ACTIVITY_TASK_V2, SubmitActiveTaskV2Command)
	...
	slot0.facade:registerCommand(GAME.COLLABRATE_BOSS_RUSH_REQUEST_DATA, CollabrateBossRushRequestDataCommand)
	...
	slot0.facade:registerCommand(GAME.EDUCATE_BUY_COLLECT, EducateBuyCollectCommand)
	...
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_GET_CHOOSE, NewEducateGetChooseCommand)
	...
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_ENTER_ASSESS, NewEducateEnterAssessCommand)
	...
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_REFRESH_SHOP, NewEducateRefreshShopCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_REQUEST_CHOICES, NewEducateRequestChoicesCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_GIVE_UP_CHOICE, NewEducateGiveUpChoiceCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_MAKE_CHOICE, NewEducateMakeChoiceCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_REFRESH_CHOICE, NewEducateRefreshChoiceCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_REPLACE_TAROT, NewEducateReplaceTarotCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_GIVE_UP_ENTRY_UP, NewEducateGiveUpEntryUpCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_UPGRADE_ENTRY, NewEducateUpgradeEntryCommand)
	slot0.facade:registerCommand(GAME.NEW_EDUCATE_GET_RANK, NewEducateGetRankCommand)
	...
	slot0.facade:registerCommand(GAME.ISLAND_EXCHANGE_ITEM, IslandExchangeItemCommand)
	...
	slot0.facade:registerCommand(GAME.ISLAND_CHANGE_ENTER, ChangeToIslandCommand)
	...
	slot0.facade:registerCommand(GAME.ISLAND_MORPH_FORM_CHANGE, IslandMorphFormChangeCommand)
	...
	slot0.facade:registerCommand(GAME.ISLAND_GO_FISHING, IslandGoFishingCommand)
	slot0.facade:registerCommand(GAME.ISLAND_FISHING_REUSLT, IslandFishingResultCommand)
	slot0.facade:registerCommand(GAME.ISLAND_EXCHANGE_LURE, IslandExchangeLureCommand)
	slot0.facade:registerCommand(GAME.ISLAND_TRADE, IslandTradeCommand)
	slot0.facade:registerCommand(GAME.ISLAND_GET_FRIEND_TRADE_RANK, IslandGetFriendTradeRankCommand)
	slot0.facade:registerCommand(GAME.ISLAND_INVITE_TRADE, IslandInviteTradeCommand)
	slot0.facade:registerCommand(GAME.ISLAND_TAKE_AUTO_COLLECTION, IslandAutomaticCollectionCommand)
	slot0.facade:registerCommand(GAME.ISLAND_GET_AUTO_COLLECTION_DATA, IslandGetAutoCollectionCommand)
	slot0.facade:registerCommand(GAME.ISLAND_CHEATER_CHANGE_VIEW_DRESSID, IslandChangeViewDressCommand)
	...
	slot0.facade:registerCommand(GAME.LOVE_LETTER_LEVEL_UP, LoveLetterLevelUpCommand)
	slot0.facade:registerCommand(GAME.GET_ALL_LOVE_LETTER_DATA, GetAllLoveLetterLevelDataCommand)
	slot0.facade:registerCommand(GAME.UNLOCK_LOVE_LETTER, UnlockLoveLetterCommand)
	...
	slot0.facade:registerCommand(GAME.PLAY_ROOM_REFRESH_ROOM, PlayRoomRefreshRoomCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_REFRESH_ROOM_INFO, PlayRoomRefreshRoomInfoCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_CREATE_ROOM, PlayRoomCreateRoomCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_SWITCH_ROOM_TYPE, PlayRoomSwitchRoomTypeCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_JOIN_ROOM, PlayRoomJoinRoomCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_EXIT_ROOM, PlayRoomExitRoomCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_READY, PlayRoomReadyCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_SWITCH_VIEWER, PlayRoomSwitchViewerCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_KICK, PlayRoomKickCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_START_GAME, PlayRoomStartGameCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_INVITE, PlayRoomInviteCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_INVITE_REFUSE, PlayRoomInviteRefuseCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_MATCH_READY, PlayRoomMatchReadyCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_SEND_CHAT, PlayRoomSendChatCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_REFRESH_RANK, PlayRoomRefreshRankCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_LOAD_SCENE_COMPLETE, PlayRoomSendSceneLoadCompleteCommand)
	slot0.facade:registerCommand(GAME.PLAY_ROOM_QUICK_MATCH, PlayRoomQuickMatchCommand)
	slot0.facade:registerCommand(GAME.ISLAND_PLAYER_CHEATER_OPERATE, IslandCheaterOperateCommand)
	slot0.facade:registerCommand(GAME.ISLAND_CHEATER_START_SOLO_GAME, IslandStartSoloGameCommand)
	...
	slot0.facade:registerCommand(GAME.AUCTION_GAME_INIT, AuctionGameInitCommand)
	slot0.facade:registerCommand(GAME.AUCTION_GAME_BID, AuctionGameBidCommand)
	slot0.facade:registerCommand(GAME.AUCTION_GAME_FORFEIT, AuctionGameForfeitCommand)
	slot0.facade:registerCommand(GAME.AUCTION_GAME_EVENT_SELECTED_ID, AuctionGameEventSelectedIDCommand)
	slot0.facade:registerCommand(GAME.AUCTION_GAME_EMOJI, AuctionGameEmojiCommand)
	slot0.facade:registerCommand(GAME.AUCTION_GAME_SWITCH_EMOJI, AuctionGameSwitchEmojiCommand)
	slot0.facade:registerCommand(GAME.AUCTION_GAME_SHOW_MATCH_WARNING_TIP, AuctionGameShowMatchWarningTipCommand)
	slot0.facade:registerCommand(GAME.AUCTION_GAME_MATCHING_RECONNECT, AuctionGameMatchingReconnectCommand)
