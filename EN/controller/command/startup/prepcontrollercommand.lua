...
slot0.execute = function(slot0, slot1)
	...
	slot0.facade:registerCommand(GAME.ISLAND_SELL_ITEM, SellIslandItemCommand)
	slot0.facade:registerCommand(GAME.ISLAND_BATCH_SELL_ITEM, BatchSellIslandItemCommand)
	...
	slot0.facade:registerCommand(GAME.ISLAND_UPGRADE_SKILL, IslandUpgradeShipSkillCommand)
	slot0.facade:registerCommand(GAME.ISLAND_GET_EXTRA_AWARD, GetIslandExtraShipAwardCommand)
	slot0.facade:registerCommand(GAME.ISLAND_UNLOCK_BUILDING, IslandUnlockBuildingCommand)
	slot0.facade:registerCommand(GAME.ISLAND_UPGRADE_BUILDING, IslandUpgradeBuildingCommand)
	slot0.facade:registerCommand(GAME.ISLAND_START_PRODUCTION, IslandStartProductionCommand)
	slot0.facade:registerCommand(GAME.ISLAND_START_PRODUCTION_WITH_COST, IslandStartProductionWithCostCommand)
	slot0.facade:registerCommand(GAME.ISLAND_CANCEL_PRODUCTION, IslandCancelProductionCommand)
	slot0.facade:registerCommand(GAME.ISLAND_FINISH_PRODUCTION, IslandFinishProductionCommand)
	slot0.facade:registerCommand(GAME.ISLAND_START_COMMISSION, IslandStartCommissionCommand)
	slot0.facade:registerCommand(GAME.ISLAND_CHANGE_COMMISSION_SHIP, IslandChangeCommissionShipCommand)
	slot0.facade:registerCommand(GAME.ISLAND_CHANGE_COMMISSION_FORMULA, IslandChangeCommissionFormulaCommand)
	slot0.facade:registerCommand(GAME.ISLAND_CANCEL_COMMISSION, IslandCancelCommissionCommand)
	slot0.facade:registerCommand(GAME.ISLAND_GET_COMMISSION_AWARD, IslandGetCommissionAwardCommand)
	...
	slot0.facade:registerCommand(GAME.ISLAND_HEART_BEAT, IslandHeartBeatCommand)
