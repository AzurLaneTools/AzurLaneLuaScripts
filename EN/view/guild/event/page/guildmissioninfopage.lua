...
slot0.OnLoaded = function(slot0)
	slot0.closeBtn = slot0._tf:Find("top/close")
	slot0.sea = slot0._tf:Find("bg/sea"):GetComponent(typeof(RawImage))
	slot0.titleTxt = slot0._tf:Find("top/title/Text"):GetComponent(typeof(Text))
	slot0.logBtn = slot0._tf:Find("bottom/log_btn")
	slot0.formationBtn = slot0._tf:Find("bottom/formationBtn")
	slot0.doingBtn = slot0._tf:Find("bottom/doing_btn")
	slot0.helpBtn = slot0._tf:Find("bottom/help")
	slot0.logPanel = slot0._tf:Find("log_panel")
	slot0.logList = UIItemList.New(slot0.logPanel:Find("scrollrect/content"), slot0.logPanel:Find("scrollrect/content/tpl"))
	slot0.peopleCnt = slot0._tf:Find("bottom/cnt/Text"):GetComponent(typeof(Text))
	slot0.effectCnt = slot0._tf:Find("bottom/effect/Text"):GetComponent(typeof(Text))

	setText(slot0._tf:Find("bottom/cnt"), i18n("guild_join_member_cnt"))
	setText(slot0._tf:Find("bottom/effect"), i18n("guild_total_effect"))

	slot0.areaTxt = slot0._tf:Find("top/title/Text/target/area"):GetComponent(typeof(Text))
	slot0.goalTxt = slot0._tf:Find("top/title/Text/target/goal"):GetComponent(typeof(Text))
	slot0.timeTxt = slot0._tf:Find("bottom/progress/time/Text"):GetComponent(typeof(Text))
	slot0.nodesUIlist = UIItemList.New(slot0._tf:Find("bottom/progress/nodes"), slot0._tf:Find("bottom/progress/nodes/tpl"))
	slot0.progress = slot0._tf:Find("bottom/progress")
	slot0.nodeLength = slot0.progress.rect.width
	slot0.healTF = slot0._tf:Find("resources/heal")
	slot0.nameTF = slot0._tf:Find("resources/name")
end
