...
slot0.OnLoaded = function(slot0)
	...
	slot0.taskTF = slot0._tf:Find("TaskPanel")
	slot0.taskUnOpenTF = slot0._tf:Find("TaskPanel/unopen")
	slot0.unOpenAdmin = slot0.taskUnOpenTF:Find("select")
	slot0.unOpenUnAdmin = slot0.taskUnOpenTF:Find("lock")
	slot0.taskOpenTF = slot0._tf:Find("TaskPanel/open")
	slot0.taskDescTxt = slot0.taskOpenTF:Find("top/desc/Text"):GetComponent(typeof(Text))
	slot0.taskAwardTxt = slot0.taskOpenTF:Find("top/desc1/Text"):GetComponent(typeof(Text))
	slot0.taskProgressTxt = slot0.taskOpenTF:Find("top/progress"):GetComponent(typeof(Text))
	slot0.taskProgressBar = slot0.taskOpenTF:Find("top/progress_bar")
	slot0.privateTaskDesc = slot0.taskOpenTF:Find("bottom/desc"):GetComponent(typeof(Text))
	slot0.privateTaskGetBtn = slot0.taskOpenTF:Find("bottom/get")
	slot0.privateTaskAcceptBtn = slot0.taskOpenTF:Find("bottom/accept")
	slot0.privateTaskProgressTxt = slot0.taskOpenTF:Find("bottom/progress/Text"):GetComponent(typeof(Text))
	slot0.privateTaskReapeatFlag = slot0.taskOpenTF:Find("bottom/reapeat")
	slot0.privateTaskResTxt = slot0.taskOpenTF:Find("bottom/res/Text"):GetComponent(typeof(Text))
	slot0.taskMaskAll = slot0._tf:Find("TaskPanel/open/mask_all")
	slot0.taskMaskTop = slot0._tf:Find("TaskPanel/open/mask_top")
	slot0.contributionList = UIItemList.New(slot0._tf:Find("TaskPanel/SubmitPanel/list"), slot0._tf:Find("TaskPanel/SubmitPanel/list/tpl"))
	slot0.contributionCntTxt = slot0._tf:Find("TaskPanel/SubmitPanel/cnt/Text"):GetComponent(typeof(Text))
	slot0.supplyFrame = slot0._tf:Find("TaskPanel/SupplyPanel/frame")
	slot0.supplyOpenTF = slot0._tf:Find("TaskPanel/SupplyPanel/frame/open")
	slot0.supplyOpenTimeTxt = slot0.supplyOpenTF:Find("time"):GetComponent(typeof(Text))
	slot0.supplyOpenLetfCntTxt = slot0.supplyOpenTF:Find("Text"):GetComponent(typeof(Text))
	slot0.supplyOpenGetBtn = slot0.supplyOpenTF:Find("get")
	slot0.supplyOpenGotBtn = slot0.supplyOpenTF:Find("got")
	slot0.supplyUnOpenTF = slot0._tf:Find("TaskPanel/SupplyPanel/frame/unopen")
	slot0.supplyUnOpenAdminTF = slot0.supplyUnOpenTF:Find("purchase")
	slot0.supplyUnOpenResTF = slot0.supplyUnOpenAdminTF:Find("Text"):GetComponent(typeof(Text))
	slot0.supplyUnOpenLockTF = slot0.supplyUnOpenTF:Find("lock")
end
