...
slot0.OnLoaded = function(slot0)
	slot0.currentTr = slot0._tf:Find("current")
	slot0.pastTr = slot0._tf:Find("past")
	...
	slot0.currProgressTr = slot0._tf:Find("current_progress")
	slot0.pastProgressTr = slot0._tf:Find("past_progress")
	slot0.currProgressTxt = slot0._tf:Find("current_progress/value"):GetComponent(typeof(Text))
	slot0.pastProgressTxt = slot0._tf:Find("past_progress/value"):GetComponent(typeof(Text))
	slot0.backBtn = slot0._tf:Find("blur_panel/adapt/top/back")
	slot2 = slot0._tf:Find("current"):GetComponent(typeof(Image))
	slot2.sprite = GetSpriteFromAtlas("MetaWorldboss/" .. WorldBossConst.GetCurrBossGroup(), "cur")

	slot2:SetNativeSize()
	setText(slot0._tf:Find("tip/Text"), i18n("world_boss_item_usage_tip"))
