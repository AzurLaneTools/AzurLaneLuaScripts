slot0 = class("WorldBossArchivesListPage", import("view.base.BaseSubView"))
slot1 = 1
slot2 = 2

function slot0.getUIName(slot0)
	return "WorldBossArchivesListUI"
end
...
function slot0.OnLoaded(slot0)
	...
	slot0.openTr = slot0:findTF("open", slot0.paintingTr)
	...
	slot0.msgBox = WorldBossArchivesMsgboxPage.New(slot0._parentTf.parent, slot0._event)
...
function slot0.Filter(slot0, slot1)
	...
	setActive(slot0.filterTr, slot1 ~= uv1 or not slot5)
...
function slot0.OnDestroy(slot0)
	...
	for slot4, slot5 in pairs(slot0.awardCards) do
		slot5:Dispose()
	end
