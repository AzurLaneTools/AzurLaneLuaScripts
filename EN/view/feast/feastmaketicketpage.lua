...
slot0.OnLoaded = function(slot0)
	...
	slot0.failedTip = slot0._tf:Find("failed_tip")
	slot0.descTr = slot0._tf:Find("desc_panel")
	...
	slot0.tipTopTr = slot0._tf:Find("tip")

	setText(slot0._tf:Find("tip/Text"), i18n("feast_label_make_ticket_tip"))
	setText(slot0._tf:Find("tip/label"), i18n("feast_label_make_ticket_click_tip"))
	setText(slot0._tf:Find("failed_tip/Text"), i18n("feast_label_make_ticket_failed_tip"))
end
