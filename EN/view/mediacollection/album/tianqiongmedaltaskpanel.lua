slot0 = class("TianqiongMedalTaskPanel")
...
slot0.UpdateList = function(slot0, slot1)
	slot0.UIlist:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			slot3 = uv0[slot1 + 1]
			slot4 = slot2:Find("frame/progressContent")
			slot6 = slot2:Find("frame/progressContent/progress")
			slot8 = slot2:Find("frame/awards")
			slot10 = slot2:Find("frame/get_btn")
			slot12 = slot2:Find("frame/go_btn")

			setText(slot2:Find("frame/desc"), slot3:getConfig("desc"))

			slot13, slot14 = uv1:getTaskProgress(slot3)
			slot15, slot16 = uv1:getTaskTarget(slot3)
			slot2:Find("frame/slider"):GetComponent(typeof(Slider)).value = slot13 / slot15

			setText(slot2:Find("frame/progressContent/progress_1"), slot14 .. "/" .. slot16)
			uv1:updateAwards(slot3:getConfig("award_display"), slot8, slot8:GetChild(0))
			setActive(slot2:Find("frame/got_btn"), slot3:getTaskStatus() == 2)
			setActive(slot10, slot3:getTaskStatus() == 1)
			setActive(slot12, slot3:getTaskStatus() == 0)
