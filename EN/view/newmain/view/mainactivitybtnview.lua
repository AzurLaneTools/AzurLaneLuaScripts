...
function slot0.Ctor(slot0, slot1, slot2)
	...
	slot0.activityBtns = {
		...
		MainActMedalCollectionBtn.New(slot3, slot2),
		MainActSenranBtn.New(slot3, slot2),
		MainActBossSingleBtn.New(slot3, slot2)
	}
	slot0.specailBtns = {
		...
		MainVoteEntranceBtn.New(slot0.eventPanel, slot2)
	}
