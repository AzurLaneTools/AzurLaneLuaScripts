...
slot0.Set = function(slot0, slot1)
	...
	slot2:GetSpine(slot1, function (slot0)
		uv0.spineChar = slot0
		uv0.model = slot0:GetModel()

		slot0:SetParent(uv0.go)
		slot0:SetAnchoredPosition(uv0.SDPosition)
		slot0:SetLocalScale(uv0.SDScale)
...
slot0.PlayAction = function(slot0, slot1)
	...
	if not slot0.loader or slot0.loader:GetLoadingRP("SD") or not slot0.spineChar then
		return
	end
	...
	slot0.spineChar:SetAction(slot2.action, 0)
	slot0.timer:Start()
