...
slot0.InitUI = function(slot0)
	slot0.skillContainer = slot0._tf:Find("bg/skill_panel/frame/skill_list/viewport")
...
slot0.AddListener = function(slot0)
	...
	onButton(slot0, slot3:Find("qr_btn"), function ()
		uv0.confirmFunc()
	end, SFX_CONFIRM)
end
...
slot0.initSkills = function(slot0)
	...
	for slot7, slot8 in ipairs(pg.ship_data_template[slot0._shipVO:getMaxConfigId()].buff_list_display) do
		...
		if slot0._shipVO.skills[slot8] then
			...
			setActive(slot11:Find("mask"), true)
...
slot0.UpdatePropertyPanel = function(slot0)
	slot0.propertyPanel = PropertyPanel.New(slot0._tf:Find("bg/property_panel/frame"))
