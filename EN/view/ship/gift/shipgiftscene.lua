...
slot0.init = function(slot0)
	slot0.adapt = slot0:findTF("adapt")
	slot0.topPanel = slot0:findTF("adapt/top")
	slot0.backBtn = slot0:findTF("adapt/top/back_btn")
	slot0.homeBtn = slot0:findTF("adapt/top/option")
	slot0.bgTf = slot0:findTF("bgGo")
	slot0.imageGrass = slot0:findTF("bgGo/ImageGrass")
	slot0.character = slot0:findTF("adapt/content")
	slot0.chat = slot0:findTF("adapt/content/chat")
	slot0.chatBg = slot0:findTF("adapt/content/chat/chatbgtop")
	slot0.chatText = slot0:findTF("adapt/content/chat/Text")
	...
	slot0.namePanel = slot0:findTF("adapt/name")
	slot0.shipName = slot0:findTF("adapt/name/nameRect/name_mask/Text")
	slot0.shipNameEn = slot0:findTF("adapt/name/english_name")
	slot0.starts = slot0:findTF("adapt/name/stars")
	slot0.shipInfoStarTpl = slot0:findTF("adapt/name/star_tpl")
	slot0.shipType = slot0:findTF("adapt/name/type")
	slot0.intimacyIcon = slot0:findTF("adapt/intimacy/icon")
	slot0.intimacyValueText = slot0:findTF("adapt/intimacy/value")
	slot0.intimacyAddValueText = GetComponent(slot0:findTF("adapt/intimacy/addValue"), typeof(RectTransform))
	slot0.painting = slot0:findTF("content/paint/fitter", slot0.adapt)
	slot0.l2dParent = slot0:findTF("content/paint/live2d", slot0.adapt)
	slot0.spineParent = slot0:findTF("content/paint/spinePainting", slot0.adapt)
	slot0.effectParent = slot0:findTF("content/paint/effect", slot0.adapt)
	slot0.intimacyAddValuePos = slot0.intimacyAddValueText.localPosition
	slot0.rightPanel = slot0:findTF("adapt/right")
	slot0.scrollRect = GetComponent(slot0:findTF("adapt/right/scrollRect"), "LScrollRect")
	slot0.giftBtn = slot0:findTF("adapt/right/giftBtn")

	setText(slot0:findTF("adapt/right/titlePanel/title/text"), i18n("ship_gift"))
	setText(slot0:findTF("label", slot0.giftBtn), i18n("ship_gift2"))
