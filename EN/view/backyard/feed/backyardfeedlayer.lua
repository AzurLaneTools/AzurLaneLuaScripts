...
slot0.init = function(slot0)
	...
	slot0.chatTxt1 = slot0._tf:Find("chat/Text1"):GetComponent(typeof(Text))
	slot0.chatTime = slot0._tf:Find("chat/Text/time"):GetComponent(typeof(Text))
	slot0.chatTxt2 = slot0._tf:Find("chat/Text2"):GetComponent(typeof(Text))
	slot0.capacityBar = slot0._tf:Find("frame/progress"):GetComponent(typeof(Slider))
	slot0.capacityBarEffect = slot0._tf:Find("frame/progress_effect"):GetComponent(typeof(Slider))
	slot0.capacityTxt = slot0._tf:Find("frame/Text"):GetComponent(typeof(Text))
	slot0.extendBtn = slot0._tf:Find("frame/extend_btn")
	slot0.additionTxt = slot0._tf:Find("frame/addition"):GetComponent(typeof(Text))
	slot0.paint = slot0._tf:Find("lenggui")
	slot0.cardTpl = slot0._tf:Find("frame/foodtpl")
	...
	setText(slot0._tf:Find("frame/extend_btn/Text"), i18n("enter_extend_food_label"))
end
