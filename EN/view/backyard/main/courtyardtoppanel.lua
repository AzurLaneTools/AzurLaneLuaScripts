...
slot0.init = function(slot0)
	slot0.backBtn = slot0._tf:Find("btns/topleft/return")
	slot0.nameTxt = slot0._tf:Find("btns/topleft/name/Text"):GetComponent(typeof(Text))
	slot0.renameBtn = slot0._tf:Find("btns/topleft/name")
	slot0.comfortableBtn = slot0._tf:Find("btns/topright/comfortable")
	slot0.comfortableTxt = slot0._tf:Find("btns/topright/comfortable/Text"):GetComponent(typeof(Text))
	slot0.comfortableImg = slot0._tf:Find("btns/topright/comfortable/icon"):GetComponent(typeof(Image))
	slot0.switchBtn = slot0._tf:Find("btns/topright/switch")
	...
	slot0.cg = GetOrAddComponent(slot0._tf:Find("btns/topright"), typeof(CanvasGroup))

	setText(slot0._tf:Find("btns/topright/comfortable/label"), i18n("word_comfort_level"))
	setText(slot0._tf:Find("btns/topright/switch/label"), i18n("courtyard_label_floor"))
end
