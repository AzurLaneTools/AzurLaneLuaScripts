...
slot0.OnLoaded = function(slot0)
	slot0.purchaseBtn = slot0._tf:Find("frame")
	slot0.tipTxt = slot0._tf:Find("tip/Text"):GetComponent(typeof(Text))
	slot0.icon = slot0._tf:Find("frame/icon/Image"):GetComponent(typeof(Image))
	slot0.tag = slot0._tf:Find("frame/icon/tag"):GetComponent(typeof(Image))
	slot0.nameTxt = slot0._tf:Find("frame/name/Text"):GetComponent(typeof(Text))
	slot0.priceTxt = slot0._tf:Find("frame/price"):GetComponent(typeof(Text))
	slot0.descTxt = slot0._tf:Find("frame/desc"):GetComponent(typeof(Text))
	slot0.limitTxt = slot0._tf:Find("frame/count"):GetComponent(typeof(Text))
	slot0.uiList = UIItemList.New(slot0._tf:Find("frame/awards"), slot0._tf:Find("frame/awards/award"))
