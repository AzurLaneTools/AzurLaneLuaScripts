slot0 = class("DOAYearHotSpringScene", import("view.base.BaseUI"))
...
slot0.init = function(slot0)
	...
	pg.ViewUtils.SetSortingOrder(slot0._tf, 4)
...
slot0.didEnter = function(slot0)
	...
	onButton(slot0, slot0._tf:Find("Top/Manage"), function ()
		uv0:emit(DOAYearHotSpringMediator.OPEN_INFO)
	end, SFX_PANEL)
...
slot0.InitSlots = function(slot0)
	...
	table.Foreach(slot0.slotTFs, function (slot0, slot1)
		onButton(uv0, slot1:Find("Usable"), function ()
			uv0:emit(DOAYearHotSpringMediator.UNLOCK_SLOT, uv0.activity.id)
		end, SFX_PANEL)
		onButton(uv0, slot1:Find("Enter"), function ()
			slot0 = uv0.activity:GetShipIds()[uv1] or 0

			uv0:emit(DOAYearHotSpringMediator.OPEN_CHUANWU, uv1, slot0 > 0 and getProxy(BayProxy):RawGetShipById(slot0))
		end, SFX_PANEL)
