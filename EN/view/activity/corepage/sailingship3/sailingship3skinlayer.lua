slot0 = class("SailingShip3SkinLayer", import("view.base.BaseUI"))
slot1 = nil
...
slot0.init = function(slot0)
	uv0 = ActivityConst.SAILING_SHIP_3_SKIN_ACT_ID
	slot0.activity = getProxy(ActivityProxy):getActivityById(uv0)
	slot0.story = slot0.activity:getConfig("config_client").story
	slot0.storyStateDic = {}
	slot0.item = slot0._tf:Find("task/item")
	slot0.items = slot0._tf:Find("task/items")
...
slot0.UpdateTask = function(slot0, slot1, slot2)
	...
	onButton(slot0, slot13, function ()
		uv0:emit(SailingShip3SkinMediator.ON_TASK_GO, uv1)
	end, SFX_PANEL)
	onButton(slot0, slot14, function ()
		...
		seriesAsync(slot0, function ()
			uv0:emit(SailingShip3SkinMediator.ON_TASK_SUBMIT, uv1)
		end)
	end, SFX_PANEL)
...
slot0.ShouldShowTip = function()
	...
	for slot8, slot9 in ipairs(getProxy(ActivityProxy):getActivityById(ActivityConst.SAILING_SHIP_3_SKIN_ACT_ID):getConfig("config_client").group_1) do
