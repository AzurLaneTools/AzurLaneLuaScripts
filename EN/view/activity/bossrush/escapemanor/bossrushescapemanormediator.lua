slot0 = class("BossRushEscapeManorMediator", import("view.base.ContextMediator"))
slot0.ON_FLEET_SELECT = "BossRushEscapeManorMediator.ON_FLEET_SELECT"
slot0.ON_EXTRA_RANK = "BossRushEscapeManorMediator.ON_EXTRA_RANK"
slot0.ON_TASK_SUBMIT = "BossRushEscapeManorMediator.ON_TASK_SUBMIT"
slot0.ON_PERFORM_COMBAT = "BossRushEscapeManorMediator.ON_PERFORM_COMBAT"
slot0.GO_SUBLAYER = "BossRushEscapeManorMediator.GO_SUBLAYER"
slot0.GO_SCENE = "BossRushEscapeManorMediator.GO_SCENE"
...
slot0.register = function(slot0)
	...
	slot0:bind(uv0.ON_FLEET_SELECT, function (slot0, slot1)
		BossRushEscapeManorPassedLayer.seriesId = slot1.configId
...
slot0.handleNotification = function(slot0, slot1)
	...
	elseif slot2 == ActivityProxy.ACTIVITY_UPDATED then
		if slot3 then
			...
			elseif slot5.id == ActivityConst.ESCAPE_BOSS_RUSH_PT_ID then
