...
slot0.init = function(slot0)
	...
	slot0.helpBtn = slot0._tf:Find("top/help_btn")
	slot0.resetBtn = slot0._tf:Find("info/reset_button")
	slot0.awardTxt = slot0._tf:Find("info/award_txt")
	slot0.timeTxt = slot0._tf:Find("info/time_txt")
	slot0.bestTxt = slot0._tf:Find("info/best_txt")
	slot0.layout = slot0._tf:Find("card_con/layout")
	slot0.item = slot0.layout:Find("card")
	slot0.bottom = slot0._tf:Find("card_con/bottom")
	slot0.line = slot0.bottom:Find("card")
	slot0.result = slot0._tf:Find("result")
	slot0.countDown = slot0._tf:Find("count_down")
	slot0.resource = slot0._tf:Find("resource")
	slot0.bestTitleText = slot0._tf:Find("info/BestTitle")
	slot0.curTitleText = slot0._tf:Find("info/CurTitle")
