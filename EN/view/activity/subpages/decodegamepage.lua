...
slot0.OnInit = function(slot0)
	...
	slot0.dayTF = slot0.bg:Find("Text"):GetComponent(typeof(Text))
	...
	slot0.itemIcon = slot0._tf:Find("AD/ring/icon")
	slot0.itemLock = slot0._tf:Find("AD/ring/lock")
	slot0.itemGot = slot0._tf:Find("AD/ring/got")
	slot0.itemProgressG = slot0._tf:Find("AD/ring/bar_g")
	slot0.itemProgressB = slot0._tf:Find("AD/ring/bar_b")
	slot0.red = slot0._tf:Find("AD/red")
	slot0.number1 = slot0._tf:Find("AD/1"):GetComponent(typeof(Image))
	slot0.number2 = slot0._tf:Find("AD/2"):GetComponent(typeof(Image))
end
