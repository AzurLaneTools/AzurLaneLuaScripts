slot0 = class("LuminousUrExPage", import("...base.BaseActivityPage"))
slot0.SP_FIRST = 1
slot0.SP_DAILY = 2
	...
	onButton(slot0, slot0._btnExchange, function ()
		if uv0.canExchange then
			pg.MsgboxMgr.GetInstance():ShowMsgBox({
				...
				onYes = function ()
					uv0:emit(ActivityMediator.ON_ACT_SHOPPING, uv0.shopId, 1, uv0.curGoods.id, 1, function ()
						if uv0._tf and not IsNil(uv0._tf) then
							uv0:OnUpdateFlush()
						end
					end)
