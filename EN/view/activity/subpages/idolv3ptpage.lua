...
slot0.OnInit = function(slot0)
	...
	slot0.trainEntranceBtn = slot0.bg:Find("train_btn")
	...
	setText(slot0.msgBox:Find("panel/title/Text"), i18n("title_info"))
...
slot0.OnUpdateFlush = function(slot0)
	...
	for slot17, slot18 in ipairs(slot0.ptData:GetCurBuffInfos()) do
		setActive(slot0.skillBtns[slot18.group]:Find("lv1"), false)
		setActive(slot0.skillBtns[slot18.group]:Find("lv2"), false)
		setActive(slot0.skillBtns[slot18.group]:Find("lv3"), false)

		if slot18.next then
			setActive(slot0.skillBtns[slot18.group]:Find("lv" .. slot18.lv), true)
		else
			setActive(slot0.skillBtns[slot18.group]:Find("lv3"), true)
		end

		setImageSprite(slot0.skillBtns[slot18.group]:Find("icon"), LoadSprite(pg.benefit_buff_template[slot18.id].icon))
	end
end
