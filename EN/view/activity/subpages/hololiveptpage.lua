...
slot0.OnInit = function(slot0)
	...
	slot0.charImg = slot0.bg:Find("charImg")
	slot0.numImg = slot0.bg:Find("numImg")
	slot0.chapterImg = slot0.bg:Find("chapterImg")
	slot0.spineCharContainer = slot0.bg:Find("SpineChar")
	slot0.scrollTextMask = slot0.bg:Find("ScrollText")
	slot0.scrollTextContainer = slot0.bg:Find("ScrollText/TextList")
	slot0.scrollTextTpl = slot0.bg:Find("TextTpl")
end
