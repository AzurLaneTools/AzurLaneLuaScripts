...
slot0.OnInit = function(slot0)
	slot0.bg = findTF(slot0._tf, "AD")
	slot0.Build = findTF(slot0.bg, "build")
	slot0.build_times = findTF(slot0.Build, "build_times")
	slot0.build_time = findTF(slot0.build_times, "time")
	slot0.Level = findTF(slot0.bg, "fight")
	slot0.Shop = findTF(slot0.bg, "shop")
	slot0.shop_times = findTF(slot0.Shop, "shop_times")
	slot0.shop_time = findTF(slot0.shop_times, "time")
	slot0.Manual = findTF(slot0.bg, "Manual")
