slot0 = class("GameRoomRollingView", import("..BaseMiniGameView"))
...
slot0.checkSuccessGrid = function(slot0)
	...
	seriesAsync({
		...
		function (slot0)
			if uv0 then
				LeanTween.delayedCall(go(uv1.rollingUI), 0.2, System.Action(function ()
					uv0()
				end))
				uv1:updateScore(uv2)
				uv1:updateCombo()
...
slot0.updateScore = function(slot0, slot1)
	...
	LeanTween.delayedCall(go(slot0.labelGameScore), 0.2, System.Action(function ()
