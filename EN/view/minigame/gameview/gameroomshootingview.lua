...
function slot0.changeStartMaskUI(slot0, slot1)
...
function slot0.showResultPanel(slot0, slot1, slot2)
	...
	GetImageSpriteFromAtlasAsync("ui/shootinggameui_atlas", "level_" .. slot0.awardLevel, slot4:Find("success/level"), true)
