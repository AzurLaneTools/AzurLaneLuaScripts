...
slot0.Prepare = function(slot0)
	slot0._gameTime = CutFruitGameConst.game_time
	...
	slot0._stopTimeStep = false
end

slot0.Step = function(slot0, slot1)
	slot0._deltaTime = slot1

	if slot0._stopTimeStep then
		return
	end
...
slot0.SetSuccess = function(slot0, slot1)
	slot0._success = slot1
end

slot0.GetSuccess = function(slot0)
	return slot0._success
end

slot0.StopTimeStep = function(slot0, slot1)
	slot0._stopTimeStep = slot1
end
