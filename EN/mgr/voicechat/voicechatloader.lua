...
slot0.OnLoaded = function(slot0)
	slot0.stateTxt = slot0._tf:Find("front/label"):GetComponent(typeof(Text))
	slot0.stateEnTxt = slot0._tf:Find("front/label/en"):GetComponent(typeof(Text))
	slot0.timeTxt = slot0._tf:Find("front/label/time"):GetComponent(typeof(Text))
	slot0.respondBtn = slot0._tf:Find("front/btns/respond")
