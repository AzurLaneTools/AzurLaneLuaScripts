return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "Quite some time had passed since they entered. By now, they had fought and destroyed many fleets comprised of Pawns.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "And each time they defeated a fleet, the very walls of the labyrinth changed all around them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "L-like I said, I might be overthinking it... But it's something...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "(It's possible... that it was a mistake to enter the labyrinth. But, we still have to keep going...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
