return {
	...
	scripts = {
		...
		},
		{
			...
			say = "Let us gather supplies while we're there.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Is it common practice to procure items locally in your branch?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Sheesh... Fortress rivals an Arbiter in strength when she gets serious.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "In retrospect, I'm really grateful you went easy on us earlier.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "War Protocol Fortress",
			say = "Yes. These so-called Enforcers have designs, weaponry, and tactics markedly similar to the ANTI-X.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "War Protocol Fortress",
			say = "Based on the presence of modules more advanced than mine, I theorize that the units above them – \"Arbiters\" – are newer models than I.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "War Protocol Fortress",
			say = "However, I should state that these Enforcers do not appear to be frontline units.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "War Protocol Fortress",
			say = "Their firepower configuration suggests that they are most likely logistics or facility defense units.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "So we basically wiped out a support fleet?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "You say that, but it's always a headache when WE have to deal with Enforcers.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Our hulls might've been damaged...?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "War Protocol Fortress",
			say = "Orders received. Commencing scan.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Huh? Someone tampered with our Cubes?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "It sounds less like a limiter and more like a safety feature.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Because, you know, isn't not turning META a good thing?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Oh, oh! It's like a superhero costume you put on and take off!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Whoa, whoa, you're not seriously considering it, are you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			actorName = "War Protocol Fortress",
			say = "My system resources are occupied by other tasks at the moment. Shall I reallocate them?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "I mean, we didn't really do much. Hell, we did more harm than good to your warships in particular.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Do we really deserve a medal for that?",
			painting = {
				alpha = 0.3,
				time = 1
			},
