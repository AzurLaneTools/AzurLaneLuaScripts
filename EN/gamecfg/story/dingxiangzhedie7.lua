return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "\"I'd change the past.\"",
					flag = 1
				},
				{
					content = "\"I'd let history take its course.\"",
					flag = 2
				},
				{
					content = "\"I'd take it one step at a time, like a minefield.\"",
					flag = 3
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "When you don't know what you're supposed to do, do what you feel is right.",
			painting = {
				alpha = 0.3,
				time = 1
			},
