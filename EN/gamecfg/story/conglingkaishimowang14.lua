return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 801040,
			nameColor = "#A9F548FF",
			say = "Incredible. You actually managed to lift the curse on the great mage...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 801040,
			nameColor = "#A9F548FF",
			say = "And not only that, you even spoke to the old heroes! I almost can't believe it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Alright, settle down. Whether it's the truth or not doesn't really matter.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Now lookie here and pose for the camera!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 901110,
			nameColor = "#A9F548FF",
			say = "Bleh... What the heck is this jiggly stuff?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "It's my favourite and speciality – eel jelly! I think it's the perfect for a victory banquet.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Though, full disclosure: I couldn't find any eels, so I used Eel Slimejuu meat instead. It's pretty similar in texture!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Come on, don't be shy. Try it!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 901130,
			nameColor = "#A9F548FF",
			say = "Slimejuu meat? Are you serious? You just stuffed a monster into your food!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 901110,
			nameColor = "#A9F548FF",
			say = "Th-thanks, kind adventurer, but I'm not hungry. I'll have to pass on this one.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 901110,
			nameColor = "#A9F548FF",
			say = "I'm sure your cooking would be lovely after a drink or–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Did somebody say drink? I've got just the thing for you!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 901110,
			nameColor = "#A9F548FF",
			say = "Excuse me, what's this? It's pitch black, yet it's somehow glowing...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "It's a very special drink, made by yours truly.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Drinking it will make all your fatigue from fighting go away, just like that!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Come ooon, I made it just for the banquet! At least have a small sip! Please?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			say = "That general of the undead army dropped this golden coin after we defeated her...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "My Info Analysis skill says this coin was produced back in the age of the old kingdom.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Why did a general of the Demon King Army have a coin like this?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "It almost makes me think the old kingdom, the undead army, and even the Demon King are all somehow connected...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "But in what way, I have no idea. Too little to work with.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "This lore stuff is pretty fascinating. Really tickles your imagination.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "*sob*... Nobody wants to eat the food I made!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "*sob*... And nobody wants to drink my special potion either!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "(I DO have an SSS-rank Curse Resistance. My gut should be able to handle this.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			options = {
				{
					content = "I'll eat your food, Liverpool.",
					flag = 1
				},
				{
					content = "I'll drink your potion, Nubian.",
					flag = 2
				},
				{
					content = "I'll have them both!",
					flag = 3
				}
			}
		},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "I scolded Liverpool and Nubian for what they did.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "It's like as soon as I'm not here, they start feeding you weird stuff...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Did you look after me while I was out cold? Thanks for that.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Heehee... How do you feel now?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Turns out that Poison Resistance really came in clutch.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			say = "You won't kill the Demon King anytime soon if you're getting knocked out even at a party.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Yeah. Imagine if I died not in a battle, but at a banquet attended by healers, angels, and clerics...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "I'd be a laughing stock for the rest of time.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "I sense subtle mockery in your words...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "...In light of these achievements, Her Majesty has decided not to hold you accountable for the destruction of her audience hall.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "Naturally, you will need equipment and supplies to brave the Wasteland. The Royal Army shall provide you with those.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "You would also have been seized by the guards and brought back to the castle to answer for your crimes.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "Furthermore, I, personally, have a special reward to give you, Commander. For your outstanding contributions.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "A special reward? What is it?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 907010,
			nameColor = "#A9F548FF",
			say = "In the name of the goddess of light and justice, I hereby grant you the Blessing of Light.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907010,
			nameColor = "#A9F548FF",
			say = "I hope that it will help you on your way to the Demon King.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "Now you carry the blessing with you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "You may return to the banquet hall and enjoy the rest of your evening.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "I hope you have a pleasant time.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "That's mean of you, Saint. Stealing the honor like that.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Doing that will require my Blessing of Steel, which protects the flesh.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Heehee, though it doesn't look like you'll be fully waking up soon either.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Until then, I want you to take my love.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "And this – just think of it like a sweet dream on your quest to kill the Demon King.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Nighty night, my dear little one.",
			painting = {
				alpha = 0.3,
				time = 1
			},
