return {
	...
	scripts = {
		...
		},
		{
			...
			options = {
				{
					content = "\"Interesting Tidbits from the Ball.\"",
					flag = 1
				},
				{
					content = "\"Ball Guests' Embarrassing Secrets Caught on Camera!\"",
					flag = 2
				}
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "I mean... It's serviceable, but it's kinda boring. It's gotta make you go, \"I HAVE to know what this is about!\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "See, I was thinking something like, \"Ball Guests' Embarrassing Secrets Caught on Camera!\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Whoa! You're a genius, Commander!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Like it or not, I'm going with it! This issue's gonna spread like wildfire!",
			painting = {
				alpha = 0.3,
				time = 1
			},
