return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "How I've missed you, Ballad Castle.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Ruined though it may be, this place's structure hasn't changed much since it was spared from the worst of the fighting.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "...Strange. I don't see a single undead anywhere.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Yes, this is supposed to be their nest... Where have they all gone?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600030,
			nameColor = "#A9F548FF",
			say = "Heehee, what brings you here? Hoping to find buried treasure among the ruins, hmm?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600040,
			nameColor = "#FF9B93",
			say = "We run this place! You wanna pass through? Then hand over your valuables!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600040,
			nameColor = "#FF9B93",
			say = "Bandits? Slander! We are decent, hardworking pirates!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Pirates on land? I've never seen that before...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600040,
			nameColor = "#FF9B93",
			say = "Well, now you have! We're pirates, AND we're on la– Wait, I'm getting sidetracked again.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600040,
			nameColor = "#FF9B93",
			say = "Hey, what were we talking about?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 9600050,
			nameColor = "#FF9B93",
			say = "You were saying, \"Hand over your valuables.\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
