	...
	scripts = {
		{
			...
			bgm = "sk-az-pv2",
			say = "Shimakaze's call for aid did not fall on deaf ears.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			bgName = "star_level_bg_142",
			say = "Gascogne, heiress to a noble family renowned for their efficiency, led a massive supply convoy to our castle.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			say = "She invited me on a stroll to hand over and discuss the supply list, but I can't help but think she has something else in mind.",
			hideRecordIco = true,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Further support is on the way, as well.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Physical supplies are merely a visible and portable medium.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "They're consumed, and they're replaced.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "In the end, my conclusion was simple.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "Wherever you go, I ask that you take me with you.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
