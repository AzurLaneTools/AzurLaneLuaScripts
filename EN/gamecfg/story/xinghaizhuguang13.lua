return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Did the Sea of Stars generate that black tornado, too?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Just for show? This IS a testing area, so it's not like it's any harm done...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 101510,
			nameColor = "#A9F548FF",
			say = "Princeton, there are enemies coming toward us...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 101510,
			nameColor = "#A9F548FF",
			say = "So... we're fighting mist now?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "To put it simply, that mist is a projection of something or someone from a higher dimension.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 101510,
			nameColor = "#A9F548FF",
			say = "Got it. I'll be careful... Get ready to fight.",
			painting = {
				alpha = 0.3,
				time = 1
			},
