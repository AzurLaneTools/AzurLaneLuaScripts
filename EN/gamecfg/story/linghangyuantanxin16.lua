return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "You've done your chores and finished your homework. That's plenty. You can just relax now.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			actorName = "TB",
			side = 2,
			say = "Yes, but those are things I was meant to do anyway. So, if you don't need a shoulder rub, how about...",
			tbActor = true,
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "I know! Why don't I make dinner? Although, we don't have many ingredients... I'll fry some eggs for the extra nutrition!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
