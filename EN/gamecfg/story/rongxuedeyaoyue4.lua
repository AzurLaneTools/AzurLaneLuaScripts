return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "\"...Thank you, Holy Iris, for this respite at the end of a tiring journey...\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "\"...I am forever grateful for your hands that lead my body and spirit towards a place to rest...\"",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "Commander, it's poor manners to sneak up on someone, particularly while also violating their privacy.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "Pray tell, did you commit the grave sin of peeping while I was changing?",
			painting = {
				alpha = 0.3,
				time = 1
			},
			...
			options = {
				...
				{
					content = "\"The Iris willed me to do it!\"",
					flag = 2
				}
			}
		},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "Since I cannot prove your guilt, I will take your word for it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "I don't buy your excuse for even a moment, but I will let it slide this once. The Iris teaches us to forgive.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "...Yes, I am offering you to join me in the water.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "I hope this experience reinvigorates you in the same way it did me.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 907012,
			nameColor = "#A9F548FF",
			say = "Trust me, you'll want to enjoy this vacation to its fullest. You may find yourself subject to the Holy Iris' guidance otherwise~",
			painting = {
				alpha = 0.3,
				time = 1
			},
