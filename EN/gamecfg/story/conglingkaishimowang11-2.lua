return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "Phew... That was the last one.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "Thank you for coming to our aid, adventurers.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Your Holiness, why'd you fight the Demon King Army with such a small force?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "Well... I didn't want to fight any monsters today.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "I simply saw these villagers being attacked whilst en route to Sentinel Bastion, and I helped them.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "I fear that the situation on the frontlines is getting worse.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "Adventurers, may I beseech you something?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "However, her army tore a hole through it during a major battle a few days ago.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "I left the Royal Capital specifically to help repair the hole. Alas, I did not anticipate the Demon King Army would attack a settlement so close to it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "I believe the Demon King means to exploit this gap in our defenses to make a move.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "They are all evacuees from Friede, a village that sits close to the hole.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 802020,
			nameColor = "#A9F548FF",
			say = "It's safe to assume that monsters are laying waste to their homes as we speak.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			options = {
				{
					content = "Of course we'll help you.",
					flag = 1
				},
				{
					content = "Only if the reward is right.",
					flag = 2
				}
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "There you have it! The Commander said so!",
			painting = {
				alpha = 0.3,
				time = 1
			},
