return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Thank god we've managed to decrypt their signals and can actually fight back against them.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Maybe those scientists back at base can make it smaller somehow...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Yeah. If they could shrink it to fit inside your pocket, we could catch the Ashes out in the open and force them to confront us.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Wait. Something is off here... The only time Ashes emit signals is when they're in combat in a general area.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "So then why would she start a fight and reveal her location, especially so close to us? It doesn't make sense...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Seems like she's challenging us to a duel.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Alternatively, she doesn't even know we're here. Whatever the case, how do we proceed?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "I say we accept her invitation and find out what she's after while we still know where she is.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
