return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "That building looks beautiful... Oh, and that one, too...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Ugghh! I wish I could take a selfie with my Master so badly!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Oh, you're right, there is! Thanks!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Oh yeah! Look who's in a fantasy city! Master, gimme a smile!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Big brother... There's a big temple to the northwest.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "I'm an apprentice cleric, so I might learn a new skill if we go there.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "That reminds me! I'm also a cleric, so I should be able to learn the same skills as you.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Let's go check out the temple right now!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			say = "(There's a temple, a marketplace, an artisan district, an adventurer's guild...)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "(Even exploring just this city is going to take a while.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Heehee, is this your first time here?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "To get past it, you'll have to visit the designated area in the city and sign up.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Oh, where are my manners? I'm Friedrich Carl, a mechanic from the Church of Steel.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "I suppose we have business at the castle. Show the way.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Of course. This way, little one!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "A hero, a commander, and two clerics...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "I hear your plea, adventurers.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "Your drive and readiness to defeat the Demon King are worthy of respect.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "On behalf of the kingdom of humanity, I thank you all.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "Yes? You may speak your mind, pious cleric.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "Indeed, you cannot defeat a foe that you know nothing about.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "That is, until just a few days ago, when one of my royal mages managed to briefly break this spell and lay eyes on her.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 201360,
			nameColor = "#A9F548FF",
			say = "Alright, have a gander. This is a royal spell – the culmination of the castle's knowledge. It's called... Instant Capture.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 201360,
			nameColor = "#A9F548FF",
			say = "Show us your mug, Demon King!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "That's her... That's the Demon King.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "(I should use my Info Analysis skill. Any info we can gain on her abilities will be useful when it's time to fight her.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "What?! The Instant Capture spell is becoming unstable! How did this happen?!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = "login",
			say = "Someone is watching me. I can feel it.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = true,
			say = "Who is it? You? You? Or perhaps... you?",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = true,
			say = "Foolish worms. You lack even basic manners.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = true,
			say = "I shall teach you a lesson about not spying on people.",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#FF9B93",
			live2d = "headtouch",
			say = "Light of Destruction, I call–",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 205050,
			nameColor = "#A9F548FF",
			say = "Damn it! Guards! Prepare a defensive spell!",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			factiontag = "Commander",
			nameColor = "#A9F548FF",
			say = "Thank god nobody was hurt. Looks like the guards kept the king safe from harm, too.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "Um, I think the king is furious with you now...",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "What did you do? Did you use your Info Analysis skill? Crap, that's not good...",
			painting = {
				alpha = 0.3,
				time = 1
			},
