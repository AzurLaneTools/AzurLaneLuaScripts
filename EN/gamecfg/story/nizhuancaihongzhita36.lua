return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "I don't get it... I just don't get it!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "What the heck is going on over there?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "Oh, I found it! A picture of the device of the Tower! I knew it had something to do with the Singularity, Commander!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "The list of ships deployed were... Ulrich von Hutten, and Peter Strasser.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "I wonder what they found though... Do you have any ideas, Commander?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "I'd better ask them directly... I won't be able to find out with just what's over here.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "Yep! I can see that there was a big energy reading at that time!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "We lost contact for a while and it was pretty freaky...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "Let's see here... \"We've sent this message to the Commander directly to Naval HQ...\" Wait, what?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "What the heck are you doing, Northern Parliament?!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "Commander, hurry and read this!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
			...
			options = {
				{
					content = "\"What was in the message?\"",
					flag = 1
				}
			}
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "Northern Parliament sent a message for you directly to Naval HQ!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"\"There is much I would like to say, but I will get straight to the point.\"",
					3
				},
				{
					"\"Thanks to the aid from the Azur Lane, we were able to turn the tides against the Sirens.\"",
					4
				},
				{
					"\"The time is ripe.\"",
				...
				{
					"\"Once again, we will begin our counterattack against the Iron Blood.\"",
					6
				},
				{
