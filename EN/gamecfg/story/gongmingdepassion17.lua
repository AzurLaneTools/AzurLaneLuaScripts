return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "Thanks. You've saved me a lot of work.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "How are your other members doing? Are they still resting?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(We're three tests deep into the Muse System, and there is still so much we don't know about it. More than we even realized.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(One thing is clear – more tests need to be run in the future.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			options = {
				{
					content = "Okay, okay, I get it.",
					flag = 1
				},
				{
					content = "I feel a headache coming on...",
					flag = 2
				}
			},
			action = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "I know there's no running away from my duty...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 1,
			say = "But please, let's talk about anything else right now!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			nameColor = "#A9F548FF",
			optionFlag = 2,
			say = "As much as I like making others happy, hearing all those names makes my head hurt.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(Well, except for Laffey who wanted a memory foam pillow, and Le Malin who wanted a year free of all work.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "(I guess it's up to me to determine their order... My work day isn't over quite yet.)",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			layout = {
				...
				{
					1,
					"Third Muse System Test - The Port's Grand Performance"
				},
				{
					3,
					{
				...
				},
				{
					3,
					{
						"Muse System Test Special Fleet 1",
						"Muse System Test Special Fleet 2",
						"Muse System Test Special Fleet 3",
						"Muse System Test Special Fleet 4",
						"Muse System Test Special Fleet 5",
						"Muse System Test Special Fleet 6",
						"Muse System Test Special Fleet 7"
					},
					1,
					"#FFFFFF"
				},
