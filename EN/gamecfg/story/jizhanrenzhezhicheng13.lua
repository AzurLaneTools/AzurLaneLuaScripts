	...
	scripts = {
		{
			...
			bgm = "sk-az-pv2",
			say = "The curtain of night falls, and a concert is about to wrap up.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			bgName = "star_level_bg_551",
			say = "According to Shimakaze, our new ally has already entered the castle premises, and it's the performer up on the stage.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "From the moment our gazes first met, every instant in time we've shared has been etched into my heart...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
