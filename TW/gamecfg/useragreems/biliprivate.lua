...
版本更新提示：
感谢您下载并使用《碧蓝航线》游戏（以下称“本游戏”或“产品”）。我们依据《中华人民共和国个人信息保护法》、《中华人民共和国网络安全法》、《信息安全技术个人信息安全规范》（GB/T 35273-2020）以及其他相关法律法规和技术规范更新了本《隐私政策》，其中主要包括如下内容：增加奖品寄送、活动邀请场景下信息收集与共享的说明。

为了更好地保护您的个人信息，建议您仔细阅读本《隐私政策》，尤其是以黑色加粗的条款。如您对本隐私政策条款有任何异议或疑问，您可通过本《隐私政策》第十条“联系我们”中公布的联系方式与我们沟通。
...
一、	引言
1.本《隐私政策》（以下称“本隐私政策”）仅适用于我们为您提供本游戏相关服务，我们将按照本隐私政策的约定处理和保护您的个人信息。
2.请您在使用本游戏前，仔细阅读并充分理解本隐私政策的全部内容。一旦您点击同意本隐私政策，或您继续使用本游戏产品/服务，即表示您同意我们按照本隐私政策使用和处理您的相关信息。
3.我们可能会不时依据法律法规或业务调整对本隐私政策进行修订。当本隐私政策发生变更后，我们会在版本更新后通过在显著位置提示、弹窗或推送通知、消息等形式向您展示变更后的内容。
...
儿童特别说明：
若您是未满18周岁的未成年人（特别是未满14周岁的儿童），请通知您的监护人共同阅读本隐私政策，特别是《儿童隐私保护政策》，在您取得您的监护人对本隐私政策全部条款，特别是《儿童隐私保护政策》全部条款的同意之后使用我们提供的游戏及服务。您点击同意本隐私政策，或者您使用或继续使用我们提供的游戏及服务、提交个人信息，都表示您已获得您的监护人的许可，且您的监护人也同意我们按照本隐私政策使用和处理您的相关信息。

二、关于我们
1.本游戏由上海幻电信息科技有限公司（以下称“本公司”）及其关联公司提供运营服务。
...
2.个人敏感信息（出自于《个人信息保护法》）：是指一旦泄露或者非法使用，容易导致自然人的人格尊严受到侵害或者人身、财产安全受到危害的个人信息，包括生物识别、宗教信仰、特定身份、医疗健康、金融账户、行踪轨迹等信息，以及不满十四周岁未成年人的个人信息。
...
10.游戏日志：当您使用我们提供的产品/服务时，我们会获取您使用我们产品/服务的详细情况，并作为有关的网络日志保存。
11.服务器日志：通常情况下，我们的服务器会自动记录您在访问网站时所发出的网页请求。这些“服务器日志”通常包括您的网络请求、互联网协议地址、浏览器类型、浏览器语言、请求的日期和时间及可以唯一识别您的浏览器的一个或多个 Cookie。
12.信息发布日志：是指您在游戏中主动上传或公开的信息记录，例如在游戏内发布信息（聊天频道、还有其他会发布信息的地方），群组聊天记录、应用会话记录和系统会话记录。记录用户账号和通讯群组名称、昵称、简介、备注、标识，信息发布、转发、评论和通讯群组等服务功能。
13.操作信息：是指您在游戏中行为信息的记录；例如修改用户账号、操作时间、操作类型、操作内容（即操作日志，如登录时间、登录地址、IP地址、充值时间等）。
...
（2）您也可以直接使用已注册的哔哩哔哩账号登录本游戏。如您使用已注册的哔哩哔哩账号登录的，我们将根据您的授权获取该哔哩哔哩账号下以及本游戏内的相关信息（包括：用户名、昵称、头像以及其他您授权的信息）以及身份验证信息（个人敏感信息）。我们承诺，收集上述信息是用于为您提供账号登录服务以及保障您的账号安全，防范安全风险。如您拒绝授权此类信息，则您将无法使用该已注册的哔哩哔哩账号登录本游戏。
（3）您也可以使用苹果账号登录本游戏。如您使用该方式登录的，则需要按照我们的指引关联您的哔哩哔哩账号。在此过程中，如您尚未注册哔哩哔哩账号，则需根据本条（1）提供相关信息注册，包括账号昵称、手机号码（个人敏感信息，用于接收验证码匹配个人身份）；若您已注册哔哩哔哩账号，则需根据本条（2）款提供相关授权绑定。
...
（2）为满足相关法律法规政策及相关主管部门的要求，我们施行网络游戏用户账号实名注册制度，全面接入国家新闻出版署实名认证系统，哔哩哔哩游戏用户需进行实名认证以继续使用和享受哔哩哔哩游戏的服务。为了完成实名认证服务，您需要提供您的个人身份信息、个人生物识别信息，包括如下：姓名、身份证件号码（个人敏感信息）信息，具体以国家新闻出版署实名认证系统的要求为准。我们向您承诺，上述信息仅用于实名认证之目的，但是，为了完成实名认证以及履行存储注册信息义务，我们将存储您提供的姓名（个人敏感信息）、身份证件号码（个人敏感信息）以及您主动提供的其他信息。如您拒绝提供实名身份信息可能会导致您无法登录哔哩哔哩游戏或在使用哔哩哔哩游戏过程中受到相应限制。
（3）为保障您正常使用我们的服务，维护游戏基础功能的正常运行，保障您的游戏账号安全，识别账号异常状态，了解产品适配性，同时也为了营造健康及安全的游戏环境，我们会收集您的设备信息：包括游戏应用信息（应用程序版本、产品版本号）、设备信息（设备ID、设备序列号、设备制造商、设备名称、设备类型和版本、设备型号、设备样式、设备识别符（如Android ID、IDFA、 IMEI、IMSI、MAC地址、OAID）、相机信息（像素、摄像头数量）、屏幕分辨率、CPU信息（核心数、频率、供应商）、内存大小、传感器信息）、网络信息（网络类型、网络运营商、接入网络的方式、网络质量数据、网络身份识别信息、网络环境信息）、浏览器类型和设置、语言设置、系统版本、IP地址、操作系统及进程信息、以及游戏崩溃记录信息、已安装应用列表信息。
（4）当您使用哔哩哔哩游戏服务时，我们会收集您的游戏日志信息，包括登录日志、操作日志、服务日志、性能日志，以便用于游戏运营统计分析、客服投诉处理及其他游戏安全分析，我们会把前述信息同步至该游戏后续版本或您正在使用的我们提供的其他产品中。
（5）当您使用哔哩哔哩游戏产品的消费功能时，我们会收集您的充值记录、消费记录以及其他使用消费功能必须的信息，以便您查询您的交易记录，同时尽最大程度保护您的虚拟物品安全。充值记录、消费记录属于敏感信息，收集上述信息为实现哔哩哔哩游戏产品的消费功能所必须，否则将无法完成交易。
（6）当您在游戏中通过文字、图片、语音和视频方式与其他玩家进行互动，我们可能会收集并保存您发送的上述文字、图片、语音和视频信息内容，用于过滤色情、暴力、政治、辱骂、恶意广告的不当内容，以此净化游戏环境，维护健康的上网环境。
4.2.2同时为了收集上述信息，我们将会申请访问您的设备信息的如下权限：
（1）本地储存及读写权限：在哔哩哔哩游戏产品应用程序运行时，为对数据进行缓存和读取，我们将获取您的本地存储及读写权限。
（2）外部存储及读写权限：当您使用到需要读取、缓存、上传图片、相册及文件的功能时，我们需要访问您的相册和游戏存档文件，同时为了缓存和读取游戏崩溃日志等信息，保证您正常登录和使用游戏，我们需要您授权我们获取您的外部储存及读写权限，读取和储存视频、音频、文件等内容，以便您使用上传、分享功能。如您拒绝提供上述信息以及权限仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的外部存储及读写权限的授权。
（3）网络访问权限：在哔哩哔哩游戏产品应用程序运行时，为了正常联网使用游戏服务，我们将需要使用您的网络访问权限。
（4）地理位置权限：当您希望与您附近的哔哩哔哩游戏产品的其他用户互动，或参与您附近的线上线下游戏周边活动，或参与哔哩哔哩游戏产品中的地区排行榜时，您需要授权我们获取您的地理位置权限，用于为您寻找附近的其他用户或参与活动，在您授权同意后，我们会收集您的地理位置信息。地理位置信息属于敏感信息，拒绝提供该信息只会导致您无法使用该功能，但不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的地理位置信息授权。
（5）相机权限：当您使用拍照、视频拍摄的功能时，您需要授权我们获取您的相机权限以便您可以使用拍摄功能。如您拒绝提供上述信息以及权限仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的相机权限授权。
（6）麦克风权限：当您使用游戏内语音功能，我们会要获取您的设备麦克风权限，收集您的语音信息，用以提供语音形式的社交功能服务。如您拒绝提供该信息仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的麦克风权限授权。
（7）通知权限：当您使用哔哩哔哩游戏中提醒功能时，您需要授权我们获取您的通知权限，用以提供提醒服务。如您拒绝授权仅会使您无法使用该提醒功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的通知权限授权。
（8）读写剪贴板权限：当您在使用哔哩哔哩游戏的过程中，主动复制、粘贴游戏内ID、文字信息时，您的剪贴板功能权限可能会被调用。剪贴板信息仅会在您的设备上进行处理，我们不会存储您的剪贴板信息用于任何其他途径。如您拒绝提供该信息仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的读写剪贴板权限授权。
（9）控制震动器权限：在哔哩哔哩游戏产品应用程序运行时，为优化我们的服务体验我们将获取您的震动器控制权限，您可以享受到部分功能及提醒的震动反馈。如您拒绝提供该权限仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的震动器控制授权。
...
4.7出于其他合理且必要的目的
（1）如果某一需要收集您的个人信息的功能或产品/服务未能在本隐私政策中予以说明的，或者我们超出了与收集您的个人信息时所声称的目的及具有直接或合理关联范围的，我们将在收集和使用你的个人信息前，通过更新本隐私政策、页面提示、弹窗、私信、网站公告或其他便于您获知的方式另行向您说明，并为您提供自主选择同意的方式，且在征得您明示同意后收集和使用。
...
1.5为了向您提供更完善、优质的产品和服务，我们的某些服务将由授权合作伙伴提供，您可以在《第三方合作目录》中对我们游戏包含的第三方SDK服务进行查询。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验，包括：为寄送赠品或奖品而向物流服务商提供您的订单信息和联系信息；为用户回流邀请、活动邀请以及通知游戏更新而向通讯服务提供商提供您的联系信息；为了方便您参与我们的营销推广活动而向服务平台提供您的联系信息。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息，我们将会采用加密、匿名化处理等措施保障您的信息安全。同时，我们会与合作伙伴签署严格的保密协定，要求他们按照我们的说明、本隐私政策以及其他任何相关的保密和安全措施来处理您的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。如果您拒绝我们的合作伙伴在提供服务时收集为提供服务所必须的个人信息，将可能导致您无法使用该第三方服务。
...
（2）由于您登录本游戏使用的账号与哔哩哔哩平台（bilibili.com）账号具有关联性，若您注销了哔哩哔哩平台（bilibili.com）账号则会导致您的游戏账号被同步注销。除了通过第（1）项提示您的方式注销本游戏账号，您也可以通过注销哔哩哔哩APP账号的方式申请注销您的游戏账号。当您注销哔哩哔哩APP账号后，您将无法再以哔哩哔哩APP账号登录和使用本游戏以及哔哩哔哩旗下的其他产品与服务；且哔哩哔哩APP账号在本游戏和哔哩哔哩及旗下的其他产品与服务使用期间已产生的但未消耗完毕的权益及未来的逾期利益等全部权益将被清除。哔哩哔哩APP账号注销的流程、条件等事项请详见哔哩哔哩APP相关功能设置页面或根据哔哩哔哩APP操作指引提交注销申请，例如安卓端哔哩哔哩APP的账号注销路径为：“我的—设置—隐私权限设置-账号注销”。
...
2.本隐私政策的标题仅为方便及阅读而设，并不影响正文其中任何规定的含义或解释。
]],
	title = "隐私政策"
}
