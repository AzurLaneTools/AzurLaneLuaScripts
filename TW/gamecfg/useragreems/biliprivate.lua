...
版本更新提示：
感谢您下载并使用《碧蓝航线》游戏（以下称“本游戏”或“产品”）。我们依据《中华人民共和国个人信息保护法》、《中华人民共和国网络安全法》、《信息安全技术个人信息安全规范》（GB/T 35273-2020）以及其他相关法律法规和技术规范更新了本《隐私政策》，其中主要包括如下内容：优化部分名词解释（见第三条）、补充说明收集的个人信息种类（见第4.2.1条）、增加剪贴板权限以及外部存储及读写权限的说明（见第四部分第4.2.2条）、更新《第三方合作目录》。
...
（2）您也可以直接使用已注册的哔哩哔哩账号登录本游戏。如您使用已注册的哔哩哔哩账号登录的，我们将根据您的授权获取该哔哩哔哩账号下以及本游戏内的相关信息（包括：用户名、昵称、头像以及其他您授权的信息）以及身份验证信息（个人敏感信息）。我们承诺，收集上述信息是用于为您提供账号登录服务以及保障您的账号安全，防范安全风险。如您拒绝授权此类信息，则您将无法使用哔哩哔哩账号登录本游戏，但不影响我们提供的其他产品和服务的正常使用。
...
（3）为保障您正常使用我们的服务，维护游戏基础功能的正常运行，保障您的游戏账号安全，识别账号异常状态，了解产品适配性，维护基础功能的正常运行，同时也为了营造健康及安全的游戏环境，我们会收集您的设备信息：包括游戏应用信息（应用程序版本、产品版本号）、设备信息（设备ID、设备序列号、设备制造商、设备名称、设备类型和版本、设备型号、设备样式、设备识别符（如Android ID、IDFA、 IMEI、IMSI、MAC地址、OAID）、相机信息（像素、摄像头数量）、屏幕分辨率、CPU信息（核心数、频率、供应商）、内存大小、传感器信息）、网络信息（网络类型、网络运营商、接入网络的方式、网络质量数据、网络身份识别信息、网络环境信息）、浏览器类型和设置、语言设置、系统版本、IP地址、操作系统及进程信息、以及游戏崩溃记录信息、已安装应用列表信息。
...
1.5为了向您提供更完善、优质的产品和服务，我们的某些服务将由授权合作伙伴提供，您可以在《第三方合作目录》中对我们游戏包含的第三方SDK服务进行查询。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息，我们将会采用加密、匿名化处理等措施保障您的信息安全。同时，我们会与合作伙伴签署严格的保密协定，要求他们按照我们的说明、本隐私政策以及其他任何相关的保密和安全措施来处理您的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。如果您拒绝我们的合作伙伴在提供服务时收集为提供服务所必须的个人信息，将可能导致您无法在本游戏中使用该第三方服务。
