return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "以自由之名，我命令，地間海全軍艦隊，就地自沉，就地自沉！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=51>「願你的國降臨，願你的旨意行在地上，如同行度在天上」</size>",
					2.5
				},
				{
					"<size=51>「我們日用的飲食，今日賜給我們」</size>",
					4
				},
				{
					"<size=51>「免我們的債，如同我們免了人的債」</size> ",
					5.5
				},
				{
					"<size=51>「不叫我們遇見試探，救我們脫離兇惡」</size>",
					7
				},
				{
					"<size=51>「因為國度，容權柄，榮耀，全是妳的，直到永遠」</size>",
					8.5
				},
				{
					"<size=51>「阿門」</size>",
