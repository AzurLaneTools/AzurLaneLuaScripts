return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "沒有問題，陛下。通過進行資料比對，前方艦隊中威脅程度最高的目標有五個。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "與之對應的，名為仲裁機關的塞壬超強力個體也一次性出現了三個……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "在五個目標之中，有四個為已知目標。分別是仲裁者·司特蓮庫斯、仲裁者·天帕嵐斯、仲裁者·赫米忒、餘燼飛龍。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "剩下的一個未知的餘燼目標根據外貌特徵判斷……極大可能是皇家方舟。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "不好意思，艾塞克斯小姐……我覺得現在不是考慮這些問題的合適時機……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffa500",
			dir = 1,
			say = "塞壬有基地，我們可沒有，所以一直以來我們才會採取速戰速決的運動戰。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "我也沒有。一邊是可交流的不確定陣營，一邊是明確的敵人，這種情況下我選擇優先消滅確定的敵人。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "沒錯~消除餘燼，或者被餘燼所消除。直到任何一方機能徹底停止之前，讓我們盡情戰鬥吧！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
