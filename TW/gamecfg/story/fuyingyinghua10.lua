return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "請代我們向{namecode:182}大人致以最誠摯的問候~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "哎？之前我聽{namecode:91}介紹祭典流程的時候，對其中一個叫“演武”的環節還挺感興趣的呢…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "啊，那個啊。演武是本次祭典中的重要組成部分，會場中的每一場演武都被視為一次對神明的供奉行為。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "那不是太可惜了嘛~入鄉隨俗，也讓我來感受一下重櫻的演武吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "呵呵呵，究竟是客套話還是真心話。重櫻新銳巡洋艦的實力，就讓我好好見識一下吧~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
