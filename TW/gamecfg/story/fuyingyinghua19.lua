return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "…{namecode:74}大人快退後，這裡交給在下便是",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "誤入陷阱、讓{namecode:74}大人身陷包圍已是失職，在下萬死莫辭",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "大人！不能為了在下而浪費了大家供奉的信仰啊！這是用來…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "如果連個重要的人都無法守護，還談什麼祭典，談什麼守護重櫻！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "重櫻不能失去{namecode:74}大人，這裡就算犧牲在下也要讓{namecode:74}大人——",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "好好休息一下，接下來…就讓我來保護{namecode:74}大人吧",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "從宴席上收到您放飛的符鳥後便知道了這裡的情況，飛速趕來了",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "哼，那樣的場面根本不適合我呢，能找機會出來透透氣可是再好不過了~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "這次祭典，本身就是個陷阱，在下不能讓您繼續冒這樣大的風險…！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "哼，正因為是這樣，吾才更要出面，必須揪出害得{namecode:158}受傷的罪魁禍首！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "對方阻礙我們，必定是想對神石做什麼手腳，絕對不能讓這樣的事情發生！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "{namecode:96}，能再為我們護航嗎，{namecode:158}需要更多的休息…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
