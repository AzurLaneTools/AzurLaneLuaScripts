return {
	...
	scripts = {
		...
		},
		{
			...
			side = 2,
			actorName = "小加加",
			say = "當年的受害者小柴郡曾表示，她真的好快，連自己也看不清她出手的速度。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "小加加",
			say = "重櫻的著名軍師小天城也曾公開表示過，沒有任何陣營能夠僅憑一己之力阻止她。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "小加加",
			say = "最後，在各大陣營集結了全部艦隊，發動了一場規模史無前例的聯合作戰後。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			side = 2,
			actorName = "小加加",
			say = "這才終於將她逼到絕路，迫使她帶著搶奪而來的甜點一起沉入了大海。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			side = 2,
			actorName = "小加加",
			say = "但是沒想到……這一戰後，她非但沒有被消滅，反而因此獲得了新的力量。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
