return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "暫停對中心的攻略，旗風妳撤出來吧，前往據點CD34內休整。只要我們控制住侍從退場的數量，就能遏制赤城的戰略。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "赤城才是著急的那一邊，我們以不變應萬變，等待她的下一步行動。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dir = 1,
			say = "沒錯。我已經做了所有能做的準備，接下來就讓局勢自然發展吧。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 301880,
			nameColor = "#A9F548FF",
			say = "如果武藏大人不命令我阻止您的話……若月只能祝您一切順利。",
			painting = {
				alpha = 0.3,
				time = 1
			},
