return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "那一片是散步的好去處，漫步在茂盛的櫻花下可是不可多得的享受哦。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "如果決定選址在這裡的話，祈禱施工安全的祈願儀式就交給我們吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "想到明天還能見面，心中雖有一絲不捨，還是離開了這個地方。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
