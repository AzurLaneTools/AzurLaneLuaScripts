return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "（雖然說之前就對這裡很好奇……畢竟本身就在海上，在海上看水族館，總覺得有些奇妙。）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_173",
			hidePaintObj = true,
			say = "原本只打算隨便逛逛，卻在水族館遇到了意料之外的三人組。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		},
		{
			...
			bgName = "star_level_bg_173",
			hidePaintObj = true,
			say = "在點頭答應了和她們同行的邀約後，我們開始沿著水族箱的通道往前走。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "因為平常基本看不見？雖然我們經常在海上，但是看著水下風景的機會是很少的吧？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			bgName = "star_level_bg_173",
			hidePaintObj = true,
			say = "伴隨著少女們輕快的嗓音，我抬頭看向水族箱裡高大的水箱。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			hidePaintObj = true,
			nameColor = "#A9F548FF",
			say = "（這景象確實很美，不過郵輪之旅結束後，水族箱裡的這些生物該怎麼處理……）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			bgName = "star_level_bg_173",
			hidePaintObj = true,
			say = "從水族館出來後，天色已經黑了。不過離睡覺的時間還早，再四處轉轉吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
