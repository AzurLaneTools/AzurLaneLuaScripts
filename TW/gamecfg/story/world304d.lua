return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "何止是難纏，以前遇到的執行者系列和它們根本不在一個檔次上！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "大家繼續拉開距離，盡量進行俯衝轟炸提高精度！唉...這種時候如果有戰列艦編隊在就好了......!",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "艾塞克斯，終於找到妳們了！司令部在失去與妳們的聯絡之後就對周邊艦隊發出了搜索命令。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "可是進入這片區域之後我們的通訊設備也開始出現故障，妳們果然也是遭遇到塞壬干擾而失聯的啊...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "妳們也要小心，對面是以電子戰和魚雷作為主要攻擊手段的未知型號，比以往的侵擾者難纏得多！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
