return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "構成完全相同的“皇家”艦隊一次次在相似的航道轉彎處出現，而帝國艦隊也在一次次的無情粉碎著面前的敵人。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "然後在“皇家”艦隊全滅之後，迷宮也會開始一輪全新又徹底的結構變化。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "可能就算是再強大的塞壬機關也調不起我這種人情緒的波動吧……唔呼呼……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			hidePaintObj = true,
			say = "不能放任這種情況下去了，得想個辦法首先讓利托里奧冷靜一下…！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
