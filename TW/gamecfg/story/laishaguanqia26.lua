return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "放心放心，我都想好了。就像給妳製作艦裝一樣，我也會給後面來的人留一套艦裝。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "我提前把艦裝分解成若干素材，然後把圖紙當做鍊金配方留在遺跡裡，妳覺得怎麼樣~？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "哼哼哼~當然，要想做出艦裝這種與心智魔方有關的造物還是需要一點特別設備輔助的。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "等我準備完成之後，一共五人份的艦裝鍊金配方和素材就拜託妳幫我藏在遺跡各處了哦。",
			painting = {
				alpha = 0.3,
				time = 1
			},
