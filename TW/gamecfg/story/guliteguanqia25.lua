return {
	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				{
					"<size=51>「喂，施佩伯爵嗎，是我，愛丁堡！」</size>",
					1
				},
				{
					"<size=51>「太好了，我就記得妳最近是港區聯絡員！」</size>",
					2
				},
				{
					"<size=51>「噓小聲點……別叫貝法！我是偷偷給妳打電話的。」</size>",
					3
				},
				{
					"<size=51>「失蹤的同伴都在我身邊哦，倒不如說還增加了新的同伴……」</size>",
					4
				},
				{
					"<size=51>「事情比較複雜，等我回去之後再跟妳細說好不好！」</size>",
					5
				},
				{
					"<size=51>「現在有個更重要的事！……我們現在的位置和回去的航線妳能不能幫我看一下。」</size>",
					6
				},
				{
					"<size=51>「拜託了，施佩伯爵！」</size>",
					6
				}
			}
		},
