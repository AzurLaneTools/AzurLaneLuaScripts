return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "運河在通航之後，大大縮減了兩個大洋之間的運輸距離。在那次大戰中也發揮了重要作用。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "然後在之後數年間進行了不間斷的拓寬、改進、加強防禦。最終才變成了如今妳現在見到的巴拿馬要塞。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "運河航道一旦受到損壞，東西兩側大洋的交通線就將受到嚴重影響甚至中斷。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "卡薩布蘭卡，妳去引導商船避難，雷諾留在防空陣地附近，一艘飛機都不能放過去。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "雖然解決不了什麼問題，不過就用你們的身體來稍微平息一下我怒火吧！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
