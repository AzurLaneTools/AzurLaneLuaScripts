return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "哇哦，這些都是什麼啊？！！你這個港區每天的伙食都是這樣的嗎，也太誇張了吧？！",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "肉腸、肉排、烤肉、肉丸子……………這些可都是肉，你管這些叫小吃？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "那你們平時的正餐得豪華到什麼程度啊？不可想像不可想像……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "當然啦，雖然是我是海盜，不過誠信有時候也是很重要的哦！",
			hidePaintEquip = true,
			painting = {
				alpha = 0.3,
				time = 1
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "來不及了，雖然寶藏還沒找到，不過位置我已經記在藏寶圖上了哦。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "————等我們再次相遇之時，我會帶著一大支海盜艦隊過來也說不定喲？做好準備吧，指揮官~",
			painting = {
				alpha = 0.3,
				time = 1
			},
