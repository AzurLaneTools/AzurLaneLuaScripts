return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "只要心誠，就算是在破敗不堪的茅屋裡神明也能聆聽到汝之祈禱的",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "我只是在想，這一連串的事件背後，究竟還有什麼遺漏了的地方",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "呵呵，不愧是傳說中“智謀如泉湧”的{namecode:82}大前輩，疑心病就是重啊",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "在座的各位都是為了重櫻的未來，才會出席天宇啟戶祭的不是嗎",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "是的，現在的重櫻，需要變革的力量，只有誠心的祈禱和信仰才能…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "我{namecode:91}，真心希望能夠幫助重櫻完成這次變革，邁向一個新的時代！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "{namecode:91}，如果妳真的能夠利用塞壬技術引領重櫻的未來，我絕不會阻礙妳",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "繼續留在碧藍航線裡，和那些天資優越的盟友過家家就是正確的道路嗎？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "祈禱用的空地已經清理出來了，{namecode:74}大人~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "不論平時的矛盾如何，希望至少僅在今夜，在座的各位能夠放下干戈…誠心為儀式祈願",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "天宇啟戶祭在記錄裡已經舉辦了百余載，吾怎能聽汝一面之詞就將其雙手奉上",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
