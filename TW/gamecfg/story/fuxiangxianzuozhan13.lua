return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "能悄無聲息繞開我們的安全系統，又能比我們還要熟練地操作海域中的設施，除了塞壬本身之外不可能有第二個可能性了吧……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "不知道是未卜先知呢，還是歪打正著呢……事不宜遲，讓我們開始新的作戰吧~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
