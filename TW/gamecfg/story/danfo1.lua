return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "因為有些同伴確實很忙，如果有這樣一個能夠委託暫時空閒的夥伴幫忙的機制我覺得也不錯哦。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官你看啊，那個幫助社團活動大樓新樓進行搬遷的任務也是大姐頭完成的哦！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "大姐頭真是太厲害了……能像這樣充滿氣勢的一個接一個完成發佈在剛建好沒多久的佈告欄上的任務……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
