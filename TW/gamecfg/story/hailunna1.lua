return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "這個是我從其他同伴那裡請教的，關於秘書艦工作細節的筆記……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官，有海倫娜的幫助工作輕鬆了很多吧？她可是個非常細心的孩子哦~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "好像明白了，又好像不明白……就這樣再這樣觀察一陣看看吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
