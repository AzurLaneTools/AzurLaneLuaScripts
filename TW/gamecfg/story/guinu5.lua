return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "——斗篷滑落之後，讓五十鈴誤認為見到鬼的元兇終於露出了真面目。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "鬼怒的語氣聽起來有些自豪。本次鬧鬼問題順利解決，至於斷電……之後還是好好檢修一下電路吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
