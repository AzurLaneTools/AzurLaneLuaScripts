return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "妖怪劇團嗎……宣傳上說得有模有樣，不過多半只是用來吸引遊客的噱頭吧……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "且，渡假地選在重櫻離島，吾等也能為諸位同伴盡一下地主之誼。",
			painting = {
				alpha = 0.3,
				time = 1
			},
