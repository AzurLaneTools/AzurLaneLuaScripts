return {
	...
	scripts = {
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "剩下的事情交給回收程序就好。在回收完成之前，我們可以好好休息一下~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "讓我先看一下測試者的數據庫哦，原本它為這次實驗準備的內容是……",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "如果我們什麼準備都不做的話，等她們來的時候看到的將會是只有一座傳送門的空白海域。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "來都來了，不如我們來負起責任修一些相對安全的遺跡，讓她們冒險一番再走好了~",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 900233,
			actorName = "淨化親",
			say = "反正這裡是現成的戰場，廢墟和殘骸要多少有多少！怎麼樣，這個主意還不錯吧？",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			dir = 1,
			nameColor = "#A9F548FF",
			say = "萊莎，剛剛我們找到的那口大鍋，那個是不是可以用來進行調和呢？",
			hidePaintEquip = true,
			painting = {
				alpha = 0.3,
				time = 1
