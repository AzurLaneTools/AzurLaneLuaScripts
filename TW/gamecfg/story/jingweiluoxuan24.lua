return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "在神秘同伴的幫助下，指揮艦的封鎖解除，艦隊也恢復了戰鬥力。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "就這樣在海霧中行駛了一段時間後，一片燃燒的戰場映入眼簾。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "這些對她們來說也許有些陌生的艦隊構成，對我來說卻再熟悉不過了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "此處是AF戰場，而且是我從未親眼所見的，屬於重櫻的AF戰場。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "彼時，正是因為突然出現的塞壬艦隊，重櫻才得以獲得了像這樣開展營救的機會。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#ffff4d",
			hidePaintObj = true,
			say = "看來妾身就要到此為止了嗎，真遺憾…真想將這趟奇妙旅程繼續下去啊…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
