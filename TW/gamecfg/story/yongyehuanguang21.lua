return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "我們的通訊器只收到了司令部斷斷續續的指令，除此之外沒有任何其他回覆。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "嗯…作為運輸船的護航艦隊，我們過分加入戰鬥的話，反而可能白白損失掉運輸船隊…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "永遠不要忘記“嚮往正義之心”......這種命令我絕對不會認可！就算只剩我一個人，我也要護送船隊繼續前進！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
