return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			optionFlag = 2,
			say = "呵呵，能在這種狀況下遭遇到女灶神小姐的後勤艦隊，我們的運氣還真是出奇的好呢~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "外面出現了十分不得了的情況，我覺得你還是出來看看比較好！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "最開始只是隨著海水飄來的一片、兩片……然後是一團、兩團……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "如此慘烈的景象我也是第一次見。從這些殘骸的量級上來看……與其說是戰場，不如說更像是……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
