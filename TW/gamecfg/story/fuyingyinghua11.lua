return {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			side = 0,
			say = "戰術？經驗？呵，力量不足就會死，這麼單純的道理，重櫻的新銳巡洋艦都看不明白嗎？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			dir = 1,
			side = 0,
			say = "哎呀，真是失望。作為吾之鐵血的盟友，重櫻的新銳巡洋艦居然孱弱到如此地步~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
