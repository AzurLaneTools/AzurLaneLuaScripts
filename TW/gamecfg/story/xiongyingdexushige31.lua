return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			side = 2,
			say = "佩薩格諾伸手指了指下方已經被密集的煙霧覆蓋的水面，爆炸與轟鳴聲在煙霧之下此起彼落。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			side = 2,
			say = "達·文西的目光遊離著，思索著能夠擺脫當前困境的方法。突然，她的目光鎖定在大劇場外牆的荊棘叢上，",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			hidePaintObj = true,
			blackBg = true,
			say = "達·文西拿出不知何時備在一旁的大型滑翔翼縱身一躍，消失在昏暗的夜空中。",
			painting = {
				alpha = 0.3,
				time = 1
			},
