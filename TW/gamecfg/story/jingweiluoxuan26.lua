return {
	...
	scripts = {
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "在震動和巨響都結束後，一個無比熟悉的聲音出現在通訊器中。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "原本是前去救援的艦隊，結果反過來成為了要被救援的對象，真是慚愧…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "嗯，妳就是一直在幫助我們的“神秘友軍”吧，非常感謝妳提供的幫助。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			hidePaintObj = true,
			dir = 1,
			say = "白鷹棋子、重櫻棋子、塞壬艦隊，以及發生在它們之間的戰鬥…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
