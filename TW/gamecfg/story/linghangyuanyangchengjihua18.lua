return {
	...
	scripts = {
		...
		},
		{
			...
			bgName = "bg_project_tb_cg13",
			hidePaintObj = true,
			say = "畢竟之前幾乎無所不能的領航員小姐……現在變成了考試成績不及格的小學生。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
