return {
	...
	scripts = {
		...
		},
		{
			...
			wait = 0.5,
			say = "……別笑了！我只是覺得剛才那種心跳加速的感覺，還蠻有趣的。",
			dispatcher = {
				name = STORY_EVENT.TEST,
				data = {
					op_list = {
