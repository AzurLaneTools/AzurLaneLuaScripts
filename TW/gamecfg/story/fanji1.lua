return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "噢噢！終於要開始正式的秘書艦工作了！指揮官，從哪個任務開始比較好？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "還以為會是些更費體力的工作…原本要一直動腦的事都是聲望在做，我其實不太擅長這種的呢…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "雖然我不太擅長需要一直盯著許多文字的那種工作，但是要整理好這些文件的話可是小菜一碟！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "聽到這個意外的建議，不由得覺得選她當秘書艦是個正確的選擇。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
