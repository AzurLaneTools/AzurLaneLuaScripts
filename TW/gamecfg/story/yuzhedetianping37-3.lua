return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "但如果我們帶領指揮官撤退的話，這個實驗場恐怕就保不住了。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			dialogueBgAlpha = 0.6,
			say = "太好了……雖然是馬可波羅的設備，不過多少起了些正面幫助。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#a020f0",
			hidePaintObj = true,
			say = "沒關係……裁決之杖一次只能瞄準一個單一目標，而且射程近準備時間長。",
			painting = {
				alpha = 0.3,
				time = 1
			},
