return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#ff5c5c",
			dir = 1,
			say = "行動模式解析完畢，狙擊模組準備進度：70%——90%——完畢。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			actor = 407030,
			nameColor = "#a9f548",
			say = "還沒完呢，妳的那個巨大的護盾，對於艦載機來說是絕佳的標靶，接下來的火力也全部吃下吧！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "哇啊……不但有我們的飛機，之前做出來的塞壬飛機也在進行著轟炸。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "塞壬艦載機在轟炸塞壬構建者，還真是一副令人愉悅的畫面，Z24，從黑暗之中瀟灑降臨！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "近距離一看，裝甲和護盾都巨大到離譜，要塞型的精英塞壬嗎……感覺會很耐打的樣子~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
