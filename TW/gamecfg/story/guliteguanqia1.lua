return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "像教師的人",
			side = 2,
			say = "老師現在為測驗準備了三套卷子，四名同學需要從中任選一套作答。請問，這三套卷子都有人選做的概率是？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			sequence = {
				{
					"<size=51>「啊，日復一日的課堂又開始了……」</size>",
					1
				},
				{
					"<size=51>「曼非斯、夢芽、還有六花這些優等生總是有著用不完的精力。」</size>",
					2
				},
				{
					"<size=51>「真是的，學習有那麼有趣嗎……」</size>",
					3
				},
				{
					"<size=51>「好睏，明明才睡醒，為什麼還是睏得要死，昨晚我究竟做了些什麼啊……」</size>",
					4
				},
				{
					"<size=51>「想不起來……算了，將夢想留在最合適的地方，繼續睡吧————」</size>",
					5
				},
				{
					"<size=51>「Zzz…………」</size>",
