return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "哎呀呀，這就開始打退堂鼓了嗎？開始之前還那麼自信滿滿的樣子呢。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "能得到您的稱讚是我的榮幸——雖然我根本打不中博格投出的球就是了…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "向著玩笑般提出請求的追趕者點了點頭，告別了利安得她們，與追趕者一起向著指揮室走去。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
