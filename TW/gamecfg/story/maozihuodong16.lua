return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Здра́вствуйте（你好），我是北方聯合的基洛夫！Товарищ Офицер（指揮官同志）是第一次和我們北方聯合的大艦隊共同戰鬥吧！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "壓迫感尤其令人印象深刻？哈哈哈~這股團結的力量和白鷹和皇家的感覺都不同吧！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "不過，即便遭遇意想不到的困境，依然可以調整方針應對，臨危不亂指揮，表現十分出色啊，指揮官同志！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "初次見面，指揮官同志，我乃「蘇維埃俄羅斯」，是北方聯合最大最強的主力戰艦之一。 ",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
