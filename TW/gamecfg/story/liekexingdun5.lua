return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "辛苦了，接下來也請繼續關照，不過在那之前，還是好好休息一下吧。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#A9F548FF",
			say = "要是姊姊再偷偷加班，薩拉妹妹就要對姊姊惡作劇了！薩拉妹妹，現在正處於絕讚大生氣中哦。",
			painting = {
				alpha = 0.3,
				time = 1
			},
		...
		},
		{
			...
			actor = 107030,
			nameColor = "#A9F548FF",
			say = "不過呢~要是姐姐答應休息一段時間，然後和指揮官一起來下一次Live的話，我就原諒姐姐啦。",
			painting = {
				alpha = 0.3,
				time = 1
			},
