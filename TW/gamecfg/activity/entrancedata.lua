return {
	...
	},
	{
		...
		isShow = function ()
			return getProxy(MetaCharacterProxy):getMetaProgressVOByID(970201) and slot1:isInAct()
		end,
		isTip = function ()
			if getProxy(MetaCharacterProxy):getMetaProgressVOByID(970201):isPassType() then
				return false
			end
