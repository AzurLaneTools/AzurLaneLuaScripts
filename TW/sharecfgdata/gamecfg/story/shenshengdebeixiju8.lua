return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "貴安~聽聞到妳發來的電報，我便立刻從皇家三島啟航而來了",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "是的呢~有的時候，這個能力可比任何戰術頭腦都實用的哦~？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "呵呵，這次來之前我和陛下都多少有些預感呢，因此特意做了些準備~比如一個能夠在夜晚發出指令，能讓艦載機在幾十里外的夜空中發現目標的裝備",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "正是如此~不過，現在尚缺一個能在緊急情況下發出正確指令的操作員呢…嗯，讓我想想",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
