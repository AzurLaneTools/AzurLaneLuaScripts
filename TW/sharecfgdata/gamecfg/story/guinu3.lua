return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "為了在劣勢情況下也能維持冷靜與從容，通過瀑布修行來磨煉意志真是最合適不過了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "我在釣魚哦。指揮官該不會打算在瀑布那裡修行吧，現在的水溫很低哦？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "雖然鬼怒用嚴厲的語氣催促著修行的再次展開，不過她的嘴角好像掠過了一絲轉瞬即逝的微笑……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
