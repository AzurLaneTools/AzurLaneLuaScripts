return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "指揮官，有件在會議上忘了說的事，佔用你幾分鐘時間可以嗎？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
