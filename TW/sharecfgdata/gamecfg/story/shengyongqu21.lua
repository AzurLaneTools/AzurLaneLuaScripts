return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "不過騷擾艦隊沒有取得成果的話，維希肯定還會有接下來的行動，還是不能放鬆警惕才是。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "話說回來在貞德她們出發之前，妳本來想說小心來自聖堂的什麼？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……等等！黎胥留，那些不會恰好就是妳想說的“實驗型兵器”的下一階段吧…？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "……「極光之壁」，這是在曾經的鳶尾教國時期，我們設想過，但從未真正實現過的概念武器。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "妳之前說存放聖堂中存放有武器的時候，我還以為妳指的是艦炮、艦載機一類的東西呢…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "設計上的極光之壁極其複雜，當初集中了鳶尾教國頂尖力量都沒有完成的東西，維希就算與鐵血合作，現在充其量也就是可堪一用的程度。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "現在對我們來說至少存在一個好消息…如果連二階段都沒有徹底完成的話，最大的威脅就不復存在了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
