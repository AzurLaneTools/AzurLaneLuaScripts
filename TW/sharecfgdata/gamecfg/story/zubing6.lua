return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "{namecode:144}也不容易啊，每天都要處理這麼多東西…",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "呵~？擔心{namecode:144}嗎？嘿嘿…可以啊，我們一起過去吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			blackBg = true,
			say = "沒反應呢……應該是睡著了吧。那就進去看看吧，小聲點別吵醒她了",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（{namecode:144}平常似乎也有摺紙鶴的習慣，不過這數量…沒想到會動搖到這個程度）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "（看來{namecode:144}真的對指揮官…這時候作為前輩應該——）",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
