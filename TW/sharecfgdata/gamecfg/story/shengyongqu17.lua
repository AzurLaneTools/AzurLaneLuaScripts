return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "前方的應該是守護聖堂外圍的小型要塞群，我們終於要進入聖堂本身的防禦體系內了。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "難道說讓我們這樣直接靠近聖堂就是她們的目的嗎？可是為什麼呢……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "黎胥留，如果我們就這樣繼續接近聖堂的話，會發生什麼不妙的事嗎？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "應該是我們多慮了。黎胥留，前方發現維希教廷的小股艦隊，正在沃克蘭的帶領下向我們駛來。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "沃克蘭帶隊？那應該還是騷擾艦隊，游擊艦隊前往迎擊，擊退對方的騷擾即可，不要深入追擊。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "贊同。命運女神，妳依然跟隨游擊艦隊前往迎擊，之後的戰鬥就直接聽從貞德的指揮吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
