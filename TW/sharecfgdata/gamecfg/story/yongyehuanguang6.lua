return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "就這？剛剛的話說的很滿，實際打起來只有這種程度嗎，真令人失望。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "沒錯，如果鐵血主力艦隊上鉤，想要進入巴倫支海襲擊船團的話，一定會被我方發現的才對。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "難道說…有情報洩露？鐵血竊取了我們的計劃！？然後想要用潛艇部隊和主力艦隊先下手吃掉我們的支援艦隊！？",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "…首先再偵測一遍周邊海域，然後把這個情報向司令部匯報吧。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
