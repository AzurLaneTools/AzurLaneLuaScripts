return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "看來關鍵時刻還是得靠我們的啊。主力艦隊就釘死在這裡，一架飛機都不要放走！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "那...那個！根據指揮官的報告......北方聯合似乎是以火力的密集覆蓋來解決精度被干擾的問題的...！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "什麼叫冒失的愛丁堡啊！我可是貝法的姐姐，終於認識到我的可靠之處了吧~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
