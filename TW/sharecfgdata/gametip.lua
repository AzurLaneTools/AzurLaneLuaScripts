...
1. <color=#92fc63>2022.7.28-2022.10.25</color>期間限時開放「蒼龍·META」的挑戰，在此期間指揮官可挑戰「蒼龍·META」累計其同步值獲取<color=#92fc63>「蒼龍·META」角色</color>及其他豐厚獎勵
...
6.火力支援
隨著信標·META挑戰的進行，從第31天開始，即2022.8.27~2022.10.25期間，艦隊挑戰「蒼龍·META」時將會獲得一次額外火力支援。火力支援會對敵人造成傷害，並為敵人施加一個持續傷害的特殊狀態（不受任何加成效果影響）。隨著本期信標·META開放的日期增加，火力支援提供的傷害也會增加。
	...
	tip = {
		{
			info = [[
活動規則：
1.<color=#92fc63>10月6日</color>為止每日0點開放<color=#92fc63>1</color>場新的遊戲，總計<color=#92fc63>7</color>場，可累計。完成遊戲獲取7塊「烤肉」可獲得夕立限定改造道具「烤肉味香水」
遊戲規則：
