...
2.「信標資料」取得與解析
·指揮官可透過在大型作戰中取得「信標資料」，達到指定數據量後進行解析並發現特定信標
·每日最多可取得<color=#92fc63>200</color>點，每日0點更新可取得點數，尚未使用的「信標資料」將會保留。
·每次解析「信標資料」所需量為<color=#92fc63>100</color>點
...
·一名角色每日最多取得<color=#92fc63>30000</color>點技能升級經驗，其中前<color=#92fc63>60%</color>的技能升級經驗擁有雙倍任務完成效率
（剩餘次數不滿2次時不生效）
