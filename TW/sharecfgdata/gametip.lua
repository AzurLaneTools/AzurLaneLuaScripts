...
1. <color=#92fc63>2026.2.12-2026.5.14</color>期間限時開放「江風·META」的挑戰，在此期間指揮官可挑戰「江風·META」累計其同步值獲得<color=#92fc63>「江風·META」角色</color>及其他豐厚獎勵
...
6.火力支援
隨著信標江風·META挑戰的進行，從第31天開始，即2026.3.14~2026.5.14期間，艦隊挑戰「江風·META」時將會獲得一次額外支援火力。火力支援會對敵人造成傷害，並為敵人施加一個持續傷害的特殊狀態（不受任何加成效果影響）。隨著本期信標江風·META開放的日期增加，火力支援提供的傷害也會增加。
※此支援只會在指揮官自己發現的信標江風·META戰鬥中出現，每次挑戰均會觸發。]]
		}
	}
}
...
·完成戰術研習任務獲得META角色的技能升級經驗，部分任務可以重複完成
...
（剩餘次數不滿2次時不生效）
·任務類型和可完成次數會隨著技能等級升級而更新
]]
		},
		{
			info = [[
4.<color=#92fc63>艦裝強化</color>
·META角色可以透過消耗艦裝強化材料對「炮擊」「雷擊」「航空」「裝填」4個屬性中的若干個進行強化
·強化會提升對應屬性值，當強化進度達到一定數值後還可獲得額外屬性提升。 
·艦裝強化材料可透過「資訊同步」獎勵及大型作戰內港口商店購買取得]]
		}
	}
}
