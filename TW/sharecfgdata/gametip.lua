...
1. <color=#92fc63>2024.6.6~2024.9.12</color>期間限時開放「{namecode:293}」的挑戰，在此期間指揮官可挑戰「{namecode:293}」累計其同步值獲取<color=#92fc63>「{namecode:293}」角色</color>及其他豐厚獎勵
...
6.火力支援
隨著信標·META挑戰的進行，從第31天開始，即2024.7.7~2024.9.12期間，艦隊挑戰「{namecode:293}」時將會獲得一次額外火力支援。火力支援會對敵人造成傷害，並為敵人施加一個持續傷害的特殊狀態（不受任何加成效果影響）。隨著本期信標·META開放的日期增加，火力支援提供的傷害也會增加。
...
_G.pg.base.gametip.meta_help = {
	tip = {
		...
		{
			info = "·META研究室擁有<color=#92fc63>「能量活化」</color>、<color=#92fc63>「戰術研修」</color>、\n<color=#92fc63>「艦裝強化」</color>、<color=#92fc63>「資訊同步」</color>4個系統模組\n"
		},
		{
			info = "1.<color=#92fc63>能量活化</color>\n·META角色達到指定等級後可以使用對應的角色結晶進行活化。活化後可以提升角色星級\n·角色結晶可以通過「資訊同步」獎勵獲取"
		},
		{
			info = [[
