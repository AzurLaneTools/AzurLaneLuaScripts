...
7.各圖完成獎勵明細如下：
	...
	完成圖7獲得鞍山x1、紅包  x1。
8.活動結束後，未消耗的顏料會被清除。
9.<color=#92fc63>1月8日</color>為止每天解鎖一個可完成的繪圖。]]
		}
	}
}
...
11.1月2日維護後-1月23日維護前可以參與演習戰鬥，獎勵領取的截止時間為1月23日24時]]
		},
		{
			info = [[
	...
	tip = {
		{
			info = [[
活動說明：
1.活動期間可以透過<color=#92fc63>「撫順大冒險II」</color>、<color=#92fc63>「繪圖日記」</color>、<color=#92fc63>「飛彩迎新春」</color>、<color=#92fc63>「新春的冒險之王」</color>獲得紅包，開啟紅包可以獲得鑽石及其他豐厚獎勵
2.紅包分為bonus和普通紅包，其中有<color=#92fc63>15</color>個bonus紅包，其餘為普通紅包，開啟紅包時優先開啟bonus紅包，bonus紅包開完後開啟普通紅包
3.累計打開<color=#92fc63>15</color>個紅包，可獲得<color=#92fc63>「撫順」限定換裝</color>，累計開啟<color=#92fc63>25</color>個紅包，可獲得<color=#92fc63>「{namecode:225}」限定換裝</color>]]
		}
	}
}
