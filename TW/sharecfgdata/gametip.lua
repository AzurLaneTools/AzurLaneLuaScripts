...
6.火力支援
隨著信標長門·META挑戰的進行，從第31天開始，即2025.7.6~2025.8.21期間，艦隊挑戰「長門·META」時將會獲得一次額外火力支援。火力支援會對敵人造成傷害，並為敵人施加一個持續傷害的特殊狀態（不受任何加成效果影響）。隨著本期信標長門·META開放的日期增加，火力支援提供的傷害也會增加。
※此支援只會在指揮官自己發現的信標長門·META戰鬥中出現，每次挑戰均會觸發。]]
		}
	}
}
