return {
	...
	BaseResourceMgr = {
		_loadAssetBundleAsync = 9791,
		_LoadAssetAsync = 9799,
		["LoadAssetAsync_AssetBundle_UnityAction<Object>_bool_bool"] = 9798,
		loadAssetBundleAsync = 9790,
		LoadAssetSync_AssetBundle_string_bool_bool = 9785,
		_loadAssetBundleTotallyAsync = 9789,
		ClearBundleRef_string_bool_bool = 9802,
		AssetExist = 9782,
		unloadUnusedAssetBundles = 9803,
		["LoadAssetAsync_AssetBundle_string_UnityAction<Object>_bool_bool"] = 9797,
		loadAssetBundleTotallyAsync = 9788,
		ClearBundleRef_AssetBundle_bool = 9800,
		getAssetSync_string_string_Type_bool_bool = 9786,
		["getAssetAsync_string_string_Type_UnityAction<Object>_bool_bool"] = 9792,
		CheckAsyncWaiting = 9795,
		Init = 9780,
		ClearBundleRefTotally = 9801,
		["getAssetAsync_string_string_UnityAction<Object>_bool_bool"] = 9793,
		dumpAssetBundles = 9804,
		getAssetSync_string_string_bool_bool = 9787,
		loadAssetBundleSync = 9783,
		_getAssetAsync = 9794,
		GetAllDependencies = 9781,
		LoadAssetSync_AssetBundle_string_Type_bool_bool = 9784,
		["LoadAssetAsync_AssetBundle_string_Type_UnityAction<Object>_bool_bool"] = 9796,
		Awake = 9779
	},
	BaseResourceMgrWrap = {
		op_Equality = 9493,
		set_UseMultiDependence = 9499,
		LoadAssetAsync = 9488,
		loadAssetBundleAsync = 9486,
		get_UnloadDependencyImmediately = 9495,
		loadAssetBundleTotallyAsync = 9485,
		unloadUnusedAssetBundles = 9491,
		AssetExist = 9481,
		set_UnloadDependencyImmediately = 9498,
		loadAssetBundleSync = 9482,
		LoadAssetSync = 9483,
		getAssetAsync = 9487,
		ClearBundleRef = 9489,
		Init = 9479,
		ClearBundleRefTotally = 9490,
		get_UseMultiDependence = 9496,
		get_LogLoad = 9494,
		Register = 9478,
		dumpAssetBundles = 9492,
		getAssetSync = 9484,
		GetAllDependencies = 9480,
		set_LogLoad = 9497
	},
	BgInfoList = {
	...
	BilibiliCallBackListerner = {
		AccountInvalid = 3084,
		CloseAgreementView = 9824,
		OnFetchFreeHostErro = 8101,
		LoginFailed = 3082,
		OnShowPrivateFailed = 9823,
		LoginSuccess = 3081,
		InitSuccess = 3079,
		SetChannelId = 3085,
		InitFailed = 3080,
		...
		PayFailed = 3087,
		OnShowPrivateSuccess = 9822,
		GameExit = 3088,
		OnShowLicenceSucces = 9820,
		OnShowLicenceFailed = 9821,
		PaySuccess = 3086,
		LoginOut = 3083
	},
	BilibiliSdkMgr = {
	...
	BrightnessHelper = {
		GetMode = 9668,
		SetScreenBrightness = 9670,
		SetBrightnessMode = 9671,
		GetValue = 9669
	},
	BrightnessHelperWrap = {
		SetScreenBrightness = 9503,
		GetMode = 9501,
		GetValue = 9502,
		Register = 9500,
		SetBrightnessMode = 9504
	},
	BuglyAgent = {
		SetUserId = 3690,
	...
	ClickEffect = {
		...
		OnStandlone = 3167,
		UpdatePos_Vector3 = 9909
	},
	["Coffee.UIExtensions.UIMirrorReflection"] = {
		AddMirrorReflectedQuad = 9947,
		GetLerpFactor = 9948,
		get_etartColor = 9944,
		get_height = 9938,
		get_startColor = 9942,
		...
		set_startColor = 9943,
		set_spacing = 9941,
		MirrorReflectVertex = 9949,
		SetDirty = 9950,
		get_spacing = 9940,
		get_targetGraphic = 9937,
		ModifyMesh = 9946
	},
	["Coffee.UIExtensions.UIVertexUtil"] = {
		Bilerp_UIVertex_UIVertex_UIVertex_UIVertex_float_float = 9953,
		AddQuadToStream = 9951,
		Lerp = 9952,
		Bilerp_Vector2_Vector2_Vector2_Vector2_float_float = 9954,
		Bilerp_Vector3_Vector3_Vector3_Vector3_float_float = 9955,
		Bilerp_Vector4_Vector4_Vector4_Vector4_float_float = 9956,
		Bilerp_Color_Color_Color_Color_float_float = 9957
	},
	Collider2DFilter = {
		Awake = 3169,
	...
	DownloadUI = {
		SetCancelCallBack = 9732,
		UpdateProgressBar = 9737,
		UpdateProgressInfo = 9739,
		UpdateInfoPanel = 9743,
		SetCloseCallBack = 9731,
		get_Inst = 9730,
		ChangeBlur = 9744,
		DisplayUpdatePanel = 9741,
		DestroyUI = 9746,
		DisplayDialog_string = 9735,
		BackPress = 9745,
		SetConfirmCallBack = 9733,
		SetDialogCallBack = 9734,
		["DisplayDialog_string_Action<bool>_bool"] = 9736,
		DisplayProgress = 9740,
		UpdateProgressBarDirect = 9738,
		DisplayInfoPanel = 9742
	},
	DrawPolygon = {
		Awake = 3181,
		draw = 3182
	...
	Effect = {
		...
		Play = 3159,
		set_ps = 9903,
		UpdatePosition_Vector3_float = 9907,
		UpdatePosition_Vector3 = 9906
	},
	EffectScriptSample = {
		Start = 2130,
		CheckProperty = 2128,
	...
	FXMakerQuickMenu = {
		...
		Start = 1687,
		OnEnable = 1685,
		IsParticleEmitterOneShot_TempParticleEmitter = 9777,
	...
	MaskExtend = {
		OnTransformChildrenChanged = 9935,
		AddMaterial = 9933,
		get_material = 9926,
		AddChildsMaterial = 9934,
		OnDisable = 9936,
		set_material = 9925,
		Refresh = 9932,
		OnEnable = 9931,
		set_refValue = 9929,
		get_childMaterial = 9928,
		get_refValue = 9930,
		set_childMaterial = 9927
	},
	MaskRaycast = {
		Raycast = 8519
	},
	...
	NcParticleSystem = {
		Ng_GetProperty = 2573,
		["LegacyScaleParticle_TempParticle[]_bool_bool"] = 9778,
	...
	NgSerialized = {
		...
		IsMesh = 1140,
		SetEllipsoidSize_TempParticleEmitter_Vector3_float = 9774,
		IsValidCopy = 1135,
		IsEllipsoidParticleEmitter_TempParticleEmitter = 9770,
		IsEnableParticleMesh = 1139,
		CopySerialized = 1138,
		["GetEllipsoidSize_TempParticleEmitter_Vector3&_float&"] = 9773,
		SetPropertyValue_SerializedProperty_object = 1132,
		IsMeshParticleEmitter_TempParticleEmitter = 9769,
		CloneComponent = 1137,
		...
		SetMeshNormalVelocity_TempParticleEmitter_float_float = 9772,
		["GetMeshNormalVelocity_TempParticleEmitter_float&_float&"] = 9771,
	...
	["p10.sc_10801"] = {
		...
		set_url = 3887,
		get_url = 3886,
		get_monday_0oclock_timestamp = 9973,
		set_proxy_ip = 3890,
		set_proxy_port = 3892,
		get_timestamp = 9971,
		set_gateway_ip = 3883,
		...
		get_is_ts = 8341,
		get_gateway_ip = 3882,
		set_monday_0oclock_timestamp = 9974,
		get_version = 3888,
		set_timestamp = 9972,
		get_proxy_port = 3891,
	...
	StickController = {
		...
		ValidPosFunc = 3558,
		Awake = 3553,
		IsPointerOverUIObjectByTouch = 9923
	},
	...
	["UnityEngine.UI.LScrollRect"] = {
		...
		RemoveLoadingItem_GameObject = 9914,
		...
		RemoveLoadingItem_GameObject_int = 9913,
		OnEnable = 3372,
		...
		SetContentAnchoredPositionOriginal = 9919,
		UpdateScrollbarLayout = 3404,
		ClearLoadingItem = 9915,
		LateUpdate = 3383,
		get_verticalScrollbarSpacing = 3334,
		GetContentAnchoredPositionOriginal = 9918,
	...
	["UnityEngine.UI.RichText"] = {
		...
		AddListener = 3532,
		["CalculateLayoutWithImage_string_IList<UICharInfo>&_IList<UIVertex>&"] = 9920,
		OnPointerClick = 3545,
		RichStringProjection = 9921,
	...
	UnityEngine_AudioBehaviourWrap = {
		_CreateUnityEngine_AudioBehaviour = 9514,
		op_Equality = 9515,
		Register = 9513
	},
	...
	UnityEngine_MaterialPropertyBlockWrap = {
		Clear = 9522,
		SetFloat = 9523,
		CopySHCoefficientArraysFrom = 9542,
		GetVector = 9535,
		SetFloatArray = 9530,
		SetMatrix = 9527,
		SetMatrixArray = 9532,
		SetVector = 9525,
		_CreateUnityEngine_MaterialPropertyBlock = 9521,
		Register = 9520,
		GetInt = 9534,
		SetBuffer = 9528,
		GetColor = 9536,
		...
		GetFloat = 9533,
		SetVectorArray = 9531,
		CopyProbeOcclusionArrayFrom = 9543,
		GetVectorArray = 9540,
		GetTexture = 9538,
		SetInt = 9524,
		SetTexture = 9529,
	...
	VersionConn = {
		CheckUseBackgroundDownload = 9970,
		Send = 3873,
		GetVersionList = 9968,
		OnData = 3876,
		GetLuaHashes = 9969,
	...
	VersionMgr = {
		...
		["DisplayDialog_string_Action<bool>"] = 9816,
		OnProxyUsing = 2987,
		GetServerState = 2990,
		enableProgrees = 8051,
		get_Inst = 2974,
		...
		CheckUpdate = 2977,
		RequestVersion = 2978,
		RequestUIForUpdateD = 9818,
		WebRequest = 2991,
		DisplayDialog_string_Action = 2981,
		FetchVersion = 2984,
		RequestUIForUpdateF = 9817,
		ModifyHashStringArrayToOld = 9819,
		Init = 2976,
		StartCheck = 9815,
		Update = 2979,
		BackPress = 2982,
	...
	["YongShi.BundleWizardRuntime.BundleWizard"] = {
		...
		GetCdnUrlList = 9676,
		GetGroupMgr = 9679,
		CreateAllDownloadGroup = 9674,
		GetOriginalCdnUrlList = 9675,
		get_Inst = 9672,
		GetGroupMgrByFilePath = 9680,
		CheckUpdate = 9683,
		DeleteCacheFiles = 9685,
		SetCdnUrlList = 9677,
		Update = 9684,
		IsAnyGroupNeedD = 9687,
		SetSwitchPackageFlag = 9678,
		StartHotfix = 9682,
		Awake = 9673,
		CheckSingleRes = 9686
	},
	["YongShi.BundleWizardRuntime.DownloadBackgroundMgr"] = {
		Clear = 9694,
		get_IsAnyTaskFailed = 9692,
		SetAllTaskFinishTag = 9695,
		SingleTaskEvent = 9699,
		ClearProgressInfo = 9693,
		get_Inst = 9688,
		get_IsUseDownloadBackgrond = 9690,
		AllTaskEvent = 9700,
		ProgressEvent = 9701,
		Init = 9696,
		IsForceBGDownload = 9704,
		StartBGDownload = 9697,
		GetCurrentServer = 9703,
		GenDownloadFileList = 9702,
		set_IsUseDownloadBackgrond = 9689,
		get_IsAllTaskFinished = 9691,
		OnError = 9698
	},
	["YongShi.BundleWizardRuntime.DownloadMgr"] = {
		StartVerifyForLua = 9714,
		DoUpdateD = 9710,
		FindF = 9705,
		Clear = 9711,
		DoUpdateF = 9708,
		UpdateF = 9707,
		StartVerify = 9712,
		VerifyResources = 9713,
		UpdateD = 9709,
		CheckF = 9706
	},
	["YongShi.BundleWizardRuntime.DownloadMgrBase"] = {
		DoCheckD = 9724,
		UpdateFileDownloadStates = 10011,
		UpdateHashFile = 9727,
		SetV = 9718,
		CheckUpdateType = 10012,
		AppendHashFile = 9726,
		NeedD = 9722,
		RewriteHashFile = 9725,
		CloseCachedStreamWriter = 9728,
		FixVersion = 9719,
		CheckD = 9723,
		get_GroupData = 9715,
		GetCurrentServer = 9720,
		set_GroupData = 9716,
		UpdateVersionFile = 9729,
		OnError = 9721,
		get_CurrentVersion = 9717
	},
	["YongShi.BundleWizardRuntime.HashUtil"] = {
		Compare = 9747,
		CalcMD5_string = 9751,
		["CompareNew_string[]_string[]_string[]_string_List<string[]>&_List<string[]>&"] = 9748,
		HashFile = 9749,
		BytesToString = 9750,
		["CalcMD5_byte[]"] = 9752,
		["CompareNew_string[]_string[]_string[]_string_List<string[]>&_List<string[]>&_List<string[]>&"] = 10013
	},
	["YongShi.BundleWizardRuntime.PathUtil"] = {
		GetPlatformName_BuildTarget = 9766,
		GetLuaName = 9757,
		ReadAllLines = 9761,
		GetPlatformName = 9765,
		GetStreamingAsset = 9760,
		GetStreamAssetsPath = 9768,
		ReadAllBytes = 9762,
		GetAssetBundle = 9758,
		GetPlatformName_RuntimePlatform = 9767,
		GetInstance = 9754,
		GetLuaBundle = 9755,
		FileExists = 9764,
		GetShortAssetBundle = 9759,
		get_Is32Bit = 9756,
		ReadAllText = 9763,
		Init = 9753
	},
	YongShi_BundleWizardRuntime_BundleWizardWrap = {
		get_updateComplete = 9564,
		GetCdnUrlList = 9552,
		set_updateComplete = 9568,
		SetCdnUrlList = 9553,
		GetOriginalCdnUrlList = 9551,
		get_Inst = 9565,
		GetGroupMgrByFilePath = 9556,
		GetGroupMgr = 9555,
		set_progress = 9567,
		set_hashStrings = 9566,
		IsAnyGroupNeedD = 9560,
		get_hashStrings = 9562,
		Register = 9550,
		op_Equality = 9561,
		GetMajorGroups = 9557,
		DeleteCacheFiles = 9559,
		get_progress = 9563,
		SetSwitchPackageFlag = 9554,
		StartHotfix = 9558
	},
	YongShi_BundleWizardRuntime_DownloadMgrBaseWrap = {
		set__cachedStreamWriter = 9622,
		get_cachedHashMap = 9596,
		set_cachedHashPath = 9606,
		set_downloadTotal = 9616,
		get_downPath = 9592,
		get__cachedStreamWriter = 9600,
		get_remoteHashFileName = 9583,
		set_localVersion = 9607,
		set_serverVersion = 9608,
		set_maxRetryTimes = 9617,
		set_cdnURLArr = 9609,
		set_remoteHashFileName = 9605,
		get_state = 9590,
		AppendHashFile = 9576,
		NeedD = 9573,
		get_serverVersion = 9586,
		set_toDelete = 9619,
		set_toUpdate = 9620,
		get_toDelete = 9597,
		Register = 9569,
		get_toUpdate = 9598,
		op_Equality = 9580,
		get_downloadCount = 9593,
		set_GroupData = 9623,
		set_errorCode = 9613,
		get_localVersionFile = 9581,
		set_useCacheVersion = 9610,
		get_useCacheVersion = 9588,
		SetV = 9570,
		UpdateHashFile = 9577,
		get_webRequest = 9599,
		set_localVersionFile = 9603,
		set_state = 9612,
		CheckD = 9574,
		get_localHashFile = 9582,
		get_localVersion = 9585,
		GetCurrentServer = 9571,
		OnError = 9572,
		get_cachedHashPath = 9584,
		get_CurrentVersion = 9602,
		set_localHashFile = 9604,
		CheckUpdateType = 9996,
		get_switchPackageFlag = 9589,
		set_webRequest = 9621,
		get_cdnURLArr = 9587,
		RewriteHashFile = 9575,
		CloseCachedStreamWriter = 9578,
		set_downloadCount = 9615,
		get_GroupData = 9601,
		get_errorCode = 9591,
		set_cachedHashMap = 9618,
		get_downloadTotal = 9594,
		set_switchPackageFlag = 9611,
		UpdateVersionFile = 9579,
		set_downPath = 9614,
		get_maxRetryTimes = 9595
	},
	YongShi_BundleWizardRuntime_DownloadMgrWrap = {
		StartVerifyForLua = 9631,
		Clear = 9629,
		FindF = 9625,
		Register = 9624,
		op_Equality = 9632,
	...
	YongShi_BundleWizardRuntime_DownloadStateWrap = {
		...
		IntToEnum = 9644,
		get_CheckOver = 9639,
		get_UpdateFailure = 9643,
		get_None = 9636,
		get_UpdateSuccess = 9642,
		Register = 9633,
		get_Checking = 9637,
		CheckType = 9635,
		get_Updating = 9641,
		get_CheckFailure = 9640,
		get_CheckToUpdate = 9638
	},
	YongshiSdkCallback = {
		LogoutFailed = 9837,
		GetUserInfoFailed = 9839,
		BindFailed = 9841,
		PayFailed = 9835,
		LoginFailed = 9833,
		PaySuccess = 9834,
	...
	YongshiSdkMgr = {
		...
		LocalLogout = 9854,
		Query = 10018,
		TriggerDeepLinking = 9874,
		callSdkApi = 8123,
		OnLoginGatewayFailed = 9858,
		SetProducts = 10015,
		UnBindApple = 9869,
		get_isPlatform = 8120,
		get_cacheUrl = 9847,
		...
		UnBindFaceBook = 9868,
		UnBindPhone = 9871,
		UserEventUpload = 9861,
		UnBindGameCenter = 9872,
		OnGatewayLogined = 9857
	},
	YongshiSdkMgrWrap = {
		get_isPlatform = 7979,
	...
	YongShiSdkProductWrap = {
		get_price = 10001,
		set_desc = 10009,
		set_currenct = 10006,
		Register = 9997,
		set_price = 10007,
		_CreateYongShiSdkProduct = 9998,
		get_currenct = 10000,
		set_pricem = 10008,
		get_id = 9999,
		get_name = 10004,
	...
	YongshiSdkUserBindInfo = {
		get_facebookKey = 9881,
		get_phoneKey = 9885,
		get_googleKey = 9883,
		IsBindFaceBook = 9889,
		get_applekey = 9878,
		set_facebookKey = 9880,
		set_googleKey = 9882,
		IsBindGoogle = 9890,
		IsBindApple = 9892,
		IsBindPhone = 9891,
	...
	YongshiSdkUserBindInfoWrap = {
		...
		set_applekey = 9659,
		SetBindInfo = 9647,
		_CreateYongshiSdkUserBindInfo = 9646,
		get_GOOGLE = 9656,
		UnBindInfo = 9649,
		GetBindInfo = 9648
	},
	...
	YonshiSdkDeepLinkWrap = {
		Clear = 9663,
		set_page = 9666,
		get_arg = 9665,
		Register = 9660,
		_CreateYonshiSdkDeepLink = 9661,
		get_page = 9664,
		set_arg = 9667,
		IsEmpty = 9662
	},
	...
	["YSToolCore.YsToolCallback"] = {
		getBrightnessMode = 9991,
		ShowLog = 9992,
		Awake = 9990
	},
	["YSToolCore.YsToolEvent"] = {
		get_Instance = 9993,
		HandleBrightMode = 9994
	},
