...
slot0.OnLoaded = function(slot0)
	...
	slot0.labelTxt = slot0._tf:Find("left/label/icon"):GetComponent(typeof(Image))
	slot0.paintingTr = slot0._tf:Find("left/print/mask/painting")
	slot0.scrollrect = slot0._tf:Find("list")
	slot0.uiItemList = UIItemList.New(slot0._tf:Find("list/content"), slot0._tf:Find("list/content/tpl"))
	slot0.dotUIItemList = UIItemList.New(slot0._tf:Find("list/dots"), slot0._tf:Find("list/dots/tpl"))
	slot0.confirmBtn = slot0._tf:Find("confirm_btn")
	slot0.nextArr = slot0._tf:Find("prints/next")
	slot0.prevArr = slot0._tf:Find("prints/prev")
	slot0.nextPrint = slot0._tf:Find("prints/print1")
	slot0.prevPrint = slot0._tf:Find("prints/print2")
