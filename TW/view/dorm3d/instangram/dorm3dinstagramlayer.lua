...
slot0.init = function(slot0)
	...
	slot0.mainBg = slot0._tf:Find("main/left_panel/bg")
	slot0.imageTF = slot0._tf:Find("main/left_panel/mask/Image"):GetComponent(typeof(Image))
	...
	setText(slot0._tf:Find("main_bg/Text"), i18n("dorm3d_privatechat_topics"))
