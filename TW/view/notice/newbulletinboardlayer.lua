...
slot0.init = function(slot0)
	slot0._closeBtn = slot0._tf:Find("bg/close_btn")
	slot0._mainTabContainer = slot0._tf:Find("bg/notice_list")
	slot0._subTabGroup = slot0._tf:Find("bg/title_list/viewport/content"):GetComponent(typeof(ToggleGroup))
	slot0._subTabContainer = slot0._tf:Find("bg/title_list/viewport/content")
	slot0._tabTpl = slot0._tf:Find("bg/title_list/tab_btn_tpl")

	SetActive(slot0._tabTpl, false)

	slot0._subTabList = {}
	slot0._contentTF = slot0._tf:Find("bg/content_view/viewport/content")
	slot0._detailTitleImg = slot0._contentTF:Find("title_img")
	slot0._detailTitleImgLayoutElement = slot0._detailTitleImg:GetComponent(typeof(LayoutElement))
	slot0._detailTitle = slot0._contentTF:Find("title")
	slot0._detailTitleTxt = slot0._contentTF:Find("title/title_txt/mask/scroll_txt")
	slot0._detailTimeTxt = slot0._contentTF:Find("title/time_txt")
	slot0._detailLine = slot0._contentTF:Find("line")
	slot0._bottom = slot0._contentTF:Find("bottom")
	slot0._contentContainer = slot0._contentTF:Find("content_container")
	slot0._contentTxtTpl = slot0._contentTF:Find("content_txt")

	setActive(slot0._contentTxtTpl, false)

	slot0._contentBannerTpl = slot0._contentTF:Find("content_banner")

	setActive(slot0._contentBannerTpl, false)

	slot0._scrollRect = slot0._tf:Find("bg/content_view"):GetComponent(typeof(ScrollRect))
	slot0._dontshow = slot0._tf:Find("bg/dont_show")
	slot0._stopRemind = slot0._tf:Find("bg/dont_show/bottom")
	slot0._subTabAnims = {}
	slot0._mainAnim = slot0._tf:GetComponent(typeof(Animation))
	slot0._bgAnim = slot0._tf:Find("bg"):GetComponent(typeof(Animation))
	slot0._contentAnim = slot0._tf:Find("bg/content_view"):GetComponent(typeof(Animation))
