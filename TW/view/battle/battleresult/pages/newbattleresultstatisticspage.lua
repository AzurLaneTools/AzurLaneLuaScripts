...
slot0.OnLoaded = function(slot0)
	...
	slot0.paintingTr = slot0._tf:Find("painting")
	slot0.resultPaintingTr = slot0._tf:Find("result")
	slot0.topPanel = slot0._tf:Find("top")
	slot0.gradeIcon = slot0._tf:Find("top/grade/icon"):GetComponent(typeof(Image))
	slot0.gradeTxt = slot0._tf:Find("top/grade/Text"):GetComponent(typeof(Image))
	slot0.chapterName = slot0._tf:Find("top/grade/chapterName"):GetComponent(typeof(Text))
	slot0.opBonus = slot0._tf:Find("top/grade/operation_bonus")
	slot0.playerName = slot0._tf:Find("top/exp/name"):GetComponent(typeof(Text))
	slot0.playerLv = slot0._tf:Find("top/exp/lv"):GetComponent(typeof(Text))
	slot0.playerExp = slot0._tf:Find("top/exp/Text"):GetComponent(typeof(Text))
	slot0.playerExpLabel = slot0._tf:Find("top/exp/Text/exp_label"):GetComponent(typeof(Text))
	slot0.playerExpBar = slot0._tf:Find("top/exp/exp_bar/progress"):GetComponent(typeof(Image))
	slot0.commmanderContainer = slot0._tf:Find("top/exp/commanders")
	slot0.shipContainer = slot0._tf:Find("left")
	...
	slot0.confrimBtn = slot0._tf:Find("bottom/confirmBtn")
	slot0.statisticsBtn = slot0._tf:Find("bottom/statisticsBtn")
	slot0.mainFleetBtn = slot0._tf:Find("bottom/mainFleetBtn")
	slot0.subFleetBtn = slot0._tf:Find("bottom/subFleetBtn")
	slot1 = slot0._tf:Find("chat/Text")
	...
	slot0.commaderTpls = {}
	slot0.emptyTpls = {
		slot0._tf:Find("top/exp/emptycomanders/1"),
		slot0._tf:Find("top/exp/emptycomanders/2")
	}
