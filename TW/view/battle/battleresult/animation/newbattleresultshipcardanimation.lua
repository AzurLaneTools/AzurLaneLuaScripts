...
function slot0.DoExpAnimation(slot0, slot1)
	parallelAsync({
		function (slot0)
...
function slot0.DoOutputAnimation(slot0, slot1)
	parallelAsync({
		function (slot0)
...
function slot0.KillCntAnimation(slot0, slot1)
...
function slot0.OutputAnimation(slot0, slot1)
...
function slot0.OutputBarAnimation(slot0, slot1)
