...
slot0.init = function(slot0)
	...
	slot0.labelHeart = slot0.mainPanel:Find("bg/left_panel/evaluation_count/heart")
	slot0.labelEva = slot0.mainPanel:Find("bg/left_panel/evaluation_count/count")
	slot0.btnLike = slot0.mainPanel:Find("bg/left_panel/btnLike")
	slot0.btnEva = slot0.mainPanel:Find("bg/bottom_panel/send_btn")
	slot0.input = slot0.mainPanel:Find("bg/bottom_panel/Input")
	slot0.inputText = slot0.input:Find("Text")
	slot0.list = slot0.mainPanel:Find("bg/right_panel/list")
	slot0.hotContent = slot0.list:Find("content/hots")
	slot0.commonContent = slot0.list:Find("content/commons")
	slot0.hotTpl = slot0.list:Find("content/hot_tpl")
	slot0.commonTpl = slot0.list:Find("content/commom_tpl")
...
slot0.didEnter = function(slot0)
	...
	onButton(slot0, slot3:Find("mainPanel/bg/top_panel/btnBack"), function ()
		uv0:onBackPressed()
	end, SFX_CANCEL)
...
slot0.flushEva = function(slot0)
	...
	for slot7 = 1, #slot2 do
		...
		slot10 = slot8:Find("bg/evaluation"):GetComponent(typeof(Text))

		setText(slot8:Find("bg/name"), slot9.nick_name .. ":")
		setText(slot8:Find("bg/zan_bg/Text"), slot9.good_count - slot9.bad_count)
