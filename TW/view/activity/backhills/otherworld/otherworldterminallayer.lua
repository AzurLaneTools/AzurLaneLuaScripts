...
slot0.findUI = function(slot0)
	...
	slot0.adventureTipTF = slot0.togglesTF:Find("2/tip")

	setText(slot0.togglesTF:Find(uv0.PAGE_PERSONAL .. "/Text"), i18n("terminal_personal_title"))
	setText(slot0.togglesTF:Find(uv0.PAGE_ADVENTURE .. "/Text"), i18n("terminal_adventure_title"))
	setText(slot0.togglesTF:Find(uv0.PAGE_GUARDIAN .. "/Text"), i18n("terminal_guardian_title"))
