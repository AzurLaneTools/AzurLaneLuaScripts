...
slot0.didEnter = function(slot0)
	...
	slot0:InitFacilityCross(slot0._map, slot0._upper, "longtenghuyue", function ()
		pg.m02:sendNotification(GAME.GO_SCENE, SCENE.ACTIVITY, {
			id = ActivityConst.SPRING_FESTIVAL_PT_2022_ID
		})
	end)
	slot0:InitFacilityCross(slot0._map, slot0._upper, "huazhongshijie", function ()
		pg.m02:sendNotification(GAME.GO_SCENE, SCENE.ACTIVITY, {
			id = ActivityConst.SPRING_FESTIVAL_CARD_2022_ID
		})
	end)
...
slot0.UpdateView = function(slot0)
	...
	setActive(slot0.upper_huazhongshijie:Find("Tip"), Activity.IsActivityReady(slot3:getActivityById(ActivityConst.SPRING_FESTIVAL_CARD_2022_ID)))
