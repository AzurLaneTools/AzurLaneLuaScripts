slot0 = class("ReversePacmanTaskItem", import("view.base.BasePanel"))
...
slot0.Init = function(slot0)
	onButton(slot0, slot0.uiGoBtn, function ()
		uv0:emit(ReversePacmanTaskMediator.ON_TASK_GO, uv0.taskVO)
	end, SFX_PANEL)
	onButton(slot0, slot0.uiGetBtn, function ()
		uv0:emit(ReversePacmanTaskMediator.ON_TASK_SUBMIT, uv0.taskVO)
	end, SFX_PANEL)
