slot0 = class("ReversePacmanTechnologyRoleSkillToggle", import("view.base.BasePanel"))
...
slot0.Init = function(slot0)
	setText(slot0.uiNameText, i18n("reverse_pacman_support"))
end
...
slot0.RefreshTip = function(slot0)
	setActive(slot0.uiTipGo, ReversePacmanTools.GetActivity():GetRoleSkillTip())
end
