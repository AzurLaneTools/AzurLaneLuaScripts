...
slot0.init = function(slot0)
	...
	slot0.redpacket = slot0._tf:Find("redpackets/redpacket")
	slot0.lineHrzTpl = slot0._tf:Find("lines/line_hrz")
	slot0.lineVecTpl = slot0._tf:Find("lines/line_vec")
	slot0.animalTpl = slot0._tf:Find("animals/animal")
	slot0.areaTpl = slot0._tf:Find("drawablearea/area")
	slot0.boxTpl = slot0._tf:Find("boxes/box")
	slot0.selectorTpl = slot0._tf:Find("selectors/selector")
	slot0.tpl = slot0._tf:Find("grids/grid")
	slot0.backBtn = slot0._tf:Find("back")
	slot0.helpBtn = slot0._tf:Find("help")
	slot0.travelPointTxt = slot0._tf:Find("points/travel"):GetComponent(typeof(Text))
	slot0.drawPointTxt = slot0._tf:Find("points/draw"):GetComponent(typeof(Text))
	slot0.travelProgressTxt = slot0._tf:Find("progress/travel"):GetComponent(typeof(Text))
	slot0.drawProgressTxt = slot0._tf:Find("progress/draw"):GetComponent(typeof(Text))
	slot0.switchBtn = slot0._tf:Find("swticher")
	...
	slot0.onekeyTravelBtn = slot0._tf:Find("onekey_travel")
	slot0.onekeyTravelingBtn = slot0._tf:Find("onekey_travel/Image")
	slot0.onekeyDrawBtn = slot0._tf:Find("onekey_draw")
	slot0.onekeyDrawingBtn = slot0._tf:Find("onekey_draw/Image")
	slot0.char = slot0._tf:Find("char/char")

	setActive(slot0.char, false)

	slot0.selectorContainer = slot0._tf:Find("selectors"):GetComponent(typeof(CanvasGroup))
	slot1 = slot0._tf:Find("drawablearea")
