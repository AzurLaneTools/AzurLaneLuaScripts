...
slot0.init = function(slot0)
	...
	slot0.listTF = slot0._tf:Find("list")
	slot0.mainTF = slot0._tf:Find("main")
	slot0.closeBtn = slot0._tf:Find("closeBtn")
	slot0.noMsgTF = slot0._tf:Find("list/bg/no_msg")
	slot0.scrollBarTF = slot0._tf:Find("list/bg/scroll_bar")
	slot0.list = slot0._tf:Find("list/bg/scrollrect"):GetComponent("LScrollRect")
	slot0.imageTF = slot0._tf:Find("main/left_panel/mask/Image"):GetComponent(typeof(RawImage))
	slot0.likeBtn = slot0._tf:Find("main/left_panel/heart")
	slot0.bubbleTF = slot0._tf:Find("main/left_panel/bubble")
	slot0.planeTF = slot0._tf:Find("main/left_panel/plane")
	slot0.likeCntTxt = slot0._tf:Find("main/left_panel/zan"):GetComponent(typeof(Text))
	slot0.pushTimeTxt = slot0._tf:Find("main/left_panel/time"):GetComponent(typeof(Text))
	slot0.iconTF = slot0._tf:Find("main/right_panel/top/head/icon")
	slot0.nameTxt = slot0._tf:Find("main/right_panel/top/name"):GetComponent(typeof(Text))
	slot0.centerTF = slot0._tf:Find("main/right_panel/center")
	slot0.contentTxt = slot0._tf:Find("main/right_panel/center/Text/Text"):GetComponent(typeof(Text))
	slot0.commentList = UIItemList.New(slot0._tf:Find("main/right_panel/center/bottom/scroll/content"), slot0._tf:Find("main/right_panel/center/bottom/scroll/content/tpl"))
	slot0.commentPanel = slot0._tf:Find("main/right_panel/last/bg2")
	slot0.optionalPanel = slot0._tf:Find("main/right_panel/last/bg2/option")
	slot0.scroll = slot0._tf:Find("main/right_panel/center/bottom/scroll")

	setText(slot0._tf:Find("closeBtn/Text"), i18n("word_back"))
