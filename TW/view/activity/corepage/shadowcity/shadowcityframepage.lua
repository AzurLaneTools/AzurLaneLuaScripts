slot0 = class("ShadowCityFramePage", import("view.activity.CorePage.CoreNewFrameTemplatePage"))
...
slot0.OnInit = function(slot0)
	...
	slot0.animClip1 = "anim_ShadowCityFramePage_switcher"
	slot0.animClip2 = "anim_ShadowCityFramePage_switcher2"
end
