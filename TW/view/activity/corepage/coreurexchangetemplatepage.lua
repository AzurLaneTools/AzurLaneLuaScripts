...
slot0.OnInit = function(slot0)
	...
	slot0._msgBox = slot0:findTF("msg_box")
	slot0._msgBoxBtnCancel = slot0:findTF("msg_box/btn_cancel")
	slot0._msgBoxBtnConfirm = slot0:findTF("msg_box/btn_confirm")
	slot0._msgBoxLabel = slot0:findTF("msg_box/label/text_cn")
	slot0._msgBoxItem = slot0:findTF("msg_box/item/IconTpl")
	slot0._msgBoxItemName = slot0:findTF("msg_box/item/name")
	slot0._msgBoxItemDesc = slot0:findTF("msg_box/item/desc")
end
...
slot0.UpdateTask = function(slot0, slot1, slot2)
	...
	setText(slot0:findTF("count", slot2), slot8)
	setActive(slot0:findTF("complete", slot2), slot9 == nil)
	setActive(slot0:findTF("btn_go", slot2), slot9 ~= nil)
