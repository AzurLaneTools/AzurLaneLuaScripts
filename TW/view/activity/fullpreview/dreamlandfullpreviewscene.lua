...
slot0.init = function(slot0)
	slot1 = slot0._tf:Find("btns")
	slot0.dreamlandBtn = slot1:Find("dreamland")
	slot0.skinBtn = slot1:Find("skin")
	slot0.buildBtn = slot1:Find("build")
	slot0.battleBtn = slot1:Find("battle")
	slot0.minigameBtn = slot1:Find("minigame")

	setText(slot0._tf:Find("top/info/Text"), i18n("dreamland_main_desc"))
...
slot0.UpdateView = function(slot0)
	setActive(slot0.minigameBtn:Find("tip"), uv0.MiniGameTip())
	setActive(slot0.dreamlandBtn:Find("dreamland/tip"), uv0.DreamlandTip())

	slot0.isFinishPre = slot0:IsFinishPreAct()

	setActive(slot0.dreamlandBtn:Find("dreamland"), slot0.isFinishPre)
	setActive(slot0.dreamlandBtn:Find("pre_act"), not slot0.isFinishPre)
	setActive(slot0.dreamlandBtn:Find("pre_act/tip"), uv0.ActivityTip(getProxy(ActivityProxy):getActivityById(slot0.preActId)))
end
