...
slot0.GetSignInAct = function(slot0)
	return getProxy(ActivityProxy):getActivityById(slot0.signInActId)
end

slot0.ClientSignInActIsEnd = function(slot0)
...
slot0.FlushSignInInfo = function(slot0)
...
slot0.FlushSignAwardsState = function(slot0)
