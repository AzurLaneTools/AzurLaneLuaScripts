slot0 = class("ValentineQte2Page", import("view.base.BaseActivityPage"))
slot0.MINIGAME_HUB_ID = 63
...
slot0.FlushIndex = function(slot0, slot1)
	slot0.indexTxt.text = "<color=#e68f72>" .. slot1.usedtime .. "</color><color=#5a4141>/7</color>"
end
