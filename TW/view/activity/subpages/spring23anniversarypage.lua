slot0 = class("Spring23AnniversaryPage", import("...base.BaseActivityPage"))
slot1 = 42
slot2 = {}
slot3 = 3.5
slot4 = 1
...
slot0.OnInit = function(slot0)
	...
	setActive(findTF(slot0._tf, "BtnList"), false)
...
slot0.findUI = function(slot0)
	...
	slot0.btnGo = slot0._tf:Find("BtnGo")
...
slot0.OnFirstFlush = function(slot0)
	...
	onButton(slot0, slot0.btnGo, function ()
		uv0:emit(ActivityMediator.EVENT_GO_SCENE, SCENE.SPRING_FESTIVAL_BACKHILL_2024)
	end)
	slot0:initPaint()
