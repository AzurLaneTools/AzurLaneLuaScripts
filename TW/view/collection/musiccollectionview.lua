...
slot0.findUI = function(slot0)
	...
	slot0.likeFilteToggle = slot0.topPanel:Find("LikeBtn")
	...
	slot0.plateListPanel = slot0._tf:Find("PlateList")
	slot0.plateTpl = slot0.plateListPanel:Find("Plate")
	...
	slot0.playPanel = slot0._tf:Find("PLayPanel")
	slot0.playPanelNameText = slot0.playPanel:Find("NameText")
	slot0.likeToggle = slot0.playPanel:Find("LikeBtn")
	slot0.likeOnImg = slot0.likeToggle:Find("On")
	slot0.songImg = slot0.playPanel:Find("SongImg/face")
	slot0.pauseBtn = slot0.playPanel:Find("PlayingBtn")
	slot0.playBtn = slot0.playPanel:Find("StopingBtn")
	slot0.playDesc = slot0.playPanel:Find("PlayDesc")
	slot0.nextBtn = slot0.playPanel:Find("NextBtn")
	slot0.preBtn = slot0.playPanel:Find("PreBtn")
	slot0.playProgressBar = slot0.playPanel:Find("Progress")
	slot0.nowTimeText = slot0.playProgressBar:Find("NowTimeText")
	slot0.totalTimeText = slot0.playProgressBar:Find("TotalTimeText")
	slot0.playSliderSC = GetComponent(slot0.playProgressBar, "LSlider")
	slot0.listBtn = slot0.playPanel:Find("ListBtn")
