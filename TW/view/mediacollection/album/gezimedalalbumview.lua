slot0 = class("GeZiMedalAlbumView", import(".MedalAlbumTemplateView"))
slot0.GROUP_ID = 50607
slot0.MEDAL_COUNT = 8
...
slot0.FindUI = function(slot0)
	...
	setActive(slot0._tf:Find("Desk"), true)
	setActive(slot0._tf:Find("DetailView"), false)
	setActive(slot0._tf:Find("TaskView"), false)
end
