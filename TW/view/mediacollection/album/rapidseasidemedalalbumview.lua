slot0 = class("RapidSeasideMedalAlbumView", import(".MedalAlbumTemplateView"))
...
slot0.FindUI = function(slot0)
	...
	slot0.medalDetailView = DreamTourMedalDetailPanel.New(slot0._tf:Find("DetailView"), slot0)
