slot0 = class("ShiningMagicMedalAlbumView", import(".MedalAlbumTemplateView"))
...
slot0.FindUI = function(slot0)
	...
	slot0.medalDetailView = ShadowCityMedalDetailPanel.New(slot0._tf:Find("DetailView"), slot0)

	slot0.medalDetailView:SetIconScale(slot0.ICON_SCALE)

	slot0.medalTaskView = FujinBayMedalTaskPanel.New(slot0._tf:Find("TaskView"), slot0)
end
