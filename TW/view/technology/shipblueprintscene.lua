...
slot0.updateModPanel = function(slot0)
	...
	pressPersistTrigger(slot0.calcMinusBtn, 0.5, function ()
	...
	pressPersistTrigger(slot0.calcPlusBtn, 0.5, function ()
...
slot0.updateFittingPanel = function(slot0)
	...
	pressPersistTrigger(slot0.fittingCalcMinusBtn, 0.5, function ()
	...
	pressPersistTrigger(slot0.fittingCalcPlusBtn, 0.5, function ()
