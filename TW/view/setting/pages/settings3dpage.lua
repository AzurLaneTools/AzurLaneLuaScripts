slot0 = class("Settings3DPage", import("...base.BaseSubView"))
...
slot0.OnBindEvent = function(slot0)
	slot0:bind(SettingsOtherGraphicsPanle.EVT_UPDTAE, function ()
		if uv0:GetPanel(SettingsOtherGraphicsPanle) then
			slot0:RefreshPanelByGraphcLevel()

			slot1 = uv0

			slot1:RebuildLayout(function ()
			end)
		end
	end)
	slot0:bind(SettingsGraphicsPanle.EVT_UPDTAE, function ()
		if uv0:GetPanel(SettingsGraphicsPanle) then
			slot0:OnUpdate()
		end
	end)
end
