slot0 = class("GameRoomLaunchView", import("..BaseMiniGameView"))
...
slot0.initEvent = function(slot0)
	...
	slot0:bind(uv0.SUBMIT_GAME_SUCCESS, function (slot0, slot1, slot2)
		slot3 = LaunchBallGameVo.gameRoundData.type
		slot4 = LaunchBallGameVo.gameRoundData.type_index

		uv0:SendSuccess(LaunchBallGameVo.scoreNum)
	end)
