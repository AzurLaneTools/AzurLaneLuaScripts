...
slot0.Ctor = function(slot0, slot1, slot2)
	...
	slot3 = GetComponent(findTF(slot0.menuUI, "lastTimes/img"), typeof(Image))
...
slot0.update = function(slot0, slot1)
	...
	setActive(findTF(slot0.btnStart, "tip"), slot0:getGameTimes(slot1) > 0)
	setText(slot0.textLastTimes, slot3)
