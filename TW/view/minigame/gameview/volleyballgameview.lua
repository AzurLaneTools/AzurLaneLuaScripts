...
slot0.didEnter = function(slot0)
	...
	onButton(slot0, slot0.selectBackBtn, function ()
		...
		pg.UIMgr.GetInstance():UnOverlayPanel(uv0.selectUI, uv0._tf)
	end, SFX_PANEL)
...
slot0.firstShow = function(slot0, slot1)
	...
	onButton(slot0, slot0.helpUI, function ()
		...
		pg.UIMgr.GetInstance():UnOverlayPanel(uv0.helpUI, uv0._tf)
...
slot0.startCountTimer = function(slot0)
	...
	slot1 = function()
		...
		if uv0.countTime <= 0 then
			...
			pg.UIMgr.GetInstance():UnOverlayPanel(uv0.countTimeUI, uv0._tf)
			uv0:resetGameAni()
			uv0:startGame()
		else
...
slot0.willExit = function(slot0)
	slot0:clearSpineChars()
	pg.UIMgr.GetInstance():UnOverlayPanel(slot0.selectUI, slot0._tf)
	pg.UIMgr.GetInstance():UnOverlayPanel(slot0.endUI, slot0._tf)
	pg.UIMgr.GetInstance():UnOverlayPanel(slot0.countTimeUI, slot0._tf)
end
