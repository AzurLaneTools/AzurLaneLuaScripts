...
slot0.GO_SUBLAYER = "MainUIMediator GO_SUBLAYER"
...
function slot0.register(slot0)
	...
	slot8 = pg.SystemOpenMgr.GetInstance()

	slot8:notification(slot4.level)
