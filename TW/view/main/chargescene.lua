...
function slot0.showItemDetail(slot0, slot1)
	...
	slot0:bindDetailTF(slot13 and slot0:findTF("window2", slot0.detail) or slot0:findTF("window", slot0.detail))

	if slot0.detailNormalTip then
		setActive(slot0.detailNormalTip, slot13)
	end

	if slot0.detailContain then
		setActive(slot0.detailContain, not slot13)
	end

	if slot13 then
		if slot0.detailNormalTip:GetComponent("Text") then
			setText(slot0.detailNormalTip, slot13)
		else
			setButtonText(slot0.detailNormalTip, slot13)
		end
	end
