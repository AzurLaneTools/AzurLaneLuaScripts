...
slot0.OnLoaded = function(slot0)
	...
	slot0.friendToggle = slot0._tf:Find("frame/on_panel/friend")
	slot0.guildToggle = slot0._tf:Find("frame/on_panel/guild")
	slot0.codeToggle = slot0._tf:Find("frame/on_panel/code")
	slot0.codeTxt = slot0._tf:Find("frame/code_panel/id/Text"):GetComponent(typeof(Text))
	slot0.codeMask = slot0._tf:Find("frame/code_panel/mask")
	slot0.codeRefreshBtn = slot0._tf:Find("frame/code_panel/refresh")
	slot0.codeRefreshTxt = slot0._tf:Find("frame/code_panel/refresh/Text"):GetComponent(typeof(Text))
	slot0.codeCopyBtn = slot0._tf:Find("frame/code_panel/copy")
	slot0.tipBtn = slot0._tf:Find("frame/tip")

	setText(slot0._tf:Find("frame/title/Text"), i18n("island_open_settings"))
	setText(slot0._tf:Find("frame/on_panel/friend/Text"), i18n("island_friend"))
	setText(slot0._tf:Find("frame/on_panel/guild/Text"), i18n("island_guild"))
	setText(slot0._tf:Find("frame/on_panel/code/Text"), i18n("island_code"))
	setText(slot0._tf:Find("frame/on_tip/Text"), i18n("island_open_settings_tip1"))
	setText(slot0._tf:Find("frame/off_tip/Text"), i18n("island_open_settings_tip2"))
	setText(slot0._tf:Find("frame/code_panel/copy/Text"), i18n("island_btn_label_copy"))
	setText(slot0._tf:Find("frame/toggle/on/Text"), i18n("island_visit_on"))
	setText(slot0._tf:Find("frame/toggle/off/Text_1"), i18n("island_visit_on"))
	setText(slot0._tf:Find("frame/toggle/on/Text_2"), i18n("island_visit_off"))
	setText(slot0._tf:Find("frame/toggle/off/Text"), i18n("island_visit_off"))
end
