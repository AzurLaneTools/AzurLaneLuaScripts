...
slot0.execute = function(slot0, slot1)
	...
	slot6:Send(29040, {
		...
		if slot0.result == 0 then
			...
			slot2:SetSystemNo(NewEducateFSM.SYSTEM.PLAN)

			slot3 = slot2:GetState(NewEducateFSM.SYSTEM.PLAN)
		...
		pg.TipsMgr.GetInstance():ShowTips("NewEducate_Schedule: " .. slot0.result)
	end)
end
