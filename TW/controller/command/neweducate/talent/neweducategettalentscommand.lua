...
slot0.execute = function(slot0, slot1)
	...
	pg.ConnectionMgr.GetInstance():Send(29019, {
		...
		if slot0.result == 0 then
			...
			slot1:SetSystemNo(NewEducateFSM.SYSTEM.TALENT)
			slot1:SetState(NewEducateFSM.SYSTEM.TALENT, NewEducateTalentState.New({
				finished = 0,
			...
			pg.TipsMgr.GetInstance():ShowTips("NewEducate_GetTalents: " .. slot0.result)
		end
	end)
end
