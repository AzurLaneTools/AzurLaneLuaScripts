...
6 完成上色可以獲得獎勵；
7 各圖完成獎勵明細如下：
	完成圖1獲得T2隨機教材 x2，300物資；
	完成圖2獲得T2隨機改造圖 x2，100石油；
	完成圖3獲得T2隨機部件 x3，300物資；
	完成圖4獲得T3攻擊教材 x2，100石油；
	完成圖5獲得T3防禦教材 x2，300物資；
	完成圖6獲得T3通用改造部件 x3，100石油；
	完成圖7獲得伊莉莎白女王換裝「女王的學園命令」；
8 活動結束後，未消耗的顏料會被清除。
9 5月26日前每天解鎖一個可完成的繪圖。]]
			}
		}
	},
	link_link_help_tip = {
