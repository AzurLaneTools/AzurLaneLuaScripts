...
(function ()
	...
	pg.base.technology_data_template[501] = {
		...
		name = "C-153-MI",
		lv_limit = 30,
		desc = "目前一切關於心智魔方的理論基礎，其基石都來源於對心智魔方基礎構造的了解程度。一些工程師們正致力於推導心智魔方的基礎構造。",
		condition = 0,
		bg = "1",
		blueprint_version = 6,
		sub_name = "中型项目",
	...
	pg.base.technology_data_template[511] = {
		...
		name = "B-622-MI",
		lv_limit = 30,
		desc = "工程師們在對心智魔方的研究過程中，提出了大量天馬行空般的設想。該科研計畫致力於透過實戰的手段，收集各種實驗數據以驗證實驗設想。",
		condition = 52001,
		bg = "1",
		blueprint_version = 6,
		sub_name = "中型项目",
...
(function ()
	...
	pg.base.technology_data_template[521] = {
		...
		name = "T-018-MI",
		lv_limit = 30,
		desc = "除去建造方面，心智魔方在日用性上的研究也被提上了進程。該科研計畫希望能夠找出心智魔方在日用性上的可能性。",
		condition = 52021,
		bg = "1",
		blueprint_version = 6,
		sub_name = "小型项目",
	...
	pg.base.technology_data_template[531] = {
		...
		name = "E-031-MI",
		lv_limit = 30,
		desc = "試著闡明心智魔方與艦裝之間的聯繫，但這無疑必須建立在大量的實驗基礎上。用一些廢棄的艦裝當試驗品吧。",
		condition = 52031,
		bg = "1",
		blueprint_version = 6,
		sub_name = "小型项目",
	...
	pg.base.technology_data_template[541] = {
		...
		name = "G-412-MI",
		lv_limit = 30,
		desc = "科技的高速發展，離不開金錢的推動。如果指揮官願意投入大量的研發資金，相信一定能取得豐碩的成果。",
		condition = 0,
		bg = "1",
		blueprint_version = 6,
		sub_name = "小型项目",
	...
	pg.base.technology_data_template[571] = {
		...
		name = "Q-302-MI",
		lv_limit = 30,
		desc = "從已觀測到的心智魔方與艦裝的相互影響效果中，試圖以可控制且穩定的方式，尋找可以利用此效果的場景。",
		condition = 0,
		bg = "1",
		blueprint_version = 6,
		sub_name = "小型项目",
	...
	pg.base.technology_data_template[591] = {
		...
		name = "H-387-MI",
		lv_limit = 30,
		desc = "雖然至今仍未有成功的紀錄。但對於心智魔方的構造研究，最簡單粗暴的方法，就是將心智魔方分解解析。",
		condition = 0,
		bg = "1",
		blueprint_version = 6,
		sub_name = "小型项目",
...
(function ()
	...
	pg.base.technology_data_template[831] = {
		...
		name = "E-031-MI",
		lv_limit = 30,
		desc = "嘗試闡明心智魔方與艦裝之間的聯系，但這無疑必須建立在大量的實驗基礎之上。用一些廢棄的艦裝當試驗品吧。",
		condition = 52031,
		bg = "1",
		blueprint_version = 9,
		sub_name = "小型項目",
...
(function ()
	...
	pg.base.technology_data_template[1524] = {
		...
		name = "H-063-UL",
		lv_limit = 30,
		desc = "被軍部實驗室列為最高機密的項目，其結果對人類，甚至整個生態圈，都能產生巨大的影響。",
		condition = 0,
		bg = "3",
		blueprint_version = 6,
		sub_name = "小型项目",
