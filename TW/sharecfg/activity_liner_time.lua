...
pg.activity_liner_time = {
		...
		param = {
			{
				7,
				1,
				"收到歐根親王的聯絡後來到了女僕咖啡廳。不遠處，一些同伴正圍著一張餐桌交談著。",
				{
					1
				}
			},
		...
		param = {
			{
				25,
				1,
				"收到龍武的聯絡後來到了中央廚房。廚房中，一些同伴正在四處翻找著什麽。",
				{
					4
				}
			},
			...
			},
			{
				28,
				1,
				"兩起事件都與食物有關，而說到食物保有量最大的地方，無疑就是倉庫了。",
				{
					6
				}
			},
		...
		param = {
			{
				23,
				1,
				"路過電影院時，聽到了一聲淒慘的尖叫，緊接著是一連串細小的爆炸聲。",
				{
					10
				}
			},
	...
	},
	{
		...
		type = 1,
		id = 51,
		desc_after = "從{namecode:448}得到了「指引」",
		bg_name = "aurora",
		time = {
			8,
			12
