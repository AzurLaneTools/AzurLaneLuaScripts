...
pg.ship_data_create_material = {
	...
	},
	{
		...
		rate_tip = {
			...
			"<color=#3dc6ff>稀有艦船</color>：51%",
			"普通艦船：30%",
			"<color=#ffde38>史特拉斯堡</color>：2.0%<color=#92FC63>(up!)</color>",
			" ",
			"<color=#ffde38>大膽</color>：0.5%",
			" ",
			"<color=#d797ff>杜布雷</color>：2.5%<color=#92FC63>(up!)</color>"
		}
	},
	{
		use_gold = 1500,
	...
	},
	{
		...
		rate_tip = {
			...
			"普通艦船：28.8%",
			" ",
			"<color=#ff5e39>亞爾薩斯</color>：1.2%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>布倫努斯</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>貝亞恩·META</color>：0.5%",
			" ",
			"<color=#d797ff>鈍劍</color>：2.5%(<color=#92fc63>up!</color>)"
		}
	},
	{
		use_gold = 1500,
