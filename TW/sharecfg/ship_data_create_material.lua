...
pg.ship_data_create_material = {
	...
	},
	{
		...
		rate_tip = {
			...
			"普通艦船：28.8%",
			" ",
			"<color=#ff5e39>{namecode:294}</color>：1.2%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>{namecode:295}</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>{namecode:189}</color>：0.5%",
			" ",
			"<color=#d797ff>{namecode:297}</color>：2.5%(<color=#92fc63>up!</color>)"
		}
	},
	{
		use_gold = 1500,
