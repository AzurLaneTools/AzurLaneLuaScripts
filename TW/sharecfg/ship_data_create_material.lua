...
pg.ship_data_create_material = {
	...
	},
	{
		...
		rate_tip = {
			...
			"<color=#3dc6ff>稀有艦船</color>：51%",
			"普通艦船：30%",
			"<color=#ffde38>埃姆登</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>呂措</color>：2.0%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#ffde38>塞德利茨</color>：0.5%",
			" ",
			"<color=#d797ff>約克</color>：2.5%(<color=#92fc63>up!</color>)",
			" ",
			"<color=#d797ff>埃爾賓</color>：2.5%(<color=#92fc63>up!</color>)"
		}
	},
	{
		use_gold = 1500,
