...
(function ()
	...
	pg.base.island_technology_template[500214] = {
		complete_title = "可前往<color=#1E8FFE>晨露農場赫莫</color>處購買<color=#1E8FFE>馬鈴薯種子</color>",
		tech_level = "1",
		tech_chara = 1,
		auto_finish = 1,
		complete_tips = "可前往<color=#1E8FFE>晨露農場赫莫</color>處購買<color=#1E8FFE>馬鈴薯種子</color>",
		island_level = 10,
		tech_desc = "先進的馬鈴薯種植技術，讓馬鈴薯能在島嶼開發區的環境中茁壯成長。",
		tech_icon = "tech_500211",
		tech_belong = 5,
		tech_name = "馬鈴薯種植技術",
		formula_id = 7500214,
