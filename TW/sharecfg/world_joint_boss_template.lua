		...
		description = {
			{
				"近地軌道支援",
				2,
				"戰鬥中，大黃蜂·META能夠得到來自於近地軌道衛星提供的多種類型支援。"
			},
			{
				"幽靈行動",
				1,
				"大黃蜂·META每隔18秒，都會為其自身增添一層光學迷彩效果，每1層<color=#92fc63>提高自身6%迴避率</color>，最多疊加3層。 \n光學迷彩效果達到3層後，大黃蜂META將會使用一次電磁脈衝攻擊，<color=#92fc63>對所有我方單位造成致盲效果</color>，持續5秒。 （視野受到影響，無法使用主炮開火、空襲支援等功能）"
			}
		},
		p_offset = {
			-16,
		...
		description = {
			{
				"二刀流·夕照",
				2,
				" 江風·META每隔一段時間施展一次<color=#92fc63>「二刀流·夕照」</color>，以殺氣鎖定，0.5秒內大幅度降低目標移動速度，並同時造成交叉斬擊，附帶產生劍氣。<color=#92fc63>斬擊若命中則固定造成目標耐久上限5%的傷害</color>。\n江風·META的<color=#92fc63>所有劍氣都會造成雷擊傷害</color>。"
			},
			{
				"過去之影",
				3,
	...
	pg.base.world_joint_boss_template[21] = {
		...
		description = {
			...
			},
			{
				"注視，直到永遠",
				1,
				"約克鎮·META在場時，每5秒降低我方全體單位3%防空與3%機動，並對此時距離她<color=#92fc63>最近的我方角色產生雙倍效果</color>。"
			},
			{
				"「零」象限展開-5%",
				1,
