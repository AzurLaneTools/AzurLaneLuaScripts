...
(function ()
	...
	pg.base.item_data_frame[206] = {
		...
		id = 206,
		time_limit_type = 0,
		desc = "<color=#ffffff>獻給所有勇於挑戰極限的指揮官們</color>\n通過參與「限界挑戰」獲得（2022.1.27-2022.4.24）",
		scene = {}
	}
	...
	pg.base.item_data_frame[209] = {
		...
		id = 209,
		time_limit_type = 0,
		desc = "<color=#ffffff>獻給所有勇於挑戰極限的指揮官們</color>\n通過參與「限界挑戰」獲得（2022.11.17-2023.2.12）",
		scene = {}
	}
	...
	pg.base.item_data_frame[212] = {
		...
		id = 212,
		time_limit_type = 0,
		desc = "<color=#ffffff>獻給所有勇於挑戰極限的指揮官們</color>\n通過參與「限界挑戰」獲得（2023.8.17-2023.11.12）",
		scene = {}
	}
	...
	pg.base.item_data_frame[306] = {
		...
		id = 306,
		time_limit_type = 0,
		desc = "<color=#ffffff>「同志們，團結起來吧！世界將在我們手中改變！」</color>\n「北境序曲」活動獲取",
		scene = {}
	}
	...
	pg.base.item_data_frame[325] = {
		...
		id = 325,
		time_limit_type = 0,
		desc = "<color=#ffffff>「在那預言之日，中庭將墜於烈焰與怒濤——」</color>\n「空相交會點」活動獲取",
		scene = {}
	}
	...
	pg.base.item_data_frame[603] = {
		...
		id = 603,
		time_limit_type = 0,
		desc = "<color=#ffffff>參與盛大宴會的紀念，向所有與會者送上最美好的祝愿！ </color>\n透過參與「宴會邀約」活動獲取",
		scene = {}
	}
	pg.base.item_data_frame[604] = {
		...
		id = 604,
		time_limit_type = 0,
		desc = "<color=#ffffff>在努力運動中，一起揮灑汗水的證明</color>\n通過參與「運動簽到」取得（24.1.11 – 24.1.25）",
		scene = {}
	}
	...
	pg.base.item_data_frame[1013] = {
		...
		id = 1013,
		time_limit_type = 0,
		desc = "綠色的脈沖電流在裝置間劈啪作響，躍動的電光貓耳與燈泡一同閃爍。\n<color=#A7A7AA>通過提升「宿舍計劃」中納希莫夫海軍上將的契合度等級獲取</color>",
		scene = {}
	}
	pg.base.item_data_frame[1014] = {
		...
		id = 1014,
		time_limit_type = 0,
		desc = "爪印與尾巴在數據流中浮現，那是來自賽博空間的貓貓問候。\n<color=#A7A7AA>通過提升「宿舍計劃」中納希莫夫海軍上將的契合度等級獲取</color>",
		scene = {}
	}
