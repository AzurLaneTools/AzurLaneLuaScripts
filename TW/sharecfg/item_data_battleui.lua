...
(function ()
	pg.base.item_data_battleui[0] = {
		...
		is_unlock = 0,
		rare = 2,
		desc = "經典的指揮介面，承載著無數場激烈戰鬥的回憶，擁有無與倫比的實用性。",
		id = 0,
		icon = "0",
		scene = {},
		rare_display = {}
	...
	pg.base.item_data_battleui[101] = {
		...
		is_unlock = 0,
		rare = 2,
		desc = "採用大膽的色彩與現代化的圖形元素，旨在為指揮官提供更具活力的視覺體驗。",
		id = 101,
		icon = "101",
		scene = {},
		rare_display = {}
	...
	pg.base.item_data_battleui[104] = {
		...
		is_unlock = 1,
		rare = 3,
		desc = "霓虹色彩與律動光束交相輝映，元素交織出流暢的節奏，為指揮作戰帶來獨特的視覺體驗。",
		id = 104,
		icon = "104",
		scene = {},
		rare_display = {
	...
	pg.base.item_data_battleui[107] = {
		...
		is_unlock = 1,
		rare = 3,
		desc = "耀眼的星光匯聚於界面中心，神秘的法陣映射著星系輪廓，每個細節都訴說著對天外的探索與征途。",
		id = 107,
		icon = "107",
		scene = {},
		rare_display = {
	...
	pg.base.item_data_battleui[109] = {
		...
		is_unlock = 1,
		rare = 3,
		desc = "以水墨勾勒而出的介面，墨跡於黑白間暈染，襯得竹影婆娑，共同營造出清冷雅緻的氛圍。",
		id = 109,
		icon = "109",
		scene = {},
		rare_display = {
	...
	pg.base.item_data_battleui[111] = {
		...
		is_unlock = 1,
		rare = 3,
		desc = "簡單皮影勾勒無窮遐想，簡約故事蘊含美好期望。暖色調與寧靜風韻共同營造出淡泊氛圍。",
		id = 111,
		icon = "111",
		scene = {},
		rare_display = {
	...
	pg.base.item_data_battleui[205] = {
		...
		is_unlock = 1,
		rare = 4,
		desc = "該介面專為喜歡忍者風格的指揮官準備，使用手裡劍與飛鏢在忍者之城大顯身手吧。",
		id = 205,
		icon = "205",
		scene = {},
		rare_display = {
