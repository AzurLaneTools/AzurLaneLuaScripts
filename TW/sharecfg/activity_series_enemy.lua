...
「願童心永駐。」]],
	...
	pg.base.activity_series_enemy[4001] = {
		...
		count = 0,
		ex_count = "",
		profiles = "【AREA-1】虛像塔週邊突現時空異常海域，帶領白鷹艦隊展開武裝偵察。",
		collection_group_id = 0,
		whether_singlefight = 1,
		id = 4001,
		limitation = {},
	...
	pg.base.activity_series_enemy[4011] = {
		...
		count = 0,
		ex_count = "",
		profiles = "【AREA-2】戰役已經開始，與鳶尾艦隊和東煌艦隊一起清理這片區域。",
		collection_group_id = 0,
		whether_singlefight = 1,
		id = 4011,
		limitation = {},
	...
	pg.base.activity_series_enemy[4021] = {
		...
		count = 0,
		ex_count = "",
		profiles = "【AREA-3】戰役已經開始，與鐵血艦隊和薩丁艦隊一同清理這區域。",
		collection_group_id = 0,
		whether_singlefight = 1,
		id = 4021,
		limitation = {},
	...
	pg.base.activity_series_enemy[4031] = {
		...
		count = 0,
		ex_count = "",
		profiles = "【AREA-4】戰役已經開始，與皇家艦隊和北聯艦隊一同清理這片區域。",
		collection_group_id = 0,
		whether_singlefight = 1,
		id = 4031,
		limitation = {},
	...
	pg.base.activity_series_enemy[4041] = {
		...
		count = 0,
		ex_count = "",
		profiles = "【AREA-5】戰役已經開始，與重櫻艦隊和鬱金艦隊一同清理這區域。",
		collection_group_id = 0,
		whether_singlefight = 1,
		id = 4041,
		limitation = {},
	...
	pg.base.activity_series_enemy[4051] = {
		...
		count = 0,
		ex_count = "",
		profiles = "【AREA-6】決戰之時已到，帶領港區聯合艦隊擊破惡夢迷宮。",
		collection_group_id = 0,
		whether_singlefight = 1,
		id = 4051,
		limitation = {},
...
在克制與放縱間搖曳。]],
	...
	pg.base.activity_series_enemy[6001] = {
		...
		ex_count = "",
		additional_awards_display = "",
		profiles = "最普通不過的單人病房，配有柔和的燈光與整潔的床鋪，但門鎖始終緊閉。",
		collection_group_id = 104,
		whether_singlefight = 0,
		id = 6001,
		limitation = {},
	...
	pg.base.activity_series_enemy[6004] = {
		...
		ex_count = "",
		additional_awards_display = "",
		profiles = "白夜山莊的地下區域，隱沒在主建築之下，埋藏著許多無人知曉的秘密。",
		collection_group_id = 107,
		whether_singlefight = 0,
		id = 6004,
		limitation = {},
	...
	pg.base.activity_series_enemy[6005] = {
		...
		count = 0,
		additional_awards_display = "",
		profiles = "白夜山莊地處偏僻，交通閉塞，直升機成了少數能快速出入此地的方式。",
		pass_awards_display = "",
		collection_group_id = 0,
		whether_singlefight = 0,
		id = 6005,
