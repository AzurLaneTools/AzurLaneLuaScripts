		...
		link_params = {
			{
				3,
				51071,
				"完成「怪談紀實：逃離白夜山莊！」-活動主頁右上方「紀念冊」中的各項紀念任務"
			}
		}
	}
