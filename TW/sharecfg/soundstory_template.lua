...
pg.soundstory_template = {
	...
	},
	{
		...
		overview = "少女的氣息如輕風拂面 \n想要陪在指揮官身邊的思緒 \n都化作了枕邊的輕聲細語",
		order = 2,
		audition_text = "這裡能感受到指揮官的氣息呢，再靠近指揮官一點吧…",
		time = "always",
		ship_id = 20135,
		id = 3,
	...
	},
	{
		...
		overview = "摩天輪、冰淇淋以及比冰淇淋更甜美的紐澤西。",
		order = 2,
		audition_text = "是在摩天輪頂端的約定俗成哦♪我會為Honey創造最美好的回憶。",
		time = "always",
		ship_id = 10517,
		id = 4,
	...
	},
	{
		...
		overview = "想要惡作劇的少女，因為自己的笨拙反而送出了一份特別的「禮物」。",
		order = 2,
		audition_text = "話說回來怎麼指揮官還沒來啊……到底要讓哈曼等多久？",
		ship_id = 10125,
		id = 6,
	...
	[11] = {
		...
		overview = "於圖書館中偶遇到看書的雲仙。\n隨後和她一同在圖書館讀書，伴著她的聲音，兩人間氣氛逐漸變得曖昧……",
		order = 2,
		audition_text = "嗯？雲仙的聲音令人沉醉…？就像……甘露一樣嗎……？",
		ship_id = 30319,
		id = 11,
	...
	[12] = {
		...
		overview = "為了繼續與華甲進行捉鬼遊戲，\n兩人躲進了一個狹窄的櫃子裡……",
		order = 2,
		audition_text = "您說我膽子變大了？在這誰都看不到的地方……大膽一點也沒關係吧。",
		ship_id = 50602,
		id = 12,
	...
	[13] = {
		...
		overview = "在這個灼熱的夏夜，\n與腓特烈·卡爾一同品味「愛」的真諦。",
		order = 2,
		audition_text = "我的指揮官……今天就一直陪在我身邊吧？",
		ship_id = 40314,
		id = 13,
	...
	[14] = {
		...
		overview = "尋找寶藏卻因意外一同落入陷阱的少女，\n於黑暗中展現了「真實的面目」。",
		order = 2,
		audition_text = "嗯？不管嘴上怎麼說，身體的反應還是很誠實嘛。一看就知道被香味吸引了呢？",
		ship_id = 960001,
		id = 14,
