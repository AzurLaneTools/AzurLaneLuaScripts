return {
	...
	},
	{
		...
		isShow = function ()
			return getProxy(MetaCharacterProxy):getMetaProgressVOByID(970205) and slot1:isInAct()
		end,
		isTip = function ()
			if getProxy(MetaCharacterProxy):getMetaProgressVOByID(970205):isPassType() then
				return false
			end
