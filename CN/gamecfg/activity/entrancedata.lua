return {
	...
	},
	{
		...
		isShow = function ()
			return getProxy(MetaCharacterProxy):getMetaProgressVOByID(970706) and slot1:isInAct()
		end,
		isTip = function ()
			if getProxy(MetaCharacterProxy):getMetaProgressVOByID(970706):isPassType() then
				return false
			end
