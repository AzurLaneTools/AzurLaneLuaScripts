...
版本更新提示：
感谢您下载并使用《碧蓝航线》游戏（以下称“本游戏”或“产品”）。我们依据《中华人民共和国网络安全法》、《信息安全技术个人信息安全规范》（GB/T 35273-2020）以及其他相关法律法规和技术规范更新了本《隐私政策》，其中主要包括如下内容：调整了我们使用您个人信息以及授权权限的场景描述（见第四部分4.1条和4.2条）。
...
（5）通知权限：当您使用哔哩哔哩游戏中提醒功能时，您需要授权我们获取您的通知权限，用以提供提醒服务。如您拒绝提供该信息仅会使您无法使用该功能，但并不影响您使用哔哩哔哩游戏产品的其他功能，您也可以随时撤回您的通知权限授权。
