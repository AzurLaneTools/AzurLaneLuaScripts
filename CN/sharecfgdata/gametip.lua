...
_G.pg.base.gametip.coloring_help_tip = {
	tip = {
		...
		{
			info = [[
1.每张绘图日记的单元格上标注有对应的颜料编号，点击右侧对应编号的颜料即可自动进行上色。
2.绘图区域可以通过双指拉伸或缩小。
...
_G.pg.base.gametip.shan_luan_task_help = {
	tip = {
		{
			info = [[
活动时间：<color=#92fc63>11.23-12.7 维护 </color>
...
_G.pg.base.gametip.help_chunjie2024 = {
	tip = {
		{
			info = [[
活动时间：<color=#92fc63>2024.1.30-2024.2.22维护</color>
活动简介：
...
_G.pg.base.gametip.island_manage_help_tip = {
	tip = [[
餐品的吸引力会影响餐品的销售情况，吸引力越高，餐品售出概率越大。
...
_G.pg.base.gametip.island_urgent_notice = {
	tip = {
		...
		{
			info = [[
在<color=#39bfff>2025.11.06维护</color>后，司令部将对本次岛屿开发季进行特殊重置，新的开发季持续时间为：<color=#39bfff>2025.11.6维护后~2026.2.5维护</color>，同时也将通过<color=#39bfff>「主界面」-「补偿」</color>向各位指挥官发放岛屿开发季相关补偿，届时还请指挥官注意查收。 
※相关重置及补偿规则： 
...
_G.pg.base.gametip.dal_chapter_tip = {
	tip = [[
<color=#92fc63><DATE A LANE>作战</color>
