...
【快速起飞】、【背水之战】]],
	...
	pg.base.strategy_data_template[200931] = {
		...
		name = "挑战模式",
		desc = [[
战斗开始时若我方任意角色装备有<color=#92fc63>奇怪装置「D」</color>，将会进入挑战模式，挑战高难度同时将有机会获得更高的通关分数。
...
【背水之战】]],
	...
	pg.base.strategy_data_template[201655] = {
		...
		name = "挑战说明",
		desc = [[
BOSS会根据当前血量百分比拟态成三种不同单位（<color=#92fc63>以70%与40%为临界点</color>），拟态状态下<color=#92fc63>受到的伤害减少50%</color>。
拟态状态下为固定血量，被<color=#92fc63>击破后变回原形，并在8秒后重新拟态</color>。
非拟态状态下护甲类型为轻甲，拟态状态下固定为重甲。
...
【背水之战】、【彩虹计划】、【绝体绝命】]],
	...
	pg.base.strategy_data_template[201741] = {
		...
		name = "挑战说明",
		desc = [[
BOSS会减少自身受到超过20距离攻击来源的伤害，<color=#92fc63>每多1距离便减少1%，最多减少50%</color>；同时提高对更远距离目标造成的伤害，超过20距离以外<color=#92fc63>每多1距离提高2%，最多提高100%</color>。
...
【背水之战】、【彩虹计划】、【绝体绝命】、【不屈意志】]],
	...
	pg.base.strategy_data_template[201743] = {
		...
		name = "挑战说明",
		desc = [[
本关卡两名BOSS中任意一名被击败，都会使另一名进入[情绪高涨]状态，<color=#ffc038>改变攻击方式并特大幅度提高自身伤害</color>。
...
【背水之战】、【彩虹计划】、【绝体绝命】、【不屈意志】]],
	...
	pg.base.strategy_data_template[201765] = {
		...
		name = "挑战说明",
		desc = [[
战斗中我方角色每次受到的治疗效果都会被BOSS窃取，使BOSS<color=#92fc63>恢复其自身1%耐久</color>，且我方空袭无法消除其黑色的弹幕。
...
【背水之战】、【彩虹计划】、【绝体绝命】、【不屈意志】]],
	...
	pg.base.strategy_data_template[201832] = {
		...
		name = "挑战说明",
		desc = [[
战斗中好人理查德周身环绕红黑色龙卷风，对较近单位产生引力影响，单位过于靠近将会被<color=#ee0000>直接【吞噬】</color>。
