...
……
“这是一场无耻的蓄意抹黑！”
白宫发言人于新闻发布会上表示，北方联合针对白鹰联邦进行大规模杀伤性武器试验的指责是毫无根据且不负责任的。这完全是针对白鹰联邦的蓄意中伤，是前进阵线对大洋联邦进行毫无底线的舆论战的又一有力证明。
发言人随后展示了一组海洋监测数据，数据表明，从海啸发生至今，百慕大海域辐射指数一直处于正常范围内，该区域中发生的地震，以及其引发的海啸，只是一次不幸的自然灾害而已。
针对这一言论，已有多名国际知名地质学家对其表示了认可。即该地震是一种极为少见的高强度浅表层地震。国际海洋环境保护组织发表声明称，该组织会密切关注这一事件可能对海洋环境造成的影响……
]],
		pic = ""
	},
	[13105] = {
