...
pg.base.ship_skin_template_14 = {
	...
	[702013] = {
		name = "微醺的海风",
		change_skin = "",
		desc = "宴会结束了？还早着呢，来，干杯吧~！指挥官，只要喝下这一杯……所有的事……都……zzz……",
		illustrator2 = -1,
		ship_group = 70201,
		group_index = 3,
		purchase_offset = "",
	...
	[702052] = {
		name = "雨夜的蓝色心情",
		change_skin = "",
		desc = "指挥官……你身上还带着雨夜的湿润气息呢，快让我来温暖你吧。这些绷带？它们也是侍奉的一环哦，具体作用是……先猜猜吧？呵呵~",
		illustrator2 = -1,
		ship_group = 70205,
		group_index = 2,
		purchase_offset = "",
	...
	[702091] = {
		name = "盲打练习：触觉麻将",
		change_skin = "",
		desc = "接下来……让我们来练习如何盲打麻将吧……这也是精神训练的一部分哦，嘿嘿~♡",
		illustrator2 = -1,
		ship_group = 70209,
		group_index = 1,
		purchase_offset = "",
	...
	[702101] = {
		name = "情感数据维护中",
		change_skin = "",
		desc = "检测到系统性错误，异常数据持续生成中，电量消耗过高，紧急诊断协议启动——指挥官，在我排查出原因之前……请就这样待在我身边……不要乱动……",
		illustrator2 = -1,
		ship_group = 70210,
		group_index = 1,
		purchase_offset = "",
	...
	[703031] = {
		name = "待君落子之时",
		change_skin = "",
		desc = "棋盘十九路，方寸见真章。学习围棋的时候，我就期待着能与你对弈——接下来，请看我以此子，为棋局，定胜负。",
		illustrator2 = -1,
		ship_group = 70303,
		group_index = 1,
		purchase_offset = "",
	...
	[718012] = {
		name = "动物特工",
		change_skin = "",
		desc = "特别的动物服装……还以为是什么着装，没想到竟然是这种装扮……！不、不用担心！指挥官同志，对北方联合的特工来说，这种程度没什么大不了的……！",
		illustrator2 = -1,
		ship_group = 71801,
		group_index = 2,
		purchase_offset = "",
	...
	[802032] = {
		name = "Milk&Kiss",
		desc = "这位客人，午睡时间结束了……别急着睁眼哦，让我用魔法帮你驱散最后一点困意吧~",
		illustrator2 = -1,
		ship_group = 80203,
		group_index = 2,
		purchase_offset = "",
