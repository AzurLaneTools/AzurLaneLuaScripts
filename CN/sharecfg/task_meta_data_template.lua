...
(function ()
	...
	pg.base.task_meta_data_template[100552] = {
		...
		id = 100552,
		target_num = 1,
		desc = "使用{namecode:555}击破等级＞30的敌方1次"
	}
	pg.base.task_meta_data_template[100553] = {
		...
		id = 100553,
		target_num = 1,
		desc = "使用{namecode:555}击破等级＞55的敌方1次"
	}
	pg.base.task_meta_data_template[100554] = {
		...
		id = 100554,
		target_num = 1,
		desc = "使用{namecode:555}击破等级＞80的敌方1次"
	}
	pg.base.task_meta_data_template[100555] = {
		...
		id = 100555,
		target_num = 1,
		desc = "使用{namecode:555}击破等级＞100的敌方1次"
	}
	...
	pg.base.task_meta_data_template[100575] = {
		...
		id = 100575,
		target_num = 1,
		desc = "使用布里斯托尔·META击破等级＞100的敌方1次"
	}
...
(function ()
	...
	pg.base.task_meta_data_template[200412] = {
		...
		id = 200412,
		target_num = 1,
		desc = "大型作战内使用克利夫兰·META击破等级＞70的敌方1次"
	}
	pg.base.task_meta_data_template[200413] = {
		...
		id = 200413,
		target_num = 1,
		desc = "大型作战内使用克利夫兰·META击破等级＞90的敌方1次"
	}
	pg.base.task_meta_data_template[200414] = {
		...
		id = 200414,
		target_num = 1,
		desc = "大型作战内使用克利夫兰·META击破等级＞100的敌方1次"
	}
	...
	pg.base.task_meta_data_template[200422] = {
		...
		id = 200422,
		target_num = 1,
		desc = "大型作战内使用龙骑兵·META击破等级＞70的敌方1次"
	}
	pg.base.task_meta_data_template[200423] = {
		...
		id = 200423,
		target_num = 1,
		desc = "大型作战内使用龙骑兵·META击破等级＞90的敌方1次"
	}
	...
	pg.base.task_meta_data_template[200461] = {
		...
		id = 200461,
		target_num = 1,
		desc = "大型作战内使用{namecode:555}获得1次胜利"
	}
	pg.base.task_meta_data_template[200462] = {
		...
		id = 200462,
		target_num = 1,
		desc = "大型作战内使用{namecode:555}击破等级＞70的敌方1次"
	}
	pg.base.task_meta_data_template[200463] = {
		...
		id = 200463,
		target_num = 1,
		desc = "大型作战内使用{namecode:555}击破等级＞90的敌方1次"
	}
	pg.base.task_meta_data_template[200464] = {
		...
		id = 200464,
		target_num = 1,
		desc = "大型作战内使用{namecode:555}击破等级＞100的敌方1次"
	}
	...
	pg.base.task_meta_data_template[200482] = {
		...
		id = 200482,
		target_num = 1,
		desc = "大型作战内使用布里斯托尔·META击破等级＞70的敌方1次"
	}
	pg.base.task_meta_data_template[200483] = {
		...
		id = 200483,
		target_num = 1,
		desc = "大型作战内使用布里斯托尔·META击破等级＞90的敌方1次"
	}
	pg.base.task_meta_data_template[200484] = {
		...
		id = 200484,
		target_num = 1,
		desc = "大型作战内使用布里斯托尔·META击破等级＞100的敌方1次"
	}
	...
	pg.base.task_meta_data_template[200512] = {
		...
		id = 200512,
		target_num = 1,
		desc = "大型作战内使用胜利·META击破等级＞70的敌方1次"
	}
	pg.base.task_meta_data_template[200513] = {
		...
		id = 200513,
		target_num = 1,
		desc = "大型作战内使用胜利·META击破等级＞90的敌方1次"
	}
	pg.base.task_meta_data_template[200514] = {
		...
		id = 200514,
		target_num = 1,
		desc = "大型作战内使用胜利·META击破等级＞100的敌方1次"
	}
	...
	pg.base.task_meta_data_template[200502] = {
		...
		id = 200502,
		target_num = 1,
		desc = "大型作战内使用萨拉托加·META击破等级＞70的敌方1次"
	}
	pg.base.task_meta_data_template[200503] = {
		...
		id = 200503,
		target_num = 1,
		desc = "大型作战内使用萨拉托加·META击破等级＞90的敌方1次"
	}
	pg.base.task_meta_data_template[200504] = {
		...
		id = 200504,
		target_num = 1,
		desc = "大型作战内使用萨拉托加·META击破等级＞100的敌方1次"
	}
...
(function ()
	pg.base.task_meta_data_template[200522] = {
		...
		id = 200522,
		target_num = 1,
		desc = "大型作战内使用灵敏·META击破等级＞70的敌方1次"
	}
	pg.base.task_meta_data_template[200523] = {
		...
		id = 200523,
		target_num = 1,
		desc = "大型作战内使用灵敏·META击破等级＞90的敌方1次"
	}
	pg.base.task_meta_data_template[200524] = {
		...
		id = 200524,
		target_num = 1,
		desc = "大型作战内使用灵敏·META击破等级＞100的敌方1次"
	}
end)()
