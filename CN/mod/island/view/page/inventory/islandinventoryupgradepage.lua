...
slot0.OnLoaded = function(slot0)
	slot0.consumeList = UIItemList.New(slot0._tf:Find("frame/bottom/consume/list"), slot0._tf:Find("frame/bottom/consume/list/tpl"))
	slot0.maxLevelTip = slot0._tf:Find("frame/bottom/bg/max_level")
	slot0.capacityTxt = slot0._tf:Find("frame/bottom/capacity/Text"):GetComponent(typeof(Text))
	slot0.confirmBtn = slot0._tf:Find("frame/confirm")
	slot0.levelTxt = slot0._tf:Find("frame/top/level"):GetComponent(typeof(Text))
	slot0.nextLevelTxt = slot0._tf:Find("frame/top/level/next"):GetComponent(typeof(Text))
	slot0.maxLevelTxt = slot0._tf:Find("frame/top/max_level"):GetComponent(typeof(Text))
	slot0.closeBtn = slot0._tf:Find("frame/top/close")

	setText(slot0._tf:Find("frame/top/title"), i18n("island_bag_upgrade_tip"))
	setText(slot0._tf:Find("frame/bottom/Text"), i18n("island_bag_upgrade_req"))
	setText(slot0._tf:Find("frame/bottom/bg/max_level"), i18n("island_bag_upgrade_max_level"))
	setText(slot0._tf:Find("frame/bottom/capacity/label"), i18n("island_bag_upgrade_capacity"))
end
