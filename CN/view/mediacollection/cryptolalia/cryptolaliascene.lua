...
slot0.init = function(slot0)
	...
	slot0.auditionBtn = slot0._tf:Find("Main/audition/toggle")
	slot0.auditionBtnOn = slot0._tf:Find("Main/audition/toggle/on")
	slot0.auditionBtnOff = slot0._tf:Find("Main/audition/toggle/off")
	slot0.cdImg = slot0._tf:Find("Main/cd"):GetComponent(typeof(Image))
	slot0.cdSignatureImg = slot0._tf:Find("Main/cd/signature"):GetComponent(typeof(Image))
	slot0.shipName = slot0._tf:Find("Main/cd/name"):GetComponent(typeof(Text))
	slot0.timeLimit = slot0._tf:Find("Main/cd/timelimit")
	slot0.timeTxt = slot0._tf:Find("Main/cd/timelimit/Text"):GetComponent(typeof(Text))
	slot0.nameTxt = slot0._tf:Find("Main/name"):GetComponent(typeof(Text))
	slot0.authorTxt = slot0._tf:Find("Main/author"):GetComponent(typeof(Text))
	slot0.descTxt = slot0._tf:Find("Main/desc"):GetComponent(typeof(Text))
	slot0.signatureImg = slot0._tf:Find("Main/desc/signature"):GetComponent(typeof(Image))
	slot0.auditionTxt = slot0._tf:Find("Main/audition/mask/Text"):GetComponent("ScrollText")
	slot0.auditionEffect = slot0._tf:Find("Main/audition/p2/Lines"):GetComponent(typeof(Animation))

	slot0.auditionEffect:Play("anim_line_reset")

	slot0.btnsTr = slot0._tf:Find("Main/btns")
	...
	slot0.scrollRect = CryptolaliaScrollRect.New(slot0._tf:Find("Main/list/tpl"), CryptolaliaScrollRectAnimation.New(slot0._tf))
	...
	setText(slot0._tf:Find("Main/cd/timelimit/label"), i18n("cryptolalia_timelimie"))
