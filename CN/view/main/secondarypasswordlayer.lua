...
slot0.init = function(slot0)
	...
	slot0.setView = slot0.window:Find("sliders/set")
	slot0.inputView = slot0.window:Find("sliders/input")
	slot0.frame = slot0._tf:Find("frame")
	slot0.informBg = slot0.window:Find("top/bg/information")
	slot0.textTitle = slot0.informBg:Find("title"):GetComponent(typeof(Text))
	slot0.textTitleEn = slot0.informBg:Find("title/title_en"):GetComponent(typeof(Text))
	slot0.inputpanel = slot0.window:Find("inputpanel")
	slot0.containerbtn = slot0.inputpanel:Find("btns")
	...
	slot0.btnconfirm = slot0.inputpanel:Find("confirmbtn")
	slot0.btndelete = slot0.inputpanel:Find("deletebtn")
	slot0.btnclose = slot0.window:Find("top/btnBack")
	slot0.resources = slot0._tf:Find("resources")
	slot0.selectFrame = slot0._tf:Find("resources/xian")
	slot0.setDigitGroup = {}
	slot0.setLine1Grid = slot0.setView:Find("line1/input/grid")
	slot0.setLine2Grid = slot0.setView:Find("line2/input/grid")
	...
	slot0.btnhide = slot0.setView:Find("line1/hidebtn/hide")
	slot0.btnshow = slot0.setView:Find("line1/hidebtn/show")
	slot0.tipseterror = slot0.setView:Find("line2/tip")
	slot0.inputDigitGroup = {}
	slot0.inputLineGrid = slot0.inputView:Find("line1/input/grid")
