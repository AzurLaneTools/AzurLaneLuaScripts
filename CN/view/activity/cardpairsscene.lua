...
slot0.init = function(slot0)
	...
	slot0.cardTpl = slot0._tf:Find("res/card")
	slot0.cardCon = slot0._tf:Find("card_con/layout")
	slot0.pics = slot0._tf:Find("res/pics")
	slot0.helpBtn = slot0._tf:Find("top/help_btn")
	slot0.timesTxt = slot0._tf:Find("num_txt")
	slot0.timeTxt = slot0._tf:Find("time_txt")
	slot0.bestTxt = slot0._tf:Find("best_txt")
	slot0.maskBtn = slot0._tf:Find("mask_btn")
	slot0.endTips = slot0._tf:Find("end_tips")

	slot0:hideChild(slot0._tf:Find("res"))
end
