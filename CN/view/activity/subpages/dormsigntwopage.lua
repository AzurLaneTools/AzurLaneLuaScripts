slot0 = class("DormSignTwoPage", import("view.base.BaseActivityPage"))
...
slot0.OnFirstFlush = function(slot0)
	slot0.uilist:make(function (slot0, slot1, slot2)
		...
		if slot0 == UIItemList.EventUpdate then
			...
			setActive(uv0:findTF("get_bg", slot2), slot5 and slot5:getTaskStatus() == 1 and not slot5:isOver())
		end
	end)
	...
	PlayerPrefs.SetString("DormSignTwoPage", uv0.GetDate())
end
...
slot0.IsShowGoRed = function()
	return PlayerPrefs.GetString("DormSignTwoPage", "") ~= uv0.GetDate()
end

slot0.IsShowAwardRed = function()
	slot0 = getProxy(ActivityTaskProxy)

	return _.any(slot0:getTaskById(ActivityConst.DORM_SIGN_ID_2), function (slot0)
