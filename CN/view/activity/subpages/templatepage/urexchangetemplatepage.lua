...
slot0.InitDic = function(slot0)
	slot0.taskTypeDic = {
		[uv0.SP_FIRST] = function (slot0, slot1)
		...
		[uv0.SP_DAILY] = function (slot0, slot1)
		...
		[uv0.RANDOM_DAILY] = function (slot0, slot1)
			slot2 = nil
		...
		[uv0.CHALLANGE] = function (slot0, slot1)
			slot2 = 0
			slot3 = nil
		...
		[uv0.SHOP_BUY] = function (slot0, slot1)
...
slot0.UpdateTask = function(slot0, slot1, slot2)
	...
	slot7, slot8 = slot0.taskTypeDic[slot4](slot0, slot6)
