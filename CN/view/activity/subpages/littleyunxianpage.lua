slot0 = class("LittleYunXianPage", import(".TemplatePage.PtTemplatePage"))

slot0.OnInit = function(slot0)
	uv0.super.OnInit(slot0)

	slot1 = slot0.bg
	slot0.adPhase1 = slot1:Find("PHASE1")
	slot1 = slot0.bg
	slot0.adPhase2 = slot1:Find("PHASE2")
	slot1 = slot0.bg
...
slot0.OnUpdateFlush = function(slot0)
	...
	setText(slot0.adPhase1, i18n("littleyunxian_tip1"))
	setText(slot0.adPhase2, i18n("littleyunxian_tip2"))
	...
	setText(slot0.step, setColorStr(slot1, "#b9aef8") .. " / " .. setColorStr(slot2, "#666176"))
	setText(slot0.progress, (slot6 >= 1 and setColorStr(slot4, COLOR_GREEN) or setColorStr(slot4, "#b9aef8")) .. "/" .. setColorStr(slot5, "#666176"))
...
slot0.updateTaskList = function(slot0, slot1, slot2, slot3, slot4)
	...
	if slot4.subType ~= 33 then
		setText(findTF(slot14, "pahase"), setColorStr(slot7, "#b1a2d3") .. "/" .. setColorStr(slot6, "#b1a2d3"))
	else
