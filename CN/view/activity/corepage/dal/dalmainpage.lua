slot0 = class("DALMainPage", import("view.activity.CorePage.CoreActivityPage"))
...
slot0.OnInit = function(slot0)
	...
	setText(slot0.shop:Find("Text"), i18n("yumia_main_tip_3"))
	setText(slot0.fight:Find("Text"), i18n("yumia_main_tip_2"))
	setText(slot0.build:Find("Text"), i18n("yumia_main_tip_1"))
end

slot0.OnDataSetting = function(slot0)
	slot0.timeMgr = pg.TimeMgr.GetInstance()
	slot0.shop_id = slot0.activity:getConfig("config_client").shopItemID
end
...
slot0.updateUI = function(slot0)
	...
	onButton(slot0, slot0.fight, function ()
		uv0:emit(ActivityMediator.ON_COLLAB_BOSSRUSH_MAP)
	end)
end
