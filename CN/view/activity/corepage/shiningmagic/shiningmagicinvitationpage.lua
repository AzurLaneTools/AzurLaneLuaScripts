slot0 = class("ShiningMagicInvitationPage", import("view.activity.CorePage.CoreActivityPage"))
...
slot0.OnFirstFlush = function(slot0)
	onButton(slot0, slot0.goBtn, function ()
		if uv0.coreActivityUI:GetActivityIdByPageClass("ShiningMagicPacmanPage") then
...
slot0.RefreshButtons = function(slot0)
	...
	slot3 = slot1 == 2
	slot4, slot5 = getActivityTask(slot0.activity)
	slot6 = slot4 and slot5 and not slot5:isFinish()
	...
	setActive(slot0.red, slot2 or slot6)
