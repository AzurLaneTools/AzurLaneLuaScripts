...
slot0.init = function(slot0)
	slot0.bgTF = slot0._tf:Find("main/bg")
	slot0.clickTF = slot0._tf:Find("click")
	slot0.paintTF = slot0._tf:Find("main/paint")
	slot0.paintTFCG = slot0.paintTF:GetComponent(typeof(CanvasGroup))
	slot0.infoTF = slot0._tf:Find("main/info")
	slot0.leftPanel = slot0._tf:Find("left_panel")
	slot0.lockBtn = slot0._tf:Find("left_panel/btns/lock")
	slot0.unlockBtn = slot0._tf:Find("left_panel/btns/unlock")
	slot0.shareBtn = slot0._tf:Find("left_panel/btns/share")
	slot0.nameTF = slot0.infoTF:Find("content/name/value"):GetComponent(typeof(Text))
	slot0.nationTF = slot0.infoTF:Find("content/nation/value"):GetComponent(typeof(Text))
	slot0.rarityTF = slot0.infoTF:Find("content/rarity/value"):GetComponent(typeof(Image))
	slot0.skillTF = slot0.infoTF:Find("content/skill/value"):GetComponent(typeof(Text))
	slot0.abilitysTF = slot0.infoTF:Find("content/abilitys/attrs")
	slot0.talentsTF = slot0.infoTF:Find("content/talents")
	slot0.talentsList = UIItemList.New(slot0.talentsTF, slot0.talentsTF:Find("talent"))
	slot0.dateTF = slot0.infoTF:Find("content/copyright/Text")
	...
	slot0.getEffect = slot0._tf:Find("main/effect")
	slot0.skipAnim = true
	...
	setText(slot0._tf:Find("main/info/content/abilitys/attrs/command/name/Text"), i18n("commander_command_ability"))
	setText(slot0._tf:Find("main/info/content/abilitys/attrs/tactic/name/Text"), i18n("commander_tactical_ability"))
	setText(slot0._tf:Find("main/info/content/abilitys/attrs/support/name/Text"), i18n("commander_logistics_ability"))
	setText(slot0._tf:Find("main/info/content/copyright/title"), i18n("commander_get_commander_coptyright"))
end
