...
slot0.init = function(slot0)
	slot0.frame = slot0._tf:Find("bg")
	slot0.closeBtn = slot0._tf:Find("bg/frame/close_btn")
	slot0.levelInfoBtn = slot0._tf:Find("bg/frame/title/help")
	slot0.levelTxt = slot0._tf:Find("bg/frame/title/Text"):GetComponent(typeof(Text))
	slot0.scrollRect = slot0._tf:Find("bg/frame/scrollrect"):GetComponent("ScrollRect")
	slot0.scrollRectContent = slot0._tf:Find("bg/frame/scrollrect/content")
	slot0.batchBtn = slot0._tf:Find("bg/frame/batch")
	slot0.opAnim = slot0._tf:Find("animation"):GetComponent(typeof(Animator))
	slot0.UIlist = UIItemList.New(slot0.scrollRectContent, slot0.scrollRectContent:Find("tpl"))
	slot0.helpBtn = slot0._tf:Find("bg/frame/help")
	slot0.cntTxt = slot0._tf:Find("bg/frame/cnt/Text"):GetComponent(typeof(Text))
	slot0.cards = {}
	...
	slot0.flower = CatteryFlowerView.New(slot0._tf:Find("bg/frame/flower"))
	slot0.bubbleTF = slot0._tf:Find("bg/bubble")
