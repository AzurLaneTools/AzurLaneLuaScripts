...
slot0.OnLoaded = function(slot0)
	slot0.scrollRect = slot0._tf:Find("frame/list"):GetComponent("LScrollRect")
	...
	slot0.leftArrBtn = slot0._tf:Find("arr_left")
	slot0.rightArrBtn = slot0._tf:Find("arr_right")
	slot0.gemTxt = slot0._tf:Find("res_gem/Text"):GetComponent(typeof(Text))
	slot0.goldTxt = slot0._tf:Find("res_gold/Text"):GetComponent(typeof(Text))
	slot0.gemAddBtn = slot0._tf:Find("res_gem/jiahao")
	slot0.goldAddBtn = slot0._tf:Find("res_gold/jiahao")
	slot0.purchaseBtn = slot0._tf:Find("frame/purchase_btn")
	slot0.purchaseAllBtn = slot0._tf:Find("frame/purchase_all_btn")
