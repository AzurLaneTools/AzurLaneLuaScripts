slot0 = class("GameRoomIceCreamView", import("..BaseMiniGameView"))
...
slot18 = function(slot0, slot1, slot2, slot3)
	slot4 = {
		Ctor = function (slot0)
			...
			GetImageSpriteFromAtlasAsync("ui/minigameui/icecreamgameui_atlas", "bubble_" .. #uv2[1], uv0:Find("Bubble"), true)
	...
	slot5 = function(slot0, slot1)
		for slot5 = math.max(#slot1[1], 2), 1, -1 do
			...
			if slot1[1][slot5] then
				...
				GetImageSpriteFromAtlasAsync("ui/minigameui/icecreamgameui_atlas", uv0[slot1[1][slot5]], slot6:Find("Scoop"), true)
				...
				if slot7 then
					GetImageSpriteFromAtlasAsync("ui/minigameui/icecreamgameui_atlas", uv2[slot7], slot6:Find("Topping"), true)
				end
			end
		end
	end
