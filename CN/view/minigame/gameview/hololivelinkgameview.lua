...
slot0.findUI = function(slot0)
	slot0.backBtn = slot0._tf:Find("ForNotchPanel/BackBtn")
	slot0.helpBtn = slot0._tf:Find("ForNotchPanel/HelpBtn")
	slot0.resetBtn = slot0._tf:Find("ResetBtn")
	slot0.timeTxt = slot0._tf:Find("ForNotchPanel/CurTime/Text")
	slot0.bestTxt = slot0._tf:Find("ForNotchPanel/BestTime/Text")
	...
	slot0.resultPanel = slot0._tf:Find("ResultPanel")
	slot0.resultPanelBG = slot0.resultPanel:Find("BG")
	slot1 = slot0.resultPanel:Find("Result")
	slot0.resultNewImg = slot1:Find("NewImg")
	slot0.resultTimeText = slot1:Find("TimeText")
	slot0.resultRestartBtn = slot1:Find("RestartBtn")
end
