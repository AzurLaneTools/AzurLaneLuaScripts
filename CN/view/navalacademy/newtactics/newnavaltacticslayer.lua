...
slot0.init = function(slot0)
	slot0.painting = slot0._tf:Find("painting"):GetComponent(typeof(Image))
	slot0.backBtn = slot0._tf:Find("adpter/frame/btnBack")
	slot0.option = slot0._tf:Find("adpter/frame/option")
	slot0.stampBtn = slot0._tf:Find("stamp")
	slot0.quickFinishPanel = slot0._tf:Find("painting/quick_finish")
	slot0.quickFinishText = slot0._tf:Find("painting/quick_finish/Text")
	slot0.studentsPage = NewNavalTacticsStudentsPage.New(slot0._tf:Find("adpter"), slot0.event)
