...
slot0.FlushShooting = function(slot0)
	setActive(slot0._tf:Find("bottom/btn_shoot/on"), slot0.contextData.gameStatus.isShooting)
	setActive(slot0._tf:Find("bottom/btn_shoot/off"), not slot0.contextData.gameStatus.isShooting)
end
