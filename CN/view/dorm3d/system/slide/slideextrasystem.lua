slot0 = class("SlideExtraSystem", import("view.dorm3d.Core.BaseSystem"))
...
slot0.OnDispose = function(slot0)
	...
	slot0:Emit(Dorm3dRoomTemplateScene.EXTRA_CHANGE_PLAYER_POSITION)
...
slot0.InitSlide = function(slot0)
	...
	if not slot0.slideGo then
		slot0.slideInited = nil
	...
	slot0.slideTreeOwner.graph.blackboard:AddVariable("_player", go(slot0:GetPlayer()))
	...
	slot0.performanceTreeOwner.graph.blackboard:AddVariable("_player", go(slot0:GetPlayer()))
...
slot0.AddLadySlide = function(slot0, slot1)
	slot0.ladyDic[slot1] = LadySlide.New(slot1, slot0:GetLadyDict()[slot1], slot0.commandConfigDic[slot1], slot0.defaultPoints[slot1], function (slot0)
		uv0:PlayVFX(slot0)
	end)
...
slot0.RemoveLadySlide = function(slot0, slot1)
	if slot0.ladyDic[slot1] then
		slot0:Emit(Dorm3dRoomTemplateScene.EXTRA_CHANGE_CHARACTER_POSITION, slot0.ladyDic[slot1].ladyEnv)
