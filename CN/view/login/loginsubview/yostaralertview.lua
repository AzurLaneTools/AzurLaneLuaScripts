...
slot0.OnInit = function(slot0)
	...
	slot0.yostarEmailTxt = slot0.yostarAlert:Find("email_input_txt")
	slot0.yostarCodeTxt = slot0.yostarAlert:Find("code_input_txt")
	slot0.yostarGenCodeBtn = slot0.yostarAlert:Find("gen_code_btn")
	slot0.yostarGenTxt = slot0.yostarGenCodeBtn:Find("Text")
	slot0.yostarSureBtn = slot0.yostarAlert:Find("login_btn")
	slot0.email_text = slot0.yostarAlert:Find("title1")
	slot0.emailhold_text = slot0.yostarEmailTxt:Find("Placeholder")
	slot0.code_text = slot0.yostarAlert:Find("title2")
	slot0.codehold_text = slot0.yostarCodeTxt:Find("Placeholder")
	slot0.genBtn_text = slot0.yostarGenCodeBtn:Find("Text")
	slot0.desc_text = slot0.yostarAlert:Find("desc")
	slot0.loginBtn_text = slot0.yostarSureBtn:Find("Image")
