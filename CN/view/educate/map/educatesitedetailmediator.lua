slot0 = class("EducateSiteDetailMediator", import("..base.EducateContextMediator"))
slot0.ON_SPECIAL_EVENT_TRIGGER = "EducateSiteDetailMediator.ON_SPECIAL_EVENT_TRIGGER"
slot0.ON_MAP_SITE_OPERATE = "EducateSiteDetailMediator.ON_MAP_SITE_OPERATE"
slot0.ON_OPEN_SHOP = "EducateSiteDetailMediator.ON_OPEN_SHOP"
slot0.ON_ADD_TASK_PROGRESS = "EducateSiteDetailMediator.ON_ADD_TASK_PROGRESS"
...
function slot0.handleNotification(slot0, slot1)
	...
	if slot1:getName() == GAME.EDUCATE_TRIGGER_SPEC_EVENT_DONE then
