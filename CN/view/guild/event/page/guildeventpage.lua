...
slot0.OnLoaded = function(slot0)
	slot0.eventList = UIItemList.New(slot0._tf:Find("eventlist/content"), slot0._tf:Find("eventlist/content/tpl"))
	slot0.reportBtn = slot0._tf:Find("report_btn")
	slot0.reportTip = slot0.reportBtn:Find("tip")
	slot0.reportTipTxt = slot0.reportBtn:Find("tip/Text"):GetComponent(typeof(Text))
	slot0.formationBtn = slot0._tf:Find("formation_btn")
	slot0.missionList = slot0._tf:Find("missionlist")
	slot0.pathContains = slot0._tf:Find("missionlist/path")
	slot0.tpl = slot0:getTpl("tpl", slot0.pathContains)
	slot0.line = slot0._tf:Find("resource/line")
	slot0.lineHead = slot0._tf:Find("resource/head")
	slot0.adapter = slot0._tf:Find("resource/adapter")
	slot0.bg = slot0._tf:Find("bg"):GetComponent(typeof(Image))
	slot0.titleTF = slot0._tf:Find("title")
	slot0.nameTxt = slot0._tf:Find("title/Text"):GetComponent(typeof(Text))
	slot0.descPanel = slot0._tf:Find("missionlist/path/desc_panel")
	slot0.descPanelTag = slot0.descPanel:Find("Image"):GetComponent(typeof(Image))

	setText(slot0._tf:Find("title/timer/label"), i18n("guild_time_remaining_tip"))

	slot0.endEventTimerTxt = slot0._tf:Find("title/timer/Text"):GetComponent(typeof(Text))
