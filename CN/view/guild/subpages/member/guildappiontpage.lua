...
slot0.OnLoaded = function(slot0)
	...
	slot0.dutyContainer = slot0._tf:Find("frame/duty")
	slot0.print = slot0._tf:Find("frame/prints/print"):GetComponent(typeof(Image))
	slot0.confirmBtn = slot0._tf:Find("frame/confirm_btn")
	slot0.nameTF = slot0._tf:Find("frame/info/name/Text"):GetComponent(typeof(Text))
	slot0.iconTF = slot0._tf:Find("frame/info/shipicon/icon"):GetComponent(typeof(Image))
	slot0.starsTF = slot0._tf:Find("frame/info/shipicon/stars")
	slot0.starTF = slot0._tf:Find("frame/info/shipicon/stars/star")
	slot0.levelTF = slot0._tf:Find("frame/info/level/Text"):GetComponent(typeof(Text))
	slot0.circle = slot0._tf:Find("frame/info/shipicon/frame")
	slot0.toggles = slot0._tf:Find("frame/duty"):GetComponent(typeof(ToggleGroup))
end
