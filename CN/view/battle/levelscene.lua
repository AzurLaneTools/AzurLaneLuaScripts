...
function slot0.tryPlayMapStory(slot0)
	...
	seriesAsync({
		...
		function (slot0)
			if isActive(uv0.actAtelierBuffBtn) and pg.NewStoryMgr.GetInstance():IsPlayed("NG0033") and getProxy(ActivityProxy):AtelierActivityAllSlotIsEmpty() and getProxy(ActivityProxy):OwnAtelierActivityItemCnt(34, 1) then
				slot2 = nil
